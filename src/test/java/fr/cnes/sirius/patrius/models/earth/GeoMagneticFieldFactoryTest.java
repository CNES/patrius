...
public class GeoMagneticFieldFactoryTest {
    ...
    public void testOrekitResourceException() throws PatriusException {
    ...
    public void testGetField() throws PatriusException, IOException {
        ...
        final List<GeoMagneticElements> geoMagList = new ArrayList<>();
     ...
     */
    @Test(expected = PatriusException.class)
    public void testUnavalaibleModelException() throws PatriusException {
