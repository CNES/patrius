...
public class VariableThrustManeuverTest {
    ...
    public void testNegativeDuration() throws PatriusException {
        ...
        Orbit o1 = this.dummyOrbit(this.fireDate.shiftedBy(-11.0));
        Assert.assertTrue(switches[0].g(new SpacecraftState(o1)) < 0);
        Orbit o2 = this.dummyOrbit(this.fireDate.shiftedBy(-9.0));
        Assert.assertTrue(switches[0].g(new SpacecraftState(o2)) > 0);
        Orbit o3 = this.dummyOrbit(this.fireDate.shiftedBy(-1.0));
        Assert.assertTrue(switches[1].g(new SpacecraftState(o3)) < 0);
        Orbit o4 = this.dummyOrbit(this.fireDate.shiftedBy(1.0));
        ...
        o1 = this.dummyOrbit(this.fireDate.shiftedBy(-11.0));
        Assert.assertTrue(switches[0].g(new SpacecraftState(o1)) < 0);
        o2 = this.dummyOrbit(this.fireDate.shiftedBy(-9.0));
        Assert.assertTrue(switches[0].g(new SpacecraftState(o2)) > 0);
        o3 = this.dummyOrbit(this.fireDate.shiftedBy(-1.0));
        Assert.assertTrue(switches[1].g(new SpacecraftState(o3)) < 0);
        o4 = this.dummyOrbit(this.fireDate.shiftedBy(1.0));
        Assert.assertTrue(switches[1].g(new SpacecraftState(o4)) > 0);
     ...
     */
    private CircularOrbit dummyOrbit(final AbsoluteDate date) throws IllegalArgumentException,
                                                             PatriusException {
        return new CircularOrbit(new PVCoordinates(Vector3D.PLUS_I, Vector3D.PLUS_J),
            FramesFactory.getEME2000(), date, CelestialBodyFactory.getEarth().getGM());
    }
     ...
     */
    @Test
    public final void testNoPropagation() throws PatriusException {
    ...
    public void testPropagation() throws PatriusException {
        ...
        final Set<SpacecraftState> states = new HashSet<SpacecraftState>();
     ...
     */
    @Test
    public final void testAnyDirectionFrame() throws PatriusException {
     ...
     */
    @Test
    public final void testPD() throws PatriusException {
    ...
    public void testPropagationSplitDuringManeuver() throws PatriusException {
        ...
        // final MassProvider massModel3 = new SimpleMassModel(state.getMass("Satellite"),
        ...
        for (int i = 0; i < res1.size(); i++) {
            ...
            Assert.assertEquals(res1.get(i).getMass("Satellite"), res2.get(i).getMass("Satellite"),
                0.);
        }
        ...
        final ContinuousThrustManeuver maneuver4 = new ContinuousThrustManeuver(startDetector,
            endDetector, new PropulsiveProperty(this.thrust, this.isp), this.direction, massModel3, tank4,
            FramesFactory.getGCRF());
        ...
        for (int i = 0; i < res1.size(); i++) {
            ...
            Assert.assertEquals(
                0.0,
                (res1.get(res1.size() - 1 - i).getMass("Satellite") - res3.get(i).getMass(
                    "Satellite"))
                    / res1.get(res1.size() - 1 - i).getMass("Satellite"), 1.0E-2);
        }
    }
    ...
    public void setUp() throws PatriusException {
        ...
        builder2.addProperty(this.tankB, "thruster");
        final Assembly assembly2 = builder2.returnAssembly();
