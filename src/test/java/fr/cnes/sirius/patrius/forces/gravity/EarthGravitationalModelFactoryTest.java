...
public class EarthGravitationalModelFactoryTest {
     ...
     */
    @Test
    public final void testGetGravitationalModel() throws IOException, ParseException, PatriusException {

        // sets a default data root
        Utils.setDataRoot("potentialFactory/grgs-format");
        this.potentialFileName = GravityFieldNames.GRGS;

        final ForceModel model = EarthGravitationalModelFactory.getGravitationalModel(this.potentialFileName,
            "grim5_C1.dat", this.n, this.m, false);
        Assert.assertNotNull(model);
        Assert.assertEquals(model.getClass(), BalminoAttractionModel.class);
    }
     ...
     */
    @Test
    public final void testGetBalmino() throws IOException, ParseException, PatriusException {
        // sets a default data root
        Utils.setDataRoot("potentialFactory/icgem-format");
        this.potentialFileName = GravityFieldNames.ICGEM;

        final ForceModel model = EarthGravitationalModelFactory.getGravitationalModel(this.potentialFileName,
            "g007_eigen_05c_coef", this.n, this.m, false);
        Assert.assertNotNull(model);
        Assert.assertEquals(model.getClass(), BalminoAttractionModel.class);
    }
     ...
     */
    @Test
    public final void testGetCunningham() throws IOException, ParseException, PatriusException {
        // sets a default data root
        Utils.setDataRoot("potentialFactory/egm-format");
        this.potentialFileName = GravityFieldNames.EGM;

        final ForceModel model =
            EarthGravitationalModelFactory.getCunningham(this.potentialFileName, "egm96_to5.ascii", this.n,
                this.m, false);
        Assert.assertNotNull(model);
        Assert.assertEquals(model.getClass(), CunninghamAttractionModel.class);
    }
     ...
     */
    @Test
    public final void testGetDroziner() throws IOException, ParseException, PatriusException {
        // sets a default data root
        Utils.setDataRoot("potentialCNES/shm-format");
        this.potentialFileName = GravityFieldNames.SHM;

        final ForceModel model =
            EarthGravitationalModelFactory.getDroziner(this.potentialFileName, "eigen_cg03c_coef", this.n,
                this.m, false);
        Assert.assertNotNull(model);
        Assert.assertEquals(model.getClass(), DrozinerAttractionModel.class);
    }
     ...
     */
    @Test
    public final void testPotentialName() throws IOException, ParseException, PatriusException {
        // Initialization
        Utils.setDataRoot("potentialCNES/potentials");

        // Test all potential models and file format
        final BalminoAttractionModel balmino1 = (BalminoAttractionModel) EarthGravitationalModelFactory.getBalmino(
            GravityFieldNames.EGM, "egm1", 5, 5, false);
        final BalminoAttractionModel balmino2 = (BalminoAttractionModel) EarthGravitationalModelFactory.getBalmino(
            GravityFieldNames.EGM, "egm2", 5, 5, false);
        final CunninghamAttractionModel cunningham1 = (CunninghamAttractionModel) EarthGravitationalModelFactory
            .getCunningham(GravityFieldNames.GRGS, "grgs1.dat", 5, 5, false);
        final CunninghamAttractionModel cunningham2 = (CunninghamAttractionModel) EarthGravitationalModelFactory
            .getCunningham(GravityFieldNames.GRGS, "grgs2.dat", 5, 5, false);
        final DrozinerAttractionModel droziner1 = (DrozinerAttractionModel) EarthGravitationalModelFactory.getDroziner(
            GravityFieldNames.ICGEM, "icgem1", 5, 5, false);
        final DrozinerAttractionModel droziner2 = (DrozinerAttractionModel) EarthGravitationalModelFactory.getDroziner(
            GravityFieldNames.ICGEM, "icgem2", 5, 5, false);
        final BalminoAttractionModel gravitationalModel1 = (BalminoAttractionModel) EarthGravitationalModelFactory
            .getGravitationalModel(GravityFieldNames.SHM, "shm1", 5, 5, false);
        final BalminoAttractionModel gravitationalModel2 = (BalminoAttractionModel) EarthGravitationalModelFactory
        ...
        Assert.assertTrue(balmino1.computeAcceleration(pv).getNorm() > 1.
            && balmino1.computeAcceleration(pv).getNorm() < 100.);
        Assert.assertTrue(balmino2.computeAcceleration(pv).getNorm() > 1000.);
     ...
     */
    @Test
    public final void testMissingCoefficients() throws IOException, ParseException, PatriusException {
