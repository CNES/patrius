...
public class MSISE2000Test {
     ...
     * First call.
     */
    private static void testAtmValues120km_01012012T120000() throws PatriusException {
    ...
    private static MSISE2000 createAtmosphere(final double solarActivity[]) throws PatriusException {
     ...
     * @throws PatriusException
     */
    private static Vector3D getPositionVector(final double lat, final double lon, final double altitude)
        throws PatriusException {
        final EllipsoidPoint geoPoint = new EllipsoidPoint(getEllipsoid(), getEllipsoid().getLLHCoordinatesSystem(),
            lat, lon, altitude, "");
        return geoPoint.getPosition();
    }

    private static OneAxisEllipsoid getEllipsoid() throws PatriusException {
