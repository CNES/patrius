...
public class MSISE2000Test {
    ...
    public void testAtmosphere() throws PatriusException {
        ...
        earth1.setAngularThreshold(EPS);
        earth1.setCloseApproachThreshold(EPS);
     ...
     *                   scilab ms_msis2000 - threshold: 1E-13, limited due to PATRIUS 4.6 frame conversion optimization)
     * 
    ...
    public void testSetup() throws PatriusException {
        ...
        this.earth.setAngularThreshold(EPS);
        this.earth.setCloseApproachThreshold(EPS);
    ...
    public void testAtmValues120km_01012000T120000_latlon() throws PatriusException {
        ...
        assertEquals(399.69913810257856, temp, 0);
        assertEquals(0.0019899540368167367, pres, 0);
        assertEquals(1.5242823809148918E-8, dens, 0);
    }
    ...
    private OneAxisEllipsoid getEllipsoid() throws PatriusException {
        final OneAxisEllipsoid ellipsoid = new OneAxisEllipsoid(6378136.46, 1.0 / 298.257223563, FramesFactory.getITRF());
        ellipsoid.setAngularThreshold(1e-10);
        return ellipsoid;
    }
