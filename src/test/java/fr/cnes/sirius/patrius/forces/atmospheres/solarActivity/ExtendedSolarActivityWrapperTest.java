...
public class ExtendedSolarActivityWrapperTest {
    ...
    public void testNominal() throws PatriusException {
        ...
        // Test
        this.genericTest(provider, meanF107A1, meanF107A2, meanAp1, meanAp2, meanKp1, meanKp2);
    }
    ...
    public void testNegativeOrNullDuration() throws PatriusException {
        ...
        // Test
        this.genericTest(provider1, meanF107A1, meanF107A2, meanAp1, meanAp2, meanKp1, meanKp2);
        this.genericTest(provider2, meanF107A1, meanF107A2, meanAp1, meanAp2, meanKp1, meanKp2);
    }
     ...
     * @throws PatriusException
     */
    private void genericTest(final SolarActivityDataProvider provider,
                             final double meanF107A1, final double meanF107A2, final double meanAp1,
                             final double meanAp2,
    ...
    private class LocalSolarActivityProvider implements SolarActivityDataProvider {
        ...
        public LocalSolarActivityProvider() {
            this.mapF107 = new TreeMap<AbsoluteDate, Double>();
            this.mapApKp = new TreeMap<AbsoluteDate, Double[]>();
    ...
    public void testPropagationShortACSOL() throws PatriusException, IOException, ParseException {
        ...
        // Create propagator
        final NumericalPropagator prop = new NumericalPropagator(createDopri());
        ...
        final Attitude initialAtt =
            attitudeProv.getAttitude(initialOrbit, initialOrbit.getDate(), initialOrbit.getFrame());
        final SpacecraftState initialState = new SpacecraftState(initialOrbit, initialAtt, initialAtt, massProv1);
        prop.setInitialState(initialState);

        // Add the force models to the propagator
        final List<ForceModel> forceList = new ArrayList<ForceModel>();
    ...
    private CartesianOrbit createInitOrbit(final Frame gcrf) {
    ...
    private Assembly createAssembly() throws PatriusException {
    ...
    private FirstOrderIntegrator createDopri() {
    ...
    private ForceModel getPotential(final int n, final int m) throws IOException, PatriusException, ParseException {
        ...
        return new BalminoAttractionModel(FramesFactory.getITRF(), provider.getAe(), provider.getMu(), C, S);
    }

    private ForceModel getDrag(final Assembly assembly) throws PatriusException, IOException, ParseException {
