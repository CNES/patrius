...
public class DrozinerAttractionModelTest {
    ...
    public void testParamList() throws PatriusException, IOException, ParseException {
        ...
        final DrozinerAttractionModel model =
            new DrozinerAttractionModel(this.ITRF2005, this.ae, this.mu, this.C, this.S);

        double k = 5;
        Assert.assertEquals(2, model.getParameters().size());
        for (int i = 0; i < model.getParameters().size(); i++) {
            model.getParameters().get(i).setValue(k);
    ...
    public void testHelioSynchronous() throws ParseException, FileNotFoundException,
        ...
        this.propagator.addForceModel(new DrozinerAttractionModel(this.ITRF2005, 6378136.460, this.mu,
            new double[][] { { 0.0 }, { 0.0 }, { this.c20 } }, new double[][] { { 0.0 }, { 0.0 },
                { 0.0 } }));
        ...
        final DrozinerAttractionModel model = new DrozinerAttractionModel(this.ITRF2005, this.aeParam,
            this.muParam, c, s);
        ...
        boolean rez = false;
        try {
            model.computeAcceleration(pv, date);
        ...
        rez = false;
        try {
            new DrozinerAttractionModel(this.ITRF2005, 6378136.460, this.mu, c, s);
        ...
        try {
            model.computeAcceleration(spacecraftState);
        } catch (final PatriusException e) {
            rez = true;
        }
    ...
    public void testEcksteinHechlerReference() throws ParseException, FileNotFoundException,
        ...
        this.propagator.addForceModel(new DrozinerAttractionModel(this.ITRF2005, this.ae, this.mu, new double[][] {
            { 1.0 }, { 0.0 }, { this.c20 }, { this.c30 }, { this.c40 }, { this.c50 }, { this.c60 }, }, new double[][] {
    ...
    private static class EckStepHandler implements PatriusFixedStepHandler {
        ...
        private EckStepHandler(final Orbit initialOrbit, final double ae, final double mu,
            ...
            final double c60) throws FileNotFoundException, PatriusException {
    ...
    @Test
    public void testTesserealWithCunninghamReference() throws PatriusException, IOException,
                                                      ParseException {
        // initialization
        ...
        this.propagator.addForceModel(new CunninghamAttractionModel(this.ITRF2005, this.ae, this.mu, this.C, this.S));
        this.propagator.setInitialState(new SpacecraftState(orbit));
        ...
        this.propagator.addForceModel(new DrozinerAttractionModel(this.ITRF2005, this.ae, this.mu, this.C, this.S));
     ...
     * @testType UT
     * @testedMethod {@link SolarRadiationPressureEllipsoid#PatriusSolarRadiationPressure(PVCoordinatesProvider, org.orekit.bodies.GeometricBodyShape, RadiationSensitive, boolean)}
     * @testedMethod {@link SolarRadiationPressureEllipsoid#PatriusSolarRadiationPressure(Parameter, PVCoordinatesProvider, org.orekit.bodies.GeometricBodyShape, RadiationSensitive, boolean)}
     * @testedMethod {@link SolarRadiationPressureEllipsoid#PatriusSolarRadiationPressure(double, double, PVCoordinatesProvider, org.orekit.bodies.GeometricBodyShape, RadiationSensitive, boolean)}
    ...
    public void testNullPD() throws PatriusException {
        ...
        final DrozinerAttractionModel model = new DrozinerAttractionModel(FramesFactory.getITRF(),
            6378000, Constants.EGM96_EARTH_MU, C, S, false, false);
        final DrozinerAttractionModel model2 = new DrozinerAttractionModel(FramesFactory.getITRF(),
        ...
        propagator.addForceModel(model2);
    ...
    public void testCSTables() {
        ...
        final DrozinerAttractionModel model = new DrozinerAttractionModel(FramesFactory.getGCRF(),
    ...
    public void testGetters() {
        ...
        final DrozinerAttractionModel model = new DrozinerAttractionModel(frame, Constants.CNES_STELA_AE,
            Constants.CNES_STELA_MU, cCoefs, sCoefs);
        Assert.assertEquals(true, model.getCentralBodyFrame().getName().equals(frame.getName()));
     ...
     * @testType UT
     * 
     * @testedMethod {@link DrozinerAttractionModel#computeAcceleration(SpacecraftState)}
     * 
    ...
    public final void testMultiplicativeFactor() throws PatriusException, IOException, ParseException {
        ...
        final DrozinerAttractionModel actualModel = new DrozinerAttractionModel(FramesFactory.getGCRF(), new Parameter("", ae),
                new Parameter("", mu), c, s, false, false);
        actualModel.setMultiplicativeFactor(5.);
        final Vector3D actual = actualModel.computeAcceleration(state);
        final Vector3D expected = new DrozinerAttractionModel(FramesFactory.getGCRF(), new Parameter("", ae),
                new Parameter("", mu), c, s, false, false).computeAcceleration(state).scalarMultiply(5.);
    ...
    public void testEnrichParameterDescriptors() {
        ...
        final DrozinerAttractionModel forceModel = new DrozinerAttractionModel(this.ITRF2005,
                this.ae, this.mu, this.C, this.S);
