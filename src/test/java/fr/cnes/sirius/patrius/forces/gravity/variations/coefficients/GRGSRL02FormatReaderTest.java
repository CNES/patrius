...
public class GRGSRL02FormatReaderTest {
    ...
    public void testGetData() throws PatriusException {
        ...
        Assert.assertEquals(0, (9.5358963053068E-14 - data.get(50).get(0).getCoefCCos2A()) / 9.5358963053068E-14, this.eps);
        Assert
            .assertEquals(0, (-1.1443954852192E-12 - data.get(20).get(1).getCoefSSin1A()) / -1.1443954852192E-12, this.eps);
