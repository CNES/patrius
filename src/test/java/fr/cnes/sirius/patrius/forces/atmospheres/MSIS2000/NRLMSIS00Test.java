...
public class NRLMSIS00Test {
    ...
    public void testCover() {
        ...
        final double res5 = (double) this.atmosModel.dnet(0., 0., 1., 1., 1.);
        //final double res5 = this.atmosModel.dnet(0., 0., 1., 1., 1.);
        Assert.assertEquals(1., res5, EPS);
        final double res6 = (double) this.atmosModel.dnet(1., 100., 1., 1., 1.);
        ...
        final Double[] th = { 0., 0. };
        double res7 = this.atmosModel.densu(alt, 2., 3., 4., -d0, -xm, th, 4., 5., mn3, zn3, tn3, tgn3);
