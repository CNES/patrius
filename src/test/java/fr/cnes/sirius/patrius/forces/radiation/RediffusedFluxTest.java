    ...
    public final void testRediffusedFlux() throws PatriusException {
        ...
        final CelestialBody mockSun = new CelestialBody(){
            ...
            public Frame getInertialEquatorFrame() throws PatriusException {
                return this.sunProvider.getInertialEquatorFrame();
            }
            ...
            public Frame getTrueRotatingFrame() throws PatriusException {
                return this.sunProvider.getTrueRotatingFrame();
            }
            ...
            public Frame getMeanEquatorFrame() throws PatriusException {
                return this.sunProvider.getMeanEquatorFrame();
            }

            @Override
            public Frame getTrueEquatorFrame() throws PatriusException {
                return this.sunProvider.getTrueEquatorFrame();
            }

            @Override
            public Frame getConstantRotatingFrame() throws PatriusException {
                return this.sunProvider.getConstantRotatingFrame();
            }

            @Override
            public Frame getMeanRotatingFrame() throws PatriusException {
                return this.sunProvider.getMeanRotatingFrame();
            }
			...
			public AttractionModel getAttractionModel() {
				return this.sunProvider.getAttractionModel();
			}

			@Override
			public void setAttractionModel(AttractionModel attractionModelIn) {
				this.sunProvider.setAttractionModel(attractionModelIn);
			}
