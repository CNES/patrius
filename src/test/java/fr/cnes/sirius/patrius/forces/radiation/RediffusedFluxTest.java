    ...
    public void testRediffusedFlux() throws PatriusException {
        ...
        final CelestialBody mockSun = new CelestialBody(){
            ...
            public CelestialBodyFrame getInertialFrameConstantModel() throws PatriusException {
                return this.sunProvider.getInertialFrameConstantModel();
            }
            ...
            public CelestialBodyFrame getRotatingFrameTrueModel() throws PatriusException {
                return this.sunProvider.getRotatingFrameTrueModel();
            }
