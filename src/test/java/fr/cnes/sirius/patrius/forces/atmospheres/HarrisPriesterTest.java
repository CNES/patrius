...
public class HarrisPriesterTest {
    ...
    public void testStandard() throws PatriusException {
        ...
        final EllipsoidPoint point = new EllipsoidPoint(this.earth, this.earth.getLLHCoordinatesSystem(), 0, 0,
            500000., "");
    ...
    public void testOutOfRange() throws PatriusException {
        ...
        final EllipsoidPoint point = new EllipsoidPoint(this.earth, this.earth.getLLHCoordinatesSystem(), 0, 0, 50000.,
            "");
        final Vector3D pos = point.getPosition();
