...
/**
    ...
    public void testPropagationDifferentDegreeOrder() throws PatriusException, IOException,
        ...
        prop1.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(state1.getMu())));
        ...
        prop2.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(state2.getMu())));
        ...
        // Check that partial derivatives are the same
    ...
    public void testContrib() throws PatriusException {
        ...
        Assert.assertArrayEquals(expectedPV, actualPV, 1E-9);
    }
    ...
    public void testEnrichParameterDescriptors() throws PatriusException {
        ...
        for (final Parameter p : forceModel.getParameters()) {
            Assert.assertTrue(p.getDescriptor().contains(StandardFieldDescriptors.FORCE_MODEL, OceanTides.class));
        }
