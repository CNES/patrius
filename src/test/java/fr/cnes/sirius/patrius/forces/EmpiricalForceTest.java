...
public class EmpiricalForceTest {
     ...
     */
    @Test
    public void testComputeDacc() throws PatriusException {
     ...
     */
    @Test
    public void testComputeDacc2() throws PatriusException {
        // computes the partial derivatives:
        double[] dAccdParam = new double[3];
        final double d = 10;
     ...
     */
    @Test
    public void testComputeDacc3() throws PatriusException {
        // computes the partial derivatives:
        double[] dAccdParam = new double[3];
        final Parameter ax = new Parameter("ax", 1.E-7);
        final Parameter ay = new Parameter("ay", 2.E-7);
    ...
    @Test
    public void testComputeDacc4() throws PatriusException {
    ...
    public void testManeuverWithLOF() throws PatriusException, IOException, ParseException {
        ...
        prop1.addForceModel(empiricalForce);
        prop1.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(
            prop1.getMu())));
        ...
        prop2.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(
            prop2.getMu())));
    ...
    public void testEnrichParameterDescriptors() {
        ...
        for (final Parameter p : forceModel.getParameters()) {
            Assert.assertTrue(p.getDescriptor().contains(StandardFieldDescriptors.FORCE_MODEL, EmpiricalForce.class));
        }
