...
public class SolarRadiationPressureTest {
     ...
     */
    private Assembly createAssemblySphereAndFacets(final double mass,
                                                   final double ka,
                                                   final double ks,
    ...
    private Assembly createAssemblySphereAndFacets(final Parameter massMain,
                                                   final Parameter mass1,
                                                   final Parameter mass2,
                                                   final Parameter kaMain,
                                                   final Parameter ksMain,
                                                   final Parameter kdMain,
                                                   final Parameter ka1,
                                                   final Parameter ks1,
                                                   final Parameter kd1,
                                                   final Parameter ka2,
    ...
    public void testOtherOccultingBody() throws PatriusException {
        ...
        final BodyShape moonModel = new OneAxisEllipsoid(1500000, 0, moon.getRotatingFrameTrueModel(), "Moon");

        /*
         * CIRCULAR
         */
        SolarRadiationPressure srp = new SolarRadiationPressure(sun, 1500000, moon.getInertialFrameConstantModel(),
        ...
        Vector3D pos1 = sun.getPVCoordinates(AbsoluteDate.J2000_EPOCH, moon.getInertialFrameConstantModel())
        ...
        SpacecraftState state1 = new SpacecraftState(new CartesianOrbit(new PVCoordinates(pos1, Vector3D.ZERO),
            moon.getInertialFrameConstantModel(), AbsoluteDate.J2000_EPOCH, Constants.WGS84_EARTH_MU), massModel);
        ...
        Vector3D pos2 = moon.getInertialFrameConstantModel()
        ...
        // Case 1: occulting body = Moon, state centered on Moon, state hidden behind Moon: acc = 0
        pos1 = sun.getPVCoordinates(AbsoluteDate.J2000_EPOCH, moon.getInertialFrameConstantModel())
            .getPosition().scalarMultiply(-0.001);
        ...
        // Case 2: occulting body = Moon, state centered on Earth, state hidden behind Moon: acc = 0
        pos2 = moon.getInertialFrameConstantModel()
            .getTransformTo(FramesFactory.getGCRF(), AbsoluteDate.J2000_EPOCH).transformPosition(pos1);
    ...
    public void testMultipleOccultingBodies() throws PatriusException {
        ...
        SolarRadiationPressure srp = new SolarRadiationPressure(sun,
            6378000, new SphericalSpacecraft(50.0, 0.5, 1, 0., 0., DEFAULT));
        srp.addOccultingBody(new OneAxisEllipsoid(1500000, 0, body2.getInertialFrameConstantModel(), "Body2"));

        // Case 1: state behind first body: acc = 0
        Vector3D pos1 = sun.getPVCoordinates(AbsoluteDate.J2000_EPOCH, body1.getInertialFrameConstantModel())
            .getPosition().scalarMultiply(-0.001);
        SpacecraftState state1 = new SpacecraftState(new CartesianOrbit(new PVCoordinates(pos1, Vector3D.ZERO),
            body1.getInertialFrameConstantModel(), AbsoluteDate.J2000_EPOCH, Constants.WGS84_EARTH_MU), massModel);
        Vector3D actualAcc = srp.computeAcceleration(state1);
        Assert.assertEquals(0, actualAcc.getNorm(), 0.);

        // Case 2: state behind second body: acc = 0
        Vector3D pos2 = sun.getPVCoordinates(AbsoluteDate.J2000_EPOCH, body2.getInertialFrameConstantModel())
            .getPosition().scalarMultiply(-0.001);
        SpacecraftState state2 = new SpacecraftState(new CartesianOrbit(new PVCoordinates(pos2, Vector3D.ZERO),
            body2.getInertialFrameConstantModel(), AbsoluteDate.J2000_EPOCH, Constants.WGS84_EARTH_MU), massModel);
        Vector3D actualAcc2 = srp.computeAcceleration(state2);
        Assert.assertEquals(0, actualAcc2.getNorm(), 0.);
        ...
        SolarRadiationPressure srp2 = new SolarRadiationPressure(sun,
            6378000, new SphericalSpacecraft(50.0, 0.5, 1, 0., 0., DEFAULT));
        srp.addOccultingBody(new OneAxisEllipsoid(6378000, 0, body3.getInertialFrameConstantModel(), "Body3"));

        Vector3D pos4 = sun.getPVCoordinates(AbsoluteDate.J2000_EPOCH, body1.getInertialFrameConstantModel())
            .getPosition().scalarMultiply(-0.001);
        ...
        // Case 1: state behind first body: acc = 0
        pos1 = sun.getPVCoordinates(AbsoluteDate.J2000_EPOCH, body1.getInertialFrameConstantModel())
            .getPosition().scalarMultiply(-0.001);
        state1 = new SpacecraftState(new CartesianOrbit(new PVCoordinates(pos1, Vector3D.ZERO),
            body1.getInertialFrameConstantModel(), AbsoluteDate.J2000_EPOCH, Constants.WGS84_EARTH_MU), massModel);
        actualAcc = srp.computeAcceleration(state1);
        ...
        // Case 2: state behind second body: acc = 0
        pos2 = sun.getPVCoordinates(AbsoluteDate.J2000_EPOCH, body2.getInertialFrameConstantModel())
            .getPosition().scalarMultiply(-0.001);
        state2 = new SpacecraftState(new CartesianOrbit(new PVCoordinates(pos2, Vector3D.ZERO),
            body2.getInertialFrameConstantModel(), AbsoluteDate.J2000_EPOCH, Constants.WGS84_EARTH_MU), massModel);
        actualAcc2 = srp.computeAcceleration(state2);
        ...
        srp2.addOccultingBody(new OneAxisEllipsoid(6378000, 0, body3.getInertialFrameConstantModel(), "Body2"));

        pos4 = sun.getPVCoordinates(AbsoluteDate.J2000_EPOCH, body1.getInertialFrameConstantModel())
            .getPosition().scalarMultiply(-0.001);
    ...
    public void testHeliocentric() throws PatriusException {
        ...
        final SolarRadiationPressure srp = new SolarRadiationPressure(Constants.SEIDELMANN_UA,
            Constants.CONST_SOL_N_M2, sun, 6378000, new SphericalSpacecraft(50.0, 0.5, 1, 0., 0., DEFAULT));
        srp.addOccultingBody(new OneAxisEllipsoid(1500000, 0, body2.getInertialFrameConstantModel(), "Body2"));
        final MassProvider massModel = new SimpleMassModel(1500., DEFAULT);
        ...
        final Orbit initialOrbit = new KeplerianOrbit(150E9, 0, 0, 0, 0, 0, PositionAngle.TRUE,
            sun.getInertialFrameConstantModel(), initialDate, Constants.IERS92_SUN_GRAVITATIONAL_PARAMETER);
        propagator.setInitialState(new SpacecraftState(initialOrbit, massModel));
        propagator.setOrbitFrame(sun.getInertialFrameConstantModel());
    ...
    public void testLightning() throws PatriusException {
        ...
        final SolarRadiationPressure srp = new SolarRadiationPressure(this.sun,
            this.earth.getEquatorialRadius(), new SphericalSpacecraft(50.0, 0.5, 0.5, 0.5, 0.,
                DEFAULT));
        final SolarRadiationPressure srp2 = new SolarRadiationPressure(this.sun,
            this.earth.getEquatorialRadius(), new SphericalSpacecraft(50.0, 0.5, 0.5, 0.5, 0.,
                DEFAULT));
        ...
        for (int t = 1; t < 3 * period; t += 1000) {
            ...
            try {
                ...
                final double ratio = srp.getLightningRatio(
                    k.propagate(currentDate).getPVCoordinates().getPosition(),
                    this.earth,
                    new ConstantPVCoordinatesProvider(this.sun
                        .getPVCoordinates(this.date, FramesFactory.getGCRF()).getPosition()
                        .scalarMultiply(-1), FramesFactory.getGCRF()), FramesFactory.getGCRF(),
                    this.date);
                final double ratio2 = srp2.getLightningRatio(
                    k.propagate(currentDate).getPVCoordinates().getPosition(),
                    this.earth,
                    new ConstantPVCoordinatesProvider(this.sun
                        .getPVCoordinates(this.date, FramesFactory.getGCRF()).getPosition()
    ...
    public void testLightningAlignment() throws PatriusException {
        ...
        final Vector3D satSunVector = this.sun.getPVCoordinates(this.date, FramesFactory.getGCRF())
            .getPosition().scalarMultiply(-1);
        ...
        Assert.assertEquals(1., srp.getLightningRatio(satSunVector, this.earth, this.sun, FramesFactory.getGCRF(),
            this.date), 0.);
    ...
    public void testException() throws PatriusException {
        ...
        final SolarRadiationPressure srp = new SolarRadiationPressure(kRef, this.sun,
    ...
    public void testSRP() throws PatriusException {
        ...
        // SRP
        final SolarRadiationPressure srp = new SolarRadiationPressure(this.dRef, this.pRef, this.sun, this.earth, sc);
    ...
    public void testPDerivatives() throws PatriusException {
        ...
        SolarRadiationPressure srp1 = new SolarRadiationPressure(this.dRef, this.pRef, this.sun,
            this.earth, sc1);
        SolarRadiationPressure srp2 = new SolarRadiationPressure(this.dRef, this.pRef, this.sun,
            this.earth, sc2);
        ...
        // SRP
        srp = new SolarRadiationPressure(this.dRef, this.pRef, this.sun, this.earth, sc);
        srp1 = new SolarRadiationPressure(this.dRef, this.pRef, this.sun, this.earth, sc1);
        srp2 = new SolarRadiationPressure(this.dRef, this.pRef, this.sun, this.earth, sc2);
    ...
    public void testNullPD() throws PatriusException {
        ...
        final SolarRadiationPressure srp = new SolarRadiationPressure(new Parameter("toto", 1.),
            this.sun, body, spacecraft, false);
        final SolarRadiationPressure srp2 = new SolarRadiationPressure(this.sun, body, spacecraft,
            false);
        final SolarRadiationPressure srp3 = new SolarRadiationPressure(1, 1, this.sun, body,
            spacecraft, false);
    ...
    public void testGetters() throws PatriusException {
        ...
        final SolarRadiationPressure SolarRadiationPressure = new SolarRadiationPressure(
        ...
        final SolarRadiationPressure solarRadiationPressure2 = new SolarRadiationPressure(
            200, 10, CelestialBodyFactory.getSun(), earthBody, builder.returnAssembly(), 3);
        ...
        builder2
            .addPart(array1, mainPart, new Transform(AbsoluteDate.J2000_EPOCH, new Rotation(Vector3D.PLUS_I, 0.25)));
        builder2
            .addPart(array2, mainPart, new Transform(AbsoluteDate.J2000_EPOCH, new Rotation(Vector3D.PLUS_K, 0.18)));
        ...
        final SolarRadiationPressure srp2 = new SolarRadiationPressure(this.dRef, this.pRef,
            CelestialBodyFactory.getSun(), earthBody, assembly, 12.);
        
        final CelestialBody body2 = CelestialBodyFactory.getMoon();
        final OneAxisEllipsoid moon = new OneAxisEllipsoid(1500000, 0, body2.getInertialFrameConstantModel(), "Body2");
        srp2.addOccultingBody(moon);
        
        final SolarRadiationPressure srp3 = new SolarRadiationPressure(
            srp2, assembly);
    ...
    public void testEnrichParameterDescriptors() throws PatriusException {
        ...
        final CelestialBody moon = CelestialBodyFactory.getMoon();
        final BodyShape moonModel = new OneAxisEllipsoid(1500000, 0, moon.getRotatingFrameTrueModel(), "Moon");
        final SolarRadiationPressure forceModel = new SolarRadiationPressure(sun, moonModel,
            new SphericalSpacecraft(50.0, 0.5, 1, 0., 0., DEFAULT));
    ...
    public void setup() throws PatriusException, IOException {
        ...
        this.date = new AbsoluteDate(new DateComponents(2003, 3, 21),
