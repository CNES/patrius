...
public class ImpulseManeuversOrbParamTest {
     ...
     * @return final state
     * @throws PropagationException - if state cannot be propagated
     */
    private SpacecraftState propagationSequence(final ImpulseManeuver impulseMan) throws PropagationException {
