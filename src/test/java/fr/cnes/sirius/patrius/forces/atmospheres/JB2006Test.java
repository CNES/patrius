...
public class JB2006Test {
    ...
    public void testComparisonWithDTM2000() throws PatriusException {
        ...
        EllipsoidPoint point;
        for (int i = 0; i < 367; i++) {
            date = date.shiftedBy(Constants.JULIAN_DAY);
            point = new EllipsoidPoint(earth, earth.getLLHCoordinatesSystem(), MathLib.toRadians(40), 0, 300 * 1000, "");
    ...
    public void testSolarInputs() throws PatriusException {
