...
public class TerrestrialTidesTest {
    ...
    public void testTerrestrialTidesDataProviderConstructor() throws PatriusException {
    ...
    public void testEnrichParameterDescriptors() throws PatriusException {
        ...
        for (final Parameter p : forceModel.getParameters()) {
            Assert.assertTrue(p.getDescriptor().contains(StandardFieldDescriptors.FORCE_MODEL, TerrestrialTides.class));
        }
    }
