...
public class SphericalGridAttractionLoaderTest {
    ...
    public void loadTest() throws PatriusException {
        ...
        Assert.assertEquals(new SphericalCoordinates(MathLib.toRadians(-30.), 0, 8000).getCartesianCoordinates()
            .distance(data.getData()[0].getPosition()), 0., Precision.DOUBLE_COMPARISON_EPSILON);
