...
public class ImpulseManeuverTest {
    ...
    // Keplerian propagator declared with two attitude provider
            public
            void testInclinationManeuver2() throws PatriusException {
    ...
    public final void testResetStateError() throws PatriusException {
     ...
     */
    @Test
    public final void testTankPropulsiveProperties() throws PatriusException {
     ...
     */
    @Test
    public void testEphemerisModeKep() throws PatriusException, ParseException, IOException {
        // Initialization
     ...
     */
    @Test
    public void testAnalyticalEphemerisEventDetectionKep() throws PatriusException, ParseException, IOException {
    ...
    public void testGetters() throws PatriusException {
        ...
        final ImpulseManeuver impulseMan = new ImpulseManeuver(new AltitudeDetector(150000, new OneAxisEllipsoid(
    ...
    public void testCopy() throws PatriusException {
        ...
        final ImpulseManeuver maneuver1 = new ImpulseManeuver(detector,
                Vector3D.MINUS_I, FramesFactory.getGCRF(), isp, massProvider, "Tank");
       ...
       final ImpulseManeuver maneuver2 = new ImpulseManeuver(detector,
               Vector3D.MINUS_I, isp, massProvider, "Tank", LOFType.LVLH);
      ...
      final ImpulseManeuver maneuver3 = new ImpulseManeuver(detector,
              Vector3D.MINUS_I, isp, massProvider, "Tank");
