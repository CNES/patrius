...
public class ConstantThrustManeuverTest {
    ...
    public void testgFunctionNullMassPartDectector() throws IllegalArgumentException, PatriusException {
        ...
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(date0, thrustDuration, new PropulsiveProperty(thrustForce, isp),
                direction, mass, tank);
    ...
    public void testNullMassPartDectector() throws IllegalArgumentException, PatriusException {
        ...
        tank.setPartName(partName);
        final ContinuousThrustManeuver maneuver = new ContinuousThrustManeuver(d1, duration,
            new PropulsiveProperty(dv, isp), Vector3D.MINUS_I, massModel, tank);
        final ContinuousThrustManeuver maneuver2 = new ContinuousThrustManeuver(d1, duration,
            new PropulsiveProperty(dv, isp), Vector3D.PLUS_I, massModel, tank);
    ...
    public void testParamList() throws PatriusException, IOException, ParseException {
        ...
        final ContinuousThrustManeuver model =
            new ContinuousThrustManeuver(date, -10.0, new PropulsiveProperty(400., 300.), Vector3D.PLUS_K,
                new SimpleMassModel(1000., "Satellite"),
    ...
    public void testPositiveDuration() throws PatriusException {
        ...
        final PropulsiveProperty engineProp = new PropulsiveProperty(thrust.getValue(),
            -thrust.getValue() / (Constants.G0_STANDARD_GRAVITY * flowRate.getValue()));
        final TankProperty tankProp = new TankProperty(1000.);
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(date, 10.0, engineProp, Vector3D.PLUS_K, new SimpleMassModel(1000.,
                "no need"), tankProp);
        final EventDetector[] switches = maneuver.getEventsDetectors();
    ...
    public void testNegativeDuration() throws PatriusException {
        ...
        ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(date, -10.0, new PropulsiveProperty(400., 300.), Vector3D.PLUS_K,
                new SimpleMassModel(1000.,
                    "Satellite"),
                new TankProperty(1000.));
        ...
        final PropulsiveProperty engineProp = new PropulsiveProperty(400.,
            -400. / (Constants.G0_STANDARD_GRAVITY * 300.));
        final TankProperty tankProp = new TankProperty(1000.);
        maneuver = new ContinuousThrustManeuver(date, -10.0, engineProp, Vector3D.PLUS_K,
    ...
    public void testRoughBehaviour() throws PatriusException {
        ...
        final SpacecraftState initialState =
            new SpacecraftState(orbit, law.getAttitude(orbit, orbit.getDate(), orbit.getFrame()), massModel);

        final AbsoluteDate fireDate = new AbsoluteDate(new DateComponents(2004, 01, 02),
            new TimeComponents(04, 15, 34.080),
            TimeScalesFactory.getUTC());
        final PropulsiveProperty engineProp = new PropulsiveProperty(fParam.getValue(),
            -fParam.getValue() / (Constants.G0_STANDARD_GRAVITY * flowRateParam.getValue()));
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(fireDate, duration, engineProp, Vector3D.PLUS_I, massModel,
                tankProp);
        ...
        final double massTolerance =
            MathLib.abs(fParam.getValue() * maneuver.getEventsDetectors()[0].getThreshold());
    ...
    public void testSameBeforeFiring() throws IllegalArgumentException, PatriusException {
        ...
        final SpacecraftState initialState1 =
            new SpacecraftState(orbit, law.getAttitude(orbit, orbit.getDate(), orbit.getFrame()), massModel1);
        ...
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(fireDate, duration, new PropulsiveProperty(f, isp), Vector3D.PLUS_I,
                massModel, tank);
     ...
     */
    @Test
    public void testAnyDirectionFrame() throws PatriusException, IOException, ParseException {
    ...
    public final void testManeuverWithLOF() throws PatriusException, IOException, ParseException {
        ...
        // Start date
        final AbsoluteDate date0 = new AbsoluteDate(2005, 1, 1, 6, 0, 0,
            tai);
        ...
        final KeplerianOrbit orbit = new KeplerianOrbit(a, e, i, pa,
            raan, w, PositionAngle.TRUE, gcrf, date0, this.mu);
        ...
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(fireDate, 100, new PropulsiveProperty(420, 318), Vector3D.PLUS_I, massModel,
                tank);
        ...
        builder2.addProperty(new MassProperty(0.), "Main");
        final TankProperty tank2 = new TankProperty(1000.);
        builder2.addPart("thruster", "Main", Transform.IDENTITY);
        ...
        // impulsion
        final ContinuousThrustManeuver maneuver2 =
            new ContinuousThrustManeuver(fireDate, 100,
                new PropulsiveProperty(420, 318), Vector3D.PLUS_I, massModel2,
                tank2, LOFType.TNW);
     ...
     * @testType UT
     * 
     * @testedMethod {@link ContinuousThrustManeuver#addContribution(SpacecraftState, org.orekit.propagation.numerical.TimeDerivativesEquations)}
     * @testedMethod {@link ContinuousThrustManeuver#computeAcceleration(SpacecraftState)}
     * 
     ...
     */
    @Test
    public final void testCoverage() throws PatriusException {
        final TimeScale tai = TimeScalesFactory.getTAI();
        final AbsoluteDate date0 = new AbsoluteDate(2005, 1, 1, 6, 0, 0,
            tai);
        final Frame gcrf = FramesFactory.getGCRF();
        final KeplerianOrbit orbit = new KeplerianOrbit(0, 0, 0, 0,
            0, 0, PositionAngle.TRUE, gcrf, date0, this.mu);
        ...
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(AbsoluteDate.J2000_EPOCH, 100., new PropulsiveProperty(420, 318),
     ...
     */
    @Test
    public final void testDAccDState() throws PatriusException {
        final String MAIN = "main";
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(new AbsoluteDate(), 100, new PropulsiveProperty(420, 318), Vector3D.PLUS_I,
                new SimpleMassModel(
                    1000., MAIN), new TankProperty(1000.));
        final KeplerianOrbit orbit = new KeplerianOrbit(0, 0, 0, 0,
            0, 0, PositionAngle.TRUE, FramesFactory.getGCRF(), new AbsoluteDate(), this.mu);
     ...
     */
    @Test
    public final void testDAccDParam() throws PatriusException, IOException, ParseException {
     ...
     * @throws ParseException
     */
    private final void testDAccDParam(final Frame frame, final LOFType type) throws PatriusException, IOException,
                                                                            ParseException {
        // mass model
        ...
        if (frame == null) {
            if (type == null) {
                ...
                maneuver =
                    new ContinuousThrustManeuver(fireDate, 100., engineProp, Vector3D.PLUS_I, massModel, tankProp);
            } else {
        ...
        maneuver.addDAccDParam(etat, thrust, dAccdParam);
        ...
        if (frame == null) {
            if (type == null) {
                final PropulsiveProperty engineProp1 = new PropulsiveProperty(thrust1.getValue(),
                    -thrust1.getValue() / (Constants.G0_STANDARD_GRAVITY * flowRate.getValue()));
                final PropulsiveProperty engineProp2 = new PropulsiveProperty(thrust2.getValue(),
                ...
                final PropulsiveProperty propulsiveProperty1 =
                    new PropulsiveProperty(thrust1, new Parameter("Isp", isp));
                final PropulsiveProperty propulsiveProperty2 =
                    new PropulsiveProperty(thrust2, new Parameter("Isp", isp));
                final TankProperty tankProperty = new TankProperty(massModel.getMass(thruster));
                tankProperty.setPartName(thruster);
                maneuver1 =
                    new ContinuousThrustManeuver(fireDate, 100., propulsiveProperty1, Vector3D.PLUS_I, massModel,
                        tankProperty, LOFType.TNW);
                maneuver2 =
                    new ContinuousThrustManeuver(fireDate, 100., propulsiveProperty2, Vector3D.PLUS_I, massModel,
                        tankProperty, LOFType.TNW);
            }
        } else {
        ...
        // finite differences:
        final Vector3D acc1 = maneuver1.computeAcceleration(etat);
        final Vector3D acc2 = maneuver2.computeAcceleration(etat);
        ...
        try {
            ...
            maneuver.addDAccDParam(etat, new Parameter("default", 0.), dAccdParam);
            Assert.fail();
    ...
    public void testStepHandler() throws PatriusException {
        ...
        final PropulsiveProperty engineProp = new PropulsiveProperty(thrust, new Parameter("Isp",
            -thrust.getValue() / (Constants.G0_STANDARD_GRAVITY * (-1. / 4000.))));
        final TankProperty tankProp = new TankProperty(massModel.getMass("Satellite"));
        tankProp.setPartName("Satellite");
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(date, duration, engineProp, Vector3D.PLUS_I, massModel, tankProp,
    ...
    public void testEventDetectorsDate() throws PatriusException {
        ...
        final ContinuousThrustManeuver maneuver1 =
            new ContinuousThrustManeuver(maneuverDate, maneuverDuration, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel1, tank1);
        ...
        final ContinuousThrustManeuver maneuver2 =
            new ContinuousThrustManeuver(detector1, detector2, new PropulsiveProperty(1., 400.),
                Vector3D.PLUS_I, massModel2, tank2);
    ...
    public void testEventDetectorsOnce() throws PatriusException {
        ...
        final ContinuousThrustManeuver maneuver1 =
            new ContinuousThrustManeuver(startDetector1, endDetector1, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel1, tank1, LOFType.TNW);
        final NumericalPropagator propagator1 = new NumericalPropagator(integrator);
        propagator1.addForceModel(maneuver1);
        propagator1.setInitialState(initialState1);
        propagator1.setMassProviderEquation(massModel1);
        ...
        builder2.addProperty(new MassProperty(0.), "Main");
        final TankProperty tank2 = new TankProperty(1000.);
        builder2.addPart("Satellite", "Main", Transform.IDENTITY);
        ...
        final ContinuousThrustManeuver maneuver2 =
            new ContinuousThrustManeuver(startDetector2, endDetector2, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel2, tank2, LOFType.TNW);
        final NumericalPropagator propagator2 = new NumericalPropagator(integrator);
        propagator2.addForceModel(maneuver2);
        propagator2.setInitialState(initialState2);
        propagator2.setMassProviderEquation(massModel2);
        ...
        final ContinuousThrustManeuver maneuver3 =
            new ContinuousThrustManeuver(startDetector3, endDetector3, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel3, tank, LOFType.TNW);
        ...
        Assert.assertEquals(state3.getEquinoctialEx(), initialState3.getEquinoctialEx(), 0.);
        Assert.assertEquals(state3.getEquinoctialEy(), initialState3.getEquinoctialEy(), 0.);
        Assert.assertEquals(state3.getHx(), initialState3.getHx(), 0.);
        Assert.assertEquals(state3.getHy(), initialState3.getHy(), 0.);
    ...
    public void testEventDetectorsSeveral() throws PatriusException {
        ...
        final ContinuousThrustManeuver maneuver1 =
            new ContinuousThrustManeuver(startDetector1, endDetector1, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel1, tank1, FramesFactory.getGCRF());
        final NumericalPropagator propagator1 = new NumericalPropagator(integrator);
        propagator1.addForceModel(maneuver1);
        propagator1.setInitialState(initialState1);
        propagator1.setMassProviderEquation(massModel1);
        ...
        final ContinuousThrustManeuver maneuver2 =
            new ContinuousThrustManeuver(startDetector2, endDetector2, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel2, tank2, FramesFactory.getGCRF());
        final NumericalPropagator propagator2 = new NumericalPropagator(integrator);
        propagator2.addForceModel(maneuver2);
        propagator2.setInitialState(initialState2);
        propagator2.setMassProviderEquation(massModel2);
    ...
    public void testStartEndDates() throws PatriusException {
        ...
        final ContinuousThrustManeuver maneuver1 =
            new ContinuousThrustManeuver(startDate, endDate.durationFrom(startDate),
        ...
        final ContinuousThrustManeuver maneuver2 =
            new ContinuousThrustManeuver(dateDetector1, dateDetector2, new PropulsiveProperty(1., 400.),
                Vector3D.PLUS_I, massModel, new TankProperty(1000.));
        ...
        final ContinuousThrustManeuver maneuver3 =
            new ContinuousThrustManeuver(otherDetector1, otherDetector2, new PropulsiveProperty(1., 400.),
                Vector3D.PLUS_I, massModel, new TankProperty(1000.));
    ...
    public void testPropagationSplitDuringManeuver() throws PatriusException {
        ...
        final List<SpacecraftState> res2 = new ArrayList<SpacecraftState>();
        final List<SpacecraftState> res3 = new ArrayList<SpacecraftState>();
        ...
        final SpacecraftState initialState1 = new SpacecraftState(initialOrbit, massModel1);
        final ContinuousThrustManeuver maneuver1 =
            new ContinuousThrustManeuver(startDetector, endDetector, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel1, tank1,
                FramesFactory.getGCRF());
        ...
        builder3.addProperty(new MassProperty(0.), "Main");
        final TankProperty tank3 = new TankProperty(state.getMass("Satellite"));
        builder3.addPart("Satellite", "Main", Transform.IDENTITY);
        ...
        final ContinuousThrustManeuver maneuver3 =
            new ContinuousThrustManeuver(startDetector, endDetector, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel3, tank3, FramesFactory.getGCRF());
        ...
        for (int i = 0; i < 7; i++) {
            Assert.assertEquals(stateArray[i], retroStateArray[i], 1.0E-15);
        }

        // Propagate to initialDate
        final AssemblyBuilder builder4 = new AssemblyBuilder();
        builder4.addMainPart("Main");
        builder4.addProperty(new MassProperty(0.), "Main");
        final TankProperty tank4 = new TankProperty(state.getMass("Satellite"));
        builder4.addPart("Satellite", "Main", Transform.IDENTITY);
        ...
        final ContinuousThrustManeuver maneuver4 =
            new ContinuousThrustManeuver(startDetector, endDetector, new PropulsiveProperty(1., 400),
                Vector3D.PLUS_I, massModel3, tank4, FramesFactory.getGCRF());
        ...
        for (int i = 0; i < res1.size(); i++) {
            ...
            Assert.assertEquals(0.0, (res1.get(res1.size() - 1 - i).getA() - res3.get(i).getA()) /
                res1.get(res1.size() - 1 - i).getA(), 1.0E-7);
     ...
     */
    @Test
    public final void testRemoveDetector() throws PatriusException {
        ...
        final Attitude attitude = attLaw.getAttitude(orbit, orbit.getDate(),
            orbit.getFrame());
        ...
        final NodeDetector ascendingDetector = new NodeDetector(FramesFactory.getEME2000(),
            NodeDetector.ASCENDING, AbstractDetector.DEFAULT_MAXCHECK, AbstractDetector.DEFAULT_THRESHOLD,
            Action.STOP, true);
        final NodeDetector descendingDetector = new NodeDetector(FramesFactory.getEME2000(),
            NodeDetector.DESCENDING, AbstractDetector.DEFAULT_MAXCHECK, AbstractDetector.DEFAULT_THRESHOLD,
            Action.STOP, true);
    ...
    public void isComputePDTest() throws PatriusException {
        final String MAIN = "main";
        final ContinuousThrustManeuver maneuver =
            new ContinuousThrustManeuver(new AbsoluteDate(), 100, new PropulsiveProperty(420, 318),
                Vector3D.PLUS_I,
                new SimpleMassModel(1000., MAIN), new TankProperty(1000.));
     ...
     */
    @Test
    public final void testConstructorsProperties() throws PatriusException {
        ...
        final PropulsiveProperty engine = new PropulsiveProperty(new Parameter("ThrustProp", thrust),
            new Parameter("Isp", isp));

        // Create all maneuvers : former constructor/new constructor with properties provided
        final ContinuousThrustManeuver maneuver1 =
            new ContinuousThrustManeuver(date, duration, new PropulsiveProperty(thrust, isp), direction,
                massProv, tank);
        ...
        final ContinuousThrustManeuver[] maneuvers =
            new ContinuousThrustManeuver[] { maneuver1 };

        final ContinuousThrustManeuver[] maneuversProp =
            new ContinuousThrustManeuver[] { maneuver1Prop };
    ...
    public void testDeltaVCalculation() throws PatriusException {
        ...
        final ContinuousThrustManeuver maneuver = new ContinuousThrustManeuver(maneuverStartDate,
            maneuverDuration, engine, new Vector3D(10., 0., 0.), massModel, tank, LOFType.TNW);
    ...
    public void testMassModelUpdate() throws PatriusException {
        ...
        final ContinuousThrustManeuver maneuver = new ContinuousThrustManeuver(maneuverStartDate,
            700, engine, new Vector3D(10., 0., 0.), massModel, tank, LOFType.TNW);
        ...
        propagator.setMasterMode(new PatriusStepHandler() {
            ...
            @Override
            public void handleStep(final PatriusStepInterpolator interpolator, final boolean isLast) throws PropagationException {
                try {
                    // Check mass is the same
                    Assert.assertEquals(interpolator.getInterpolatedState().getMass("Satellite"), massModel.getMass("Satellite"), 0.);
...
//                            + massModel.getMass("Satellite"));
    ...
    private class MySH implements PatriusFixedStepHandler {
        ...
        public MySH(final ContinuousThrustManeuver maneuver, final Parameter thrust) {
