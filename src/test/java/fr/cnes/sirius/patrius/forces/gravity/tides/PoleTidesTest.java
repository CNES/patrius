...
public class PoleTidesTest {
     ...
     */
    @Test
    public void testCoefficients() throws PatriusException {
     ...
     */
    @Test
    public void testCoefficientsPD() throws PatriusException {
    ...
    public void testEnrichParameterDescriptors() throws PatriusException {
        ...
        for (final Parameter p : forceModel.getParameters()) {
            Assert.assertTrue(p.getDescriptor().contains(StandardFieldDescriptors.FORCE_MODEL, PoleTides.class));
        }
    }
}
