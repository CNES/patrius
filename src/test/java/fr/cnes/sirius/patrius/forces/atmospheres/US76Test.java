...
public class US76Test {
     ...
     * Frame of pos vector
     */
    private CelestialBodyFrame frame1;
    ...
    public void testNoteTechnique() throws PatriusException {
        ...
        final EllipsoidPoint point0 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            alt0, "");
        final EllipsoidPoint point1 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            alt1, "");
        final EllipsoidPoint point2 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            alt2, "");
        final EllipsoidPoint point3 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            alt3, "");
        final EllipsoidPoint point4 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            alt4, "");
        final EllipsoidPoint point5 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            alt5, "");
        final EllipsoidPoint point6 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            alt6, "");
        final EllipsoidPoint point7 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            alt7, "");
        final EllipsoidPoint point8 = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,            alt8,           "");

        // density at sea level
        final double density0 = this.atmosModel1.getDensity(this.date1, point0.getPosition(), this.frame1);

        // pressure at sea level
        final double pressure0 = this.atmosModel1.getPress(this.date1, point0.getPosition(), this.frame1);

        // temperature at sea level
        final double temp0 = this.atmosModel1.getTemp(this.date1, point0.getPosition(), this.frame1);
        final double refTemp0 = 288.15;

        // alt = 20km
        final double density1 = this.atmosModel1.getDensity(this.date1, point1.getPosition(), this.frame1);
        final double pressure1 = this.atmosModel1.getPress(this.date1, point1.getPosition(), this.frame1);
        final double temp1 = this.atmosModel1.getTemp(this.date1, point1.getPosition(), this.frame1);
        final double refDensity1 = 7.1865E-2;
        final double refPressure1 = 5.4032E-2;
        final double refTemp1 = 216.65;

        // alt = 40km
        final double density2 = this.atmosModel1.getDensity(this.date1, point2.getPosition(), this.frame1);
        final double pressure2 = this.atmosModel1.getPress(this.date1, point2.getPosition(), this.frame1);
        final double temp2 = this.atmosModel1.getTemp(this.date1, point2.getPosition(), this.frame1);
        final double refDensity2 = 3.1437E-03;
        final double refPressure2 = 2.7389E-3;
        final double refTemp2 = 251.05;

        // alt = 60km
        final double density3 = this.atmosModel1.getDensity(this.date1, point3.getPosition(), this.frame1);
        final double pressure3 = this.atmosModel1.getPress(this.date1, point3.getPosition(), this.frame1);
        final double temp3 = this.atmosModel1.getTemp(this.date1, point3.getPosition(), this.frame1);
        final double refDensity3 = 2.3536E-04;
        final double refPressure3 = 2.0048E-4;
        final double refTemp3 = 245.45;

        // alt = 80km
        final double density4 = this.atmosModel1.getDensity(this.date1, point4.getPosition(), this.frame1);
        final double pressure4 = this.atmosModel1.getPress(this.date1, point4.getPosition(), this.frame1);
        final double temp4 = this.atmosModel1.getTemp(this.date1, point4.getPosition(), this.frame1);
        final double refDensity4 = 1.2817E-05;
        final double refPressure4 = 8.7468E-6;
        final double refTemp4 = 196.65;

        // alt = 85km
        final double density5 = this.atmosModel1.getDensity(this.date1, point5.getPosition(), this.frame1);
        final double pressure5 = this.atmosModel1.getPress(this.date1, point5.getPosition(), this.frame1);
        final double temp5 = this.atmosModel1.getTemp(this.date1, point5.getPosition(), this.frame1);
        final double refDensity5 = 6.7098E-06;
        final double refPressure5 = 4.3985E-6;
        final double refTemp5 = 188.84;

        // alt = 90km
        final double density6 = this.atmosModel1.getDensity(this.date1, point6.getPosition(), this.frame1);
        final double pressure6 = this.atmosModel1.getPress(this.date1, point6.getPosition(), this.frame1);
        final double temp6 = this.atmosModel1.getTemp(this.date1, point6.getPosition(), this.frame1);
        final double refDensity6 = 2.789E-6;
        final double refPressure6 = 1.8119E-6;
        final double refTemp6 = 186.87;

        // alt = 100km
        final double density7 = this.atmosModel1.getDensity(this.date1, point7.getPosition(), this.frame1);
        final double pressure7 = this.atmosModel1.getPress(this.date1, point7.getPosition(), this.frame1);
        final double temp7 = this.atmosModel1.getTemp(this.date1, point7.getPosition(), this.frame1);
        final double refDensity7 = 4.575E-7;
        final double refPressure7 = 3.1593E-7;
        final double refTemp7 = 195.08;

        // alt = 120km
        final double density8 = this.atmosModel1.getDensity(this.date1, point8.getPosition(), this.frame1);
        final double pressure8 = this.atmosModel1.getPress(this.date1, point8.getPosition(), this.frame1);
        final double temp8 = this.atmosModel1.getTemp(this.date1, point8.getPosition(), this.frame1);
     ...
     * 
     * @testPassCriteria if returned density is Rho(z = 0)
     * 
     * @referenceVersion 2.3
     * 
     * @nonRegressionVersion 3.0.1
     ...
     */
    @Test
    public void testOutOfBound1() throws PatriusException {

        // Verify that for z < z_min => rho(z) = rho(z_min)
        final EllipsoidPoint point_zmin = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            0, "");
        final EllipsoidPoint point_znegative = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(),            0, 0,            -10, "");

        final Vector3D posNegative = point_znegative.getPosition();
        final Vector3D posMin = point_zmin.getPosition();
        ...
        Assert.assertEquals(rho1, rho2, Precision.DOUBLE_COMPARISON_EPSILON);
    }
     ...
     * 
     * @testPassCriteria if returned density is Rho(z = 1000 km)
     * 
     * @referenceVersion 2.3
     * 
     * @nonRegressionVersion 3.0.1
     ...
     */
    @Test
    public void testOutOfBound2() throws PatriusException {

        // Verify that for z > z_max => rho(z) = rho(z_max)
        final EllipsoidPoint point_zmax = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(), 0, 0,
            1000.e3, "");
        final EllipsoidPoint point_outOfBound = new EllipsoidPoint(this.earth1, this.earth1.getLLHCoordinatesSystem(),            0,            0, 10000.e3, "");

        final Vector3D posOutOfBound = point_outOfBound.getPosition();
        final Vector3D posMax = point_zmax.getPosition();
    ...
    public void testGetVelocity() throws PatriusException {
        ...
        checkVectors(refVel, cmpVel, EPS);
    }
