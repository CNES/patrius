...
public class CunninghamAttractionModelTest {
     ...
     */
    @Test
    public void testAddDAccDParam() throws PatriusException, IOException, ParseException {
     ...
     */
    public void testSupportsJacobianParameter() throws IOException, ParseException,
        PatriusException {
        Utils.setDataRoot("potential");
    ...
    public void testNewtonianAttraction() throws IllegalArgumentException, PatriusException {
        ...
        // coverage tests:
        final NewtonianAttractionModel model = new NewtonianAttractionModel(FramesFactory.getGCRF(), this.muParam);
        this.muParam.setValue(5.);
        Assert.assertEquals(5., model.getMu(), 0.0);
    ...
    public void testMultiplicativeFactor() throws PatriusException, IOException, ParseException {
        ...
        final CunninghamAttractionModel actualModel = new CunninghamAttractionModel(FramesFactory.getGCRF(),
            new Parameter("", ae),
            new Parameter("", mu), c, s, 4, 4);
        actualModel.setMultiplicativeFactor(5.);
        final CunninghamAttractionModel expectedModel = new CunninghamAttractionModel(FramesFactory.getGCRF(),
            new Parameter("", ae),
            new Parameter("", mu), c, s, 4, 4);
    ...
    public void testEnrichParameterDescriptors() throws IOException, ParseException,
        ...
        for (final Parameter p : forceModel.getParameters()) {
            Assert.assertTrue(p.getDescriptor().contains(StandardFieldDescriptors.FORCE_MODEL,
                CunninghamAttractionModel.class));
        }
    }
