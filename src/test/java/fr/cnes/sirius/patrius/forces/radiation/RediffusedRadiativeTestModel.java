...
public class RediffusedRadiativeTestModel extends Parameterizable implements RediffusedRadiationSensitive {
    /** Serializable UID. */
    private static final long serialVersionUID = -8795202193842945007L;
     ...
     */
    @Override
    public Vector3D rediffusedRadiationPressureAcceleration(final SpacecraftState state, final ElementaryFlux[] f) {
        return new Vector3D(1.e-10 * f.length, 1.e-10 * f.length, 1.e-10 * f.length);
    }
