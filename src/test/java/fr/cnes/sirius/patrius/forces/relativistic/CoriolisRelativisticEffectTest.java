...
public class CoriolisRelativisticEffectTest {
    ...
    public void setUp() throws PatriusException {
        ...
        this.sun = new CelestialBody(){
        	...
        	private AbstractAttractionModel model = sunJPL.getAttractionModel();
            ...
            public CelestialBodyFrame getInertialFrameConstantModel() throws PatriusException {
                return sunJPL.getInertialFrameConstantModel();
            }
            ...
            public CelestialBodyFrame getRotatingFrameTrueModel() throws PatriusException {
                return sunJPL.getRotatingFrameTrueModel();
            }
