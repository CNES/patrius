...
public class CoriolisRelativisticEffectTest {
    ...
    public void setUp() throws PatriusException {
        ...
        this.sun = new CelestialBody(){
            ...
            // default sun shape
        	private GeometricBodyShape shape = sunJPL.getShape();
        	
        	// default sun attraction model
        	private AttractionModel model = sunJPL.getAttractionModel();
            ...
            public Frame getInertialEquatorFrame() throws PatriusException {
                return sunJPL.getInertialEquatorFrame();
            }
            ...
            public Frame getTrueRotatingFrame() throws PatriusException {
                return sunJPL.getTrueRotatingFrame();
            }
