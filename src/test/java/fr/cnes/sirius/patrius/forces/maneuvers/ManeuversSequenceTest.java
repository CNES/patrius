...
public class ManeuversSequenceTest {
     ...
     */
    @Test
    public final void testPropagateWithManeuversSequence() throws PatriusException {
        // The initial date:
     ...
     */
    @Test
    public final void testGenericEventsManeuver() throws PatriusException {
    ...
    public void testGetters() throws PatriusException {
        ...
        sequence.add(this.constant2);
        this.impulse1 = new ImpulseManeuver(new AltitudeDetector(150000, new OneAxisEllipsoid(Constants.CNES_STELA_AE,
        ...
        this.impulse2 = new ImpulseManeuver(new AltitudeDetector(120000, new OneAxisEllipsoid(Constants.CNES_STELA_AE,
            Constants.GRIM5C1_EARTH_FLATTENING, FramesFactory.getCIRF())), Vector3D.MINUS_I, 50, new MassModel(
            ForceModelsDataTest.getAssembly()), "Tank");
        sequence.add(this.impulse2);

        final Set<ContinuousThrustManeuver> continuousList = new HashSet<ContinuousThrustManeuver>();
        continuousList.add(this.constant1);
        continuousList.add(this.constant2);

        final Set<ImpulseManeuver> impulseList = new HashSet<ImpulseManeuver>();
