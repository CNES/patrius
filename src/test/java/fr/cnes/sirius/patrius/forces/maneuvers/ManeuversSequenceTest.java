...
public class ManeuversSequenceTest {
    ...
    public void testPropagateWithManeuversSequence() throws PatriusException {
        ...
        final SpacecraftState initialState1 = new SpacecraftState(orbit, massModel);
        ...
        final SpacecraftState initialState2 = new SpacecraftState(orbit, massModel);
        ...
        Assert.assertEquals(finalState1.getA(), finalState2.getA(), 2E-7);
        Assert.assertEquals(finalState1.getE(), finalState2.getE(), 3E-13);
        Assert.assertEquals(finalState1.getI(), finalState2.getI(), Precision.DOUBLE_COMPARISON_EPSILON);
        Assert.assertEquals(finalState1.getLv(), finalState2.getLv(), 2E-10);
