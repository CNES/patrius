...
public class SmallManeuverAnalyticalModelTest {
    ...
    public void testLowEarthOrbit1() throws PatriusException {
        ...
        withoutManeuver.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(withoutManeuver
            .getInitialState().getMu())));
        final NumericalPropagator withManeuver = this.getPropagator(leo, mass, t0, dV, f, isp);
        withManeuver.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(withManeuver
            .getInitialState().getMu())));
    ...
    private NumericalPropagator getPropagator(final Orbit orbit, final MassProvider mass,
        ...
        final NumericalPropagator propagator = new NumericalPropagator(integrator,
            initialState.getFrame(), orbit.getType(), PositionAngle.TRUE);
