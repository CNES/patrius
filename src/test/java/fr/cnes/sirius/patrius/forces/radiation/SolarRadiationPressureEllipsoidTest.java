...
import fr.cnes.sirius.patrius.bodies.GlobalIAUPoleType;
...
public class SolarRadiationPressureEllipsoidTest {
    ...
    public void testOtherOccultingBody() throws PatriusException {
        ...
        final GeometricBodyShape moonModel = new ExtendedOneAxisEllipsoid(1500000, 0, moon.getTrueRotatingFrame(), "Moon");
    ...
    public void testMultipleOccultingBodies() throws PatriusException {
        ...
        final SolarRadiationPressureEllipsoid srp = new SolarRadiationPressureEllipsoid(sun, body1Model, new SphericalSpacecraft(50.0, 0.5, 1, 0., 0.,
                "Default"));
        srp.addOccultingBody(new ExtendedOneAxisEllipsoid(1500000, 0, body2.getInertialEquatorFrame(), "Body2"));
        final MassProvider massModel = new SimpleMassModel(1500., "Default");
        ...
        final SolarRadiationPressureEllipsoid srp2 = new SolarRadiationPressureEllipsoid(sun, body1Model, new SphericalSpacecraft(50.0, 0.5, 1, 0., 0.,
                "Default"));
        srp2.addOccultingBody(new ExtendedOneAxisEllipsoid(6378000, 0, body3.getInertialEquatorFrame(), "Body2"));
    ...
    public void testHeliocentric() throws PatriusException {
        ...
        final Orbit initialOrbit = new KeplerianOrbit(150E9, 0, 0, 0, 0, 0, PositionAngle.TRUE, sun.getInertialEquatorFrame(), initialDate, Constants.IERS92_SUN_GRAVITATIONAL_PARAMETER);
        propagator.setInitialState(new SpacecraftState(initialOrbit, massModel));
        propagator.setOrbitFrame(sun.getInertialEquatorFrame());
    ...
    public void testEnrichParameterDescriptors() throws PatriusException {
        ...
        final GeometricBodyShape moonModel = new ExtendedOneAxisEllipsoid(1500000, 0,
                moon.getTrueRotatingFrame(), "Moon");
        ...
        public IAUPole getIAUPole() {
            return new IAUPole(){
                ...
                public double getPrimeMeridianAngle(AbsoluteDate date,
                        GlobalIAUPoleType iauPoleType) {
                    return getPrimeMeridianAngle(date);
                }

                @Override
                public Vector3D getPoleDerivative(AbsoluteDate date,
                        GlobalIAUPoleType iauPoleType) {
                    return getPoleDerivative(date);
                }

                @Override
                public double getPrimeMeridianAngleDerivative(AbsoluteDate date,
                        GlobalIAUPoleType iauPoleType) {
                    return getPrimeMeridianAngleDerivative(date);
                }
            };
        };
