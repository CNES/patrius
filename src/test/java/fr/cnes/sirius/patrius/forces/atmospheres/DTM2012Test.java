...
public class DTM2012Test {
     ...
     */
    @Test
    public void testData() throws PatriusException {
        ...
        data = computeData(earth, day, alti * 1000, xlon * 1000, MathLib.toRadians(lat), hl * FastMath.PI / 12, f,
            fbar, akp3, akp24);
    ...
    private final static AtmosphereData computeData(final OneAxisEllipsoid earth, final double day,
        ...
        final DTMInputParameters params = new DTMInputParameters(){
            /** Serializable UID. */
            private static final long serialVersionUID = -7206166089868369129L;
        ...
        final PVCoordinatesProvider sun = new PVCoordinatesProvider(){
            /** Serializable UID. */
            private static final long serialVersionUID = 8368346714016988655L;
    ...
    public void testPropagationDTM2012vsDTM2000() throws PatriusException {
        ...
        final OneAxisEllipsoid earth = new OneAxisEllipsoid(ae, f, FramesFactory.getITRF(), "Earth");
        final PVCoordinatesProvider sun = new MeeusSun();
        final DTMInputParameters params = new DTMInputParameters(){
            /** Serializable UID. */
            private static final long serialVersionUID = 5376906282476667476L;
        ...
        Assert.assertEquals(0,
            state2012.getPVCoordinates().getPosition().distance(state2000.getPVCoordinates().getPosition()), 1000);
    }
    ...
    public SpacecraftState propagate(final ExtendedAtmosphere atmosphere) throws PatriusException {
        ...
        propagator.setInitialState(new SpacecraftState(initialOrbit, loi.getAttitude(initialOrbit, initialDate,
            EME2000Frame), massModel));
