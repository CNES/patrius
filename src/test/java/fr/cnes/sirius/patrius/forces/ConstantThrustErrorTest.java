...
public class ConstantThrustErrorTest {
    ...
    public void testPropagationWithDifferentFrame() throws PatriusException, IOException, ParseException {
        ...
        final FirstOrderIntegrator dop853 = new DormandPrince853Integrator(.1,
            7200, tol[0], tol[1]);
        final NumericalPropagator propagator1 = new NumericalPropagator(dop853);
        ...
        builder2.addPart("Tank", "Main", Transform.IDENTITY);
     ...
     */
    @Test
    public final void testUnsupportedParam() {
        final double[] dAccdParam = new double[3];
        // Initial date:
        final double mu = Constants.GRIM5C1_EARTH_MU;
        // Reference frame:
     ...
     */
    @Test
    public final void testNegativeDuration() {
        // Reference frame:
        final Frame gcrf = FramesFactory.getGCRF();
        // Constant thrust maneuver error:
     ...
     */
    @Test
    public final void derivativesComputationOnlyWhenFiring() throws PatriusException {
    ...
    public final void testManeuverWithLOF() throws PatriusException, IOException, ParseException {
        ...
        final FirstOrderIntegrator dop8532 = new DormandPrince853Integrator(.1,
            7200, tol2[0], tol2[1]);
        final NumericalPropagator propagator2 = new NumericalPropagator(dop8532);
    ...
    public void testPropagationSplitDuringManeuver() throws PatriusException {
        ...
        for (int i = 0; i < 7; i++) {
            Assert.assertEquals(stateArray[i], retroStateArray[i], 1.0E-16);
        }
    ...
    private class QuadraticFunction implements IParamDiffFunction {
        ...
        @Override
        public ArrayList<Parameter> getParameters() {
            final ArrayList<Parameter> l = new ArrayList<Parameter>(3);
            l.add(this.a);
            l.add(this.b);
            l.add(this.c);
            return l;
