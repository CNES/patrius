...
public class GravitationalAttractionWrenchTest {
    ...
    public void testComputeWrenchSpacecraftState() throws PatriusException {
        ...
        checkV(exp.getOrigin(), act.getOrigin(), this.eps);
        checkV(exp.getTorque(), act.getTorque(), this.eps);
        checkV(exp.getForce(), act.getForce(), this.eps);
