...
public class GenericWrenchModelTest {
    ...
    public void testComputeWrenchSpacecraftState() throws PatriusException {
        ...
        this.checkV(Vector3D.ZERO, act.getOrigin(), this.eps);
        this.checkV(force.computeAcceleration(null), act.getForce(), this.eps);
        this.checkV(origin.crossProduct(force.computeAcceleration(null)), act.getTorque(), this.eps);

        final Vector3D tor = wrench.computeTorque(this.s);
        this.checkV(origin.crossProduct(force.computeAcceleration(null)), tor, this.eps);
    ...
    public void testComputeWrenchSpacecraftStateVector3DFrame() throws PatriusException {
        ...
        this.checkV(otherOrigin, act.getOrigin(), this.eps);
        this.checkV(force.computeAcceleration(this.s), act.getForce(), this.eps);
        this.checkV(origin.crossProduct(force.computeAcceleration(this.s)).add(
