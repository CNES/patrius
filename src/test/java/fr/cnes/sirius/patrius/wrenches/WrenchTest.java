...
public class WrenchTest {
    ...
    public void testSum() {
        ...
        assertVectors(sd.getOrigin(), Vector3D.MINUS_I, this.eps);
        assertVectors(sd.getForce(), Vector3D.MINUS_J.add(Vector3D.MINUS_K), this.eps);
        assertVectors(sd.getTorque(), Vector3D.MINUS_K.add(Vector3D.PLUS_J), this.eps);

        assertVectors(sd1.getOrigin(), Vector3D.MINUS_I, this.eps);
        assertVectors(sd1.getForce(), Vector3D.MINUS_J.add(Vector3D.MINUS_K), this.eps);
        assertVectors(sd1.getTorque(), Vector3D.MINUS_K.add(Vector3D.PLUS_J), this.eps);
    ...
    public void testDisplace() {
        ...
        assertVectors(sd.getOrigin(), Vector3D.PLUS_I, this.eps);
        assertVectors(sd.getForce(), Vector3D.MINUS_J, this.eps);
        assertVectors(sd.getTorque(), Vector3D.PLUS_K, this.eps);

        assertVectors(sd.getTorque(Vector3D.PLUS_I), Vector3D.PLUS_K, this.eps);

        assertVectors(sd1.getOrigin(), Vector3D.PLUS_I, this.eps);
        assertVectors(sd1.getForce(), Vector3D.MINUS_J, this.eps);
        assertVectors(sd1.getTorque(), Vector3D.PLUS_K, this.eps);

        assertVectors(sd1.getTorque(Vector3D.PLUS_I), Vector3D.PLUS_K, this.eps);
    ...
    public void testGetters() {
        final Wrench s = new Wrench(Vector3D.MINUS_I, Vector3D.MINUS_J, Vector3D.MINUS_K);
        assertVectors(s.getOrigin(), Vector3D.MINUS_I, this.eps);
        assertVectors(s.getForce(), Vector3D.MINUS_J, this.eps);
        assertVectors(s.getTorque(), Vector3D.MINUS_K, this.eps);
    }
    ...
    public void testToString() {
        ...
        Assert.assertEquals(s.toString(),
            "Wrench{Origin{-1.0; 0.0; 0.0},Force{0.0; -1.0; 0.0},Torque{0.0; 0.0; -1.0}}");
    }
    ...
    public void testDoubleArray() throws PatriusException {
        ...
        assertEquals(new double[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 }, s.getWrench(), this.eps);
    }
