...
public class PyramidalFieldTest {
    ...
    private static final String SEVERAL_BOUNDARY_LOOPS =
        "The union or intersection is too complex and connot be computed.";
    ...
    public void pyramidalTest() {
        ...
        Assert.assertTrue(field.isInTheField(testedDirection));
        Assert.assertEquals(field.getAngularDistance(testedDirection), MathLib.atan2(1.0, 2.0), this.comparisonEpsilon);
    ...
    public void inInTheFieldConvexTest() {
        ...
        for (int i = 0; i < directions.length; i++) {
            ...
            final Vector2D vectInPlane =
                new Vector2D(-lambda, new Vector2D(directions[i].getX(), directions[i].getY()));
     ...
     * 
     * @throws PatriusException thrown if an error occurs with the binary space partition. Such error can occur if one
     *         of the fields is
    ...
    public void getIntersectionWithTest() throws PatriusException {
        ...
        Assert.assertTrue(PyramidalFieldTest.equals(result, expected, this.comparisonEpsilon));
    ...
    public void getUnionWithTest() throws PatriusException {
        ...
        Assert.assertTrue(PyramidalFieldTest.equals(union, expected, this.comparisonEpsilon));
        ...
        Assert.assertTrue(PyramidalFieldTest.equals(fieldAUnionWithFieldB, fieldA, this.comparisonEpsilon));
        Assert.assertTrue(PyramidalFieldTest.equals(fieldBUnionWithFieldA, fieldA, this.comparisonEpsilon));
     ...
     * {@link PyramidalField#turnClockwise() turnClockwise}.
     * 
     * @throws PatriusException thrown if an error occurs with the binary space partition. Such error can occur if one
     *         of the fields is
     *         concave and leads to several intersections.
     * 
     * @testedMethod {@link PyramidalField#turnClockwise()}
     */
    @Test
    public void clockwiseComputationTest() throws PatriusException {
        ...
        Assert.assertTrue(complementaryOfAntiClockwise.turnClockwise());
        final PyramidalField twiceComplementaryOfAntiClockwise =
            complementaryOfAntiClockwise.getComplementaryFieldOfView();
        ...
        final PyramidalField clockwiseConcaveField =
            new PyramidalField("Clockwise concave field", clockwiseConcaveFieldDirs);
     ...
     * @return a string representation of a pyramidal field.
     */
    ...
    /**
     * Build a new {@link RectangularPyramidalFieldBuilder} by rotating the initial base vectors in the plane.
     * 
     * @param field {@link PyramidalField} istance
     * 
     * @param axis
     *        the rotation axis
     * 
    ...
    public static class RectangularPyramidalFieldBuilder {
        ...
        /**
         * Build a new {@link RectangularPyramidalFieldBuilder} applying a translation of the initial base vectors.
         * 
         * @param translation
