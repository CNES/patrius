...
public class MultiOrbitalCovarianceTest {
    ...
    private static final Orbit CARTESIAN_ORBIT_1;

    /** Default second Cartesian orbit used for the tests. */
    private static final Orbit CARTESIAN_ORBIT_2;

    /** Default orbits collection used for the tests. */
    private static final List<Orbit> ORBITS;

    /** Default 12X12 covariance matrix used for the tests. */
    private static final SymmetricPositiveMatrix COVARIANCE_MATRIX_12X12;

    /** Default 18X18 covariance matrix used for the tests. */
    private static final SymmetricPositiveMatrix COVARIANCE_MATRIX_18X18;

    /**
     * Parameter descriptors associated with the default 12x12 covariance matrix (Cartesian
     * coordinates).
     */
    private static final List<ParameterDescriptor> DEFAULT_CARTESIAN_PARAMETER_DESCRIPTORS_12X12;

    /**
     * Parameter descriptors associated with the default 18x18 covariance matrix (Cartesian
     * coordinates).
     */
    private static final List<ParameterDescriptor> DEFAULT_CARTESIAN_PARAMETER_DESCRIPTORS_18X18;

    /**
     * Parameter descriptors associated with the default 12X12 covariance matrix (Keplerian
     * parameters, true anomaly).
     */
    private static final List<ParameterDescriptor> DEFAULT_KEPLERIAN_PARAMETER_DESCRIPTORS_12X12_TRUE_ANOMALY;
    ...
    static {
        ...
        CARTESIAN_ORBIT_1 = new CartesianOrbit(pv1, GCRF, DATE, Constants.EGM96_EARTH_MU);
        ...
        CARTESIAN_ORBIT_2 = new CartesianOrbit(pv2, GCRF, DATE, Constants.EGM96_EARTH_MU);
    ...
    public void testTransform6x6ToLOF() throws PatriusException {
        ...
        for (final LOFType lofType : evaluatedLOF) {
            ...
            for (final Orbit orbit : ORBITS) {
                ...
                final Frame destFrame = new LocalOrbitalFrame(GCRF, lofType, orbit,
                        expectedFrameName);
    ...
    public void testTransform6x6ToLOFInertialFrame2nd() throws PatriusException {
        ...
        for (final LOFType lofType : evaluatedLOF) {
            ...
            for (final Orbit orbit : initialOrbits) {
                ...
                final Orbit orbitInertial = orbit.getType().convertOrbit(orbit, GCRF);
                final Frame destFrame = new LocalOrbitalFrame(GCRF, lofType, orbitInertial,
                        expectedFrameName);
    ...
    public void testTransform6x6ToFrozenLOF() throws PatriusException {
        ...
        for (final LOFType lofType : evaluatedLOF) {
            ...
            for (int i = 0; i < ORBITS.size(); i++) {
                ...
                final Frame destFrame = new LocalOrbitalFrame(GCRF, lofType, orbit, lofType.name())
    ...
    public void testShiftedBy6x6() throws PatriusException {
        ...
        final MultiOrbitalCovariance expected = new MultiOrbitalCovariance(shiftedCovariance,
                shiftedOrbits, nbAdditionalParameters, GCRF, OrbitType.CARTESIAN,
                PositionAngle.TRUE);
        checkEquality(expected, result, ABSTOL, RELTOL);
    }
    ...
    public void testTransformWrongOrbitDate() throws PatriusException {
        ...
        final Covariance initialCovariance = new Covariance(COVARIANCE_MATRIX_12X12,
                DEFAULT_CARTESIAN_PARAMETER_DESCRIPTORS_12X12);
        final MultiOrbitalCovariance initialMultiOrbitalCovariance = new MultiOrbitalCovariance(
                initialCovariance, ORBITS, nbAdditionalParameters, GCRF, OrbitType.CARTESIAN,
                PositionAngle.ECCENTRIC);
    ...
    public void testGetOrbitalCovariance() {
        ...
        // Check the results
        OrbitalCovarianceTest.checkEquality(expectedOrbitalCovariance1, orbitalCovariance1, ABSTOL,
                RELTOL);
        OrbitalCovarianceTest.checkEquality(expectedOrbitalCovariance2, orbitalCovariance2, ABSTOL,
                RELTOL);
    }
