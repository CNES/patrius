...
public class StelaZonalAttractionTest {
     ...
     */
    @Test
    public void testComputeZonal() throws PatriusException {
     ...
     */
    @Test
    public void testComputeZonalShortPeriods() throws PatriusException, IOException, ParseException {
        ...
        final double[] pertJ2 = zonal.computeShortPeriods(orbit, null);
        ...
        // Order 8 and higher
        final double[] sp8 = new StelaZonalAttractionJ8(1., 1.).computeShortPeriods(orbit, null);
        final double[] sp9 = new StelaZonalAttractionJ9(1., 1.).computeShortPeriods(orbit, null);
        final double[] sp10 = new StelaZonalAttractionJ10(1., 1.).computeShortPeriods(orbit, null);
        final double[] sp11 = new StelaZonalAttractionJ11(1., 1.).computeShortPeriods(orbit, null);
        final double[] sp12 = new StelaZonalAttractionJ12(1., 1.).computeShortPeriods(orbit, null);
        final double[] sp13 = new StelaZonalAttractionJ13(1., 1.).computeShortPeriods(orbit, null);
        final double[] sp14 = new StelaZonalAttractionJ14(1., 1.).computeShortPeriods(orbit, null);
        final double[] sp15 = new StelaZonalAttractionJ15(1., 1.).computeShortPeriods(orbit, null);
     ...
     */
    @Test
    public void testComputeZonalPartialDerivatives() throws PatriusException, IOException, ParseException {
