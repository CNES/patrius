...
public class StelaEquinoctialOrbitTest {
     ...
     */
    @Test
    public void testPVCoordinatesComputation() throws PatriusException {
        ...
        checkDouble(4643107.10407, pvs.getPosition().getX(),
            EPSILON * MathLib.abs(pvs.getPosition().getX()), "X");
        checkDouble(1432369.73327, pvs.getPosition().getY(),
            EPSILON * MathLib.abs(pvs.getPosition().getY()), "Y");
        checkDouble(-4945115.63544, pvs.getPosition().getZ(),
        ...
        checkDouble(3850.91197413, pvs.getVelocity().getZ(),
     ...
     */
    @Test
    public void testJacobianWrtCartesian() {
     ...
     */
    @Test
    public void testJacobianWrtParameters() {
        final double[][] jacobian = new double[6][6];
     ...
     */
    @Test
    public void testMapOrbitToArray() {
     ...
     */
    @Test
    public void testInclinationCorrection() {
        // Check 1
        final double mu = 3.9860044144982E14;
    ...
    public void serialisationTest() {
        ...
        // test equals
        assertEqualsStelaOrbit(orbit, orbit2);
    }
    ...
    private static void assertEqualsStelaOrbit(final StelaEquinoctialOrbit orbit1,
    ...
    private static void checkDouble(final double expected, final double actual,
            final double threshold, final String tag) {
