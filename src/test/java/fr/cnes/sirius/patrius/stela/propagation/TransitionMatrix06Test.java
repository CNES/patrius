 ...
 * @since 2.1
 */
public class TransitionMatrix06Test {
    ...
    // { 1E-4, 1E-6, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4 },
    // { 1E-4, 1E-6, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4 },
    // { 1E-4, 1E-6, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4 },
    // { 1E-4, 1E-6, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4 },
    // { 1E-4, 1E-6, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4 },
    ...
    // };
    // private final double[][] tolerance_old = {
    // { 1E-4, 1E-3, 1E1, 1E-0, 1E1, 1E1, 1E-4, 1E1 },
    // { 1E-4, 1E-6, 1E-1, 1E-1, 1E-4, 1E-4, 1E-4, 1E-0 },
    // { 1E-4, 1E-6, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-0 },
    // { 1E-4, 1E-6, 1E-4, 1E-4, 1E-4, 1E-3, 1E-4, 1E-0 },
    // { 1E-4, 1E-6, 1E-2, 1E-3, 1E-4, 1E-4, 1E-4, 1E-0 },
    // { 1E-4, 1E-6, 1E-3, 1E-3, 1E-4, 1E-4, 1E-4, 1E-0 }
    // };

    private final double[][] tolerance = {
        { 1E-6, 1E-1, 1E1, 1E-0, 1E1, 1E-0, 1E-4, 1E1 },
        { 1E-5, 1E-4, 1E-1, 1E-1, 1E-4, 1E-5, 1E-4, 1E1 },
        { 1E-3, 1E-8, 1E-5, 1E-5, 1E-4, 1E-4, 1E-4, 1E-0 },
        { 1E-3, 1E-8, 1E-5, 1E-5, 1E-5, 1E-3, 1E-4, 1E-0 },
        { 1E-4, 1E-9, 1E-2, 1E-3, 1E-5, 1E-5, 1E-4, 1E-0 },
        { 1E-5, 1E-9, 1E-3, 1E-3, 1E-5, 1E-5, 1E-4, 1E-0 },
    };

    /** Comparison type for each cell of transition matrix. */
    private final ComparisonTypes[][] comparisonType = {
        { ComparisonTypes.RELATIVE, ComparisonTypes.ABSOLUTE, ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE,
    ...
    public void test() throws PatriusException, IOException, ParseException {
        new GenericTransitionMatrixTest("Transition Matrix test 06", this.delta, this.jjfin, this.jjdeb, this.a,
            this.eccentricity,
            this.eccentricity, this.pom, this.gom, this.m, this.mu, this.tolerance,
