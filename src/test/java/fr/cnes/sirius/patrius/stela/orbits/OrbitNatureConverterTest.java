...
public class OrbitNatureConverterTest {
     ...
     */
    @Test
    public void testToMean() throws PatriusException {
     ...
     */
    @Test
    public void testToOsculating() throws PatriusException {
        // Test with NO forces (earth potential only)
     ...
     */
    @Test
    public void testToOsculatingSeveralForces() throws PatriusException {
     ...
     */
    @Test
    public void testToMeanOtherFrame() throws PatriusException {
        // Test with NO forces (earth potential only)
     ...
     */
    @Test
    public void testToOsculatingOtherFrame() throws PatriusException {
     ...
     */
    @Test
    public void testConvergence() throws PatriusException, IOException, ParseException {
        ...
        OrbitNatureConverter.setThreshold(1E-14);
    }

    public static class PatriusPotentialCoefficientsProvider implements PotentialCoefficientsProvider {

        /** Serializable UID. */
        private static final long serialVersionUID = 8803028651076350638L;
