...
public class PerigeeAltitudeDetectorTest {
     ...
     */
    @Test
    public void testPerigeeAltitudeDetectorDoubleDouble() {
     ...
     */
    @Test
    public void testPerigeeAltitudeDetectorDoubleDoubleDouble() {
     ...
     */
    @Test
    public void testPerigeeAltitudeDetectorDoubleDoubleDoubleActionAction() {
        final double refChk = 7.;
        final double refAlt = 8.;
        final double refRad = 9.;
     ...
     */
    @Test
    public void testPerigeeAltitudeDetectorDoubleDoubleDoubleDouble() {
     ...
     */
    @Test
    public void testPerigeeAltitudeDetectorDoubleDoubleDoubleDoubleOrbitNatureConverter() {
     ...
     */
    @Test
    public void testPerigeeAltitudeDetectorDoubleDoubleActionAction() {
        final double refThr = 6.;
        final double refChk = 7.;
        final double refAlt = 8.;
        final double refRad = 9.;
     ...
     */
    @Test
    public void testPerigeeAltitudeDetectorDoubleDoubleDoubleDoubleOrbitNatureConverterActionAction() {
        final OrbitNatureConverter onc =
            new OrbitNatureConverter(new ArrayList<StelaForceModel>());
        final double refThr = 6.;
        final double refChk = 7.;
     ...
     */
    @Test
    public void testGOsc() throws PatriusException {
        final OrbitNatureConverter onc =
            new OrbitNatureConverter(new ArrayList<StelaForceModel>());
        final double refThr = 6.;
        final double refChk = 7.;
