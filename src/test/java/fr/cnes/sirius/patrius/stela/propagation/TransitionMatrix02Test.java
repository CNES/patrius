 ...
 * @since 2.1
 */
public class TransitionMatrix02Test {
    ...
    // { 1E-5, 1E3, 1E3, 1E3, 1E3, 1E3, 1E3, 1E2 },
    // { 1E-1, 1E-1, 1E-1, 1E-1, 1E-1, 1E-1, 1E-1, 1E-0 },
    // { 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-2 },
    // { 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-0 },
    // { 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-2 },
    // { 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-4, 1E-2 }
    // };

    private final double[][] tolerance = {
        { 1E-4, 1E-0, 1E3, 1E3, 1E2, 1E2, 1E-12, 1E2 },
        { 1E-5, 1E-4, 1E-2, 1E-2, 1E-1, 1E-1, 1E-12, 1E-2 },
        { 1E-4, 1E0, 1E-5, 1E-5, 1E-4, 1E-5, 1E-12, 1E-5 },
        { 1E-3, 1E0, 1E-5, 1E-5, 1E-4, 1E-5, 1E-12, 1E-5 },
        { 1E-3, 1E0, 1E-5, 1E-5, 1E-6, 1E-5, 1E-12, 1E-8 },
        { 1E-2, 1E0, 1E-5, 1E-5, 1E-6, 1E-6, 1E-12, 1E-7 },
    };

    /** Comparison type for each cell of transition matrix. */
    private final ComparisonTypes[][] comparisonType = {
        { ComparisonTypes.RELATIVE, ComparisonTypes.ABSOLUTE, ComparisonTypes.ABSOLUTE, ComparisonTypes.ABSOLUTE,
            ComparisonTypes.ABSOLUTE,
            ComparisonTypes.ABSOLUTE, ComparisonTypes.ABSOLUTE, ComparisonTypes.ABSOLUTE },
        { ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE,
            ...
            ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE, ComparisonTypes.ABSOLUTE },
        { ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE,
            ComparisonTypes.RELATIVE,
            ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE, ComparisonTypes.ABSOLUTE },
        { ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE, ComparisonTypes.RELATIVE,
    ...
    public void test() throws PatriusException, IOException, ParseException {
        new GenericTransitionMatrixTest("Transition Matrix test 02", this.delta, this.jjfin, this.jjdeb, this.a,
            this.eccentricity, this.i, this.pom, this.gom,
            this.m, this.mu, this.tolerance, this.dragArea,
            this.refArea, this.isOsculating, this.refCoef, this.mass, this.cx, this.dt, this.reentryAltitude,
            this.drag, this.tess, this.comparisonType).run();
    }
}
