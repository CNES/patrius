...
public class MeeusSunStelaTest {
    ...
    public void testTransformation() throws PatriusException {
        Assert.assertNotNull(this.sun.getInertialFrameConstantModel().getTransformTo(FramesFactory.getEME2000(),
            AbsoluteDate.J2000_EPOCH));
        Assert.assertNotNull(this.sun.getRotatingFrameTrueModel().getTransformTo(FramesFactory.getEME2000(),
            AbsoluteDate.J2000_EPOCH));
    }
