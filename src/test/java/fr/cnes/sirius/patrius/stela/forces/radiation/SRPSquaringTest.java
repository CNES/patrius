...
public class SRPSquaringTest {
    ...
    public void testGetFlux() throws IllegalArgumentException, PatriusException {
        final Vector3D result = this.srp.getFlux(this.orbit, this.sun.getPVCoordinates(this.orbit.getDate(), this.orbit.getFrame()));
     ...
     * 
     * @testedMethod {@link SRPSquaring#computeShortPeriods(StelaEquinoctialOrbit)}
     * 
     * @description tests short periods method
     * 
     * @input StelaEquinoctialOrbit
     * 
     * @output
     ...
     */
    @Test
    public void testComputeSRPShortPeriods() throws PatriusException {

        final double[] result = this.srp.computeShortPeriods(this.orbit);
    ...
    public void setup() throws PatriusException {
        ...
        final ArrayList<StelaForceModel> forcelist = new ArrayList<StelaForceModel>();
        ...
        builder.addMainPart(main);
        builder.addProperty(new MassProperty(mass2), main);
        builder.addProperty(new RadiativeProperty(0, 0, reflectCoef), main);
        builder.addProperty(new RadiativeSphereProperty(MathLib.sqrt(reflectingArea2 / FastMath.PI)), main);
