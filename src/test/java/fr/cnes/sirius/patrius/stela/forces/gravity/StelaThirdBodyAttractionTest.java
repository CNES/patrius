...
public class StelaThirdBodyAttractionTest {
     ...
     */
    @Test
    public final void testComputePerturbations() throws PatriusException {
        ...
        Report.printToReport("Perturbation (degree 3)", expDeg3, this.subtract(pert3, pert2));
        Report.printToReport("Perturbation (degree 4)", expDeg4, this.subtract(pert4, pert3));
        Report.printToReport("Perturbation (degree 5)", expDeg5, this.subtract(pert5, pert4));
     ...
     */
    @Test
    public final void testComputePartialDerivatives() throws PatriusException, IOException, ParseException {
        ...
        Report.printToReport("Partial derivatives (degree 3)", expDeg3SecDeriv, this.subtract(der3, der2));
        Report.printToReport("Partial derivatives (degree 4)", expDeg4SecDeriv, this.subtract(der4, der3));
    }
     ...
     */
    @Test
    public final void testComputeShortPeriods() throws PatriusException {
    ...
    private class UserEphemerisForTest1 implements IUserEphemeris {
        ...
        public Map<AbsoluteDate, PVCoordinates> getEphemeris() {
            final Map<AbsoluteDate, PVCoordinates> map = new TreeMap<AbsoluteDate, PVCoordinates>();
