...
public class StelaAeroModelTest {
     ...
     */
    @Test
    public final void testComputeDragAcceleration() throws PatriusException {
     ...
     */
    @Test
    public final void testComputeDDragAccDState() throws PatriusException {
     ...
     */
    @Test
    public final void testComputeDDragAccDState2() throws PatriusException {
    ...
    public final void testGetSpeedOfSound() throws PatriusException {
        ...
        final Atmosphere refAtmosphere = new MSISE2000(new ClassicalMSISE2000SolarData(solarActivity),
            new OneAxisEllipsoid(ae, f, FramesFactory.getTIRF()), sun);
        ...
        // Check
        Assert.assertEquals((speedOfSound - ref) / ref, 0., 1E-7);
    }
