...
public class QuaternionGuidanceProfilesTest {
     ...
     */
    @Test
    public void testQuaternionHarmonicProfile() throws PatriusException {
        ...
        Assert.assertEquals(1., profile.getAngularFrequencies()[0], 0.);
        Assert.assertEquals(5., profile.getAngularFrequencies()[1], 0.);
        Assert.assertEquals(2., profile.getAngularFrequencies()[2], 0.);
        Assert.assertEquals(2.5, profile.getAngularFrequencies()[3], 0.);
        // test the getter of the a0 coefficients:
        Assert.assertEquals(1., profile.getConstants()[0], 0.);
        Assert.assertEquals(1., profile.getConstants()[1], 0.);
        Assert.assertEquals(1., profile.getConstants()[2], 0.);
        Assert.assertEquals(1., profile.getConstants()[3], 0.);
        // test the getter of the cosinus coefficients:
        Assert.assertEquals(3., profile.getCosArrays()[0][2], 0.);
        Assert.assertEquals(4., profile.getCosArrays()[1][3], 0.);
        Assert.assertEquals(1., profile.getCosArrays()[2][0], 0.);
        Assert.assertEquals(2., profile.getCosArrays()[3][1], 0.);
        // test the getter of the sinus coefficients:
        Assert.assertEquals(2., profile.getSinArrays()[0][2], 0.);
        Assert.assertEquals(1., profile.getSinArrays()[1][3], 0.);
        Assert.assertEquals(4., profile.getSinArrays()[2][0], 0.);
        Assert.assertEquals(3., profile.getSinArrays()[3][1], 0.);
    ...
    public void testQuaternionHarmonicProfileCopyMethod() throws PatriusException {
        ...
        final AbsoluteDateInterval interval = new AbsoluteDateInterval(IntervalEndpointType.CLOSED, start, end,
                IntervalEndpointType.CLOSED);
        final AbsoluteDateInterval newIntervalOfValidity = new AbsoluteDateInterval(IntervalEndpointType.CLOSED,
                start.shiftedBy(5), end.shiftedBy(-5), IntervalEndpointType.CLOSED);

        // build guidance profile
        QuaternionHarmonicProfile profile = new QuaternionHarmonicProfile(start, FramesFactory.getGCRF(), q0fs, q1fs,
                q2fs, q3fs, interval);
        ...
        Assert.assertEquals(0,
                attitudeActual.getRotationAcceleration().distance(attitudeRef.getRotationAcceleration()), 0);
    }
     ...
     */
    @Test
    public void testQuaternionHarmonicProfileSpin() throws PatriusException {
        ...
        // build guidance profile
        final QuaternionHarmonicProfile refProfile = new QuaternionHarmonicProfile(start, FramesFactory.getGCRF(),
                q0fs, q1fs, q2fs, q3fs, interval);
        ...
        final Orbit orbit = new KeplerianOrbit(7000000, 0, 0, 0, 0, 0, PositionAngle.TRUE, FramesFactory.getGCRF(),
                start.shiftedBy(10.), Constants.EGM96_EARTH_MU);
     ...
     *
     * @testedMethod {@link QuaternionPolynomialProfile#QuaternionPolynomialProfile(Frame,
     ...
     */
    @Test
    public void testQuaternionPolynomialProfile() throws PatriusException {
        ...
        final AbsoluteDateInterval interval1 = new AbsoluteDateInterval(IntervalEndpointType.CLOSED, date0, date1,
                IntervalEndpointType.CLOSED);
        final QuaternionPolynomialSegment segment1 = new QuaternionPolynomialSegment(q0pf1, q1pf1, q2pf1, q3pf1, date0,
                interval1, false);
        ...
        final AbsoluteDateInterval interval2 = new AbsoluteDateInterval(IntervalEndpointType.OPEN, date1, date2,
                IntervalEndpointType.CLOSED);
        final QuaternionPolynomialSegment segment2 = new QuaternionPolynomialSegment(q0pf2, q1pf2, q2pf2, q3pf2, date0,
                interval2, false);

        // create the list of segments:
        final List<QuaternionPolynomialSegment> segments = new ArrayList<>();
        ...
        Assert.assertEquals(FramesFactory.getGCRF(), profile.getReferenceFrame());
        ...
        Assert.assertEquals(q0pf1.getCoefficients()[0], profile.getQ0Coefficients().get(interval1)[0], 0.);
        Assert.assertEquals(q1pf1.getCoefficients()[1], profile.getQ1Coefficients().get(interval1)[1], 0.);
        Assert.assertEquals(q2pf1.getCoefficients()[2], profile.getQ2Coefficients().get(interval1)[2], 0.);
        Assert.assertEquals(q3pf1.getCoefficients()[3], profile.getQ3Coefficients().get(interval1)[3], 0.);

        Assert.assertEquals(q0pf2.getCoefficients()[3], profile.getQ0Coefficients().get(interval2)[3], 0.);
        Assert.assertEquals(q1pf2.getCoefficients()[2], profile.getQ1Coefficients().get(interval2)[2], 0.);
        Assert.assertEquals(q2pf2.getCoefficients()[1], profile.getQ2Coefficients().get(interval2)[1], 0.);
        Assert.assertEquals(q3pf2.getCoefficients()[0], profile.getQ3Coefficients().get(interval2)[0], 0.);
    ...
    public void testQuaternionPolynomialProfileCopyMethod() throws PatriusException {
        ...
        final AbsoluteDateInterval newIntervalOfValidity = new AbsoluteDateInterval(IntervalEndpointType.CLOSED,
                date0.shiftedBy(5), date1.shiftedBy(10), IntervalEndpointType.CLOSED);

        final Attitude attitudeRef = profile.getAttitude(null, date0.shiftedBy(5), FramesFactory.getGCRF());

        // Test case n°1 : in a standard usage, the interval stored should be updated
        final QuaternionPolynomialProfile tmp = profile.copy(newIntervalOfValidity);
        profile = profile.copy(newIntervalOfValidity);
        Assert.assertTrue(profile.getTimeInterval().equals(newIntervalOfValidity));
        // Also check attitude in the middle of the validity interval
        ...
        final AbsoluteDateInterval interval116 = interval1.mergeTo(interval2);
        final QuaternionPolynomialProfile profile116 = new QuaternionPolynomialProfile(FramesFactory.getGCRF(),
                interval116, segments, "My nature");
        final AbsoluteDateInterval interval116Reduced = new AbsoluteDateInterval(date0.shiftedBy(-10), date2.shiftedBy(-10));
        try {
            // New interval not included in former interval
            final QuaternionPolynomialProfile profile116Copy = profile116.copy(interval116Reduced);
        ...
        try {
            ...
            final AbsoluteDateInterval interval116Reduced2 = new AbsoluteDateInterval(date0.shiftedBy(10),
                    date2.shiftedBy(-10));
            final QuaternionPolynomialProfile profile116Copy2 = profile116.copy(interval116Reduced2);
     ...
     * @testedMethod {@link QuaternionPolynomialProfile#getAttitude(PVCoordinatesProvider, AbsoluteDate, Frame)}
     *
     * @description checks that the profile spin can be computed on the boundaries (performed by
     *              finite differences)
     *
     * @input methods inputs
     *
     ...
     */
    @Test
    public void testQuaternionPolynomialProfileBoundary() throws PatriusException {
        ...
        final AbsoluteDateInterval interval = new AbsoluteDateInterval(IntervalEndpointType.CLOSED, date0, date1,
                IntervalEndpointType.CLOSED);
        final QuaternionPolynomialSegment segment = new QuaternionPolynomialSegment(q0pf1, q1pf1, q2pf1, q3pf1, date0,
                interval, false);

        final List<QuaternionPolynomialSegment> segments = new ArrayList<>();
        segments.add(segment);
        final QuaternionPolynomialProfile profile = new QuaternionPolynomialProfile(FramesFactory.getGCRF(), interval,
                segments);
        ...
        final double spin0p1dt = profile.getAttitude(null, date0.shiftedBy(0.2), FramesFactory.getGCRF()).getSpin()
                .getNorm();
        final double spin0p2dt = profile.getAttitude(null, date0.shiftedBy(0.4), FramesFactory.getGCRF()).getSpin()
                .getNorm();
        Assert.assertEquals(spin0p1dt + (spin0p1dt - spin0p2dt), spin0, 1E-2);
        // Check (right side) - Should be close enough to linear interpolation from 2 previous
        // points
        final double spin1 = profile.getAttitude(null, date1, FramesFactory.getGCRF()).getSpin().getNorm();
        final double spin1m1dt = profile.getAttitude(null, date1.shiftedBy(-0.2), FramesFactory.getGCRF()).getSpin()
                .getNorm();
        final double spin1m2dt = profile.getAttitude(null, date1.shiftedBy(-0.4), FramesFactory.getGCRF()).getSpin()
                .getNorm();
        ...
        final QuaternionPolynomialSegment segment2 = new QuaternionPolynomialSegment(q0pf1, q1pf1, q2pf1, q3pf1, date0,
                interval2, false);
        final List<QuaternionPolynomialSegment> segmentsList = new ArrayList<>();
     ...
     */
    @Test
    public void testQuaternionPolynomialProfileSpin() throws PatriusException {
        ...
        final AbsoluteDateInterval interval = new AbsoluteDateInterval(IntervalEndpointType.CLOSED, start, end,
                IntervalEndpointType.CLOSED);
        final QuaternionPolynomialSegment segment = new QuaternionPolynomialSegment(q0pf1, q1pf1, q2pf1, q3pf1, start,
                interval, false);
        ...
        final QuaternionPolynomialProfile refProfile = new QuaternionPolynomialProfile(FramesFactory.getGCRF(),
                interval, segments);
        final QuaternionPolynomialProfile profile1 = new QuaternionPolynomialProfile(FramesFactory.getGCRF(), interval,
                segments, 0.2);
        final QuaternionPolynomialProfile profile2 = new QuaternionPolynomialProfile(FramesFactory.getGCRF(), interval,
                segments, 1.0);
    ...
    public void testQuaternionPolynomialProfileRotationAcceleration() throws PatriusException {
        ...
        // Build orbit
        final Orbit orbit = new KeplerianOrbit(7000000, 0, 0, 0, 0, 0, PositionAngle.TRUE, FramesFactory.getGCRF(),
                start.shiftedBy(25.), Constants.EGM96_EARTH_MU);
     ...
     *
     * @description tests the reduced time feature of QuaternionPolynomialSegment: check that a
     *              segment with reduced time
     *              and dilated coefficients returns the same result as a segment with standard time
     ...
     */
    @Test
    public void testQuaternionPolynomialSegmentReducedTime() {
        ...
        final QuaternionPolynomialSegment segment = new QuaternionPolynomialSegment(q0pf1, q1pf1, q2pf1, q3pf1, date0,
                interval1, false);
        final QuaternionPolynomialSegment segmentReduced = new QuaternionPolynomialSegment(q0pf1r, q1pf1r, q2pf1r,
                q3pf1r, interval1, false);
     ...
     * @testType UT
     *
     * @testedMethod {@link QuaternionPolynomialSegment#QuaternionPolynomialSegment(PolynomialChebyshevFunction, PolynomialChebyshevFunction, PolynomialChebyshevFunction, PolynomialChebyshevFunction, AbsoluteDateInterval, boolean)}
     *
     * @description Test the constructor of QuaternionPolynomialSegment for PolynomialChebyshevFunctions
     *
     * @testPassCriteria the polynomial coefficients returned by the QuaternionPolynomialSegment are correct
     *
     * @referenceVersion 4.11
     */
    @Test
    public void testQuaternionPolynomialSegmentConstructorChebyshev() {
        ...
        final double[] y0 = { 1, 2, 3 };
        final PolynomialChebyshevFunction q0pcf1 = new PolynomialChebyshevFunction(-1.5, 4.6, y0);
        final double[] y1 = { 2, 3, 4 };
        final PolynomialChebyshevFunction q1pcf1 = new PolynomialChebyshevFunction(-1.5, 4.6, y1);
        final double[] y2 = { 3, 4, 5 };
        final PolynomialChebyshevFunction q2pcf1 = new PolynomialChebyshevFunction(-1.5, 4.6, y2);
        final double[] y3 = { 4, 5, 6, 7 };
        final PolynomialChebyshevFunction q3pcf1 = new PolynomialChebyshevFunction(-1.5, 4.6, y3);

        // create the segment
        final AbsoluteDateInterval interval = new AbsoluteDateInterval(IntervalEndpointType.CLOSED, date0, date1,
            IntervalEndpointType.CLOSED);
        final QuaternionPolynomialSegment segment = new QuaternionPolynomialSegment(q0pcf1, q1pcf1, q2pcf1, q3pcf1,
            interval, false);
        
        // Check that the coefficients are correctly retrieved through the segment
        Assert.assertArrayEquals(y0, segment.getQ0Coefficients(), Precision.DOUBLE_COMPARISON_EPSILON);
    }

    /**
     * @testType UT
     *
     * @testedMethod {@link QuaternionPolynomialSegment#getOrientation(AbsoluteDate)}
     *
     * @description tests that the getOrientation() method returns a rotation if the boolean
     *              "needsNormalization" is set to true.
     *
     * @testPassCriteria the outputs are the expected one
     *
     * @referenceVersion 4.11
     ...
     */
    @Test
    public void testGetOrientationNormalized() {
        ...
        final AbsoluteDateInterval interval1 = new AbsoluteDateInterval(IntervalEndpointType.CLOSED, date0, date1,
                IntervalEndpointType.CLOSED);
        final QuaternionPolynomialSegment segmentNoNormalization = new QuaternionPolynomialSegment(q0pf1, q1pf1, q2pf1,
                q3pf1, date0, interval1, false);

        final Rotation rotationNoNormalization = segmentNoNormalization.getOrientation(date);

        // Check that q0²+q1²+q2²+q3²!=1 for the not normalized rotation
        Assert.assertTrue(MathLib.abs(1 - rotationNoNormalization.getQi()[0] * rotationNoNormalization.getQi()[0]
                + rotationNoNormalization.getQi()[1] * rotationNoNormalization.getQi()[1]
                + rotationNoNormalization.getQi()[2] * rotationNoNormalization.getQi()[2]
                + rotationNoNormalization.getQi()[3] * rotationNoNormalization.getQi()[3]) > Precision.DOUBLE_COMPARISON_EPSILON);

        // The normalization boolean is set to true
        final QuaternionPolynomialSegment segmentWithNormalization = new QuaternionPolynomialSegment(q0pf1, q1pf1,
                q2pf1, q3pf1, date0, interval1, true);

        final Rotation rotationWithNormalization = segmentWithNormalization.getOrientation(date);

        // Check that q0²+q1²+q2²+q3²=1 for the normalized rotation
        Assert.assertEquals(1,rotationWithNormalization.getQi()[0]*rotationWithNormalization.getQi()[0] + rotationWithNormalization.getQi()[1]*rotationWithNormalization.getQi()[1]
                + rotationWithNormalization.getQi()[2] * rotationWithNormalization.getQi()[2]
                + rotationWithNormalization.getQi()[3] * rotationWithNormalization.getQi()[3],
     ...
     * @testType UT
     *
     * @testedMethod {@link QuaternionDatePolynomialSegment#getOrientation(AbsoluteDate)}
     *
     * @description tests that the getOrientation() method returns the correct rotation (also test with and without
     *              normalization)
     *
     * @testPassCriteria the outputs are the expected one
     *
     ...
     */
    @Test
    public void testGetDateOrientation() {
        ...
        final Rotation actualRotation = segment.getOrientation(date);

        final Rotation expectedRotation = new Rotation(false, q0pf.value(date), q1pf.value(date),
            q2pf.value(date), q3pf.value(date));

        Assert
            .assertEquals(expectedRotation.getQi()[0], actualRotation.getQi()[0], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert
            .assertEquals(expectedRotation.getQi()[1], actualRotation.getQi()[1], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert
            .assertEquals(expectedRotation.getQi()[2], actualRotation.getQi()[2], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert
            .assertEquals(expectedRotation.getQi()[3], actualRotation.getQi()[3], Precision.DOUBLE_COMPARISON_EPSILON);

        final Rotation rotationNoNormalization = segment.getOrientation(date);

        // Check that q0²+q1²+q2²+q3²!=1 for the not normalized rotation
        Assert
            .assertTrue(MathLib.abs(1 - rotationNoNormalization.getQi()[0] * rotationNoNormalization.getQi()[0]
                    + rotationNoNormalization.getQi()[1] * rotationNoNormalization.getQi()[1]
                    + rotationNoNormalization.getQi()[2] * rotationNoNormalization.getQi()[2]
                    + rotationNoNormalization.getQi()[3] * rotationNoNormalization.getQi()[3]) > Precision.DOUBLE_COMPARISON_EPSILON);

        // The normalization boolean is set to true
        final QuaternionDatePolynomialSegment segmentWithNormalization = new QuaternionDatePolynomialSegment(q0pf,
            q1pf, q2pf, q3pf, interval, true);

        final Rotation rotationWithNormalization = segmentWithNormalization.getOrientation(date);

        // Check that q0²+q1²+q2²+q3²=1 for the normalized rotation
        Assert.assertEquals(1, rotationWithNormalization.getQi()[0] * rotationWithNormalization.getQi()[0]
                + rotationWithNormalization.getQi()[1] * rotationWithNormalization.getQi()[1]
                + rotationWithNormalization.getQi()[2] * rotationWithNormalization.getQi()[2]
                + rotationWithNormalization.getQi()[3] * rotationWithNormalization.getQi()[3],
            Precision.DOUBLE_COMPARISON_EPSILON);

        // Cover an exception cases in the getOrientation(AbsoluteDate) method
        try {
            segment.getOrientation(date1.shiftedBy(0.1));
            Assert.fail();
        } catch (final IllegalArgumentException e) {
            // Expected
            Assert.assertTrue(true);
     ...
     * @testType UT
     *
     * @testedMethod {@link QuaternionDatePolynomialSegment#getTimeInterval()}
     *
     * @description tests that the getTimeInterval() method returns the correct rotation
     *
     * @testPassCriteria the outputs are the expected one
     *
     * @referenceVersion 4.11
    ...
    public void testGetTimeInterval() {
        ...
        final AbsoluteDateInterval actualInterval = segment.getTimeInterval();
