...
public class SunPointingTest {
     ...
     */
    @Test
    public final void testBasicPolesAxis() throws PatriusException {
        // ellipstic orbit
     ...
     */
    @Test
    public final void testBasicNormal() throws PatriusException {
        // ellipstic orbit
        final double mu = Constants.EGM96_EARTH_MU;
        final AbsoluteDate date = new AbsoluteDate(2012, 4, 2, 15, 3, 0, TimeScalesFactory.getTAI());
        final double a = 10000000;
     ...
     */
    @Test
    public final void testConstructors() throws PatriusException {
        // ellipstic orbit
        final AbsoluteDate date = new AbsoluteDate(2012, 4, 2, 15, 3, 0, TimeScalesFactory.getTAI());
