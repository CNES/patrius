...
public class EarthToCelestialBodyCenterDirectionTest {
     ...
     * 
     * @testedMethod {@link EarthToCelestialBodyCenterDirection#getTargetPVCoordinates(AbsoluteDate, Frame)}
     * 
     ...
     * @testedFeature {@link features#CENTRAL_BODY_CENTER_DIRECTION}
     * 
     * @testedMethod {@link EarthToCelestialBodyCenterDirection#getLine(PVCoordinatesProvider, AbsoluteDate, Frame)}
     * 
     ...
     * @testedFeature {@link features#CENTRAL_BODY_CENTER_DIRECTION}
     * 
     * @testedMethod {@link EarthToCelestialBodyCenterDirection#getVector(PVCoordinatesProvider, SignalDirection, AbsoluteDate, FixedDate, Frame, double)}
     * 
     * @description Instantiation of a direction described
     *              by the direction Earth center => celestial body center (the central body's center is the target
    ...
    public void testGetVectorWithDelay() throws PatriusException{      
        ...
        final Frame bodyFrame = this.sun.getInertialFrame(IAUPoleModelType.TRUE);
        ...
        direction = StellarAberrationCorrection.applyInverseTo(earthToSun.getTargetPvProvider(),
            preStellarCorrectionDirection, bodyFrame, t0).negate();
        Assert.assertEquals(direction.getX(), actual.getX(), 8E-6);
        Assert.assertEquals(direction.getY(), actual.getY(), 2E-4);
        Assert.assertEquals(direction.getZ(), actual.getZ(), 8E-6);
        ...
        preStellarCorrectionDirection = frozenToBodyFrame.transformVector(preStellarCorrectionDirection);
        direction = StellarAberrationCorrection.applyTo(earthDirection.getTargetPvProvider(),
            preStellarCorrectionDirection, bodyFrame, t0);
        Assert.assertEquals(direction.getX(), actual.getX(), 8E-6);
        Assert.assertEquals(direction.getY(), actual.getY(), 2E-4);
        Assert.assertEquals(direction.getZ(), actual.getZ(), 8E-6);
        ...
        preStellarCorrectionDirection = pvTarget.getPosition().subtract(pvOrigin.getPosition());
        preStellarCorrectionDirection = frozenToBodyFrame.transformVector(preStellarCorrectionDirection);
        direction = StellarAberrationCorrection.applyInverseTo(earthDirection.getTargetPvProvider(),
            preStellarCorrectionDirection, bodyFrame, t0);
        Assert.assertEquals(direction.getX(), actual.getX(), 8E-6);
        Assert.assertEquals(direction.getY(), actual.getY(), 2E-4);
        Assert.assertEquals(direction.getZ(), actual.getZ(), 8E-6);
        ...
        preStellarCorrectionDirection = pvTarget.getPosition().subtract(pvOrigin.getPosition()).negate();
        preStellarCorrectionDirection = frozenToBodyFrame.transformVector(preStellarCorrectionDirection);
        direction = StellarAberrationCorrection.applyTo(earthToSun.getTargetPvProvider(),
            preStellarCorrectionDirection, bodyFrame, t0).negate();
        Assert.assertEquals(direction.getX(), actual.getX(), 8E-6);
        Assert.assertEquals(direction.getY(), actual.getY(), 2E-4);
        Assert.assertEquals(direction.getZ(), actual.getZ(), 8E-6);
        ...
        preStellarCorrectionDirection = frozenToBodyFrame.transformVector(preStellarCorrectionDirection);
        direction = StellarAberrationCorrection.applyTo(earthDirection.getTargetPvProvider(),
            preStellarCorrectionDirection.negate(), bodyFrame, t0);
        Assert.assertEquals(direction.getX(), actual.getX(), this.comparisonEpsilon);
        Assert.assertEquals(direction.getY(), actual.getY(), this.comparisonEpsilon);
        Assert.assertEquals(direction.getZ(), actual.getZ(), this.comparisonEpsilon);
