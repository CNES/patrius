...
public class GlintApproximatePointingDirectionTest {
    ...
    public void getTargetPVCoordinatesITRFTest() throws PatriusException {
        ...
        final GlintApproximatePointingDirection glint = new GlintApproximatePointingDirection(earth, sunPVProvider,
            solver);
        final Vector3D glintPos = getTargetPVCoordinates(satPVProvider, date, earth.getBodyFrame(), earth, glint,
            sunPVProvider);
        ...
        Assert.assertEquals(0., earth.buildPoint(glintPos, FramesFactory.getITRF(), date, "").getLLHCoordinates()
            .getHeight()
                / satPV.getPosition().getNorm(), 2E-16);
        // Check Glint position is on Earth surface
        Assert.assertEquals(0., earth.buildPoint(glintPosDirectly, FramesFactory.getITRF(), date, "")
     ...
     */
    @Test
    public void getTargetPVCoordinatesEME2000Test() throws PatriusException {
        ...
        final Vector3D glintPos = getTargetPVCoordinates(spacecraftPVProvider, date, FramesFactory.getEME2000(),
            this.earthShape, glint, this.sun);

        // ============================== CHECK ============================== //

        // Check Glint position is on Earth surface
        final EllipsoidPoint pointGlint = this.earthShape.buildPoint(glintPos, FramesFactory.getEME2000(), date, "");
        final double glintAltitude = pointGlint.getLLHCoordinates().getHeight();
        ...
        final Vector3D zenith = FramesFactory.getITRF().getTransformTo(FramesFactory.getEME2000(), date)
            .transformVector(pointGlint.getNormal());
     ...
     */
    @Test
    public void getLineTest() throws PatriusException {
        // Initialization
        final AbsoluteDate date = AbsoluteDate.MODIFIED_JULIAN_EPOCH
            .shiftedBy(57467 * Constants.JULIAN_DAY + 48941.15241788);
        final Vector3D spacecraftPos = new Vector3D(-2912.4990063408, -105.77182409557, -6457.8615136281)
        ...
        final Vector3D glintPos = getTargetPVCoordinates(spacecraftPVProvider, date, this.earthShape.getBodyFrame(),
            this.earthShape, glint, this.sun);
     ...
     */
    @Test
    public void getVectorTest() throws PatriusException {
     ...
     */
    @Test
    public void glintApproximatePointingDirectionTest() throws PatriusException {
        // Initialization
        final AbsoluteDate date = AbsoluteDate.MODIFIED_JULIAN_EPOCH
            .shiftedBy(57467 * Constants.JULIAN_DAY + 48941.15241788);
        final Vector3D spacecraftPos = new Vector3D(-2912.4990063408, -105.77182409557, -6457.8615136281)
        ...
        // Glint Point coordinates in J2000
        final Vector3D defaultGlintPos = getTargetPVCoordinates(spacecraftPVProvider, date, FramesFactory.getEME2000(),
     ...
     */
    // @Test
    // public void testAlign() throws OrekitException {
    // // Initialization
    ...
    //
    // // ============================== CHECK ============================== //
    // Assert.assertTrue(glintCoord.getPosition().crossProduct(satPos).isZero());
     ...
     * @throws PatriusException
     */
    private static Vector3D getTargetPVCoordinates(final PVCoordinatesProvider pvCoord, final AbsoluteDate date,
