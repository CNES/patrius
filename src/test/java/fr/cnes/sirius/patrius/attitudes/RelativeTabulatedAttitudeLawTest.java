...
/**
     ...
     */
    @Test
    public void testlawBeforeCstlawAfterCst() throws PatriusException {
        ...
        Assert.assertTrue(compareAttitudes(relativeTabulatedAttitudeLaw.getAttitude(orbit),
        ...
        Assert.assertTrue(compareAttitudes(this.attExp, this.attActual, true));
        ...
        Assert.assertTrue(compareAttitudes(this.attExp, this.attActual, false));

        // test getAttitude() with date within the interval of validity
        dateTest = this.validityInterval.getLowerData().shiftedBy(1.5);
        this.attActual = relativeTabulatedAttitudeLaw.getAttitude(null, dateTest, this.frame);
        this.attExp = this.relativeTabulatedAttitudeLegWithAR.getAttitude(null, dateTest, this.frame);
        Assert.assertTrue(compareAttitudes(this.attActual, this.attExp, true));
...
/**
     ...
     */
    @Test
    public void testlawBeforeExtrlawAfterExtr() throws PatriusException {
     ...
     */
    @Test
    public void testConstructorWithRotations() throws PatriusException {
     ...
     * @throws PatriusException
     */
    private static boolean compareAttitudes(final Attitude expected, final Attitude actual, final boolean compareDate)
        throws PatriusException {

        boolean eqDate = true;
        if (compareDate) {
            eqDate = eqNull(expected.getDate(), actual.getDate());
        }
