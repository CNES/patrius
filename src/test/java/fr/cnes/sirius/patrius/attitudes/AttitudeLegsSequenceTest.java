...
public class AttitudeLegsSequenceTest {
     ...
     */
    @Test
    public void testAddErrors() throws PatriusException {
        // creation of the attitude laws sequence:
        this.sequence = new StrictAttitudeLegsSequence<>();
     ...
     */
    @Test
    public void testGetAttitudeOrbit() throws PatriusException {
     ...
     */
    @Test
    public void testHeadTailSubCopy() {

        // Init sequence
        StrictAttitudeLegsSequence<AttitudeLeg> sequence = new StrictAttitudeLegsSequence<>();
        ...
        // ========================================================================
        // Build sequence ]date1; date2[ U ]date2; date3[ U ]date3; date4[
        sequence = new StrictAttitudeLegsSequence<>();
     ...
     */
    @Test
    public void testGetAttitudeErrors() throws PatriusException {
        // creation of the attitude laws sequence:
        this.sequence = new StrictAttitudeLegsSequence<>();
