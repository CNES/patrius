...
import fr.cnes.sirius.patrius.attitudes.profiles.QuaternionPolynomialSegment;
...
public class QuaternionLagrangePolynomialProfileComputer implements Serializable {
    ...
    private QuaternionPolynomialProfile computeProfile(final StrictAttitudeLegsSequence<AttitudeLeg> attLegsSequence,
        ...
        final List<QuaternionPolynomialSegment> polynomials = new ArrayList<QuaternionPolynomialSegment>();
     ...
     */
    private QuaternionPolynomialSegment computeSegment(final AttitudeProvider attProv,
                                                       final PVCoordinatesProvider pvProv,
        ...
        return new QuaternionPolynomialSegment(q0, q1, q2, q3, interval);
