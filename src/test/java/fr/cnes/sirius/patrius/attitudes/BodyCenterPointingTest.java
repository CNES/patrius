...
public class BodyCenterPointingTest {
    ...
    public void testDeltaT() throws PatriusException {
        ...
        final BodyCenterGroundPointing law1 = new BodyCenterGroundPointing(new OneAxisEllipsoid(3678000, 0.001, FramesFactory.getGCRF()), Vector3D.PLUS_I, Vector3D.PLUS_J);
        final BodyCenterGroundPointing law2 = new BodyCenterGroundPointing(new OneAxisEllipsoid(3678000, 0.001, FramesFactory.getGCRF()), Vector3D.PLUS_I, Vector3D.PLUS_J, 0.5);
    ...
    public void testRotationAcceleration() throws PatriusException {
        ...
        final OneAxisEllipsoid earthShape = new OneAxisEllipsoid(6378136.460, 1 / 298.257222101, this.itrf);
        ...
        Assert.assertNotNull(bodyCenterGroundPointingLaw.getTargetPoint(this.circ, this.date, this.itrf));
