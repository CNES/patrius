...
public class AttitudeEphemerisGeneratorTest {
     ...
     */
    @Test
    public void testFixedStepNominal() throws PatriusException {
        /* Test - nominal case: */
     ...
     */
    @Test
    public void testFixedStepNominal2() throws PatriusException {
        // Initialization
        ...
        final StrictAttitudeLegsSequence<AttitudeLeg> attSeq = new StrictAttitudeLegsSequence<>();
        attSeq.add(attLeg);
        ...
        final List<Attitude> ephemAttList = new LinkedList<>(ephemAtt);
     ...
     */
    @Test
    public void testFixedStepSmallerInterval() throws PatriusException {
     ...
     */
    @Test
    public void testFixedStepTransitionPoints() throws PatriusException {
     ...
     */
    @Test
    public void testFixedStepTransitionPointsAndSmallerInterval() throws PatriusException {
     ...
     */
    @Test
    public void testVariableStep() throws PatriusException {
     ...
     */
    @Test
    public void testVariableStepSmallerInterval() throws PatriusException {
     ...
     */
    @Test
    public void testVariableStepSmallerInterval2() throws PatriusException {
        /* Test - restricted time interval, angMax = 0.15 */
        final AbsoluteDate testDate0 = this.date0.shiftedBy(2 * 60 + 7);
        final AbsoluteDate testDateF = this.dateF.shiftedBy(-55);
        final AbsoluteDateInterval testInterval = new AbsoluteDateInterval(IntervalEndpointType.OPEN, testDate0,
     ...
     */
    @Test
    public void testVariableStepTransitionPoints() throws PatriusException {
     ...
     */
    @Test
    public void testVariableStepTransitionPointsAndSmallerInterval() throws PatriusException {
        /* Test - transition points generation (start points) + restricted time interval: */
        /* Test - restricted time interval: */
        final AbsoluteDate testDate0 = this.date0.shiftedBy(2 * 60 + 7);
        final AbsoluteDate testDateF = this.dateF.shiftedBy(-55);
    ...
    public void setUp() throws PatriusException {
        ...
        this.sequence = new StrictAttitudeLegsSequence<>();
