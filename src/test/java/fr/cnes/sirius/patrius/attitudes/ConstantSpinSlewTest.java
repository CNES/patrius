...
public class ConstantSpinSlewTest {
    ...
    public void testLimitCases() throws PatriusException {
        ...
        final Slew slerp = new ConstantSpinSlew(
            this.previousLaw.getAttitude(circOrbit, refdate, FramesFactory.getEME2000()), this.nextLaw.getAttitude(
                circOrbit,
    ...
    public void testDurationConstraint() throws PatriusException {
        ...
        ConstantSpinSlew slerp =
            new ConstantSpinSlew(this.previousLaw.getAttitude(circOrbit, this.previousLaw.getTimeInterval()
                .getUpperData(), FramesFactory.getITRF()),
                this.nextLaw.getAttitude(circOrbit, this.previousLaw.getTimeInterval().getUpperData().shiftedBy(300),
        ...
        slerp =
            new ConstantSpinSlew(this.previousLaw.getAttitude(circOrbit, this.nextLaw.getTimeInterval().getLowerData()
                .shiftedBy(-300), FramesFactory.getEME2000()),
                this.nextLaw.getAttitude(circOrbit, this.nextLaw.getTimeInterval().getLowerData(),
    ...
    public void testAngularVelocityConstraint() throws PatriusException {
        // Case : the given date is the start date
        Slew slerp =
            new ConstantSpinSlewComputer(0.2).compute(circOrbit, this.previousLaw, this.previousLaw.getTimeInterval()
                .getUpperData(), this.nextLaw, null);
    ...
    // test for rotation acceleration : compare actual acceleration and acceleration obtained with finite differences.
        ...
        final Slew slerp =
            new ConstantSpinSlew(this.previousLaw.getAttitude(circOrbit, this.previousLaw.getTimeInterval()
                .getUpperData(), FramesFactory.getEME2000()),
                this.nextLaw.getAttitude(circOrbit, this.previousLaw.getTimeInterval().getUpperData().shiftedBy(300),
                    FramesFactory.getEME2000()));
