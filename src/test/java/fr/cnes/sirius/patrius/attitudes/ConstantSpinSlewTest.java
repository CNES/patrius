...
public class ConstantSpinSlewTest {
     ...
     */
    @Test
    public void testLimitCases() throws PatriusException {
        // start date
        final AbsoluteDate refdate = this.previousLaw.getTimeInterval().getUpperData();
        // constant spin slew
        final Slew slerp = new ConstantSpinSlew(this.previousLaw.getAttitude(this.circOrbit, refdate,
            FramesFactory.getEME2000()), this.nextLaw.getAttitude(this.circOrbit, refdate.shiftedBy(300),
     ...
     */
    @Test
    public void testDurationConstraint() throws PatriusException {
        // Case : the given date is the start date
        ConstantSpinSlew slerp = new ConstantSpinSlew(this.previousLaw.getAttitude(this.circOrbit, this.previousLaw
            .getTimeInterval().getUpperData(), FramesFactory.getITRF()), this.nextLaw.getAttitude(this.circOrbit,
            this.previousLaw.getTimeInterval().getUpperData().shiftedBy(300), FramesFactory.getITRF()));
        ...
        Assert.assertTrue(compareAttitude(att, initialAttitude));
        ...
        Assert.assertTrue(compareAttitude(att, finalAttitude));
        ...
        slerp = new ConstantSpinSlew(this.previousLaw.getAttitude(this.circOrbit, this.nextLaw.getTimeInterval()
            .getLowerData().shiftedBy(-300), FramesFactory.getEME2000()), this.nextLaw.getAttitude(this.circOrbit,
            this.nextLaw.getTimeInterval().getLowerData(), FramesFactory.getEME2000()));
     ...
     */
    @Test
    public void testAngularVelocityConstraint() throws PatriusException {
        // Case : the given date is the start date
        Slew slerp = new ConstantSpinSlewComputer(0.2).compute(this.circOrbit, this.previousLaw, this.previousLaw
        ...
        // Case : the given date is not the start date
        slerp = new ConstantSpinSlewComputer(0.2).compute(this.circOrbit, this.previousLaw, null, this.nextLaw,
            this.nextLaw.getTimeInterval().getLowerData());
    ...
    // test for rotation acceleration : compare actual acceleration and acceleration obtained with finite differences.
        public
        void
            testRotationAcceleration() throws PatriusException {
        ...
        // Case : the given date is the start date
        final Slew slerp = new ConstantSpinSlew(this.previousLaw.getAttitude(this.circOrbit, this.previousLaw
            .getTimeInterval().getUpperData(), FramesFactory.getEME2000()), this.nextLaw.getAttitude(this.circOrbit,
            this.previousLaw.getTimeInterval().getUpperData().shiftedBy(300), FramesFactory.getEME2000()));
    ...
    public void testCopyMethod() throws PatriusException {
        ...
        // Slew creation
        final Attitude att1 = this.previousLaw.getAttitude(this.circOrbit, startDate, FramesFactory.getEME2000());
        final Attitude att2 = this.nextLaw.getAttitude(this.circOrbit, endDate, FramesFactory.getEME2000());
        ...
        final Slew slerp4 = new ConstantSpinSlewComputer(0.2).compute(this.circOrbit, this.previousLaw,
            this.previousLaw                .getTimeInterval().getUpperData(), this.nextLaw, null);
        ...
        Assert.assertEquals(0,
            attitudeActual.getRotationAcceleration().distance(attitudeRef.getRotationAcceleration()), 1E-15);
    ...
    public void setUp() throws PatriusException {
        ...
        final EllipsoidPoint point = new EllipsoidPoint(earthShape, earthShape.getLLHCoordinatesSystem(), 60, 120, 0,
            "");

        final AttitudeLaw fixedRateLaw = new TargetPointing(earthShape.getBodyFrame(), point.getPosition());
     ...
     *         orekit exception
     */
    private static boolean compareAttitude(final Attitude att1, final Attitude att2) throws PatriusException {
