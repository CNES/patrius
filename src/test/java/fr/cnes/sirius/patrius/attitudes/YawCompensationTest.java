...
public class YawCompensationTest {
    ...
    public void testTarget() throws PatriusException {
        ...
        final Vector3D noYawObserved = nadirLaw.getTargetPosition(this.circOrbit, this.date, this.frameITRF2005);

        // with yaw compensation
        final Vector3D yawObserved = yawCompensLaw.getTargetPosition(this.circOrbit, this.date, this.frameITRF2005);
    ...
    public void testAlignment() throws PatriusException {
        ...
        final Transform toBodyFrame = inertFrame.getTransformTo(earthFrame, this.date);
        ...
        // sat position in body frame
        final Vector3D satInBodyFrame = toBodyFrame.transformPosition(satInert);

        final EllipsoidPoint point = this.earthShape.getIntersectionPoint(
            new Line(satInert, satInert.add(Constants.WGS84_EARTH_EQUATORIAL_RADIUS, zInert)), satInBodyFrame,
            inertFrame, this.circOrbit.getDate());
        final Vector3D pEarth = point.getPosition();
    ...
    public void testCompensMinMax() throws PatriusException {
        ...
        while (extrapDate.durationFrom(this.date) < duration) {
            ...
            final double extrapLat = this.earthShape
                .buildPoint(extrapPvSatEME2000.getPosition(), FramesFactory.getEME2000(), extrapDate, "")
    ...
    public void testFrameIndependency() throws PatriusException {
        ...
        final EllipsoidBodyShape earth = new OneAxisEllipsoid(Constants.GRIM5C1_EARTH_EQUATORIAL_RADIUS,
        ...
        final PVCoordinatesProvider pvProv = this.circOrbit;
        final AbsoluteDate start = this.date;
