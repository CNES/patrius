...
public class AbstractAttitudeProviderTest {
     ...
     */
    @Test
    public void testGetSpin() throws PatriusException {
     ...
     */
    @Test
    public void testGetAttitudeWithoutSpinDerivatives() throws PatriusException {
     ...
     */
    @Test
    public void testGetAttitudeWithSpinDerivatives() throws PatriusException {
     ...
     *              </p>
     *              <p>
     *              Two AttitudeLegs and AttitudeLaws are defined. Their rotation accelerations are computed numerically
     *              and are compared to their analytical rotation acceleration on a whole orbital period.
     *              </p>
     *
     * @testPassCriteria Acceleration vectors obtained are equal to the expected ideal accelerations (absolute
     *                   tolerance: 1E-12)
     * 
    ...
    public void testComputeSpinDerivativeByFD() throws PatriusException {
        ...
        final EllipsoidBodyShape body = new OneAxisEllipsoid(6378, 0.001, FramesFactory.getGCRF());
     ...
     *              </p>
     *              <p>
     *              Two AttitudeLegs and AttitudeLaws are defined. Their spins are computed numerically and are compared
     *              to their analytical spin on a whole orbital period.
     *              </p>
     *
    ...
    public class MyAttitudeProvider extends AbstractAttitudeLaw {
        ...
        /** Serializable UID. */
        private static final long serialVersionUID = 6635864139837512114L;
