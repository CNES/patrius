...
public class ToCelestialBodyCenterDirectionTest {
    ...
    public void testGetVector() {
        ...
        try {
            ...
            final Frame earthFrame = earth.getInertialEquatorFrame();
    ...
    public void testGetLine() {
        ...
        try {
            ...
            // creation of the earth as CelestialBody
            final CelestialBody earth = CelestialBodyFactory.getEarth();
            final Frame earthFrame = earth.getTrueEquatorFrame();
    ...
    public void testGetVectorDelay() throws PatriusException{
        ...
        final CelestialBody earth = CelestialBodyFactory.getEarth();
        final Frame targetFrame = earth.getTrueEquatorFrame();
        ...
        actual = toEarth.getVector(origin, SignalDirection.TOWARD_TARGET, fixedDate, FixedDate.EMISSION, gcrf, eps);
        ...
        actual = toEarth.getVector(origin, SignalDirection.TOWARD_TARGET, fixedDate, FixedDate.RECEPTION, gcrf, eps);
        // true signal propagation duration
        ...
        actual = toEarth.getVector(origin, SignalDirection.FROM_TARGET, fixedDate, FixedDate.EMISSION, gcrf, eps);
        // true signal propagation duration
        ...
        actual = toEarth.getVector(origin, SignalDirection.FROM_TARGET, fixedDate, FixedDate.RECEPTION, gcrf, eps);
        // true signal propagation duration
    ...
    public void testGetLineDelayKeplerianMotion() throws PatriusException{
        ...
        // the target celestial body
        final CelestialBody earth = CelestialBodyFactory.getEarth();
        final Frame bodyFrame = earth.getTrueEquatorFrame();
