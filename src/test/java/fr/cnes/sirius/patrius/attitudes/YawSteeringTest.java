...
public class YawSteeringTest {
    ...
    public void testGetters() throws PatriusException {
        ...
        Assert.assertEquals(groundPointingLaw.getTargetPoint().getLLHCoordinates().getLatitude(),
            ((TargetGroundPointing) yawSteering.getGroundPointingLaw()).getTargetPoint().getLLHCoordinates()
                .getLatitude(), 0);
