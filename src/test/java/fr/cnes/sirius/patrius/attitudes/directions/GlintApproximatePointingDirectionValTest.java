...
public class GlintApproximatePointingDirectionValTest {
    ...
    public void glintPositionValTest() throws IOException, PatriusException {
        ...
        for (int j = 2; j < nbLines - 2; j++) {
            ...
            // nadir point
            final EllipsoidPoint satGeo =
                this.earthShape.buildPoint(satPos, this.earthShape.getBodyFrame(), ss.getDate(), "");
            final EllipsoidPoint nadirGeo = new EllipsoidPoint(this.earthShape,
                this.earthShape.getLLHCoordinatesSystem(),
                satGeo.getLLHCoordinates().getLatitude(), satGeo.getLLHCoordinates().getLongitude(), 0.0, "");
            final Vector3D nadirPos = nadirGeo.getPosition();
    ...
    private class MyAttitudeLaw extends AbstractAttitudeLaw {
        ...
        /** Serializable UID. */
        private static final long serialVersionUID = 6961340648254902518L;
    ...
    public void setUp() throws PatriusException {
        ...
        this.earthShape = new OneAxisEllipsoid(this.equatorialRadius, this.flatness,
