...
public class MomentumDirectionTest {
     ...
     * @testedMethod {@link MomentumDirection#getVector(PVCoordinatesProvider, AbsoluteDate, Frame)}
     * 
     * @description Instantiation of a direction described by a {@link PVCoordinatesProvider}
     *              only, and getting of the vector normal to the trajectory
     *              plane
     * 
     * @testPassCriteria the returned vector is the correct one, orthogonal to both position and
    ...
    public void testGetVectorPVCoordinateProvider() throws PatriusException {
        ...
        // An orbit
        final Orbit orbit = new KeplerianOrbit(7000000, 0, 0, 0, 0, 0, PositionAngle.TRUE, FramesFactory.getGCRF(), AbsoluteDate.J2000_EPOCH, Constants.EGM96_EARTH_MU);

        // Direction creation
        MomentumDirection direction = new MomentumDirection(orbit);
     ...
     */
    @Test
    public final void testSpecialCase() throws PatriusException {
        // date
        ...
        // eme2000 frame
        final Frame bodyFrame = CelestialBodyFactory.getEarth().getInertialEquatorFrame();
        // satellite frame
