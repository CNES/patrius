...
public class GroundVelocityDirectionTest {
     ...
     */
    @Test
    public final void testCircEquaSpherFixedEarth() {
        try {
            // gcrf
     ...
     */
    @Test
    public final void testCircEquaSpherEarth() {
        try {
     ...
     */
    @Test
    public final void testCircIncFixedSpherEarth() {
        try {
     ...
     */
    @Test
    public final void testCircIncFixedSpherEarthAlpha0() {
        try {
     ...
     */
    @Test
    public final void testCircIncSpherEarthAlpha0() {
        try {
    ...
    public final void testGetVector() {
        ...
        try {
            ...
            // nadir point
            final GeodeticPoint point = earth.transform(orbit.getPVCoordinates().getPosition(), gcrf, date);
            final GeodeticPoint nadir = new GeodeticPoint(point.getLatitude(), point.getLongitude(), 0.);

            // ground velocity
            final Vector3D surfacePointLocation = itrf.getTransformTo(gcrf, date).transformPosition(
                earth.transform(nadir));
