...
public class MultiAttitudeProviderTest {
    ...
    @Test
    public void testMultiAttitudeProvider() throws PatriusException {
        // Initializations
        ...
        final Map<String, Orbit> orbits = new HashMap<>();
        ...
        this.multiNumericalPropagator.addForceModel(
            new DirectBodyAttraction(new NewtonianGravityModel(this.state1.getMu())), STATE1);
        this.multiNumericalPropagator.addForceModel(
            new DirectBodyAttraction(new NewtonianGravityModel(this.state2.getMu())), STATE2);
        ...
        final Map<String, Orbit> orbitsFin1 = new HashMap<>();
        ...
        final Map<String, Orbit> orbitsFin2 = new HashMap<>();
        ...
        final Map<String, PVCoordinatesProvider> pvFin2 = new HashMap<>();
    ...
    private class MyMultiAttitudeProvider implements MultiAttitudeProvider {
        ...
        /** Serializable UID. */
        private static final long serialVersionUID = 7894103606344911656L;
