...
public class AngularVelocitiesProfilesTest {
     ...
     */
    @Test
    public final void testHarmonicProfileSpinValue() throws PatriusException {
     ...
     */
    @Test
    public final void testHarmonicProfileOrientationValue() throws PatriusException {
     ...
     */
    @Test
    public final void testAngularVelocityPolynomialProfile() throws PatriusException {
    ...
    public final void testGetAttitudeAngularVelocitiesPolynomialProfile() throws PatriusException {
        ...
        final List<AngularVelocitiesPolynomialProfileLeg> polynomials = new ArrayList<AngularVelocitiesPolynomialProfileLeg>();
     ...
     */
    @Test
    public final void testHeadTailSubAngularVelocityPolynomialProfile() throws PatriusException {
        ...
        AngularVelocitiesPolynomialProfileLeg leg3 = new AngularVelocitiesPolynomialProfileLeg(
                ...
                AngularVelocityIntegrationType.WILCOX_4, 0.001);
        List<AngularVelocitiesPolynomialProfileLeg> segments = new ArrayList<AngularVelocitiesPolynomialProfileLeg>();
        segments.add(leg3);
        segments.add(leg2);
        segments.add(leg1);
        ...
        segments = new ArrayList<AngularVelocitiesPolynomialProfileLeg>();
        segments.add(leg3);
        segments.add(leg2);
        segments.add(leg1);
        sequence = new AngularVelocitiesPolynomialProfile(segments);
     ...
     */
    @Test
    public final void testHeadTailSubAngularVelocityPolynomialSlew() throws PatriusException {
