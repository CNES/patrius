...
public class AngularVelocitiesProfilesTest {
     ...
     */
    @Test
    public final void testHarmonicProfileSpinValue()
                                                    throws PatriusException {
        ...
        final OneAxisEllipsoid earth = new OneAxisEllipsoid(ae, 0,
        ...
        final KeplerianOrbit orbit = new KeplerianOrbit(6700000, .001, .15, 0,
            0, 0, PositionAngle.MEAN, gcrf, date0, Constants.EGM96_EARTH_MU);
        ...
        final AngularVelocitiesHarmonicProfile profile = GuidanceProfileBuilder
            .computeAngularVelocitiesHarmonicProfile(leg, prop, gcrf,
                date0, T, 6, AngularVelocityIntegrationType.WILCOX_4,
                1 / 8.);

        // Attitude
        final Rotation original = law.getAttitude(prop, date1, cirf)
            .getRotation().revert();
        final Rotation computed = profile.getAttitude(prop, date1, cirf)
            .getRotation().revert();
        Assert.assertEquals(0,
            MathLib.toDegrees(Rotation.distance(original, computed)),
            1E-4);

        // Spin
        final Vector3D originalS = leg.getAttitude(prop, date1, cirf).getSpin();
        final Vector3D computedS = profile.getAttitude(prop, date1, cirf)
            .getSpin();
        Assert.assertEquals(0, originalS.subtract(computedS).getNorm()
            / originalS.getNorm(), 1e-8);
     ...
     */
    @Test
    public final void testHarmonicProfileOrientationValue()
                                                           throws PatriusException {

        Report.printMethodHeader("testHarmonicProfileOrientationValue", "Orientation computation", "Math", 1e-14,
        ...
        final Frame gcrf = FramesFactory.getGCRF();
        final Frame cirf = FramesFactory.getCIRF();
        final AttitudeLawLeg law = new AttitudeLawLeg(new ConstantAttitudeLaw(FramesFactory.getEME2000(),
            new Rotation(Vector3D.PLUS_K, .15)), date0, date2);
        ...
        final AngularVelocitiesHarmonicProfile profile = GuidanceProfileBuilder
            .computeAngularVelocitiesHarmonicProfile(law, prop, gcrf,
                date0, T, 2, AngularVelocityIntegrationType.WILCOX_4,
                1 / 8.);
        ...
        final Vector3D computedS = profile.getAttitude(prop, date1, cirf)
            .getOrientation().getRotationRate();
     ...
     */
    @Test
    public final void testHarmonicProfileGetters() throws PatriusException {
        ...
        new AttitudeLawLeg(new ConstantAttitudeLaw(FramesFactory.getEME2000(),
            new Rotation(Vector3D.PLUS_K, .15)), date0, date2);
        ...
        final AngularVelocitiesHarmonicProfile profile2 = new AngularVelocitiesHarmonicProfile(
            xfs, yfs, zfs, gcrf, 
            new AbsoluteDateInterval(IntervalEndpointType.CLOSED, date0,
                date2, IntervalEndpointType.CLOSED), Rotation.IDENTITY, date0,
     ...
     */
    @Test
    public final void testAngularVelocityPolynomialProfile()
                                                            throws PatriusException {
        ...
        final PolynomialFunctionLagrangeForm xpf1L = new PolynomialFunctionLagrangeForm(
            x, y0);
        ...
        final PolynomialFunctionLagrangeForm ypf1L = new PolynomialFunctionLagrangeForm(
            x, y1);
        ...
        final PolynomialFunctionLagrangeForm zpf1L = new PolynomialFunctionLagrangeForm(
            x, y2);
        ...
        final AbsoluteDateInterval interval1 = new AbsoluteDateInterval(
            IntervalEndpointType.CLOSED, date0, date1,
        ...
        final AngularVelocitiesPolynomialProfileLeg segment1 = new AngularVelocitiesPolynomialProfileLeg(
            xpf1, ypf1, zpf1, gcrf, interval1, initialRotation, date0, AngularVelocityIntegrationType.WILCOX_4, 0.001);
        final List<AngularVelocitiesPolynomialProfileLeg> segments = new ArrayList<AngularVelocitiesPolynomialProfileLeg>();
        segments.add(segment1);

        // test the value() method:
        Assert.assertEquals(2.0, segment1.getXCoefficients()[0]);

        final PolynomialFunction xpf2 = PolynomialsUtils
            .createHermitePolynomial(5);
        final PolynomialFunction ypf2 = PolynomialsUtils
            .createHermitePolynomial(5);
        final PolynomialFunction zpf2 = PolynomialsUtils
            .createHermitePolynomial(5);

        // create the second segment:
        final AbsoluteDateInterval interval2 = new AbsoluteDateInterval(
            IntervalEndpointType.OPEN, date1, date2,
            IntervalEndpointType.CLOSED);
        final AngularVelocitiesPolynomialProfileLeg segment2 = new AngularVelocitiesPolynomialProfileLeg(
            xpf2, ypf2, zpf2, gcrf, interval2, initialRotation, date0, AngularVelocityIntegrationType.WILCOX_4, 0.001);
        ...
        Assert.assertEquals(xpf1.getCoefficients()[0], profile
            .getXCoefficients().get(interval1)[0]);
        Assert.assertEquals(ypf1.getCoefficients()[1], profile
            .getYCoefficients().get(interval1)[1]);
        Assert.assertEquals(zpf1.getCoefficients()[2], profile
            .getZCoefficients().get(interval1)[2]);

        Assert.assertEquals(xpf2.getCoefficients()[3], profile
            .getXCoefficients().get(interval2)[3]);
        Assert.assertEquals(ypf2.getCoefficients()[2], profile
            .getYCoefficients().get(interval2)[2]);
        Assert.assertEquals(zpf2.getCoefficients()[1], profile
            .getZCoefficients().get(interval2)[1]);

        // tests the getSpin() method:
        final AbsoluteDate testDate = date0.shiftedBy(25.);
        final Vector3D actual = profile.getAttitude(null, testDate, gcrf)
            .getOrientation().getRotationRate();
        ...
        final Rotation orientation1 = profile
            .getAttitude(null, date0.shiftedBy(25.), gcrf).getOrientation()
            .getRotation();
        ...
        final Rotation orientation2 = profile2
            .getAttitude(null, date0.shiftedBy(25.), gcrf).getOrientation()
            .getRotation();
     ...
     */
    @Test
    public final void testAngularVelocityPolynomialSlew() throws PatriusException {
        ...
        final Rotation orientation1 = profile
            .getAttitude(date0.shiftedBy(25.), gcrf).getOrientation()
            .getRotation();
     ...
     */
    @Test
    public final void testGetAttitude()
                                       throws PatriusException {
        ...
        final AngularVelocitiesHarmonicProfile profile = GuidanceProfileBuilder
            .computeAngularVelocitiesHarmonicProfile(law, prop, gcrf,
                date0, T, 8, AngularVelocityIntegrationType.WILCOX_4,
                1 / 8.);
        ...
        Assert.assertEquals(0, MathLib.toDegrees(Rotation.distance(expected.getRotation(), actual.getRotation())), 1E-4);
     ...
     * 
     * @descriptioncheck that attitude is properly computed with a simple profile (piecewise constant)
     * 
     * @input methods inputs
     * 
     * @output methods outputs
     * 
     * @testPassCriteria attitude (angle and axis rotation) is as expected (reference result: math, threshold: 1E-7
     ...
     */
    @Test
    public final void testGetAttitudeAngularVelocitiesPolynomialProfile() throws PatriusException {
        ...
        final List<AngularVelocitiesPolynomialProfileLeg> polynomials =
            new ArrayList<AngularVelocitiesPolynomialProfileLeg>();

        final AbsoluteDateInterval timeInterval1 =
            new AbsoluteDateInterval(IntervalEndpointType.CLOSED, lowerDate, midDate, IntervalEndpointType.CLOSED);
        final PolynomialFunctionLagrangeForm x1L =
            new PolynomialFunctionLagrangeForm(new double[] { 0, 1000 }, new double[] { 0, 0 });
        final double[] c_x1 = x1L.getCoefficients();
        final PolynomialFunction x1 = new PolynomialFunction(c_x1);
        final PolynomialFunctionLagrangeForm y1L =
            new PolynomialFunctionLagrangeForm(new double[] { 0, 1000 }, new double[] { 0, 0 });
        final double[] c_y1 = y1L.getCoefficients();
        final PolynomialFunction y1 = new PolynomialFunction(c_y1);
        final PolynomialFunctionLagrangeForm z1L =
            new PolynomialFunctionLagrangeForm(new double[] { 0, 1000 }, new double[] { 2, 2 });
        final double[] c_z1 = z1L.getCoefficients();
        final PolynomialFunction z1 = new PolynomialFunction(c_z1);
        final AngularVelocitiesPolynomialProfileLeg segment1 =
            new AngularVelocitiesPolynomialProfileLeg(x1, y1, z1, FramesFactory.getGCRF(), timeInterval1, Rotation.IDENTITY, lowerDate, 
                AngularVelocityIntegrationType.EDWARDS, 0.01, 100);
        polynomials.add(segment1);
        final AbsoluteDateInterval timeInterval2 =
            new AbsoluteDateInterval(IntervalEndpointType.CLOSED, midDate, upperDate, IntervalEndpointType.CLOSED);
        final PolynomialFunctionLagrangeForm x2L =
            new PolynomialFunctionLagrangeForm(new double[] { 0, 1000 }, new double[] { 0, 0 });
        final double[] c_x2 = x2L.getCoefficients();
        final PolynomialFunction x2 = new PolynomialFunction(c_x2);
        final PolynomialFunctionLagrangeForm y2L =
            new PolynomialFunctionLagrangeForm(new double[] { 0, 1000 }, new double[] { 0, 0 });
        final double[] c_y2 = y2L.getCoefficients();
        final PolynomialFunction y2 = new PolynomialFunction(c_y2);
        final PolynomialFunctionLagrangeForm z2L =
            new PolynomialFunctionLagrangeForm(new double[] { 0, 1000 }, new double[] { 3, 3 });
        final double[] c_z2 = z2L.getCoefficients();
        final PolynomialFunction z2 = new PolynomialFunction(c_z2);
        final AngularVelocitiesPolynomialProfileLeg segment2 =
            new AngularVelocitiesPolynomialProfileLeg(x2, y2, z2, FramesFactory.getGCRF(), timeInterval2, segment1.getOrientation(midDate), midDate,
                AngularVelocityIntegrationType.EDWARDS, 0.01);
        polynomials.add(segment2);

        final AbsoluteDateInterval timeInterval =
            new AbsoluteDateInterval(IntervalEndpointType.CLOSED, lowerDate, upperDate, IntervalEndpointType.CLOSED);
        final AngularVelocitiesPolynomialProfile profile =
            new AngularVelocitiesPolynomialProfile(polynomials);

        // First segment: check that attitude after 100s has a rotation of 200 rad around z (or -200 rad around -z)
        // Accuracy (1E-7) depends on Edwards integration step
        final Attitude attitude1 =
            profile.getAttitude(null, AbsoluteDate.J2000_EPOCH.shiftedBy(100), FramesFactory.getGCRF());
        Assert.assertEquals(2. * FastMath.PI - (100. * 2.) % (2. * FastMath.PI), attitude1.getRotation().getAngle(),
            1E-7);
        Assert.assertEquals(0, attitude1.getRotation().getAxis().subtract(new Vector3D(0, 0, -1)).getNorm(), 0.);

        // Second segment: check that attitude after 600s has a rotation of 1300 rad around z (or -1300 rad around -z)
        // Accuracy (1E-7) depends on Edwards integration step
        final Attitude attitude2 =
            profile.getAttitude(null, AbsoluteDate.J2000_EPOCH.shiftedBy(600), FramesFactory.getGCRF());
        Assert.assertEquals(2. * FastMath.PI - (500. * 2. + 100. * 3.) % (2. * FastMath.PI), attitude2.getRotation()
            .getAngle(), 1E-6);
        Assert.assertEquals(0, attitude2.getRotation().getAxis().subtract(new Vector3D(0, 0, -1)).getNorm(), 1E-15);
    }
    ...
    public void testAngularVelocityHarmonicProfileCopyMethod() throws PatriusException {
        ...
        AngularVelocitiesHarmonicProfile profile1 = new AngularVelocitiesHarmonicProfile(
            xfs, yfs, zfs, gcrf, interval, Rotation.IDENTITY, startDate, AngularVelocityIntegrationType.WILCOX_4, 0.15);
        ...
        // Test case n°2 : when the new interval isn't included, the method copy should throw an exception
        try {
    ...
    public void testAngularVelocityPolynomialProfileCopyMethod() throws PatriusException {
        ...
        final AbsoluteDateInterval timeInterval =
            new AbsoluteDateInterval(IntervalEndpointType.CLOSED, lowerDate, upperDate, IntervalEndpointType.CLOSED);
        final AbsoluteDateInterval newIntervalOfValidity =
                new AbsoluteDateInterval(IntervalEndpointType.CLOSED, lowerDate.shiftedBy(5), upperDate.shiftedBy(-10), IntervalEndpointType.CLOSED);
        AngularVelocitiesPolynomialProfile profile = new AngularVelocitiesPolynomialProfile(polynomials);
        profile.setSpinDerivativesComputation(true);

        final Attitude attitudeRef = profile.getAttitude(null, lowerDate.shiftedBy(5), FramesFactory.getGCRF());

        // Test case n°1 : in a standard usage, the interval stored should be updated
        profile = profile.copy(newIntervalOfValidity);
        Assert.assertTrue(profile.getTimeInterval().equals(newIntervalOfValidity));
        // Also check attitude in the middle of the validity interval
        final Attitude attitudeActual = profile.getAttitude(null, lowerDate.shiftedBy(5), FramesFactory.getGCRF());
        Assert.assertEquals(0, Rotation.distance(attitudeActual.getRotation(), attitudeRef.getRotation()), 0);
        Assert.assertEquals(0, attitudeActual.getSpin().distance(attitudeRef.getSpin()), 0);
        Assert.assertEquals(0, attitudeActual.getRotationAcceleration().distance(attitudeRef.getRotationAcceleration()), 1E-15);
    ...
    public void testAngularVelocityPolynomialSlewCopyMethod() throws PatriusException {
        ...
        // create the guidance profile
        final AbsoluteDateInterval timeInterval =
                new AbsoluteDateInterval(IntervalEndpointType.CLOSED, date0, date2, IntervalEndpointType.CLOSED);
            final AbsoluteDateInterval newIntervalOfValidity =
                    new AbsoluteDateInterval(IntervalEndpointType.CLOSED, date0.shiftedBy(5), date1.shiftedBy(-10), IntervalEndpointType.CLOSED);
