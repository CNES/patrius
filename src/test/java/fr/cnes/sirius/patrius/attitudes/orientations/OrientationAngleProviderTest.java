...
public class OrientationAngleProviderTest {
    ...
    public final void testOrientationAngleLegsSequence() throws PatriusException {
        ...
        // Build profile
        final OrientationAngleLegsSequence<LinearLeg> provider = new OrientationAngleLegsSequence<LinearLeg>();
     ...
     */
    @Test
    public final void testHeadTailSubOrientationAngleLegsSequence() throws PatriusException {

        // Init sequence
        OrientationAngleLegsSequence<AbstractOrientationAngleLeg> sequence = new OrientationAngleLegsSequence<AbstractOrientationAngleLeg>();
        ...
        // ========================================================================
        // Build sequence ]date1; date2[ U ]date2; date3[ U ]date3; date4[
        sequence = new OrientationAngleLegsSequence<AbstractOrientationAngleLeg>();
     ...
     */
    @Test
    public final void testHeadTailSubOrientationAngleProfileSequence() throws PatriusException {
    ...
    public void testCopyMethodOrientationAngleProfileSequence() throws PatriusException {
        ...
        provider1.add(new LinearLeg(new AbsoluteDateInterval(interval2.getLowerData(), interval2
                .getUpperData()), 1., 2.5));
        final OrientationAngleLegsSequence<LinearLeg> provider2 = new OrientationAngleLegsSequence<LinearLeg>();
