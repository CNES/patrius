...
public class TabulatedAttitudeTest {
     ...
     */
    @Test
    public void tabulatedAttitudeCreationNewConstructorTest() throws PatriusException {
        ...
        // input list creation
        List<Attitude> attList = new ArrayList<>();
     ...
     */
    @Test
    public void attitudeComputationNewConstTest() throws PatriusException {
        ...
        // input list creation
        final List<Attitude> attList = new ArrayList<>();
        attList.add(attitude0);
        attList.add(attitude1);
        attList.add(attitude2);
        attList.add(attitude3);
        ...
        // Expected rotation
        List<TimeStampedAngularCoordinates> attListAR = new ArrayList<>();
     ...
     */
    @Test
    public void interpolPrecisionTest() throws PatriusException {
        ...
        new JPLCelestialBodyLoader("unxp2000.405",
            EphemerisType.EARTH);
        ...
        final StrictAttitudeLegsSequence<AttitudeLeg> attSequence = new StrictAttitudeLegsSequence<>();
        ...
        for (double dt = 1; dt < duration; dt += 1.) {
            ...
            final ArrayList<TimeStampedAngularCoordinates> attForSlerp = new ArrayList<>();
     ...
     */
    @Test
    public void tabulatedAttitudeFromEphemeris() throws PatriusException {
        Utils.setDataRoot("regular-dataCNES-2003");
        ...
        final NumericalPropagator propagator = new NumericalPropagator(new DormandPrince853Integrator(0.1, 500, absTOL,
            relTOL), initialState.getFrame(), OrbitType.CARTESIAN, PositionAngle.MEAN);
        ...
        final StrictAttitudeLegsSequence<AttitudeLeg> seq = new StrictAttitudeLegsSequence<>();
        seq.add(law1);
        seq.add(rdv);
        seq.add(law2);
        ...
        final List<Attitude> ephemerisList = new ArrayList<>();
     ...
     */
    @Test
    public void tabulatedAttitudeWithSpinAndSpinDerivatives() throws PatriusException {
        // attitudes creation
        final Rotation rot1 = new Rotation(false, 0.48, 0.64, 0.36, 0.48);
        final Rotation rot2 = new Rotation(false, 0.64, 0.48, 0.48, 0.36);
        final AbsoluteDate date0 = AbsoluteDate.J2000_EPOCH;
    ...
    public void testRoundOffError() throws PatriusException {
        ...
        final List<Attitude> listAtt = new ArrayList<>();
    ...
    public void testTabulatedAttitudeCopyMethod() throws PatriusException {
        ...
        tabAtt1.setAngularDerivativesFilter(AngularDerivativesFilter.USE_R);
