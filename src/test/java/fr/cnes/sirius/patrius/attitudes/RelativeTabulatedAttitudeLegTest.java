...
/**
     ...
     */
    @Test
    public final void testConst4() throws PatriusException {
        ...
        expectecAtt = new Attitude(this.frame, this.buildTimeStampedAR(0));
        Assert.assertTrue(this.compareAttitudes(expectecAtt, actualAtt));

        // test on last attitude
        actualAtt = relativeTabulatedAttitudeLeg.getAttitude(null, dateLast, this.frame);
        expectecAtt = new Attitude(this.frame, this.buildTimeStampedAR(9));
        Assert.assertTrue(this.compareAttitudes(expectecAtt, actualAtt));
        ...
        expectecAtt = new Attitude(this.frame, this.buildTimeStampedAR(1));
        Assert.assertTrue(this.compareAttitudes(expectecAtt, actualAtt));
        ...
        sampleToInterpolate = new ArrayList<TimeStampedAngularCoordinates>();
        sampleToInterpolate.add(this.buildTimeStampedAR(0));
        sampleToInterpolate.add(this.buildTimeStampedAR(1));
        sampleToInterpolate.add(this.buildTimeStampedAR(2));
        sampleToInterpolate.add(this.buildTimeStampedAR(3));
        ...
        Assert.assertTrue(this.compareAttitudes(expectecAttEME2000, actualAtt));
        ...
        for (double i = 0; i < 9; i += 0.1) {
            Assert.assertTrue(this.compareAttitudes(tab.getAttitude(null, this.refDate.shiftedBy(i), this.frame),
        ...
        sampleToInterpolate.add(this.buildTimeStampedAR(2));
        sampleToInterpolate.add(this.buildTimeStampedAR(3));
        sampleToInterpolate.add(this.buildTimeStampedAR(4));
        sampleToInterpolate.add(this.buildTimeStampedAR(5));
        sampleToInterpolate.add(this.buildTimeStampedAR(6));
        sampleToInterpolate.add(this.buildTimeStampedAR(7));
        sampleToInterpolate.add(this.buildTimeStampedAR(8));
        sampleToInterpolate.add(this.buildTimeStampedAR(9));
        expectecAtt = new Attitude(this.frame, TimeStampedAngularCoordinates.interpolate(dateBetween1and2,
...
/**
     ...
     */
    @Test
    public final void testConst3() throws PatriusException {
...
/**
     ...
     */
    @Test
    public final void testConst2() throws PatriusException {
        ...
        final List<TimeStampedAngularCoordinates> sampleToInterpolate = new ArrayList<TimeStampedAngularCoordinates>();
        sampleToInterpolate.add(this.buildTimeStampedAR(0));
        sampleToInterpolate.add(this.buildTimeStampedAR(1));
...
/**
     ...
     */
    @Test
    public final void testConst1() throws PatriusException {
    ...
    public final void testRotationAcceleration() throws PatriusException {
        ...
        final List<Pair<Double, AngularCoordinates>> sample = new ArrayList<Pair<Double, AngularCoordinates>>();
        for (double dt = 0; dt < duration; dt += freqSample) {
            ...
            sample.add(new Pair<Double, AngularCoordinates>(dt, ar));
        }
        ...
        for (double i = 0.1; i < duration - 2; i += 1) {
            ...
            final Vector3D accDerivateSpin =
                this.getSpinFunction(relativeTab, null, frameToCompute, initDate.shiftedBy(i))
    ...
    public final void setUp() throws PatriusException {
        ...
        this.listArOneAtt = new ArrayList<Pair<Double, AngularCoordinates>>();
        this.listRot = new ArrayList<Pair<Double, Rotation>>();
        this.listAtt = new ArrayList<Attitude>();
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (i == 0) {
                this.listArOneAtt.add(new Pair<Double, AngularCoordinates>((double) i, ar));
            }
            ...
            this.listAtt.add(new Attitude(this.frame, this.buildTimeStampedAR(i)));
        }
    }
}
