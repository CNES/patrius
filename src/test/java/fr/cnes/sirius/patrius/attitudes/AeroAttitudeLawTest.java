...
public class AeroAttitudeLawTest {
     ...
     * @testedFeature {@link features#AERO_ATTITE_LAW}
     * 
     * @testedMethod {@link AeroAttitudeLaw#aircraftToAero(double, double, double, double, double)}
     * 
     * @description Compute aerodynamic velocity
     * 
     * @testPassCriteria result is as expected (consistency with getAttitude() method, absolute threshold: 1E-14)
     * 
     * @referenceVersion 3.4
     * 
     * @nonRegressionVersion 3.4
     */
    @Test
    public void testAircraftToAero() throws PatriusException {
        FramesFactory.setConfiguration(getSimplifiedConfiguration());
