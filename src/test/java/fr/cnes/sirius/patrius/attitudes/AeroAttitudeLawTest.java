...
public class AeroAttitudeLawTest {
     ...
     */
    @Test
    public final void testRotation() throws PatriusException {
        ...
        final EllipsoidBodyShape earthGCRF = new ExtendedOneAxisEllipsoid(
     ...
     */
    @Test
    public final void testRotationVariable() throws PatriusException {
     ...
     */
    @Test
    public final void testSpin() throws PatriusException {
     ...
     */
    @Test
    public final void testAcceleration() throws PatriusException {
    ...
    public void testGetters() throws PatriusException {
        ...
        final AeroAttitudeLaw aeroAttitudeLaw = new AeroAttitudeLaw(angleofattack, sideslip, rollVel,
            new ExtendedOneAxisEllipsoid(Constants.CNES_STELA_AE,
