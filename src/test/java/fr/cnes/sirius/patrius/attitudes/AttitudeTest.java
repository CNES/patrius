...
public class AttitudeTest {
    ...
    @Test
    public final void testSerialisation() {
        final double rate = 2 * FastMath.PI / (12 * 60);
        final double dt = 10.0;
        ...
        for (final Attitude attitude : attitudes) {
            ...
            this.assertEqualsAttitude(attitudeBis, attitude);
        }
    }

    private void assertEqualsAttitude(final Attitude attitudeBis, final Attitude attitude) {
