...
public class TopocentricFrameTest {
    ...
    public void testCartesianConstructors() throws PatriusException {
        ...
        Assert.assertEquals(1., xDiff, 1E-4);
        Assert.assertEquals(1., yDiff, 1E-4);
        Assert.assertEquals(1., zDiff, 1E-4);
        ...
        cartesian = this.earthFacetShape.getIntersectionPoints(line, earthFacetShape.getBodyFrame(),
            AbsoluteDate.J2000_EPOCH)[0];
        final double expectedAltitude = 5E3;
        ...
        Assert.assertEquals(1., zDiff, Utils.epsilonTest);
        Assert.assertEquals(1., northCheck, Utils.epsilonTest);
        Assert.assertEquals(0., (expectedAltitude-altitude)/expectedAltitude, 1E-10);
    ...
    public void setUp() throws IOException {
        try {
            ...
            writeBodyFile(modelFile, 51, 100, this.facetBodyRadius/1E3);
            ...
            this.earthFacetShape = new FacetBodyShape("My body", celestialBody.getRotatingFrameTrueModel(),
