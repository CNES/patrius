...
/**
 * Test class for {@link EclipticMODProvider} class.
 */
public class EclipticMODProviderTest {

    /**
     * Test {@link EclipticMODProvider#getTransform(AbsoluteDate)} Test {@link EclipticMODProvider#getTransform(AbsoluteDate, boolean)}
     * Test
     * {@link EclipticMODProvider#getTransform(AbsoluteDate, fr.cnes.sirius.patrius.frames.configuration.FramesConfiguration)}
     * Test
     * {@link EclipticMODProvider#getTransform(AbsoluteDate, fr.cnes.sirius.patrius.frames.configuration.FramesConfiguration, boolean)}
     */
    @Test
    public void testGetTransform() throws PatriusException {

        // Initialization
        final EclipticMODProvider provider = new EclipticMODProvider();
