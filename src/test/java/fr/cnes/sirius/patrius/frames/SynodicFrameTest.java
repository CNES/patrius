...
public class SynodicFrameTest {
    ...
    private void testSynodicFrame(final LOFType lofType) throws PatriusException {
        ...
        Assert.assertTrue(t1.getRotationRate().equals(Vector3D.ZERO));
        Assert.assertTrue(t1.getVelocity().equals(Vector3D.ZERO));
        ...
        Assert.assertTrue(pvProv.getPVCoordinates(date, frame2).equals(PVCoordinates.ZERO));
        final Transform t2 = frame2.getTransformTo(lof, date);
        Assert.assertTrue(t2.getRotation().isIdentity());
        Assert.assertTrue(t2.getRotationRate().equals(Vector3D.ZERO));
        Assert.assertTrue(t2.getTranslation().equals(Vector3D.ZERO));
        Assert.assertTrue(t2.getVelocity().equals(Vector3D.ZERO));
        ...
        Assert.assertTrue(t3.getRotationRate().equals(Vector3D.ZERO));
        Assert.assertTrue(t3.getVelocity().equals(Vector3D.ZERO));
