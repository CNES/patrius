...
public class TransformTest {
    ...
    public void testAccelerationComposition() {
        ...
        final Transform t1 = this.buildRandomTransform(random);
        final Transform t2 = this.buildRandomTransform(random);
    ...
    public void testProjectVelocityAndAccelerationCelestLab() throws PatriusException {
        ...
        Frame originFrame = FramesFactory.getGCRF();
        // define the destination frame
        FactoryManagedFrame destinationFrame = FramesFactory.getEME2000();
        ...
        FactoryManagedFrame modifDestinationFrame = FramesFactory.getMOD(false);
        // change the referential of the destination frame
    ...
    private Transform buildRandomTransform(final RandomGenerator random) {

        final Vector3D p = this.randomVector(1.0e3, random);
        final Vector3D v = this.randomVector(1.0, random);
        final Vector3D a = this.randomVector(1.0e-3, random);
        final Rotation r = this.randomRotation(random);
        final Vector3D o = this.randomVector(0.1, random);
