...
public class TODProviderTest {
    ...
    public void testAASReferenceLEO() throws PatriusException {
        ...
        Report.printMethodHeader("testAASReferenceLEO", "Frame conversion", "Vallado paper", 1.e-14,
        ...
        final PVCoordinates pvTODiau76Wcorr =
            new PVCoordinates(new Vector3D(5094516.216953642, 6127365.2732571075, 6380344.526512777),
                new Vector3D(-4746.0883360670405, 786.0783266874986, 5531.9312619654365));
    ...
    public void testAASReferenceGEO() throws PatriusException {
        ...
        Report.printMethodHeader("testAASReferenceGEO", "Frame conversion", "Vallado paper", 1.e-14,
                ComparisonType.ABSOLUTE);
    ...
    @Test
    public void testInterpolationAccuracyWithEOP() throws PatriusException {
    ...
    @Test
    public void testInterpolationAccuracyWithoutEOP() throws PatriusException {
