...
/**
 * Test class for {@link GCRFProvider} class.
 */
public class GCRFProviderTest {

    /**
     * Test {@link GCRFProvider#getTransform(AbsoluteDate)}
     * Test {@link GCRFProvider#getTransform(AbsoluteDate, boolean)}
     * Test {@link GCRFProvider#getTransform(AbsoluteDate, fr.cnes.sirius.patrius.frames.configuration.FramesConfiguration)}
     * Test {@link GCRFProvider#getTransform(AbsoluteDate, fr.cnes.sirius.patrius.frames.configuration.FramesConfiguration, boolean)}
     */
    @Test
    public void testGetTransform() throws PatriusException {
        ...
        // Initialization
        final GCRFProvider provider = new GCRFProvider();
