...
public class BulletinBFilesLoaderTest extends AbstractFilesLoaderTest {
    ...
    @Test
    public void testStartDate2() throws PatriusException, IOException {
        setRoot("regular-dataPBASE");
        final EOP2000History history = new EOP2000History(EOPInterpolators.LAGRANGE4);
        new BulletinBFilesLoader().fillHistory(history,
            getClass().getClassLoader().getResourceAsStream(
                "regular-dataPBASE/Earth-orientation-parameters/monthly/bulletinb_IAU2000-216.txt"));
        Assert.assertEquals(new AbsoluteDate(2005, 12, 5, TimeScalesFactory.getUTC()),
            history.getStartDate());
    }
    ...
    @Test
    public void testEndDate2() throws PatriusException, IOException {
        setRoot("regular-dataPBASE");
        final EOP2000History history = new EOP2000History(EOPInterpolators.LAGRANGE4);
        new BulletinBFilesLoader().fillHistory(history,
            getClass().getClassLoader().getResourceAsStream(
                "regular-dataPBASE/Earth-orientation-parameters/monthly/bulletinb_IAU2000-216.txt"));
        Assert.assertEquals(new AbsoluteDate(2006, 1, 4, TimeScalesFactory.getUTC()),
            history.getEndDate());
    }
