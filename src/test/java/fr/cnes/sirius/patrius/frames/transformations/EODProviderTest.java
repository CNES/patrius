...
/**
 * Test class for {@link EODProvider} class.
 */
public class EODProviderTest {

    /**
     * Test {@link EODProvider#getTransform(AbsoluteDate)}
     * Test {@link EODProvider#getTransform(AbsoluteDate, boolean)}
     * Test {@link EODProvider#getTransform(AbsoluteDate, fr.cnes.sirius.patrius.frames.configuration.FramesConfiguration)}
     * Test {@link EODProvider#getTransform(AbsoluteDate, fr.cnes.sirius.patrius.frames.configuration.FramesConfiguration, boolean)}
     */
    @Test
    public void testGetTransform() throws PatriusException {

        // Initialization
        final EODProvider provider = new EODProvider();
