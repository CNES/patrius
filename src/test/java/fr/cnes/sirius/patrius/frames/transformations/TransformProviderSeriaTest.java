...
public class TransformProviderSeriaTest {
    ...
    @Test
    public final void seriaFixedTransformProviderTest()
        ...
        for (final FixedTransformProvider ftp : ftps) {
            ...
            this.ftpEq(ftp, ftpRecover);
        }

    }

    private void ftpEq(final FixedTransformProvider ftp1,
            final FixedTransformProvider ftp2) {
        TransformTest.assertEqualsTransform(ftp1.getTransform(null), ftp2.getTransform(null));
    }

    @Test
    public final void seriaHelmertTransformationTest() throws PatriusException {
        ...
        for (final HelmertTransformation ht : hts) {
            ...
            this.htEq(ht, htRecover);
        }

    }

    private void htEq(final HelmertTransformation ht1, final HelmertTransformation ht2) {
