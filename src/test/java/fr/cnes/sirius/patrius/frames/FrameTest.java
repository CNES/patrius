...
public class FrameTest {
    ...
    public void testReferentialSimple1() throws PatriusException {
        ...
        Assert.assertTrue(tres1.getCartesian().getVelocity().equals(Vector3D.ZERO));
     ...
     */
    @Test
    public final void testGetFirstPseudoInertialAncestor() throws PatriusException {
        Utils.setDataRoot("regular-data");
     ...
     */
    @Test
    public final void testGetFirstCommonPseudoInertialAncestor() throws PatriusException {
        Utils.setDataRoot("regular-data");
        Assert.assertEquals(FramesFactory.getGCRF(), FramesFactory.getGCRF().getFirstCommonPseudoInertialAncestor(FramesFactory.getGCRF()));
        Assert.assertEquals(FramesFactory.getCIRF(), FramesFactory.getITRF().getFirstCommonPseudoInertialAncestor(FramesFactory.getTIRF()));
        Assert.assertEquals(FramesFactory.getGCRF(), FramesFactory.getITRF().getFirstCommonPseudoInertialAncestor(FramesFactory.getVeis1950()));
        Assert.assertEquals(null, OrphanFrame.getNewOrphanFrame("Orphan frame").getFirstCommonPseudoInertialAncestor(FramesFactory.getGCRF()));
    }
