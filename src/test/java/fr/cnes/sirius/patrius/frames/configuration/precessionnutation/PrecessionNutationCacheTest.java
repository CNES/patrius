...
public class PrecessionNutationCacheTest {
    ...
    public void testCIPDvInperpolations() {
        ...
        for (int i = 0; i < 43200; i += 600) {
            ...
            assertArrayEquals(cipN, cipD, this.epsNd);
            assertArrayEquals(cipN3, cipD3, this.epsNd);
        }
    }
