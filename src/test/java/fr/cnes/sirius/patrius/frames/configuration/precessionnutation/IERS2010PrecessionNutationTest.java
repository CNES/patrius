...
public class IERS2010PrecessionNutationTest {
    ...
    public void testRef() throws IllegalArgumentException {
        ...
        assertArrayEquals(cip10ref, pnD.getCIPMotion(date), Precision.EPSILON);
        assertArrayEquals(cip03ref, pnD3.getCIPMotion(date), Precision.EPSILON);
        ...
        assertArrayEquals(cip10dvRef, pnD.getCIPMotionTimeDerivative(date), Precision.EPSILON);
        assertArrayEquals(cip03dvRef, pnD3.getCIPMotionTimeDerivative(date), Precision.EPSILON);
    }
