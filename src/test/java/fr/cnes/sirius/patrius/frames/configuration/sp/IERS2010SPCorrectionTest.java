...
/**
 * Test class for {@link IERS2010SPCorrection}.
 * 
 * @author Rami Houdroge
 * @since 1.3
 * @version $Id: IERS2010SPCorrectionTest.java 18089 2017-10-02 17:02:50Z bignon $
 */
public class IERS2010SPCorrectionTest {

    /** threshold. */
    private final double eps = Precision.EPSILON;

    /** model. */
    private final IERS2010SPCorrection sp = new IERS2010SPCorrection();
