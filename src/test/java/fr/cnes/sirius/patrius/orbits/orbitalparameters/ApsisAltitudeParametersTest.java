...
public class ApsisAltitudeParametersTest {
     ...
     */
    @Test
    public void testApsisParametersToKeplerianParameters() {
    ...
    public void testAllConversionTypes() {
        ...
        // Check conversions
        checkApsisAltitudeParameters(new double[] { 100E3, 400E3, 0.1, 0.2, 0.3, 0.4 }, parameters
        ...
        checkApsisAltitudeParameters(new double[] { 100E3, 400E3, 0.1, 0.2, 0.3, 0.4 },
     ...
     *        epsilon
     */
    private static void checkApsisAltitudeParameters(final double[] expected, final ApsisAltitudeParameters params,
                                              final double eps) {
        checkRelDiff(expected[0], params.getPeriapsisAltitude(), eps);
        checkRelDiff(expected[1], params.getApoapsisAltitude(), eps);
        checkRelDiff(expected[2], params.getI(), eps);
        checkRelDiff(expected[3], params.getPerigeeArgument(), eps);
        checkRelDiff(expected[4], params.getRightAscensionOfAscendingNode(), eps);
        checkRelDiff(expected[5], params.getAnomaly(PositionAngle.TRUE), eps);
    }
     ...
     *        epsilon
     */
    private static void checkKeplerianParameters(final double[] expected, final KeplerianParameters params,
                                                 final double eps) {
        checkRelDiff(expected[0], params.getA(), eps);
        checkRelDiff(expected[1], params.getE(), eps);
        checkRelDiff(expected[2], params.getI(), eps);
        checkRelDiff(expected[3], params.getPerigeeArgument(), eps);
        checkRelDiff(expected[4], params.getRightAscensionOfAscendingNode(), eps);
        checkRelDiff(expected[5], params.getAnomaly(PositionAngle.TRUE), eps);
