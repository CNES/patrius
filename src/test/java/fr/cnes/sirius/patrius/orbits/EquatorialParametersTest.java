...
public class EquatorialParametersTest {
    ...
    public void testEquatorialToKeplerian() {
        ...
        checkDouble(42166.71200, equa.getA(), Utils.epsilonTest * kep.getA(), "a");
    ...
    public void testJacobianFiniteDifferences() throws PatriusException {
        ...
        for (final PositionAngle type : PositionAngle.values()) {
            final double hP = 2.0;
            final double[][] finiteDiffJacobian = finiteDifferencesJacobian(type, orbEqua, hP);
            final double[][] jacobian = new double[6][6];
    ...
    private static double[][] finiteDifferencesJacobian(final PositionAngle type,
                                                        final EquatorialOrbit orbit, final double hP) {
        final double[][] jacobian = new double[6][6];
        for (int i = 0; i < 6; ++i) {
    ...
    private static void fillColumn(final PositionAngle type, final int i, final EquatorialOrbit orbit,
