...
public class CartesianParametersTest {
    ...
    public void testCartesianToEquinoctial() {
        ...
        this.checkDouble(42255170.0028257, p.getA(), Utils.epsilonTest * p.getA(), "a");
        this.checkDouble(0.592732497856475e-03, p.getEquinoctialEx(),
                Utils.epsilonE * MathLib.abs(p.getE()), "ex");
        this.checkDouble(-0.206274396964359e-02, p.getEquinoctialEy(),
        ...
        this.checkDouble(MathUtils.normalizeAngle(2 * MathLib.asin(MathLib.sqrt((MathLib.pow(
                0.128021863908325e-03, 2) + MathLib.pow(-0.352136186881817e-02, 2)) / 4.)), p
                .getI()), p.getI(), Utils.epsilonAngle * MathLib.abs(p.getI()), "i");
        this.checkDouble(MathUtils.normalizeAngle(0.234498139679291e+01, p.getLM()), p.getLM(),
    ...
    public void testCartesianToKeplerian() {
        ...
        this.checkDouble(22979265.3030773, p.getA(), Utils.epsilonTest * p.getA(), "a");
        this.checkDouble(0.743502611664700, p.getE(), Utils.epsilonE * MathLib.abs(p.getE()), "e");
        this.checkDouble(0.122182096220906, p.getI(), Utils.epsilonAngle * MathLib.abs(p.getI()),
                "i");
        this.checkDouble(2.3298867611497447, p.getLE(), Utils.epsilonTest * p.getLE(), "Le");
        this.checkDouble(2.2990194129226746, p.getLv(), Utils.epsilonTest * p.getLv(), "Lv");
    ...
    public void testShiftElliptic() {
        ...
        final CartesianOrbit orbit = new CartesianOrbit(pvCoordinates, FramesFactory.getEME2000(),
                this.date, this.mu);
        this.testShift(orbit, new KeplerianOrbit(orbit), 1.0e-13);
    }
    ...
    public void testShiftCircular() {
        ...
        final CartesianOrbit orbit = new CartesianOrbit(pvCoordinates, FramesFactory.getEME2000(),
                this.date, this.mu);
        this.testShift(orbit, new CircularOrbit(orbit), 1.0e-15);
    }
    ...
    public void testShiftHyperbolic() {
        ...
        final CartesianOrbit orbit = new CartesianOrbit(pvCoordinates, FramesFactory.getEME2000(),
                this.date, this.mu);
        this.testShift(orbit, new KeplerianOrbit(orbit), 1.0e-15);
    }

    private void testShift(final CartesianOrbit tested, final Orbit reference,
