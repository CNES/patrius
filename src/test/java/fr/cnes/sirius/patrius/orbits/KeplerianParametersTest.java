...
public class KeplerianParametersTest {
    ...
    public void testKeplerianToEquinoctial() {
        ...
        this.checkDouble(24464560.0, kep.getA(), Utils.epsilonTest * kep.getA(), "a");
        this.checkDouble(-0.412036802887626, kep.getEquinoctialEx(),
                Utils.epsilonE * MathLib.abs(kep.getE()), "ex");
        this.checkDouble(-0.603931190671706, kep.getEquinoctialEy(),
        ...
        this.checkDouble(MathUtils.normalizeAngle(0.416203300000000e+01, kep.getLM()), kep.getLM(),
    ...
    public void testJacobianFinitedifferencesEllipse() throws PatriusException {
        ...
        for (final PositionAngle type : PositionAngle.values()) {
            final double hP = 2.0;
            final double[][] finiteDiffJacobian = this.finiteDifferencesJacobian(type, orbKep, hP);
            final double[][] jacobian = new double[6][6];
    ...
    private double[][] finiteDifferencesJacobian(final PositionAngle type,
            final KeplerianOrbit orbit, final double hP) throws PatriusException {
        final double[][] jacobian = new double[6][6];
        for (int i = 0; i < 6; ++i) {
    ...
    private void fillColumn(final PositionAngle type, final int i, final KeplerianOrbit orbit,
     ...
     */
    @Test
    public final void testgetJacobian() throws PatriusException {
