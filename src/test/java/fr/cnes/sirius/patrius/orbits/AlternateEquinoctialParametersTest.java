...
public class AlternateEquinoctialParametersTest {
    ...
    @Test
    public void testAltEquinoctialToEquinoctialEll() throws PatriusException {
    ...
    private double[][] finiteDifferencesJacobian(final PositionAngle type,
            final AlternateEquinoctialOrbit orbit, final double hP) throws PatriusException {
        final double[][] jacobian = new double[6][6];
        for (int i = 0; i < 6; ++i) {
     ...
     */
    private void fillColumn(final PositionAngle type, final int i,
    ...
    @Test
    public void testAltEquinoctialConvCirc() throws PatriusException {
    ...
    @Test
    public void testAltEquinoctialConvCart() throws PatriusException {
    ...
    @Test
    public void testAltEquinoctialConvApsis() throws PatriusException {
    ...
    @Test
    public void testAltEquinoctialConvEquat() throws PatriusException {
    ...
    @Test
    public void testAltEquinoctialConvEquin() throws PatriusException {
    ...
    @Test
    public void testAltEquinoctialConvKepl() throws PatriusException {
