...
public class CircularParametersTest {
    ...
    public void testCircularToCartesian() {
        ...
        checkDouble(0.233745668678733e+05, pos.getX(), Utils.epsilonTest * r, "X");
        checkDouble(-0.350998914352669e+05, pos.getY(), Utils.epsilonTest * r, "Y");
        checkDouble(-0.150053723123334e+01, pos.getZ(), Utils.epsilonTest * r, "Z");

        checkDouble(0.809135038364960e+05, vel.getX(), Utils.epsilonTest * v, "Vx");
        checkDouble(0.538902268252598e+05, vel.getY(), Utils.epsilonTest * v, "Vy");
        checkDouble(0.158527938296630e+02, vel.getZ(), Utils.epsilonTest * v, "Vz");
