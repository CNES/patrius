...
public class ConstantPVCoordinatesProviderTest {
    ...
    public void checkPVTranslatedFrame() throws PatriusException {
        ...
        final ConstantPVCoordinatesProvider constantPV = new ConstantPVCoordinatesProvider(new PVCoordinates(position, velocity), gcrf);
    ...
    public void checkMoonPVCoordinates() throws PatriusException {
        ...
        final Frame moonFrame = moon.getInertialEquatorFrame();
        
        // moon center position in its attached frame {0, 0, 0}
        final ConstantPVCoordinatesProvider moonPvProvider = new ConstantPVCoordinatesProvider(Vector3D.ZERO, moonFrame);
