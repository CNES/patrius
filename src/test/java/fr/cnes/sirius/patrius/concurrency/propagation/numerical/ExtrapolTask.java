...
public class ExtrapolTask implements ParallelTask {
    ...
    private ForceModel getMoonPotential() throws PatriusException, IOException, ParseException {
        ...
        final JPLEphemeridesLoader loader = new JPLEphemeridesLoader(this.jplFile,
    ...
    private void setUp() throws IOException, ParseException, PatriusException {
        ...
        // JPL ephemeris
        loaderEMB = new JPLEphemeridesLoader(this.jplFile,
            JPLEphemeridesLoader.EphemerisType.EARTH_MOON);
        loaderSSB = new JPLEphemeridesLoader(this.jplFile,
        ...
        loaderSUN = new JPLEphemeridesLoader(this.jplFile, JPLEphemeridesLoader.EphemerisType.SUN);
