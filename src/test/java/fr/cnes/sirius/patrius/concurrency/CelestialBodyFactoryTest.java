...
public class CelestialBodyFactoryTest {
    ...
    public void celestialBodyConcurrentTest() throws PatriusException {
        ...
        final CelestialBody b1 = this.orderedCelestialBodyPicker();
        final CelestialBody b2 = this.orderedCelestialBodyPicker();

        // Get the first one's body frame
        final Frame b1Frame = b1.getTrueRotatingFrame();
     ...
     */
    private CelestialBody orderedCelestialBodyPicker() throws PatriusException {
