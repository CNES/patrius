...
public class EphEventsTask extends AbstractSimpleParallelTaskImpl {
    ...
    static {
        SP = new ArrayList<SpacecraftState>();
        try {
            setUp();
     ...
     */
    private static JPLEphemeridesLoader loaderEMB;
    /**
     * JPL ephemeris loader
     */
    private static JPLEphemeridesLoader loaderSSB;
    /**
     * JPL ephemeris loader
     */
    private static JPLEphemeridesLoader loaderSUN;
    /**
     * JPL ephemeris file
     */
    ...
    private static ForceModel getMoonPotential() throws PatriusException, IOException, ParseException {
        ...
        final JPLEphemeridesLoader loader = new JPLEphemeridesLoader(FJPLFILE,
    ...
    private static ForceModel getSrp() throws PatriusException, IOException, ParseException {
        ...
        return new SolarRadiationPressureCircular(dRef, pRef, sun, requa, vehicle);
    }
    ...
    private static ForceModel getDTM2000Force() throws PatriusException {
        ...
        final double angThre = 1e-10;
        earth.setAngularThreshold(angThre);
    ...
    private static void setUp() throws IOException, ParseException, PatriusException {
        ...
        // JPL ephemeris
        loaderEMB = new JPLEphemeridesLoader(FJPLFILE,
            JPLEphemeridesLoader.EphemerisType.EARTH_MOON);
        loaderSSB = new JPLEphemeridesLoader(FJPLFILE,
        ...
        loaderSUN = new JPLEphemeridesLoader(FJPLFILE, JPLEphemeridesLoader.EphemerisType.SUN);
        ...
        final JPLEphemeridesLoader loaderEarth = new JPLEphemeridesLoader(FJPLFILE,
