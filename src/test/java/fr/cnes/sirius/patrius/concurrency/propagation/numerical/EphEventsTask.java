...
public class EphEventsTask extends AbstractSimpleParallelTaskImpl {
    ...
    private static void computeStates() {
        ...
        try {
            ...
            propagator = new NumericalPropagator(getDOPIntegrator(), initialState.getFrame(), OrbitType.EQUINOCTIAL,
                PositionAngle.TRUE);
     ...
     *         e
     */
    private static ForceModel getEarthPotential() throws PatriusException {
        // degree
        final int n = 60;
        // order
        final int m = 60;
     ...
     *         e
     */
    private static ForceModel getMoonPotential() throws PatriusException {
     ...
     *         e
     */
    private static ForceModel getSrp() throws PatriusException {
    ...
    private static void setUp() throws IOException, ParseException, PatriusException {
        ...
        loaderSUN = new JPLCelestialBodyLoader(FJPLFILE, PredefinedEphemerisType.SUN);
        ...
        final EllipsoidBodyShape earthShape = (EllipsoidBodyShape) earth.getShape();

        final EllipsoidPoint point1 = new EllipsoidPoint(earthShape, earthShape.getLLHCoordinatesSystem(),
            MathLib.toRadians(40), MathLib.toRadians(300), 0., "");
        final EllipsoidPoint point2 = new EllipsoidPoint(earthShape, earthShape.getLLHCoordinatesSystem(),
            MathLib.toRadians(-30), MathLib.toRadians(250), 0., "");
        final EllipsoidPoint point3 = new EllipsoidPoint(earthShape, earthShape.getLLHCoordinatesSystem(),
