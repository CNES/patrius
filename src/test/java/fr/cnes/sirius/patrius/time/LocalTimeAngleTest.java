...
public class LocalTimeAngleTest {
     ...
     */
    @Test
    public void meanLocalTimeAngleTest() throws PatriusException {
     ...
     */
    @Test
    public void trueLocalTimeAngleTest() throws PatriusException {
        sun = CelestialBodyFactory.getSun();
        localTime = new LocalTimeAngle(sun);
     ...
     */
    @Test
    public void trueLocalTimeAngleTest2() throws PatriusException {
     ...
     */
    @Test
    public void testRAAN() throws PatriusException {
        // UTC - TAI = 37s
