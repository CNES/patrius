...
public class DateComponentsTest {
    ...
    private static void checkSymmetry(final int start, final int n) {
    ...
    public static void checkWellFormed(final int startYear, final int endYear,
            final int startJ2000, final int endJ2000) {
    ...
    public void testSerialization() {
        ...
        TestUtils.checkSerializedEquality(DateComponents.BEIDOU_EPOCH);
