...
public class TimeComponentsTest {
    ...
    public void testStringPrecision() {
        Assert.assertEquals("00:00:00", new TimeComponents(0).toString(0));
        Assert.assertEquals("06:00:00.0", new TimeComponents(21600).toString(1));
        Assert.assertEquals("12:00:00.00", new TimeComponents(43200).toString(2));
        Assert.assertEquals("18:00:00.000", new TimeComponents(64800).toString(3));
        Assert.assertEquals("23:59:59.9000", new TimeComponents(86399.9).toString(4));
    }
