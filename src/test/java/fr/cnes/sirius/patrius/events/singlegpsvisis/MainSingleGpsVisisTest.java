...
public class MainSingleGpsVisisTest {
    ...
    private static void addForceAndAttitude(final Orbit initialOrbit,
        ...
        final Assembly sphericalSpacecraft = MainSingleGpsVisisTest.getSphericalVehicle(1000, 1, 2.3, 0.3, 0.4, 0.3);
        ...
        prop.addForceModel(newtonianAttraction);
    }
    ...
    private class MyEclipseDetector extends EclipseDetector {
        ...
        private final List<String> enterDate = new ArrayList<>();
        private final List<String> exitDate = new ArrayList<>();
