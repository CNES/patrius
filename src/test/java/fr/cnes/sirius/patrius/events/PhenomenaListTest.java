...
public class PhenomenaListTest {
     ...
     */
    @Test
    public final void testPhenomenaList() {
    ...
    public final void testGetList() throws PatriusException {
        // Expected list:
        final List<Phenomenon> expectedList = new ArrayList<Phenomenon>();
     ...
     */
    @Test
    public final void testGetPhenomena() throws PatriusException {
        // Actual list:
        final PhenomenaList list = new PhenomenaList();
        list.add(phen1);
        list.add(phen2);
    ...
    @Test
    public final void testSerialization() throws PatriusException {
