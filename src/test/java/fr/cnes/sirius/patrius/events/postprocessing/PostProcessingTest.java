...
public class PostProcessingTest {
     ...
     */
    @Test
    public final void testF1() throws PatriusException, InterruptedException {
        // creation of the timeline from the logger used during the propagation
        final Timeline list = new Timeline(log, interval);
        ...
        final LinkedList<Phenomenon> phenList = new LinkedList<Phenomenon>(previousPhenomena);
     ...
     */
    @Test
    public final void testF1ListCodes() throws PatriusException, InterruptedException {
        // creation of the timeline from the logger used during the propagation
        Timeline list = new Timeline(log, interval);
        // initial phenomena number
        final int phenomenaNumber = list.getPhenomenaList().size();

        // number of elements that have to be removed
        int removedItems = 0;
        final Set<Phenomenon> previousPhenomena = new TreeSet<Phenomenon>();
     ...
     */
    @Test
    public final void testF2() throws PatriusException {
        ...
        // creation of the timeline from the logger used during the propagation
        final Timeline list = new Timeline(dummyLogger, interval);
        ...
        // creation of the timeline
        final Timeline list2 = new Timeline(dummyLogger, interval);
     ...
     */
    @Test
    public final void testF2AllElements() throws PatriusException {
        // creation of the timeline
        final CodedEventsLogger dummyLogger = new CodedEventsLogger();
        ...
        final Timeline list = new Timeline(dummyLogger, timelineInterval);
     ...
     */
    @Test
    public final void testF3() throws PatriusException {
        // creation of the timeline from the logger used during the propagation
        final Timeline list = new Timeline(log, interval);
     ...
     */
    @Test
    public final void testF4() throws PatriusException {
        ...
        final List<String> phen = new ArrayList<String>();
     ...
     */
    @Test
    public final void testF5() throws PatriusException {
        // creation of the timeline from the logger used during the propagation
        final Timeline list = new Timeline(log, interval);
     ...
     */
    @Test
    public final void testC1() throws PatriusException {
        // creation of the timeline from the logger used during the propagation
        final Timeline list = new Timeline(log, interval);
     ...
     */
    @Test
    public final void testC2() throws PatriusException {
        // creation of the timeline from the logger used during the propagation
        final Timeline list = new Timeline(log, interval);
        ...
        final List<String> phenCodesList = new ArrayList<String>();
        ...
        final Map<String, String> phenCodesMap = new HashMap<String, String>();
     ...
     */
    @Test
    public final void testC3C4() throws PatriusException {
        ...
        final Timeline list = new Timeline(log1, interval);
     ...
     */
    @Test
    public final void testC5() throws PatriusException {
        ...
        final Timeline list3 = new Timeline(log2, interval2);
     ...
     */
    @Test
    public final void testNew() throws PatriusException {
        // creation of the timelines 1 and 2 from the logger used during the propagation:
        final Timeline list1 = new Timeline(log, interval);
        final Timeline list2 = new Timeline(log, interval);
        ...
        final Timeline list3 = new Timeline(log, interval);
