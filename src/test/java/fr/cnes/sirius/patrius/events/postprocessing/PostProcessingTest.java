...
public class PostProcessingTest {
     ...
     */
    @Test
    public final void testORCriterion() throws PatriusException {
     ...
     */
    @Test
    public void testNotCriterion() throws PatriusException{
        ...
        Assert.assertEquals(list.getPhenomenaList(), Arrays.asList(new Phenomenon(startInterval, true, endInterval, true, complementary, comment)));
