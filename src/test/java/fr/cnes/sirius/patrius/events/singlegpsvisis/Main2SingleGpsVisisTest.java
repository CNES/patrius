...
public class Main2SingleGpsVisisTest {
    ...
    public void testEclipseDetection2() throws PatriusException {
        ...
        final ArrayList<GenericCodingEventDetector> cedl = new ArrayList<>();
        ...
        // Check
        final Timeline timeLine = new Timeline(logger, datesInterval, null);
    ...
    private class GPS_orbits {
        ...
        private final ArrayList<KeplerianOrbit> gpsOrbList = new ArrayList<>();
