    ...
    public class MySpheroidEclipseDetector extends EclipseDetector {
        ...
        public Action eventOccurred(final SpacecraftState s,
            ...
            this.mapNew.put(
                s.getDate(),
                new Double[] {
                    this.getOccultingRadiusProvider().getLocalRadius(s.getPVCoordinates().getPosition(), s.getFrame(),
                        s.getDate(), EllipsoidEclipseDetectorTest.this.sun), s.getLv(), increasing ? 0. : 1. });
            return Action.CONTINUE;
        }
