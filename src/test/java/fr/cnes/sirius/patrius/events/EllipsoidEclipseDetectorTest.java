...
public class EllipsoidEclipseDetectorTest {
    ...
    public void testVeryThinEllipsoid() {
        ...
        try {
            ...
            // spheridcal radius
            final EllipsoidBodyShape earth = new OneAxisEllipsoid(this.ae, .99, this.bodyFrame, this.name);
    ...
    public void testWithAugmentedEllipsoid() {
        ...
        try {
            ...
            // Earth with flattening and equatorial radius adjusted so that the conjugate radius is equal to the
            // spheridcal radius
            final EllipsoidBodyShape earth = new OneAxisEllipsoid(this.ae / (1 - this.f), this.f,
    ...
    public void testWithEllipsoid() {
        ...
        try {
            ...
            final EllipsoidBodyShape earth = new OneAxisEllipsoid(this.ae, this.f, this.bodyFrame, this.name);
    ...
    public void testWithSphericalEarth() {
        try {
            ...
            // Earth with no flattening
            final EllipsoidBodyShape earth = new OneAxisEllipsoid(this.ae, 0, this.bodyFrame, this.name);
     ...
     */
    @Test
    public void testDistanceEffect() throws PatriusException {
        ...
        final PVCoordinatesProvider occultedBody = new ConstantPVCoordinatesProvider(occultedPV, this.frame);
        ...
        try {
            ...
            final EllipsoidBodyShape earth = new OneAxisEllipsoid(this.ae, 0.0,
            ...
            numProp.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(iniState.getMu())));
    ...
    public void testLightingRatioSpheroid() throws PatriusException {
        ...
        final PVCoordinatesProvider occulted = new PVCoordinatesProvider(){
            /** Serializable UID. */
            private static final long serialVersionUID = 7794508455785809290L;
        ...
        final EllipsoidBodyShape occulting =
            new OneAxisEllipsoid(0.3 * r, 0.1, frame,
                "Spheroid");
    ...
    public class MySpheroidEclipseDetector extends EclipseDetector {
        ...
        /** Logs event data */
        private final TreeMap<AbsoluteDate, Double[]> mapNew = new TreeMap<>();
    ...
    public class MySphericalEclipseDetector extends EclipseDetector {
        ...
        /** Logs event data */
        private final TreeMap<AbsoluteDate, Double[]> mapNewOld = new TreeMap<>();
