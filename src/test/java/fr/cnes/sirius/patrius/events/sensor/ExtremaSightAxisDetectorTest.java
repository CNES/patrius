...
public class ExtremaSightAxisDetectorTest {
    ...
    public void setup() throws PatriusException {
        ...
        final PVCoordinatesProvider target = new TopocentricFrame(new EllipsoidPoint(this.earth,
            this.earth.getLLHCoordinatesSystem(), 0.0, 0.0, 0.0, ""), "target");
    ...
    @Test
    public void testGwithAssembly() throws PatriusException {
     ...
     */
    @Test
    public void testConstructorsWithActions() throws PatriusException {
        final PVCoordinatesProvider target = this.targetMap.get("onBodyZero");
    ...
    @Test
    public void testNewMessageException() {
        try {
            new ExtremaSightAxisDetector(
    ...
    @Test
    public void testNewMessageException2() {
        try {
            new ExtremaSightAxisDetector(
