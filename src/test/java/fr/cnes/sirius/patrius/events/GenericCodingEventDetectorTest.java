...
public class GenericCodingEventDetectorTest {
     ...
     * 
     * @testedMethod {@link GenericCodingEventDetector#logEventsOverTimeInterval
     *               (CodedEventsLogger, Propagator, CodingEventDetector,
     *               AbsoluteDateInterval)}
     */
    @Test
    public final void testLogEventsOverTimeInterval() throws PatriusException {
        // Coded events logger
