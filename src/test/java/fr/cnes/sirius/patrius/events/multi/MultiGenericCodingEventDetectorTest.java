...
public class MultiGenericCodingEventDetectorTest {
    ...
    public void setUpBeforeClass() throws PatriusException {
        ...
        final Attitude attitude = new LofOffset(orbit.getFrame(), LOFType.LVLH).getAttitude(orbit, orbit.getDate(),
            orbit.getFrame());
        state = new HashMap<String, SpacecraftState>();
     ...
     */
    @Test
    public final void testMultiGenericCodingEventPhen() {
     ...
     */
    @Test
    public final void testMultiGenericCodingEventNoPhen() {
     ...
     */
    @Test
    public final void testMultiGenericCodingEventDelayOcc() {
        // The MultiCodingEventDetector is created:
    ...
    public final void testOverriddenMethods() throws PatriusException {
        ...
        final Map<String, SpacecraftState> states0 = new HashMap<String, SpacecraftState>();
