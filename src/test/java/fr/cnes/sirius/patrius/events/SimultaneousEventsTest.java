...
public class SimultaneousEventsTest {
     ...
     */
    @Test
    public final void testSimultaneousDistanceKeplerianPropagator() throws PatriusException {
     ...
     */
    @Test
    public final void testSimultaneousDistanceNumericalPropagator() throws PatriusException {
        final double propagShift = 100000.;
        final double distance = 1.4818E11;
     ...
     */
    @Test
    public final void testSimultaneousNodesKeplerianPropagator() throws PatriusException {
     ...
     */
    @Test
    public final void testSameDateStop() throws PatriusException {
        ...
        final KeplerianPropagator propagator1 = new KeplerianPropagator(initialOrbit, null, Constants.EGM96_EARTH_MU,
            massModel);
        this.sameDateStopTest(propagator1);
        ...
        this.sameDateStopTest(propagator2);
    }
     ...
     */
    @Test
    public final void testSameDateRemoveDetector() throws PatriusException {
        ...
        final KeplerianPropagator propagator1 = new KeplerianPropagator(initialOrbit, null, Constants.EGM96_EARTH_MU,
            massModel);
        this.sameDateRemoveDetectorTest(propagator1);

        // Numerical propagator
        final NumericalPropagator propagator2 = new NumericalPropagator(new ClassicalRungeKuttaIntegrator(30.));
        propagator2.setInitialState(new SpacecraftState(initialOrbit, massModel));
        propagator2.setMassProviderEquation(massModel);
        this.sameDateRemoveDetectorTest(propagator2);
    }
     ...
     * @throws PatriusException
     */
    private void sameDateStopTest(final Propagator propagator) throws PatriusException {
     ...
     * @throws PatriusException
     */
    private void sameDateRemoveDetectorTest(final Propagator propagator) throws PatriusException {
