...
public class SensorVisibilityTest {
    ...
    public void sensorVisibilityTest() throws PatriusException {
        ...
        final PVCoordinatesProvider mainTarget = new BasicPVCoordinatesProvider(
        ...
        inhibitionTargets[0] = new BasicPVCoordinatesProvider(inhibitionTargetCoordinates1,
            EME2000Frame);
        inhibitionTargets[1] = new BasicPVCoordinatesProvider(inhibitionTargetCoordinates2,
            EME2000Frame);

        // Radius provider
        final LocalRadiusProvider radius = new ConstantRadiusProvider(0.0);
        ...
        final LocalRadiusProvider[] inhibitionTargetsRadiuses = { radius, radius };
    ...
    public void sphericalTargetTest() throws PatriusException {
        ...
        // Radius provider
        final LocalRadiusProvider inhibitionRadius = new ConstantRadiusProvider(
        ...
        // Radius provider
        final LocalRadiusProvider targetRadius = new ConstantRadiusProvider(mainTargetRadius);
        sensorProperty.setMainTarget(mainTarget, targetRadius);
        final LocalRadiusProvider[] inhibitionTargetsRadiuses = { inhibitionRadius };
        sensorProperty.setInhibitionFieldsAndTargets(inhibitFields, inhibitionTargets,
            inhibitionTargetsRadiuses);
    ...
    public void maskingTest() throws PatriusException {
        ...
        final EllipsoidBodyShape asteroid = new ExtendedOneAxisEllipsoid(10000., 0.,
