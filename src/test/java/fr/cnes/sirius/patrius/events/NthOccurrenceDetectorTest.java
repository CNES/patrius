...
public class NthOccurrenceDetectorTest {
     ...
     */
    @Test
    public void testConstructeur() throws PatriusException {
    ...
    public void testAOLDetector() throws PatriusException {
        ...
        final EventDetector nodeDetector = new NodeDetector(inertialFrame, 0, AbstractDetector.DEFAULT_MAXCHECK,
            ...
            public
                ...
                NthOccurrenceDetectorTest.this.testStatus &=
                    (NthOccurrenceDetectorTest.this.nthDetector <= 6 && s.getA() == 7000000 || NthOccurrenceDetectorTest.this.nthDetector > 6
                        && s.getA() != 7000000);
    ...
    class MyImpulseManeuver extends ImpulseManeuver {
        /**
         * TODO description of the constructor
         * 
         * @param trigger
         * @param deltaVSat
         * @param isp
         ...
         * @throws PatriusException
         * 
         * @see TODO the references that explain the algorithm (might be useless for constructor)
         * 
         * @since TODO the version when this constructor is created
         */
        public MyImpulseManeuver(final EventDetector trigger, final Vector3D deltaVSat, final double isp)
            throws PatriusException {
