...
public class NthOccurrenceDetectorTest {
    ...
    public void testAOLDetector() throws PatriusException {
        ...
        final NumericalPropagator numP1 = new NumericalPropagator(extrapolator1, FramesFactory.getEME2000());
        ...
        numP1.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(initialState.getMu())));
