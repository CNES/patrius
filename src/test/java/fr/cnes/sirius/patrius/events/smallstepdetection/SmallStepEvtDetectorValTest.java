...
public class SmallStepEvtDetectorValTest {
    ...
    public void createRefs() throws PatriusException, IOException,
        ...
        final NumericalPropagator propagator = new NumericalPropagator(
            integrator, this.initialState.getFrame(), OrbitType.CARTESIAN, PositionAngle.TRUE);
    ...
    private static final class EclipseDetectorWrapper implements EventDetector {
        ...
        private final List<Double> inEventDates = new ArrayList<>();
        private final List<Double> outEventDates = new ArrayList<>();
        ...
        private final Map<AbsoluteDate, Boolean> allEventDates = new TreeMap<>();
        ...
        public EclipseDetectorWrapper(final double maxChk, final double thr,
            ...
            this.ecld = new EclipseDetector(octed, octedRad, octing, octingRad, 0, maxChk, thr){

                /** Serializable UID. */
                private static final long serialVersionUID = -3778234411924364866L;
