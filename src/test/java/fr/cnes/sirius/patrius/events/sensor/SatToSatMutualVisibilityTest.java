...
public class SatToSatMutualVisibilityTest {
    ...
    public void mutualVisibilityTest() throws PatriusException {
        ...
        // event detector with first sensors
        final AbstractDetector detector5 = new SatToSatMutualVisibilityDetector(
            this.mainSpacecraftSensorModel1, this.secondarySpacecraftSensorModel2, secondaryPropagator,
            false, maxCheck, threshold);
        mainPropagator.addEventDetector(detector5);
        detector5.setPropagationDelayType(PropagationDelayType.LIGHT_SPEED);

        // test
        SpacecraftState endState2 = mainPropagator.propagate(this.date.shiftedBy(10000.0));
     ...
     */
    @Test
    public final void testExceptions() throws PropagationException {
        final double maxCheck = 1.;
        final double threshold = 10.e-10;
     ...
     */
    @Test
    public final void testMutualVisibility() throws PatriusException, IOException {
        ...
        builder_gps28.addMainPart("Main");
        builder_gps28.addPart("sensor_gps28", "Main", Transform.IDENTITY);
