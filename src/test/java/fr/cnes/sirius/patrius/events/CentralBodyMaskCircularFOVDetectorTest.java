...
public class CentralBodyMaskCircularFOVDetectorTest {
    ...
    public void testMisc() throws PatriusException {
        ...
        final EllipsoidBodyShape spheroEarth = new ExtendedOneAxisEllipsoid(
            Constants.EGM96_EARTH_EQUATORIAL_RADIUS, Constants.GRIM5C1_EARTH_FLATTENING,
            earth.getTrueRotatingFrame(), SPHERO_EARTH);
    ...
    public void testTargetOne() throws PatriusException {
        ...
        final TwoDirectionsAttitude aProv = new TwoDirectionsAttitude(fstDir, sndDir,
    ...
    private final class DatesEventDetector implements EventDetector {
        ...
        /** . */
        final List<AbsoluteDate> incrEvtDates = new ArrayList<AbsoluteDate>();
        /** . */
        final List<AbsoluteDate> decrEvtDates = new ArrayList<AbsoluteDate>();
