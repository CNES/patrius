...
public class ManoeuverAndApsideDetection {
    ...
    @Test
    public void main() throws IllegalArgumentException, PatriusException {
        ...
        if (mode == DOP) {
            ...
            propagator = new NumericalPropagator(absInteg, initialState.getFrame(), OrbitType.CARTESIAN,
                PositionAngle.TRUE);
