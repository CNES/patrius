...
public class MultiCodedEventsLoggerTest {
    ...
    public void setUp() throws PatriusException {
        ...
        final NodeDetector nodeDetector = new NodeDetector(orbit, FramesFactory.getEME2000(),
            ...
            /** Serializable UID. */
            private static final long serialVersionUID = -3757351756905853962L;
        ...
        final EclipseDetector eclipseDetector = new EclipseDetector(CelestialBodyFactory.getSun(), sunRadius,
            ...
            /** Serializable UID. */
            private static final long serialVersionUID = -2407363423948589096L;
        ...
        final EllipsoidBodyShape earthShape = (EllipsoidBodyShape) CelestialBodyFactory.getEarth().getShape();
        final EllipsoidPoint point = new EllipsoidPoint(earthShape, new LLHCoordinates(
            earthShape.getLLHCoordinatesSystem(), MathLib.toRadians(60), MathLib.toRadians(5), 0.), "");
     ...
     */
    @Test
    public void testMultiCodedEventsLogger() {
    ...
    public void testEventOccurred() throws PatriusException {
        ...
        final NodeDetector nodeDetector = new NodeDetector(orbit, FramesFactory.getEME2000(),
            ...
            /** Serializable UID. */
            private static final long serialVersionUID = 5827239641568190379L;
    ...
    public void testDelayedEvents() throws PatriusException {
        ...
        propagator.setEphemerisMode();
        propagator.addInitialState(new SpacecraftState(orbit), STATE1);
        propagator.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(orbit.getMu())), STATE1);
        // Propagate during two orbital periods:
        propagator.propagate(date0, dateF);
    ...
    public void testOccurrenceEvents() throws PatriusException {
        ...
        propagator.setEphemerisMode();
        propagator.addInitialState(new SpacecraftState(orbit), STATE1);
        propagator.getInitialStates().get(STATE1).getMu();
        propagator.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(propagator.getInitialStates()
            .get(STATE1).getMu())), STATE1);
        // Propagate during two orbital periods:
        propagator.propagate(date0, dateF);
