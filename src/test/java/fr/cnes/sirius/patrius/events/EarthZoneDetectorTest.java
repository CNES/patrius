...
public class EarthZoneDetectorTest {
    ...
    public void detectorTest() throws PatriusException {
        ...
        // detector creation
        List<double[][]> zones = new ArrayList<double[][]>();
        zones.add(zone);
        ...
        // detector creation
        final List<Vector3D[]> zonesVect = new ArrayList<Vector3D[]>();
        zonesVect.add(zone3);
    ...
    public void wrongZoneTest() throws PatriusException {
        ...
        try {
            ...
            zone3[2] = new Vector3D(-FastMath.PI / 4., FastMath.PI / 4.);
            zone3[3] = new Vector3D(FastMath.PI / 4., -FastMath.PI / 4.);
            final List<Vector3D[]> zones = new ArrayList<Vector3D[]>();
            zones.add(zone3);
    ...
    public final void testConstructor() throws PatriusException {
        ...
        final double[][] zone = { { FastMath.PI / 4., FastMath.PI / 2. },
            ...
            { FastMath.PI / 4., 0. } };
        // detector creation
        final List<double[][]> zones = new ArrayList<double[][]>();
        zones.add(zone);
        ...
        zone3[2] = new Vector3D(-FastMath.PI / 4., -FastMath.PI / 4.);
        zone3[3] = new Vector3D(FastMath.PI / 4., -FastMath.PI / 4.);
        final List<Vector3D[]> zones2 = new ArrayList<Vector3D[]>();
        zones2.add(zone3);
