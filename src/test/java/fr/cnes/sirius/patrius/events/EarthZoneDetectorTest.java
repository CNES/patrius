...
import fr.cnes.sirius.patrius.events.detectors.EarthZoneDetector;
...
public class EarthZoneDetectorTest {
    ...
    public void testConstructor() {
        ...
        // earth
        final double r = 6000000.0;
        final EllipsoidBodyShape earth = new OneAxisEllipsoid(r, 0.0, FramesFactory.getEME2000());
        // zone
        final double[][] zone = { { FastMath.PI / 4., FastMath.PI / 2. },
            { FastMath.PI / 4., FastMath.PI }, { FastMath.PI / 4., -FastMath.PI / 2. },
            { FastMath.PI / 4., 0. } };
