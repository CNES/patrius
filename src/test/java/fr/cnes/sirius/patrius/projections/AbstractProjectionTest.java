...
public class AbstractProjectionTest {
    ...
    public static void setUpBeforeClass() throws PatriusException {
        ...
        listVector2D = new ArrayList<Vector2D>();
     ...
     */
    @Test
    public final void testDiscretize() throws PatriusException {
        ...
        final List<Vector2D> expected = new ArrayList<Vector2D>();
        ...
        this.checkListVector2D(expected, actual, eps);
     ...
     */
    @Test
    public final void testDiscretizeAndApplyTo() throws PatriusException {
        ...
        final List<Vector2D> expected1 = new ArrayList<Vector2D>();
        ...
        final List<Vector2D> expected2 = new ArrayList<Vector2D>();

        final List<Vector2D> expected3 = new ArrayList<Vector2D>();
        ...
        final List<Vector2D> expected4 = new ArrayList<Vector2D>();
        ...
        final List<Vector2D> expected5 = new ArrayList<Vector2D>();
        ...
        final List<Vector2D> expected6 = new ArrayList<Vector2D>();
        ...
        final List<Vector2D> expected7 = new ArrayList<Vector2D>();
        ...
        this.checkListVector2D(expected1, actual1, eps);
        this.checkListVector2D(expected2, actual2, eps);
        this.checkListVector2D(expected3, actual3, eps);
        this.checkListVector2D(expected4, actual4, eps);
        this.checkListVector2D(expected5, actual5, eps);
        this.checkListVector2D(expected6, actual6, eps);
        this.checkListVector2D(expected7, actual7, eps);
     ...
     */
    @Test
    public final void testApplyToAndDiscretize() throws PatriusException {
    ...
    public final void testApplyInverseTo() throws PatriusException {
        ...
        final List<GeodeticPoint> expected = new ArrayList<GeodeticPoint>();
        ...
        this.checkListGeodeticPoint(expected, actual1, eps);
        this.checkListGeodeticPoint(expected, actual2, eps);
     ...
     */
    private void checkListVector2D(final List<Vector2D> expected, final List<Vector2D> actual, final double eps) {
