...
public class ProjectionEllipsoidUtilsTest {
    ...
    public static void setUpBeforeClass() throws PatriusException {
        ...
        // Projections
        ellipsoid = new ExtendedOneAxisEllipsoid(6378137.0, 1. / 298.257223563, null,
            "default earth");
    ...
    public final void testSeries() throws PatriusException {
        ...
        // Test cache update
        final ExtendedOneAxisEllipsoid ellipsoid2 = new ExtendedOneAxisEllipsoid(6300000.0, 1. / 200, null,
                "earth 2");
     ...
     */
    private void checkListGeodeticPoint(
                                        final List<GeodeticPoint> expected,
     ...
     */
    @Test
    public final void testComputeCenterAlongLoxodrome() throws PatriusException {
        ...
        final ExtendedOneAxisEllipsoid ellipsoid = new ExtendedOneAxisEllipsoid(6378137.0, 0, null, "");
