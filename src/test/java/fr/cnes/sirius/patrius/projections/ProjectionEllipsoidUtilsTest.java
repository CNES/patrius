...
public class ProjectionEllipsoidUtilsTest {
    ...
    /** Geodetic point used in the tests (longitude = -Pi). */
    private static GeodeticPoint point5;

    /** Geodetic point used in the tests (longitude = Pi). */
    private static GeodeticPoint point6;
    ...
    public static void setUpBeforeClass() {
        ...
        // Projections
        ellipsoid = new OneAxisEllipsoid(6378137.0, 1. / 298.257223563, null,
            "default earth");
        ...
        point5 = new GeodeticPoint(0, -MathLib.PI, 0);
        
        // Point 6 (longitude = Pi)
        point6 = new GeodeticPoint(0.1, MathLib.PI - 0.1, 0);
    ...
    public void testComputeBearing() throws PatriusException {
        ...
        final double actual1 = ProjectionEllipsoidUtils.computeBearing(point1, point2, ellipsoid);
        final double actual2 = ProjectionEllipsoidUtils.computeBearing(point2, point1, ellipsoid);
        final double actual3 = ProjectionEllipsoidUtils.computeBearing(point1, point3, ellipsoid);
        final double actual4 = ProjectionEllipsoidUtils.computeBearing(point3, point1, ellipsoid);
        final double actual5 = ProjectionEllipsoidUtils.computeBearing(point2, point3, ellipsoid);
        final double actual6 = ProjectionEllipsoidUtils.computeBearing(point3, point2, ellipsoid);
        final double actual11 = ProjectionEllipsoidUtils.computeBearing(point5, point6, ellipsoid);
        ...
        final double actual7 = ProjectionEllipsoidUtils.computeBearing(point1, point5, ellipsoid);
        final double actual8 = ProjectionEllipsoidUtils.computeBearing(point1, point6, ellipsoid);
        ...
        final double actual9 = ProjectionEllipsoidUtils.computeBearing(point1, point7, ellipsoid);
        final double actual10 = ProjectionEllipsoidUtils.computeBearing(point1, point8, ellipsoid);
        ...
        try {
            ProjectionEllipsoidUtils.computeBearing(point1, point1, ellipsoid);
            Assert.fail();
     ...
     */
    @Test
    public void testComputeSphericalAzimuth() {
    ...
    public void testComputeLoxodromicDistance() throws PatriusException {
        ...
        // actual
        final double[] lox = {
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point1, point2, ellipsoid),
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point2, point1, ellipsoid),
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point1, point3, ellipsoid),
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point3, point1, ellipsoid),
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point2, point3, ellipsoid),
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point3, point2, ellipsoid),
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point5, point6, ellipsoid),
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point7, point8, ellipsoid) };
        ...
        try {
            ProjectionEllipsoidUtils.computeLoxodromicDistance(point1, badPoint, ellipsoid);
            Assert.fail();
        } catch (final PatriusException e) {
            Assert.assertTrue(true);
        }
     ...
     */
    @Test
    public void testComputeMeridionalDistance() throws PatriusException {
     ...
     */
    @Test
    public void testComputeInverseMeridionalDistance() throws PatriusException {
        Report.printMethodHeader("testComputeInverseMeridionalDistance",
            "Compute inverse meridional distance",
    ...
    public void testComputePointAlongLoxodrome() throws PatriusException {
        ...
        // ref
        final List<GeodeticPoint> refPoints = new ArrayList<>();
        ...
        // ref
        final List<GeodeticPoint> actualPoints = new ArrayList<>();
        ...
        // exceptions :
        try {
            ProjectionEllipsoidUtils.computePointAlongLoxodrome(new GeodeticPoint(
                MathUtils.DEG_TO_RAD * 90,
                0.03, 256.), d1, 0.1, ellipsoid);
            Assert.fail();
        } catch (final PatriusException e) {
            Assert.assertTrue(true);
        }
     ...
     */
    @Test
    public void testComputeInverseRectifyingLatitude() throws PatriusException {
        Report.printMethodHeader("testComputeInverseRectifyingLatitude",
            "Compute inverse rectifying latitude",
            "LibKernel 10.0.0", 0, ComparisonType.RELATIVE);
     ...
     */
    @Test
    public void testComputeOrthodromicDistance() {
    ...
    public void testComputePointAlongOrthodrome() {
        Report.printMethodHeader("testComputePointAlongOrthodrome",
            "Compute point along orthodrome",
            "LibKernel 10.0.0", 0, ComparisonType.RELATIVE);

        final GeodeticPoint actual = ProjectionEllipsoidUtils.computePointAlongOrthodrome(point1,
            12345., 0.5,
            ellipsoid);
        ...
        Assert.assertEquals(0.,
            (expected.getLatitude() - actual.getLatitude()) / expected.getLatitude(), eps);
        Assert.assertEquals(0.,
            (expected.getLongitude() - actual.getLongitude()) / expected.getLongitude(), eps);
     ...
     */
    @Test
    public void testDiscretizationGreatCircle() {
        Report.printMethodHeader("testDiscretizationGreatCircle",
            "Discretization along Great Circle",
            "LibKernel 10.0.0", 3E-14, ComparisonType.RELATIVE);

        // 3 maxlength cases
        final List<GeodeticPoint> actual1 = ProjectionEllipsoidUtils.discretizeGreatCircle(point1,
            point2,
            1000000, ellipsoid);
        final List<GeodeticPoint> actual2 = ProjectionEllipsoidUtils.discretizeGreatCircle(point1,
            point2, 0,
            ellipsoid);
        final List<GeodeticPoint> actual3 = ProjectionEllipsoidUtils.discretizeGreatCircle(point1,
            point2,
            4000000, ellipsoid);

        final double eps = 3E-14;
        final List<GeodeticPoint> expected1 = new ArrayList<>();
        expected1.add(new GeodeticPoint(MathLib.toRadians(43.43087666000001), MathLib
            .toRadians(1.4977419400000025),
            256.));
        expected1.add(new GeodeticPoint(MathLib.toRadians(35.80077182694041), MathLib
            .toRadians(8.237088262669358),
            0.));
        expected1.add(new GeodeticPoint(MathLib.toRadians(27.852456068881388), MathLib
            .toRadians(13.777774346708954),
            0.));
        expected1.add(new GeodeticPoint(MathLib.toRadians(19.70725940634673), MathLib
            .toRadians(18.56131861964875),
            0.));

        final List<GeodeticPoint> expected2 = new ArrayList<>();
        expected2.add(new GeodeticPoint(MathLib.toRadians(43.43087666000001), MathLib
            .toRadians(1.4977419400000025),
            256.));
        expected2.add(new GeodeticPoint(MathLib.toRadians(11.459155902616466), MathLib
            .toRadians(22.918311805232932),
            1234.));

        final List<GeodeticPoint> expected3 = new ArrayList<>();
        expected3.add(new GeodeticPoint(MathLib.toRadians(43.43087666000001), MathLib
            .toRadians(1.4977419400000025),
            256.));
        expected3.add(new GeodeticPoint(MathLib.toRadians(11.459155902616466), MathLib
            .toRadians(22.918311805232932),
            1234.));
    ...
    public void testDiscretizationRhumbLine() throws PatriusException {
        ...
        // 3 maxlength cases
        final List<GeodeticPoint> actual1 = ProjectionEllipsoidUtils.discretizeRhumbLine(point1,
            point2, 1000000,
            ellipsoid);
        final List<GeodeticPoint> actual2 = ProjectionEllipsoidUtils.discretizeRhumbLine(point1,
            point2, 0,
            ellipsoid);
        final List<GeodeticPoint> actual3 = ProjectionEllipsoidUtils.discretizeRhumbLine(point1,
            point2, 4000000,
            ellipsoid);
        ...
        expected1.add(new GeodeticPoint(MathLib.toRadians(43.43087666000001), MathLib
            .toRadians(1.4977419400000025),
            256.));
        expected1.add(new GeodeticPoint(MathLib.toRadians(35.45214288961152), MathLib
            .toRadians(7.534123017198017),
            0.));
        expected1.add(new GeodeticPoint(MathLib.toRadians(27.46289676019212), MathLib
            .toRadians(12.998775866019459),
            0.));
        expected1.add(new GeodeticPoint(MathLib.toRadians(19.464531632933117), MathLib
            .toRadians(18.080863380100528),
            0.));
    ...
    public void testSeries() {
        Report.printMethodHeader("testSeries", "Ellipsoid series", "LibKernel 10.0.0", 2E-16,
            ComparisonType.RELATIVE);
     ...
     */
    private static void checkListGeodeticPoint(final List<GeodeticPoint> expected,
                                        final List<GeodeticPoint> actual,
                                        final double eps) {
        Assert.assertEquals(expected.size(), actual.size());
        for (int i = 0; i < expected.size(); i++) {
            if (expected.get(i).getLatitude() != 0) {
                Assert.assertEquals(0., (expected.get(i).getLatitude() - actual.get(i)
                    .getLatitude())
            ...
            Report.printToReport("Point " + i + " (latitude)", expected.get(i).getLatitude(),
                actual.get(i)
                    .getLatitude());
            Report.printToReport("Point " + i + " (longitude)", expected.get(i).getLongitude(),
                actual.get(i)
                    .getLongitude());
            Report.printToReport("Point " + i + " (altitude)", expected.get(i).getAltitude(),
                actual.get(i)
                    .getAltitude());
        }
    }
     ...
     * @testedFeature {@link features#PROJECTION_ELLIPSOID}
     * 
     * @testedMethod {@link ProjectionEllipsoidUtils#computeCenterPointAlongLoxodrome(GeodeticPoint, GeodeticPoint, EllipsoidBodyShape)}
     * 
    ...
    public void testComputeCenterAlongLoxodrome() throws PatriusException {
        ...
        // On the equator
        final GeodeticPoint p1 = new GeodeticPoint(0, 1., 0);
        final GeodeticPoint p2 = new GeodeticPoint(0, 2., 0);
        final GeodeticPoint actual1 = ProjectionEllipsoidUtils.computeCenterPointAlongLoxodrome(p1, p2, ellipsoid);
        final GeodeticPoint expected1 = new GeodeticPoint(0, 1.5, 0);

        Assert.assertEquals(expected1.getLatitude(), actual1.getLatitude(), 0.);
        Assert.assertEquals(expected1.getLongitude(), actual1.getLongitude(), 0.);

        // On a meridian
        final GeodeticPoint p3 = new GeodeticPoint(1., 0., 0);
        final GeodeticPoint p4 = new GeodeticPoint(2., 0., 0);
        final GeodeticPoint actual2 = ProjectionEllipsoidUtils.computeCenterPointAlongLoxodrome(p3, p4, ellipsoid);
        final GeodeticPoint expected2 = new GeodeticPoint(1.5, 0., 0);

        Assert.assertEquals(expected2.getLatitude(), actual2.getLatitude(), 0.);
        Assert.assertEquals(expected2.getLongitude(), actual2.getLongitude(), 0.);

        // Same points
        final GeodeticPoint p5 = new GeodeticPoint(0., 0., 0);
        final GeodeticPoint p6 = new GeodeticPoint(0., 0., 0);
        final GeodeticPoint actual3 = ProjectionEllipsoidUtils.computeCenterPointAlongLoxodrome(p5, p6, ellipsoid);
        final GeodeticPoint expected3 = new GeodeticPoint(0., 0., 0);

        Assert.assertEquals(expected3.getLatitude(), actual3.getLatitude(), 0.);
        Assert.assertEquals(expected3.getLongitude(), actual3.getLongitude(), 0.);
    }
}
