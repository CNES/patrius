 ...
 * @author cardosop
 * 
 * @version $Id: TaskTwoFactory.java 17915 2017-09-11 12:35:44Z bignon $
 * 
 * @since version when the file was created - TODO
 * 
 */
public class TaskTwoFactory implements ParallelTaskFactory<TaskTwo> {
     ...
     */
    @Override
    public TaskTwo newInstance() {
        return new TaskTwo(++this.counter);
    }
