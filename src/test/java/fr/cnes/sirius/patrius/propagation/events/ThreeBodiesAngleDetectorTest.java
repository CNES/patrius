...
public class ThreeBodiesAngleDetectorTest {
     ...
     */
    @Test
    public final void testThreeBodiesAngleDetectorCtor1() {
     ...
     */
    @Test
    public final void testThreeBodiesAngleDetectorCtor2() {
     ...
     */
    @Test
    public final void testThreeBodiesAngleDetectorCtor3() throws PatriusException {
        final ThreeBodiesAngleDetector detector = new ThreeBodiesAngleDetector(sun, moon, earth, 4.0123, 600, 0.001,
            Action.STOP);
     ...
     */
    @Test
    public final void testTwoOrbits() throws PatriusException {
        // sets up the orbits:
        final double mu = CelestialBodyFactory.getEarth().getGM();
        // first orbit:
        final double a1 = 8000000;
    ...
    public void testSatelliteStationSatellite() throws PatriusException {
        ...
        final GeodeticPoint point = new GeodeticPoint(MathLib.toRadians(60), MathLib.toRadians(20), 0);
        ...
        propagator2.resetInitialState(new SpacecraftState(orbit2));
     ...
     */
    @Test
    public final void testExceptions() throws PatriusException {
        /** Sat id 1 */
