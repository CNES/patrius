...
public class ExtremaGenericDetectorTest {
     ...
     */
    @Test
    public final void testConstructorsAndGetters() throws PatriusException {
        ...
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector1 = new ExtremaGenericDetector<EventDetector>(
        ...
        Assert.assertEquals(extGenOrbDetector1.getThreshold(), ExtremaGenericDetector.DEFAULT_THRESHOLD);

        // Create an ExtremaGenericOrbitDetector with the ExtremaGenericOrbitDetector(D, ExtremumType, double)
        // constructor
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector2 = new ExtremaGenericDetector<EventDetector>(
        ...
        Assert.assertEquals(extGenOrbDetector2.getThreshold(), ExtremaGenericDetector.DEFAULT_THRESHOLD);

        // Create an ExtremaGenericOrbitDetector with the ExtremaGenericOrbitDetector(D, ExtremumType, double, double)
        // constructor
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector3 = new ExtremaGenericDetector<EventDetector>(
        ...
        Assert.assertEquals(extGenOrbDetector3.getThreshold(), ExtremaGenericDetector.DEFAULT_THRESHOLD);

        // Create an ExtremaGenericOrbitDetector with the ExtremaGenericOrbitDetector(D, ExtremumType, double, double,
        // double) constructor
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector4 = new ExtremaGenericDetector<EventDetector>(
        ...
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector5 = new ExtremaGenericDetector<EventDetector>(
        ...
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector6 = new ExtremaGenericDetector<EventDetector>(
     ...
     */
    @Test
    public final void testEventOccurredAndG() throws PatriusException {
        ...
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector1 = new ExtremaGenericDetector<EventDetector>(
            ...
            ExtremaGenericDetector.DEFAULT_MAXCHECK, ExtremaGenericDetector.DEFAULT_THRESHOLD,
        ...
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector2 = new ExtremaGenericDetector<EventDetector>(
            ...
            ExtremaGenericDetector.DEFAULT_THRESHOLD, Action.CONTINUE, Action.STOP, true, false);
        // Distance is decreasing and integration direction is forward
     ...
     */
    @Test
    public final void testCopy() throws PatriusException {
        // Create an EventDetector
        final EclipseDetector extOriEveDetector = new EclipseDetector(CelestialBodyFactory.getSun(), SUN_RADIUS,
            CelestialBodyFactory.getEarth(), EARTH_RADIUS, 1e-12, 100, 1E-6);
        // Create an ExtremaGenericOrbitDetector
        final ExtremaGenericDetector<EventDetector> extGenOrbDetector = new ExtremaGenericDetector<EventDetector>(
            extOriEveDetector, ExtremumType.MIN_MAX, 60., 240., 1.0E-2, Action.STOP, Action.STOP, true, true);
     ...
     */
    @Test
    public final void testGetSlopeSelection() throws PatriusException {
     ...
     */
    @Test
    public final void testFind() throws PatriusException {
     ...
     */
    @Test
    public final void testLogExtremaEvents() throws PatriusException {
        // Create an EventDetector
        final EclipseDetector extOriEveDetector = new EclipseDetector(CelestialBodyFactory.getSun(), SUN_RADIUS,
            CelestialBodyFactory.getEarth(), EARTH_RADIUS, 1e-12, 100, 1E-6);
        // Create an ExtremaGenericOrbitDetector
        ...
        final AbsoluteDate lowerData = iniDate.shiftedBy(-120);
        final AbsoluteDate upperData = iniDate.shiftedBy(120);
