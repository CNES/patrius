...
public class AdaptedEventDetectorTest {
    ...
    public final void testAdaptedEventDetectorGError() {
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedEventDetectorEventOccuredError() {
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedEventDetectorResetStateError() {
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedEventDetectorInitError() {
