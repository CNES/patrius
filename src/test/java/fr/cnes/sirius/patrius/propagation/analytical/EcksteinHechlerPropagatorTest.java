...
public class EcksteinHechlerPropagatorTest {
    ...
    public void wrongAttitude() throws PropagationException {
        final KeplerianOrbit orbit = new KeplerianOrbit(1.0e10, 1.0e-4, 1.0e-2, 0, 0, 0,
                PositionAngle.TRUE, FramesFactory.getEME2000(), AbsoluteDate.J2000_EPOCH,
                3.986004415e14);
        ...
        final EcksteinHechlerPropagator propagator = new EcksteinHechlerPropagator(orbit, wrongLaw,
                new ConstantAttitudeLaw(FramesFactory.getEME2000(), Rotation.IDENTITY), this.ae,
