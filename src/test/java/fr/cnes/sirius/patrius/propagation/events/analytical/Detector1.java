...
public class Detector1 extends Detector {
    ...
    /** Serializable UID. */
    private static final long serialVersionUID = -3703821293604959932L;
    ...
    public SpacecraftState resetState(final SpacecraftState oldState) {
        ...
        final Orbit newOrbit = new KeplerianOrbit(oldState.getA(), oldState.getE(), oldState.getI(), 0, 0, newAnomaly,
            PositionAngle.MEAN, FramesFactory.getEME2000(), oldState.getDate(), oldState.getMu());
        return new SpacecraftState(newOrbit);
