...
public class DistanceDetectorTest {
     ...
     */
    @Test
    public void testDistanceDetectorCtor() {
     ...
     */
    @Test
    public void testDistanceDetectorCtor2() {
        final DistanceDetector detector =
     ...
     */
    @Test
    public void testDistanceDetectorCtor3() {
        final DistanceDetector detector =
            new DistanceDetector(theSun, 54321., 10, 0.1, Action.STOP, Action.STOP);
        ...
        final DistanceDetector detector3 = new DistanceDetector(theSun, 54321., 0, 10, 0.1, Action.STOP, false);
        final DistanceDetector detector4 = (DistanceDetector) detector3.copy();
        // Test getter
        Assert.assertEquals(54321., detector4.getDistance());
        Assert.assertEquals(theSun, detector4.getBody());

        final DistanceDetector detector5 = new DistanceDetector(theSun, 54321., 1, 10, 0.1, Action.STOP, false);
        final DistanceDetector detector6 = (DistanceDetector) detector5.copy();
        // Test getter
    ...
    public void testDistanceDetectorCtorError() {
    ...
    public void testG() throws PatriusException {
        ...
        final double expectedDot = 1.4818489552857028E11;
    ...
    public void testPropagation01() throws PatriusException {
        ...
        final double expectedShift = 1481.1756625387886;
     ...
     */
    @Test
    public void testTwoEquatorialOrbits() throws PatriusException {
        final double propagShift = 100000.;
