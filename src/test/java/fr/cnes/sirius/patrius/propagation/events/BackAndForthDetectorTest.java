...
public class BackAndForthDetectorTest {
    ...
    public void testBackAndForth() throws PatriusException {
        ...
        final EllipsoidPoint stationPosition = new EllipsoidPoint(earth, earth.getLLHCoordinatesSystem(),
            MathLib.toRadians(0.), MathLib.toRadians(100.), 110., "");
        final TopocentricFrame stationFrame = new TopocentricFrame(stationPosition, "");
