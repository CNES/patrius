...
public class AdditionalStatesDetectorValTest {
    ...
    public void testAddStateEventDetectorLogger() throws PatriusException {
        ...
        final ElectricalPowerDetector electricalPowerDetector =
            new ElectricalPowerDetector(aeq.getName(), powerTodetect, EventDetector.DECREASING){

                /** Serializable UID. */
                private static final long serialVersionUID = -5450536856188441185L;
    ...
    public void multipleAdditionalStatesTest() throws PatriusException {
        ...
        final ElectricalPowerDetector electricalPowerDetector =
            new ElectricalPowerDetector(aeqElec.getName(), powerTodetect, EventDetector.DECREASING){

                /** Serializable UID. */
                private static final long serialVersionUID = 2351261156951182483L;
    ...
    private final class AddStatesStepHandler implements PatriusStepHandler {
        ...
        /** Serializable UID. */
        private static final long serialVersionUID = -9040307448506737973L;
