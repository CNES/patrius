...
public class AdapterPropagatorTest {
    ...
    public void testLowEarthOrbit() throws PatriusException, ParseException, IOException {
        ...
        final BoundedPropagator withoutManeuver = this.getEphemeris(leo, mass, 5, new LofOffset(leo.getFrame(),
                LOFType.LVLH, RotationOrder.XZY, FastMath.PI / 2.0, -FastMath.PI / 2.0, 0.0), t0, Vector3D.ZERO, f,
                isp, false, false, null, 0, 0);
        final BoundedPropagator withManeuver = this.getEphemeris(leo, mass, 5, new LofOffset(leo.getFrame(),
    ...
    public void testEccentricOrbit() throws PatriusException, ParseException, IOException {
        ...
        final double vExhaust = Constants.G0_STANDARD_GRAVITY * isp;
        final double dt = -(mass * vExhaust / f) * MathLib.expm1(-dV.getNorm() / vExhaust);
        final BoundedPropagator withoutManeuver = this.getEphemeris(heo, mass, 5, new LofOffset(heo.getFrame(),
                LOFType.LVLH, RotationOrder.XZY, FastMath.PI / 2.0, -FastMath.PI / 2.0, 0.0), t0, Vector3D.ZERO, f,
                isp, false, false, null, 0, 0);
        final BoundedPropagator withManeuver = this.getEphemeris(heo, mass, 5, new LofOffset(heo.getFrame(),
                LOFType.LVLH, RotationOrder.XZY, FastMath.PI / 2.0, -FastMath.PI / 2.0, 0.0), t0, dV, f, isp, false,
                false, null, 0, 0);
    ...
    public void testNonKeplerian() throws PatriusException, ParseException, IOException {
        ...
        final BoundedPropagator withoutManeuver = this.getEphemeris(leo, mass, 10, new LofOffset(leo.getFrame(),
                LOFType.VNC), t0, Vector3D.ZERO, f, isp, true, true, gravityField, 8, 8);
        final BoundedPropagator withManeuver = this.getEphemeris(leo, mass, 10, new LofOffset(leo.getFrame(),
    ...
    private BoundedPropagator getEphemeris(final Orbit orbit,
            final double mass,
            final int nbOrbits,
            ...
            final int degree,
            final int order) throws PatriusException, ParseException, IOException {
