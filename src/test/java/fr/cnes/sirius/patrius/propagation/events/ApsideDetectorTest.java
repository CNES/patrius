...
public class ApsideDetectorTest {
     ...
     */
    @Test
    public void testApsideDetectorOrbit() {
     ...
     */
    @Test
    public void testApsideDetectorDoubleOrbit() {
        final ApsideDetector detector =
     ...
     */
    @Test
    public void testApsideDetectorNoOrbit() {
        final ApsideDetector detector =
     ...
     */
    @Test
    public void testPropagationStop() throws PatriusException {
        ...
        propagator.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(tISSSpState.getMu())));
        // logger:
     ...
     */
    @Test
    public void testPropagationRemoveDetectorResetState() throws PatriusException {
        final ApsideDetector perigee = new ApsideDetector(ApsideDetector.PERIGEE, tISSOrbit.getKeplerianPeriod() / 3,
            1.0e-13 * tISSOrbit.getKeplerianPeriod(), Action.CONTINUE);
        final ApsideDetector apogee = new ApsideDetector(ApsideDetector.APOGEE, tISSOrbit.getKeplerianPeriod() / 3,
            1.0e-13 * tISSOrbit.getKeplerianPeriod(), Action.CONTINUE);
    ...
    class MyApsideDetector extends ApsideDetector {
        ...
        /** Serializable UID. */
        private static final long serialVersionUID = -2914566036777839786L;
