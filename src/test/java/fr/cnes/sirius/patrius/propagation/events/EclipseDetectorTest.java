...
public class EclipseDetectorTest {
    ...
    public void testConstructors() throws PatriusException {
        ...
        final BodyShape body = new BodyShape(){
            ...
            @Override
            public double
                getApparentRadius(final PVCoordinatesProvider posObserver, final AbsoluteDate date,
            ...
            @Override
            public Vector3D[] closestPointTo(Line line, Frame frame, AbsoluteDate date) throws PatriusException {
                return null;
            }

            @Override
            public GeodeticPoint transformFromZenith(Vector3D point, Vector3D zenith, Frame frame, AbsoluteDate date)
                throws PatriusException {
                return null;
            }
