...
public class LiuMeanOsculatingConverterTest {
    ...
    public void testFrames() throws PatriusException {
        ...
        Assert.assertEquals(0., this.relDiff(osc1.getA(), osc2InCIRF.getA()), eps);
        Assert.assertEquals(0., this.relDiff(osc1.getE(), osc2InCIRF.getE()), eps);
        Assert.assertEquals(0., this.relDiff(osc1.getI(), osc2InCIRF.getI()), eps);
        Assert.assertEquals(0., this.relDiff(osc1.getPerigeeArgument(), osc2InCIRF.getPerigeeArgument()), eps);
        Assert.assertEquals(0., this.relDiff(osc1.getRightAscensionOfAscendingNode(), osc2InCIRF.getRightAscensionOfAscendingNode()), eps);
        Assert.assertEquals(0., this.relDiff(osc1.getMeanAnomaly() % (2. * FastMath.PI), osc2InCIRF.getMeanAnomaly() % (2. * FastMath.PI)), eps);
    }
    ...
    public void testConversionAR() throws PatriusException {
        ...
        // Check that the parameters of the orbit converted twice is equal to the parameters of the initial orbit.
        Assert.assertEquals(0., this.relDiff(orbit.getA(), mean.getA()), eps);
        Assert.assertEquals(0., this.relDiff(orbit.getE(), mean.getE()), eps);
        Assert.assertEquals(0., this.relDiff(orbit.getI(), mean.getI()), eps);
        Assert.assertEquals(0., this.relDiff(orbit.getPerigeeArgument(), mean.getPerigeeArgument()), eps);
        Assert.assertEquals(0., this.relDiff(orbit.getRightAscensionOfAscendingNode(), mean.getRightAscensionOfAscendingNode()), eps);
        Assert.assertEquals(0., this.relDiff(orbit.getMeanAnomaly() % (2. * FastMath.PI), mean.getMeanAnomaly() % (2. * FastMath.PI)), eps);
    }
    ...
    public void testThreshold() throws PatriusException {
        ...
        try { 
        	// Osculating to mean conversion
            final KeplerianOrbit osc = (KeplerianOrbit) propagator.osc2mean(orbit); 
            Assert.fail();
        } 
    ...
    public void testMeanOscConversion() throws PatriusException {
        ...
        // Assert
        Assert.assertEquals(0., this.relDiff(osc1.getA(), osc2.getA()), eps2);
        Assert.assertEquals(0., this.relDiff(osc1.getE(), osc2.getE()), eps1);
        Assert.assertEquals(0., this.relDiff(osc1.getI(), osc2.getI()), eps2);
        Assert.assertEquals(0., this.relDiff(osc1.getPerigeeArgument(), osc2.getPerigeeArgument()), eps1);
        Assert.assertEquals(0., this.relDiff(osc1.getRightAscensionOfAscendingNode(), osc2.getRightAscensionOfAscendingNode()), eps2);
        Assert.assertEquals(0., this.relDiff(osc1.getMeanAnomaly(), osc2.getMeanAnomaly()), eps1);
    }
    ...
    public void testPropagateMeanOrbit() throws PatriusException {
        ...
        try { 
        	final Orbit orbit = propagator.propagateMeanOrbit(date) ; 
        	Assert.fail();
        } 
