...
public class LatitudeDetectorTest {
     ...
     */
    @Test
    public void testLatitudeDetector() throws PatriusException {
        // propagator
     ...
     */
    @Test
    public void testDefinedAction() throws PropagationException {
        // propagator
    ...
    class MyLatitudeDetector extends LatitudeDetector {
        /** Serializable UID. */
        private static final long serialVersionUID = 862199713794752207L;
        private final ArrayList<AbsoluteDate> dateReset;

        public MyLatitudeDetector(final double latitudeToDetect, final EllipsoidBodyShape earth, final int slopeType,
     ...
     */
    @Test
    public void testConstructorDOWN() throws PatriusException {
