...
public class MassDetectorsTest {
    ...
    @Test
    public void testAssemblySynchronization1() throws PatriusException, IOException, ParseException {
    ...
    @Test
    public void testAssemblySynchronization2() throws PatriusException, IOException, ParseException {
    ...
    public void testOneMassGoesToZero() throws PatriusException {
        ...
        propagator.addForceModel(new AblationForce(massModelOnePart, MAIN));
        ...
        Assert.assertEquals(0., finalState.getMass(MAIN), Utils.epsilonTest);
        Assert.assertEquals(0., massModelOnePart.getMass(MAIN), Utils.epsilonTest);
    ...
    public void testOneMassGoesToZeroInMultiProp() throws PatriusException {
        ...
        mainPropagator.setAdditionalStateTolerance(SpacecraftState.MASS + MAIN, new double[] { 1 }, new double[] { 1 },
            STATE1);
        mainPropagator.setMassProviderEquation(massModelOnePart2, STATE2);
        // Add ablation force on main part
        mainPropagator.addForceModel(new AblationForce(massModelOnePart1, MAIN), STATE1);
        ...
        // Main part final mass should be equal to zero
        Assert.assertEquals(0., finalStates.get(STATE1).getMass(MAIN), Utils.epsilonTest);
        Assert.assertEquals(0., massModelOnePart1.getMass(MAIN), Utils.epsilonTest);
        // Total final mass should be equal to zero
        Assert.assertEquals(0., massModelOnePart1.getTotalMass(), Utils.epsilonTest);

        // Second state mass should remain the same
        Assert.assertEquals(mainMass, finalStates.get(STATE2).getMass(MAIN), Utils.epsilonTest);
        Assert.assertEquals(mainMass, massModelOnePart2.getMass(MAIN), Utils.epsilonTest);
     ...
     */
    @Test
    public final void test10kgMassDetector() throws PatriusException {
        // state
        final SpacecraftState spc = new SpacecraftState(orbit, massModel);
     ...
     */
    @Test
    public final void test1ConstantManeuverAnd10kgMassDetector() throws IllegalArgumentException, PatriusException,
        ...
        // Check
        this.checkMasses(finalState, massModel, 500, 10, 200);
    }
     ...
     */
    @Test
    public final void test3ConstantManeuvers() throws IllegalArgumentException, PatriusException,
                                              IOException, ParseException {
        ...
        // Check
        this.checkMasses(finalState, massModel, 500, 0, 200 - 32.63076);
    }
     ...
     */
    @Test
    public final void test1ConstantManeuver() throws IllegalArgumentException, PatriusException,
                                             IOException, ParseException {
        ...
        // Check
        this.checkMasses(finalState, massModel, 500, 300, 41.74 - 0.408);
    }
     ...
     */
    @Test
    public final void testMassOrder() throws PatriusException {
     ...
     */
    @Test
    public final void testDormandPrince() throws PatriusException, IOException, ParseException {
        ...
        final ForceModel potentiel = new BalminoAttractionModel(FramesFactory.getITRF(), ae, mu, c, s);
     ...
     */
    private void checkMasses(final SpacecraftState finalState, final MassProvider massModel, final double exp_Body,
