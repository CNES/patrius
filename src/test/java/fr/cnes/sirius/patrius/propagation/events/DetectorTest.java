...
public class DetectorTest {
    ...
    public final void testDetectionPropagationDelay() throws PatriusException {
        ...
        sensor.addMaskingCelestialBody(new ExtendedOneAxisEllipsoid(700E6, 0, sun1.getInertiallyOrientedFrame(), "Sun1"));
        ...
        sensor2.addMaskingCelestialBody(new ExtendedOneAxisEllipsoid(700E6, 0, sun2.getInertiallyOrientedFrame(), "Sun2"));
        ...
        d1 = new VisibilityFromStationDetector(station, null, 1, 1E-12);
    ...
    private void checkPropagation(final AbstractDetector detector1, final AbstractDetector detector2) throws PatriusException {
        ...
        detector1.setPropagationDelayType(PropagationDelayType.LIGHT_SPEED);
        ...
        detector2.setPropagationDelayType(PropagationDelayType.INSTANTANEOUS);
    ...
    private AbsoluteDate propagate(final AbstractDetector detector, final PropagationDelayType delayType,
        ...
        // Propagation, stops at first event detection
        propagator.addEventDetector(detector);
        detector.setPropagationDelayType(delayType);
