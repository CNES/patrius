...
public class ElevationDetectorTest {
    ...
    public void testAgata() throws PatriusException {
        ...
        final CheckingDetector detector =
            new CheckingDetector(MathLib.toRadians(5.0), new TopocentricFrame(point, "Gstation"));
    ...
    private static class CheckingDetector extends ElevationDetector implements PatriusFixedStepHandler {
        ...
        public void handleStep(final SpacecraftState currentState, final boolean isLast)
            ...
            try {
                ...
                final EllipsoidPoint p = shape.buildPoint(currentState.getPVCoordinates().getPosition(),
                    currentState.getFrame(), currentState.getDate(), "");
                final Vector3D subSat = new EllipsoidPoint(shape, shape.getLLHCoordinatesSystem(), p
                    .getLLHCoordinates().getLatitude(), p.getLLHCoordinates().getLongitude(), 0.0, "").getPosition();
