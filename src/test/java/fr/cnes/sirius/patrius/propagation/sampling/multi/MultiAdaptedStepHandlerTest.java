...
public class MultiAdaptedStepHandlerTest {
    ...
    public void testPropagationCopy() throws PatriusException {
        ...
        propagator.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(
            propagator.getInitialStates().get(STATE1).getMu())), STATE1);
        ...
        // Interpolators
        final List<MultiPatriusStepInterpolator> interpolators = new ArrayList<>();
        ...
        final MultiPatriusStepHandler handler = new MultiPatriusStepHandler(){
            ...
            /** Serializable UID. */
            private static final long serialVersionUID = -2384198313470711252L;
    ...
    public void testCopy() {
        ...
        final MultiPatriusStepHandler orekitStepHandler = new MultiPatriusStepHandler(){
            /** Serializable UID. */
            private static final long serialVersionUID = 800342156226005793L;
            ...
            @Override
            public void handleStep(final MultiPatriusStepInterpolator interpolator, final boolean isLast)
                throws PropagationException {
                // nothing to do
            }
        };
