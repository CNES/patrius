...
public class SpacecraftStateTest {
    ...
    public void testHashCode() throws PatriusException {
        ...
        final Map<String, double[]> addStates = new HashMap<String, double[]>();
    ...
    public void testShiftError()
                                throws ParseException, PatriusException {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testAttitudeForcesFramesConsistency() throws PatriusException {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testAttitudeEventsFramesConsistency() throws PatriusException {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testAttitudeForcesAndAdditionalStatesConsistency() throws PatriusException {
        // Test frames consistency between orbit and attitude for events computation
        final Attitude attForces =
            new Attitude(this.orbit.getDate(), this.orbit.getFrame(), Rotation.IDENTITY, Vector3D.ZERO);
        final Attitude attEvents =
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testAttitudeEventsAndAdditionalStatesConsistency() throws PatriusException {
        // Test frames consistency between orbit and attitude for events computation
        final Attitude attForces =
            new Attitude(this.orbit.getDate(), this.orbit.getFrame(), Rotation.IDENTITY, Vector3D.ZERO);
        final Attitude attEvents =
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testAttitudeAndAdditionalStatesConsistency() throws PatriusException {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testAttitudeAndAdditionalStatesConsistency2() throws PatriusException {
        // Test attitude additional state consistency
        final Map<String, double[]> addStates = new HashMap<String, double[]>();
        final Attitude att =
            new Attitude(this.orbit.getDate(), this.orbit.getFrame(), Rotation.IDENTITY, Vector3D.ZERO);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testAttitudeAndAdditionalStatesConsistency3() throws PatriusException {
        // Test attitude additional state consistency
        final Map<String, double[]> addStates = new HashMap<String, double[]>();
        new Attitude(this.orbit.getDate(), this.orbit.getFrame(), Rotation.IDENTITY, Vector3D.ZERO);
        addStates.put(AttitudeType.ATTITUDE.toString(), new double[] { 1.0, 1.0, 1.0, 1.0 });
     ...
     */
    @Test
    public void testTransformInertialToSpacecraftFrame() throws ParseException, PatriusException {
        double maxDP = 0;
        double maxDV = 0;
        double maxDA = 0;
     ...
     */
    @Test
    public void testTransformFrameToSpacecraftFrame() throws ParseException, PatriusException {
     ...
     */
    @Test
    public void testTransformInertialToLOF() throws ParseException, PatriusException {
     ...
     */
    @Test
    public void testTransformFrameToLOF() throws ParseException, PatriusException {
        final LOFType lofType = LOFType.LVLH;
        final Frame frame = FramesFactory.getGCRF();
        double maxDP = 0;
        double maxDV = 0;
    ...
    public void testEqualsAddStates() {
        ...
        final Map<String, double[]> state1 = new TreeMap<String, double[]>();
        final Map<String, double[]> state2 = new TreeMap<String, double[]>();
