...
public class CNESBugsA1036Test {
    ...
    public void testALLPROBS() throws PatriusException, IOException, ParseException {
        ...
        final EventDetector continuousDetector = new myContinuousDateDetector(evtDate);
        ...
        System.out.println("1ère tentative sur [T0  ; Tf-0.000001] => ça marche : ");
        System.out.println("mais regarder la derniere date: 2000-04-01T00:59:60.000  !!");
        ...
        System.out.println("4ème tentative sur [T0  ; Tf] (tolérances en 1e-3) : ça fonctionne... ");
        // Problème n° 2 (enlever le // pour mettre en évidence)
        ephemPropag.clearEventsDetectors();
        ephemPropag.addEventDetector(new myDiscontinuousDateDetector(60, 1e-3, evtDate));

        ephemPropag.addEventDetector(new myContinuousDateDetector(60, 1e-3, evtDate));
    ...
    public static NumericalPropagator myNumericPropag(final Orbit initialOrbit) throws PatriusException, IOException,
        ...
        final ForceModel prs = new SolarRadiationPressureCircular(sun, earth.getEquatorialRadius(), vehicle);
