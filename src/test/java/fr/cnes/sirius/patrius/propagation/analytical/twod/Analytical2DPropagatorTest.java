...
public class Analytical2DPropagatorTest {
     ...
     */
    @Test
    public void testPropagate() throws PatriusException {
     ...
     */
    @Test
    public void testPropagateWithEvents() throws PatriusException {
        ...
        final TopocentricFrame labo = new TopocentricFrame(new EllipsoidPoint(earth, earth.getLLHCoordinatesSystem(),
            MathLib.toRadians(43), MathLib.toRadians(1.5), 400, ""), "toulouse");
     ...
     */
    @Test
    public void testPropagateWithManeuverAndAttitude() throws PatriusException {
