...
public class MultiNumericalPropagatorTest {
    ...
    public final void testAddStatesExceptions() throws PatriusException {
        ...
        try {
            ...
            testOk = true;
            Assert.assertEquals(PatriusMessages.WRONG_CORRESPONDENCE_STATES_EQUATIONS.getSourceString(), e.getMessage());
        }
        Assert.assertTrue(testOk);
    ...
    private void propagateInType(final OrbitType type,
            final PositionAngle angle) throws PatriusException, IOException, ParseException {
        this.setUp();
    ...
    public final void testForcesModels() throws IOException, ParseException, PatriusException {
        ...
        final ForceModel potential = new DrozinerAttractionModel(FramesFactory.getITRF(), provider.getAe(),
                provider.getMu(), C, S);
    ...
    public final void testAttractionModel() throws IOException, ParseException, PatriusException {
        ...
        Assert.assertEquals(Utils.mu, this.multiNumericalPropagator.getNewtonianAttractionForceModel(STATE1).getMu(),
                E_14);
        ...
        Assert.assertEquals(newMu, this.multiNumericalPropagator.getNewtonianAttractionForceModel(STATE1).getMu(), E_14);
    }
    ...
    public void setUp() throws PatriusException {
        ...
        // state
        this.orbit2 = new KeplerianOrbit(a, e, i, pa, raan, w, PositionAngle.TRUE, FramesFactory.getICRF(),
                this.initialDate, this.mu);
     ...
     */
    private void checkVectors(final Vector3D expected,
