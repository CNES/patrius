...
public class MultiNumericalPropagatorTest {
    ...
    public void testEphemerisMode() throws PatriusException {
        ...
        checkVectors(pos, posMultiSat, new Vector3D(E_13, E_14, E_14));
        checkVectors(vel, velMultiSat, new Vector3D(E_14, E_14, E_14));
    ...
    public void testAttractionModel() throws IOException, ParseException, PatriusException {
        ...
        final ForceModel newtonianForce = new NewtonianAttractionModel(newMu);
        ...
        Assert
            .assertEquals(newMu, this.multiNumericalPropagator.getNewtonianAttractionForceModel(STATE1).getMu(), E_14);
    }
