...
public class MultiIntegratedEphemerisTest {
    ...
    public void testNormalKeplerIntegration() throws PatriusException {
        ...
        this.numericalPropagator.addInitialState(new SpacecraftState(this.initialOrbit, mass), STATE1);
        ...
        final BoundedPropagator invEphemeris = this.numericalPropagator.getGeneratedEphemeris(STATE1);
        ...
        final PVCoordinates pvExp =
            this.numericalPropagator.getPVCoordinates(finalDate, FramesFactory.getEME2000(), STATE1);
