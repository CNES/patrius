...
public class AnomalyDetectorTest {
     ...
     */
    @Test
    public void testAnomalyDetectorCtor1() {
     ...
     */
    @Test
    public void testAnomalyDetectorCtor2() {
     ...
     */
    @Test
    public void testAnomalyDetectorCtor3() {
     ...
     */
    @Test
    public void testTrueCircularOrbit() throws PatriusException {
     ...
     */
    @Test
    public void testFalseCircularOrbit() throws PatriusException {
     ...
     */
    @Test
    public void testEquinoctialCircularOrbit() throws PatriusException {
     ...
     */
    @Test
    public void testEquinoctialNonCircularOrbit() throws PatriusException {
     ...
     */
    @Test
    public void testOrbitTrueAnomaly() throws PatriusException {
        final double period = orbit.getKeplerianPeriod();
        final Propagator propagator = new KeplerianPropagator(orbit);
     ...
     */
    @Test
    public void testOrbitMeanAnomaly() throws PatriusException {
        final double period = orbit.getKeplerianPeriod();
        final Propagator propagator = new KeplerianPropagator(orbit);
     ...
     */
    @Test
    public void testOrbitEccentricAnomaly() throws PatriusException {
        final double period = orbit.getKeplerianPeriod();
        final Propagator propagator = new KeplerianPropagator(orbit);
