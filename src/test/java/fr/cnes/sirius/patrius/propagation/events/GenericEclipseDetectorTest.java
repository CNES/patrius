...
public class GenericEclipseDetectorTest {
    ...
    /** The Earth. */
    private static CelestialPoint earth;
     ...
     */
    @Test
    public void testGenericEclipseDetectorCtor1() throws PatriusException {
     ...
     */
    @Test
    public void testGenericEclipseDetectorCtor2() throws PatriusException {
     ...
     */
    @Test
    public void testMoonEarthEclipse() throws PatriusException {
     ...
     */
    @Test
    public void testSunEarthEclipse() throws PatriusException {
        final double period = orbit.getKeplerianPeriod();
        final Propagator propagator = new KeplerianPropagator(orbit);
        // creates the eclipse detectors overriding the eventOccurred function (the propagation does not stop when an
        // event is detected):
     ...
     */
    @Test
    public void testVenusEarthEclipse() throws PatriusException {
        final double period = orbit.getKeplerianPeriod();
        final Propagator propagator = new KeplerianPropagator(orbit);
        // creates the eclipse detectors overriding the eventOccurred function (the propagation does not stop when an
        // event is detected):
     ...
     */
    @Test
    public void testTwoSatellites() throws PatriusException {
        final double period = orbit.getKeplerianPeriod();
     ...
     */
    @Test
    public void testInertialDirection() throws PatriusException {
