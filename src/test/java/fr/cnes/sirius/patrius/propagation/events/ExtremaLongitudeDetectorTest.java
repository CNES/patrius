...
public class ExtremaLongitudeDetectorTest {
     ...
     */
    @Test
    public final void testGTOOrbitMax() throws PatriusException {
     ...
     */
    @Test
    public final void testGTOOrbitMin() throws PatriusException {
     ...
     */
    @Test
    public final void testGTOOrbitMinMax() throws PatriusException {
    ...
    public final void testConstructorAndOccured() throws PatriusException {
        ...
        Assert.assertEquals(MathLib.toRadians(14.0), propagationGeoPoint.getLongitude(), EPSILON_LONGITUDE);
     ...
     */
    @Test
    public final void testLowOrbitMinMax() throws PatriusException {
    ...
    public final void computeVerification(final Propagator propagator, final AbsoluteDate end,
        ...
        for (final LoggedEvent event : logger.getLoggedEvents()) {
            ...
            final double detectedLongitude = MathLib.toDegrees(geoPoint.getLongitude());
     ...
     */
    @Test
    public final void testConstructor2() throws PatriusException {
