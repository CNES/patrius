...
public class NadirSolarIncidenceDetectorTest {
    ...
    public void sunConstructorTest() throws PatriusException {
        ...
        final EventDetector detector3 = new NadirSolarIncidenceDetector(-0.2, earth, 0, 0, Action.CONTINUE, false,
            CelestialBodyFactory.getSun());
        // Different detector
        final EventDetector detector1 = new NadirSolarIncidenceDetector(-0.2, earth, 0, 0, Action.CONTINUE, false,
            new MeeusSun());
        // Checks
