...
public class TLETest {
    ...
    public void testFT2357() throws PatriusException {
        // Test 7th character
        String line1 = "1 37820O 11053A   18027.60500207  .00000000  00000-0  13127-3 2  0000";
    ...
    public void testSymmetry() throws PatriusException {
        this.checkSymmetry("1 27421U 02021A   02124.48976499 -.00021470  00000-0 -89879-2 0    20",
                "2 27421  98.7490 199.5121 0001333 133.9522 226.1918 14.26113993    62");
        this.checkSymmetry("1 31928U 98067BA  08269.84884916  .00114257  17652-4  13615-3 0  4412",
                "2 31928  51.6257 175.4142 0001703  41.9031 318.2112 16.08175249 68368");
    }

    private void checkSymmetry(final String line1, final String line2) throws PatriusException {
    ...
    public void testBug74() throws PatriusException {
        this.checkSymmetry("1 00001U 00001A   12026.45833333 2.94600864  39565-9  16165-7 1    12",
                "2 00001 627.0796  94.4522 0000000 264.9662   0.4817  0.00000000    12");
    }

    @Test
    public void testBug77() throws PatriusException {
        this.checkSymmetry("1 05555U 71086J   12026.96078249 -.00000004  10000-8  01234-9 0  9081",
    ...
    @Test
    public void testSatCodeCompliance() throws IOException, PatriusException, ParseException {
    ...
    public void testSerialization() {
        ...
        try {
            ...
            for (final TLE tle : TLEs) {
                ...
                this.assertEqualsTLE(tle, tlebis);
    ...
    private void assertEqualsTLE(final TLE tle1, final TLE tle2) {
