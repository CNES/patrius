...
public class EventsDetectionBoundsTest {
     ...
     */
    @Test
    public void testNumericalPropagatorDP853Integrator() throws PatriusException {
     ...
     */
    @Test
    public void testNumericalPropagatorClassicalRKIntegrator() throws PatriusException {
     ...
     * @throws PatriusException
     */
    public Propagator buildNumericalPropagator(final FirstOrderIntegrator integrator) throws PatriusException {
