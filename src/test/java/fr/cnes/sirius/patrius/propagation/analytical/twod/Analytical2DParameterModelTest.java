...
public class Analytical2DParameterModelTest {
    ...
    public void setup() {
        ...
        this.model = new Analytical2DParameterModel(new DatePolynomialFunction(this.ref, new PolynomialFunction(poly)),
            trig);
    }
    ...
    public void testAnalytical2DParameterModel() {
        ...
        try {
            new Analytical2DParameterModel(new DatePolynomialFunction(new AbsoluteDate(), new PolynomialFunction(
    ...
    public void testGetters() {
        ...
        Assert.assertEquals(3, ((DatePolynomialFunction) this.model.getCenteredModel()).getCoefficients().length);
        Assert.assertEquals(1., ((DatePolynomialFunction) this.model.getCenteredModel()).getCoefficients()[0]);
        Assert.assertEquals(.5, ((DatePolynomialFunction) this.model.getCenteredModel()).getCoefficients()[1]);
        Assert.assertEquals(.3, ((DatePolynomialFunction) this.model.getCenteredModel()).getCoefficients()[2]);
