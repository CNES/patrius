...
public class AdaptedMonoMultiEventDetectorTest {
    ...
    public void setUpBeforeClass() throws PatriusException {
        ...
        muMap = new HashMap<String, Double>();
        muMap.put(STATE1, mu);
        ...
        states = new HashMap<String, SpacecraftState>();
    ...
    public final void testAdaptedMonoEventDetectorGError() {
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedMultiEventDetectorGError() {
        final MultiStateVectorInfo stateVectorInfo = new MultiStateVectorInfo(states, muMap, frameMap);
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedMonoEventDetectorEventOccuredError() {
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedMultiEventDetectorEventOccuredError() {
        final MultiStateVectorInfo stateVectorInfo = new MultiStateVectorInfo(states, muMap, frameMap);
        final CrashingMultiEventDetector crashEdMulti = new CrashingMultiEventDetector();
        final AdaptedMultiEventDetector multiDetector = new AdaptedMultiEventDetector(crashEdMulti,
            tISSOrbit.getType(), PositionAngle.MEAN, attitudeLawMap,
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedMonoEventDetectorResetStateError() {
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedMultiEventDetectorResetStateError() {
        final MultiStateVectorInfo stateVectorInfo = new MultiStateVectorInfo(states, muMap, frameMap);
        final double[] bogusY = { 0.1, 0.2, 0.3, 0.7, 0.4, 0.1, 0.6 };
        final CrashingMultiEventDetector crashEdMulti = new CrashingMultiEventDetector();
        final AdaptedMultiEventDetector multiDetector = new AdaptedMultiEventDetector(crashEdMulti,
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedMonoEventDetectorInitError() {
     ...
     */
    @Test(expected = PatriusExceptionWrapper.class)
    public final void testAdaptedMultiEventDetectorInitError() {
     ...
     */
    @Test
    public final void testAdaptedMonoEventDetectorResetState() {
     ...
     */
    @Test
    public final void testMultiAbstractDetector() throws PatriusException {
