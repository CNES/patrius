...
public class PartialDerivativesTest {
    ...
    /**
     * CHeck that returned Jacobian at initialization is identity even if propagation frame is different from state frame.
    ...
    public void testFT2902() throws PatriusException {
        ...
        Orbit orbitITRF = OrbitType.CARTESIAN.convertOrbit(orbitGcrf, FramesFactory.getITRF()); 
        ...
        SpacecraftState propState = prop.propagate(AbsoluteDate.J2000_EPOCH); 

        // Check matrix is identity
        double[][] res = mapper1.getStateJacobian(propState);
