...
public class TLESeriesTest {
    ...
    @Test(expected = PatriusException.class)
    public void testNoTopexPoseidonNumber() throws PatriusException {
        final TLESeries series = new TLESeries("^spot-5\\.tle$", false);
        series.loadTLEData(22076);
    }

    @Test(expected = PatriusException.class)
    public void testNoTopexPoseidonLaunchElements() throws PatriusException {
        final TLESeries series = new TLESeries("^spot-5\\.tle$", false);
        series.loadTLEData(1992, 52, "A");
    }

    @Test
    public void testAvailableSatNums() throws PatriusException {
        final int[] refIds = {
    ...
    @Test
    public void testSpot5Available() throws PatriusException {
        final TLESeries series = new TLESeries("^spot-5\\.tle$", false);
        final Set<Integer> available = series.getAvailableSatelliteNumbers();
    ...
    @Test
    public void testSpot5WithExtraLines() throws PatriusException {
    ...
    @Test
    public void testPVStart() throws PatriusException {
        final TLESeries series = new TLESeries("^spot-5\\.tle$", false);
        series.loadTLEData();
    ...
    @Test
    public void testPVEnd() throws PatriusException {
    ...
    @Test
    public void testSpot5() throws PatriusException {
    ...
    @Test
    public void testProp() throws PatriusException {
