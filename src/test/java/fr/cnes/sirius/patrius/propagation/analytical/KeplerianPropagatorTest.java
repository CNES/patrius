...
public class KeplerianPropagatorTest {
    ...
    public void sameDateCartesian() throws PatriusException {
        ...
        // -----------------------
        final KeplerianPropagator extrapolator = new KeplerianPropagator(this.initialOrbitPV, null,
            this.initialOrbitPV.getMu(), DEFAULT_MASS);
        ...
        Assert.assertEquals(n * delta_t, finalOrbit.getLM() - this.initialOrbitPV.getLM(),
            Utils.epsilonTest * MathLib.abs(n * delta_t));
        Assert.assertEquals(
            MathUtils.normalizeAngle(finalOrbit.getLM(), this.initialOrbitPV.getLM()),
            this.initialOrbitPV.getLM(),
            Utils.epsilonAngle * MathLib.abs(this.initialOrbitPV.getLM()));

        Assert.assertEquals(finalOrbit.getA(), this.initialOrbitPV.getA(), Utils.epsilonTest
                * this.initialOrbitPV.getA());
        Assert.assertEquals(finalOrbit.getE(), this.initialOrbitPV.getE(), Utils.epsilonE
                * this.initialOrbitPV.getE());
        Assert.assertEquals(
            MathUtils.normalizeAngle(finalOrbit.getI(), this.initialOrbitPV.getI()),
    ...
    public void sameDateKeplerian() throws PatriusException {
        ...
        final AttitudeProvider inertial = new ConstantAttitudeLaw(FramesFactory.getEME2000(),
            Rotation.IDENTITY);
        final KeplerianPropagator extrapolator = new KeplerianPropagator(initialOrbit,
            bodyCenterPointing, inertial, this.mu, massModel);
        ...
        // Check attitude
        final Attitude expAttForces = bodyCenterPointing.getAttitude(initialOrbit,
        ...
        Assert.assertEquals(expAttForces.getRotation().getQi()[0], actualAttForces.getRotation()
            .getQi()[0], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert.assertEquals(expAttForces.getRotation().getQi()[1], actualAttForces.getRotation()
            .getQi()[1], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert.assertEquals(expAttForces.getRotation().getQi()[2], actualAttForces.getRotation()
            .getQi()[2], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert.assertEquals(expAttForces.getRotation().getQi()[3], actualAttForces.getRotation()
            .getQi()[3], Precision.DOUBLE_COMPARISON_EPSILON);
        ...
        Assert.assertEquals(expAttEvents.getRotation().getQi()[0], actualAttEvents.getRotation()
            .getQi()[0], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert.assertEquals(expAttEvents.getRotation().getQi()[1], actualAttEvents.getRotation()
            .getQi()[1], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert.assertEquals(expAttEvents.getRotation().getQi()[2], actualAttEvents.getRotation()
            .getQi()[2], Precision.DOUBLE_COMPARISON_EPSILON);
        Assert.assertEquals(expAttEvents.getRotation().getQi()[3], actualAttEvents.getRotation()
            .getQi()[3], Precision.DOUBLE_COMPARISON_EPSILON);
    ...
    public void propagatedCartesian() throws PatriusException {
        ...
        // -----------------------
        final KeplerianPropagator extrapolator = new KeplerianPropagator(initialOrbit,
            new ConstantAttitudeLaw(FramesFactory.getEME2000(), Rotation.IDENTITY), mu);
        ...
        Assert.assertEquals(finalOrbit.getA(), initialOrbit.getA(), Utils.epsilonTest
                * initialOrbit.getA());
        Assert.assertEquals(finalOrbit.getEquinoctialEx(), initialOrbit.getEquinoctialEx(),
            Utils.epsilonE);
        Assert.assertEquals(finalOrbit.getEquinoctialEy(), initialOrbit.getEquinoctialEy(),
            Utils.epsilonE);
    ...
    public void testException() throws PropagationException {
        ...
        multiplexer.add(new PatriusStepHandler(){
            ...
            public void
                ...
                if (isLast) {
                    throw new PropagationException((Throwable) null, new DummyLocalizable(
                        "dummy error"));
                }
            }
        });
    ...
    public void ascendingNode() throws PatriusException {
        final AttitudeProvider bodyCenterPointing = new BodyCenterPointing(FramesFactory.getGCRF());
        final AttitudeProvider inertial = new ConstantAttitudeLaw(FramesFactory.getEME2000(),
            (new Rotation(true, 0.1, 0.2, 0.4, 0.1)));

        final KeplerianOrbit orbit = new KeplerianOrbit(7.8e6, 0.032, 0.4, 0.1, 0.2, 0.3,
            PositionAngle.TRUE, FramesFactory.getEME2000(), AbsoluteDate.J2000_EPOCH,
            3.986004415e14);
        final KeplerianPropagator propagator = new KeplerianPropagator(orbit, bodyCenterPointing,
            inertial);
    ...
    public void testRemoveDetector() throws PatriusException {
        ...
        final KeplerianOrbit orbit = new KeplerianOrbit(7.8e6, 0.032, 0.4, 0.1, 0.2, 0.3,
            PositionAngle.TRUE, FramesFactory.getEME2000(), initDate, 3.986004415e14);
    ...
    public void altitude() throws PatriusException {
        final KeplerianOrbit orbit = new KeplerianOrbit(7.8e6, 0.032, 0.4, 0.1, 0.2, 0.3,
            ...
            3.986004415e14);
        final KeplerianPropagator propagator = new KeplerianPropagator(orbit);
        final EllipsoidBodyShape bodyShape = new OneAxisEllipsoid(6378137.0, 1.0 / 298.257222101,
            FramesFactory.getITRF());
        final AltitudeDetector detector = new AltitudeDetector(1500000, bodyShape,
            0.05 * orbit.getKeplerianPeriod(), AbstractDetector.DEFAULT_THRESHOLD);
        ...
        final EllipsoidPoint ep = bodyShape.buildPoint(propagated.getPVCoordinates().getPosition(),
            propagated.getFrame(), propagated.getDate(), "");
        Assert.assertEquals(1500000, ep.getLLHCoordinates().getHeight(), 0.1);
    }
    ...
    public void variableStepHyperbolic() throws PatriusException {
        final KeplerianOrbit orbit = new KeplerianOrbit(-7.8e6, 1.1, 0.4, 0.1, 0.2, 0.3,
            PositionAngle.TRUE, FramesFactory.getEME2000(), AbsoluteDate.J2000_EPOCH,
            3.986004415e14);
        final KeplerianPropagator propagator = new KeplerianPropagator(orbit);
    ...
    public void testIssue14() throws PatriusException {
        ...
        final KeplerianOrbit initialOrbit = new KeplerianOrbit(7.8e6, 0.032, 0.4, 0.1, 0.2, 0.3,
            PositionAngle.TRUE, FramesFactory.getEME2000(), initialDate, 3.986004415e14);
        final KeplerianPropagator propagator = new KeplerianPropagator(initialOrbit);

        propagator.setEphemerisMode();
        propagator.propagate(initialDate.shiftedBy(initialOrbit.getKeplerianPeriod()));
        final PVCoordinates pv1 = propagator.getPVCoordinates(initialDate,
            FramesFactory.getEME2000());

        propagator.setEphemerisMode();
        propagator.propagate(initialDate.shiftedBy(initialOrbit.getKeplerianPeriod()));
        final PVCoordinates pv2 = propagator.getGeneratedEphemeris().getPVCoordinates(initialDate,
            FramesFactory.getEME2000());

        // Check PV1 = PV2
        Assert.assertEquals(0.0, pv1.getPosition().subtract(pv2.getPosition()).getNorm()
                / pv1.getPosition().getNorm(), 1.0e-15);
        Assert.assertEquals(0.0, pv1.getVelocity().subtract(pv2.getVelocity()).getNorm()
                / pv1.getVelocity().getNorm(), 1.0e-15);
    }
     ...
     */
    @Test
    public void testGetGeneratedEphemeris() throws PatriusException {
        // FT-478
        final Orbit orb = new KeplerianOrbit(7200000.0, 0.01, 0.0, 0.0, 0.0, 0.0,
     ...
     * 
     * @input KeplerianOrbit(7350036.7731690155, 0.01906887725038333, 1.711148611453987,
     *        -1.9818436549702414,
    ...
    public void propagatedKeplerianInTIRF() throws PatriusException {
        ...
        final Orbit initialOrbit = new KeplerianOrbit(7350036.7731690155, 0.01906887725038333,
            1.711148611453987, -1.9818436549702414, -2.0071033459669896, 0.002140087127289445,
            PositionAngle.TRUE, orbitFrame, initDate, this.mu);
        ...
        Assert.assertEquals(n * delta_t, finalOrbit.getLM() - convInitialOrbit.getLM(),
            Utils.epsilonAngle);
        ...
        final double delta = finalOrbit.getEquinoctialEx()
                * (MathLib.sin(finalOrbit.getLE()) - MathLib.sin(convInitialOrbit.getLE()))
                - finalOrbit.getEquinoctialEy()
        ...
        // the orbital elements except for Mean/True/Eccentric latitude arguments are the same
        Assert.assertEquals(finalOrbit.getA(), convInitialOrbit.getA(), Utils.epsilonTest
                * convInitialOrbit.getA());
        Assert.assertEquals(finalOrbit.getEquinoctialEx(), convInitialOrbit.getEquinoctialEx(),
            Utils.epsilonE);
        Assert.assertEquals(finalOrbit.getEquinoctialEy(), convInitialOrbit.getEquinoctialEy(),
            Utils.epsilonE);
        ...
        Assert.assertEquals(finalOrbit.getPVCoordinates().getPosition().getNorm(), finalOrbit2
     ...
     *              propagator is set in ephemeris mode without having fed before with an attitude
     *              (it is fed after).
     *              The rotation of the output spacecraft obtained is accessed after the
     *              propagation.
     * 
    ...
    public void testSetEphemerisMode() throws PatriusException {
        ...
        // Initial date
        final AbsoluteDate initialDate = new AbsoluteDate(new DateComponents(2010, 6, 4),
            new TimeComponents(12, 0, 0.), TimeScalesFactory.getTAI());
    ...
    public void testSetAttitudeProvider() throws PatriusException {
        ...
        // propagation until "endDate"
        final SpacecraftState finalState = propagator.propagate(this.initialOrbitPV.getDate()
            .shiftedBy(86400));
        ...
        // Get rotation at final date
        try {
            ephemeris.getAttitudeProviderEvents().getAttitude(finalState.getOrbit()).getRotation();
            ephemeris.getAttitudeProviderForces().getAttitude(finalState.getOrbit()).getRotation();
        } catch (final NullPointerException exception) {
            // Should never happen !
            Assert.fail();
        }
     ...
     * @throws PatriusException
     *         if an error occurs
     * @description Evaluate the keplerian propagator serialization / deserialization process.
     *
     * @testPassCriteria The keplerian propagator can be serialized and deserialized.
     */
    @Test
    public void testSerialization() throws PatriusException {
        ...
        final KeplerianPropagator extrapolator = new KeplerianPropagator(initialOrbit,
            bodyCenterPointing, inertial, this.mu, massModel);
        final KeplerianPropagator deserializedExtrapolator = TestUtils
    ...
    class MyDoubleDateDetector extends DateDetector {
        ...
        /** Serializable UID. */
        private static final long serialVersionUID = -7884343320923300130L;
