...
public class EventShifterTest {
    ...
    public void testNegNeg() throws PatriusException {
        this.propagator.addEventDetector(createRawDetector("raw increasing", "raw decreasing", 1.0e-9));
        this.propagator.addEventDetector(new EventShifter(createRawDetector("shifted increasing",
            "shifted decreasing",
            1.0e-3),
            true, -15, -20));
        this.propagator.addEventDetector(new EventShifter(createRawDetector("unshifted increasing",
    ...
    public void testIncreasingError() throws PatriusException {
        this.propagator.addEventDetector(createRawDetector("raw increasing", "raw decreasing", 2.0e-9));
        this.propagator.addEventDetector(new EventShifter(createRawDetector("-10s increasing", "-10s decreasing",
            2.0e-3),
            true, -10, -10));
        this.propagator.addEventDetector(new EventShifter(createRawDetector("-100s increasing",
            "-100s decreasing", 3.0e-2),
            true, -100, -100));
        this.propagator.addEventDetector(new EventShifter(createRawDetector("-1000s increasing",
    ...
    private EventDetector createRawDetector(final String nameIncreasing, final String nameDecreasing,
        ...
        return new EclipseDetector(CelestialBodyFactory.getSun(), this.sunRadius,
            ...
            /** Serializable UID. */
            private static final long serialVersionUID = 1971663809651306821L;
