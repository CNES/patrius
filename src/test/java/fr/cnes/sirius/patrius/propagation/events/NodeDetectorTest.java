...
public class NodeDetectorTest {
    ...
    public final void testEventOccurred() throws PatriusException {
        ...
        Assert.assertEquals(Action.STOP, detector2.getActionAtAscending());
        Assert.assertEquals(Action.STOP, detector2.getActionAtDescending());
        Assert.assertEquals(false, detector2.removeAtAscending());
        Assert.assertEquals(false, detector2.removeAtDescending());
