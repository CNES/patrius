...
public class DifferentialOrbitConverterTest extends AbstractTLEFitterTest {
    ...
    public void testConversionGeoPositionVelocity() throws PatriusException {
        this.checkFit(this.getGeoTLE(), 86400, 300, 1.0e-3, false, false, 1.234e-7);
    }

    @Test
    public void testConversionGeoPositionOnly() throws PatriusException {
        this.checkFit(this.getGeoTLE(), 86400, 300, 1.0e-3, true, false, 1.213e-7);
    }
    ...
    public void testConversionLeoPositionVelocityWithBStar() throws PatriusException {
        this.checkFit(this.getLeoTLE(), 86400, 300, 1.0e-3, false, true, 2.154e-5);
    }
