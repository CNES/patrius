...
public class PVCoordinatesTest {
    ...
    public void testLinearConstructors() {
        ...
        checkPV(new PVCoordinates(5, pv4), new PVCoordinates(4, pv1, 3, pv2, 2, pv3, 1, pv4),
                1.0e-15);
    }
    ...
    public void testNormalize() {
        ...
        for (int i = 0; i < 200; ++i) {
            ...
            final DerivativeStructure x =
                ...
                /** Serializable UID. */
                private static final long serialVersionUID = 1246362172921982154L;
            ...
            final DerivativeStructure y =
                differentiator.differentiate(new UnivariateFunction(){
                /** Serializable UID. */
                private static final long serialVersionUID = 5233791565120655994L;
            ...
            final DerivativeStructure z =
                differentiator.differentiate(new UnivariateFunction(){
                /** Serializable UID. */
                private static final long serialVersionUID = 1683511226850593042L;
    ...
    public void testCrossProduct() {
        ...
        for (int i = 0; i < 200; ++i) {
            ...
            final DerivativeStructure x =
                differentiator.differentiate(new UnivariateFunction(){
                /** Serializable UID. */
                private static final long serialVersionUID = -5302669204340569L;
            ...
            final DerivativeStructure y =
                differentiator.differentiate(new UnivariateFunction(){
                /** Serializable UID. */
                private static final long serialVersionUID = 9100149724647088745L;
            ...
            final DerivativeStructure z =
                differentiator.differentiate(new UnivariateFunction(){
                /** Serializable UID. */
                private static final long serialVersionUID = -1798821916914514489L;
    ...
    public void testNegate() {
        ...
        final PVCoordinates pvNegate =
            new PVCoordinates(new Vector3D(-1, -0.1, -10), new Vector3D(1, 0.1, 10), new Vector3D(-1, -2, 3));
        checkPV(pv.negate(), pvNegate, 1.0e-15);
    }
    ...
    public void testSerialization() {
        ...
        for (int i = 0; i < 500; ++i) {
            ...
            PVCoordinates pvC1 = randomPVCoordinates(generator, 1.0, 1.0, 1.0);
            PVCoordinates pvC2 = TestUtils.serializeAndRecover(pvC1);
            assertEqualsPVCoordinates(pvC2, pvC1);

            pvC1 = randomPVCoordinates(generator, 1e6, 1e3, 1.0);
    ...
    private static void checkPV(final PVCoordinates expected, final PVCoordinates real,
