...
public class TimeStampedPVCoordinatesTest {
    ...
    public void testInterpolatePolynomialPVA() {
        ...
        for (int i = 0; i < 20; ++i) {
            ...
            final PolynomialFunction pxDot = px.derivative();
            final PolynomialFunction pyDot = py.derivative();
            final PolynomialFunction pzDot = pz.derivative();
            final PolynomialFunction pxDotDot = pxDot.derivative();
            final PolynomialFunction pyDotDot = pyDot.derivative();
            final PolynomialFunction pzDotDot = pzDot.derivative();
