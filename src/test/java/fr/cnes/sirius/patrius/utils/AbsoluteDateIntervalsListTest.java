...
public class AbsoluteDateIntervalsListTest {
     ...
     */
    @Test
    public void testAbsoluteDateIntervalsList() {
     ...
     */
    @Test
    public void testGetIntervalsContainingDate() throws PatriusException {
        // The AbsoluteDateIntervalsList is created:
        final AbsoluteDateIntervalsList list = new AbsoluteDateIntervalsList();
     ...
     */
    @Test
    public void testOrderIntervalsInTheList() throws PatriusException {
     ...
     */
    @Test
    public void testGetInclusiveInterval() throws PatriusException {
        // set up the dates:
        // set up the time intervals to add;
        final AbsoluteDateInterval i1 = new AbsoluteDateInterval(this.closed, date1, date2, this.closed);
     ...
     */
    @Test
    public void testGetComplementaryIntervals() throws PatriusException {
        // set up the dates:
        // set up the time intervals to add;
        final AbsoluteDateInterval i1 = new AbsoluteDateInterval(this.closed, date1, date2, this.closed);
