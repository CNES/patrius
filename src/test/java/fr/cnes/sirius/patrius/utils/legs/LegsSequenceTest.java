...
public class LegsSequenceTest {
    ...
    public final void testToPrettyStringLegsSequence() throws PatriusException {
        ...
        final LegsSequence emptyLegsSequence = new LegsSequence<Leg>() {
            ...
            @Override
            public Leg current(TimeStamped t) {
                return null;
            }
            ...
            @Override
            public Set<Leg> simultaneous(Leg leg) {
                return null;
            }
            ...
            @Override
            public LegsSequence<Leg> head(Leg toLeg) {
                return null;
            }

            @Override
            public LegsSequence<Leg> tail(Leg fromLeg) {
                return null;
            }

            @Override
            public LegsSequence<Leg> sub(Leg fromLeg,
                    Leg toLeg) {
                return null;
            }

            @Override
            public LegsSequence<Leg> sub(AbsoluteDate fromT,
                    AbsoluteDate toT,
                    boolean strict) {
                return null;
            }
            ...
            @Override
            public LegsSequence<Leg> sub(AbsoluteDateInterval interval,
                    boolean strict) {
                return null;
            }

            @Override
            public LegsSequence<Leg> head(AbsoluteDate toT,
                    boolean strict) {
                return null;
            }

            @Override
            public LegsSequence<Leg> tail(AbsoluteDate fromT,
                    boolean strict) {
                return null;
            }

            @Override
            public boolean isEmpty(AbsoluteDate date,
                    AbsoluteDate end) {
                return false;
            }
            ...
            @Override
            public LegsSequence<Leg> copy(AbsoluteDateInterval newInterval,
                    boolean strict) {
                return null;
            }
        };
        ...
        // New legs sequence
        final LegsSequence legsSequence = new LegsSequence<Leg>() {
