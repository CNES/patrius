...
public class PatriusMessagesTest {
     ...
     */
    @Test
    public final void testAllKeysPresentInPropertiesFiles() {
     ...
     */
    @Test
    public final void testNoMissingFrenchTranslation() {
        for (final PatriusMessages message : PatriusMessages.values()) {
     ...
     */
    @Test
    public final void testNoMissingEnglishTranslation() {
        for (final PatriusMessages message : PatriusMessages.values()) {
     ...
     */
    @Test
    public final void testMissingKlingonTranslation() {
        for (final PatriusMessages message : PatriusMessages.values()) {
     ...
     */
    @Test
    public final void testGetSourceString() {
        for (final PatriusMessages message : PatriusMessages.values()) {
