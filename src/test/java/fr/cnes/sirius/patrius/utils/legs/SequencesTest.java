...
public class SequencesTest {
     ...
     */
    @Test
    public void testEmptyTimeSequence() {
        ...
        final List<Leg> collection1 = new ArrayList<>();
        ...
        final List<Leg> collection = new ArrayList<>();
        collection.add(leg1);
     ...
     */
    @Test
    public void testEmptyLegsSequence() {
        // Create an empty legs sequence
     ...
     */
    @Test
    public void testUnmodifiableLegsSequence() {
        
        // Build sequence [date1; date2] U [date2; date3] U [date3; date4]
        final StrictLegsSequence<Leg> sequenceOriginal = new StrictLegsSequence<>();
        final AbsoluteDate date1 = AbsoluteDate.J2000_EPOCH.shiftedBy(0.);
        final AbsoluteDate date2 = AbsoluteDate.J2000_EPOCH.shiftedBy(10.);
     ...
     */
    @Test
    public void testUnmodifiableTimeSequence() {
     ...
     */
    @Test
    public void testUnmodifiableSequence() {
        // Legs sequence
    ...
    private class LinearLeg implements Leg {
        ...
        public LinearLeg copy(final AbsoluteDateInterval newInterval) {
            return new LinearLeg(newInterval, this.a, this.b
                    + (newInterval.getLowerData().durationFrom(getTimeInterval().getLowerData())) * this.a);
        }
    }
}
