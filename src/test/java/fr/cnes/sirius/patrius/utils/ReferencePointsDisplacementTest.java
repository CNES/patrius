...
public class ReferencePointsDisplacementTest {
     ...
     */
    @Test
    public void pointCorrectionTest() throws PatriusException {
     ...
     */
    @Test
    public void testPoleTidesCorrection() throws PatriusException {
    ...
    public static void setUp() throws PatriusException {
        ...
        final JPLCelestialBodyLoader loaderSun = new JPLCelestialBodyLoader(fileName,
            EphemerisType.SUN);

        final JPLCelestialBodyLoader loaderMoon = new JPLCelestialBodyLoader(fileName,
            EphemerisType.MOON);
