...
public class TopocentricPVTest {
    ...
    public void testEqualsAndHashCode() {
        ...
        // New instance
        final TopocentricPV instance = new TopocentricPV(0.1, 0.5, 2., 1.3, 1.2, 0.3);
        ...
        TopocentricPV other = new TopocentricPV(0.1, 0.5, 2., 1.3, 1.2, 0.3);
        ...
        // Different elevation
        other = new TopocentricPV(1., 0.5, 2., 1.3, 1.2, 0.3);
        ...
        // Different azimuth
        other = new TopocentricPV(0.1, 1., 2., 1.3, 1.2, 0.3);
        ...
        // Different range
        other = new TopocentricPV(0.1, 0.5, 1., 1.3, 1.2, 0.3);

        Assert.assertFalse(instance.equals(other));
        Assert.assertFalse(other.equals(instance));
        Assert.assertFalse(instance.hashCode() == other.hashCode());

        // Different elevation rate
        other = new TopocentricPV(0.1, 0.5, 2., 1., 1.2, 0.3);

        Assert.assertFalse(instance.equals(other));
        Assert.assertFalse(other.equals(instance));
        Assert.assertFalse(instance.hashCode() == other.hashCode());

        // Different azimuth rate
        other = new TopocentricPV(0.1, 0.5, 2., 1.3, 1., 0.3);
        ...
        other = new TopocentricPV(0.1, 0.5, 2., 1.3, 1.2, 1.);
    ...
    public void testSerialization() {
        final TopocentricPV topo = new TopocentricPV(0.1, 0.5, 2., 1.3, 1.2, 0.3);
        final TopocentricPV deserializedTopo = TestUtils.serializeAndRecover(topo);
