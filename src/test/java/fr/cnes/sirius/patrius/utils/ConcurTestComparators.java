 ...
 * @author cardosop
 * 
 * @version $Id: ConcurTestComparators.java 17918 2017-09-11 13:04:41Z bignon $
 * 
 * @since 1.1
 * 
 */
public class ConcurTestComparators {
     ...
     * 
     * @testedMethod {@link Comparators#equals}
     * 
     ...
     * @testedFeature {@link features#DOUBLES_COMPARISONS}
     * 
     * @testedMethod {@link Comparators#lowerOrEqual}
     * 
     ...
     */
    @Test(invocationCount = NUMBER_OF_INVOCATIONS, threadPoolSize = NUMBER_OF_THREADS, timeOut = TIMEOUT)
    public void testLowerOrEqualDoubleDouble() {
        // nominal cases : two real doubles
     ...
     */
    @Test(invocationCount = NUMBER_OF_INVOCATIONS, threadPoolSize = NUMBER_OF_THREADS, timeOut = TIMEOUT)
    public void testGreaterOrEqualDoubleDouble() {
        // nominal cases : two real doubles
     ...
     */
    @Test(invocationCount = NUMBER_OF_INVOCATIONS, threadPoolSize = NUMBER_OF_THREADS, timeOut = TIMEOUT)
    public void testLowerStrictDoubleDouble() {
        // nominal cases : two real doubles
     ...
     */
    @Test(invocationCount = NUMBER_OF_INVOCATIONS, threadPoolSize = NUMBER_OF_THREADS, timeOut = TIMEOUT)
    public void testGreaterStrictDoubleDouble() {
        // nominal cases : two real doubles
     ...
     */
    @Test(invocationCount = NUMBER_OF_INVOCATIONS, threadPoolSize = NUMBER_OF_THREADS, timeOut = TIMEOUT)
    public void testLowerOrEqualDoubleDoubleDouble() {
        final double eps = 1.0e-14;
        // nominal cases : two real doubles
     ...
     */
    @Test(invocationCount = NUMBER_OF_INVOCATIONS, threadPoolSize = NUMBER_OF_THREADS, timeOut = TIMEOUT)
    public void testGreaterOrEqualDoubleDoubleDouble() {
        final double eps = 1.0e-14;
        // nominal cases : two real doubles
     ...
     */
    @Test(invocationCount = NUMBER_OF_INVOCATIONS, threadPoolSize = NUMBER_OF_THREADS, timeOut = TIMEOUT)
    public void testLowerStrictDoubleDoubleDouble() {
        final double eps = 1.0e-14;
        // nominal cases : two real doubles
     ...
     */
    @Test(invocationCount = NUMBER_OF_INVOCATIONS, threadPoolSize = NUMBER_OF_THREADS, timeOut = TIMEOUT)
    public void testGreaterStrictDoubleDoubleDouble() {
        final double eps = 1.0e-14;
        // nominal cases : two real doubles
