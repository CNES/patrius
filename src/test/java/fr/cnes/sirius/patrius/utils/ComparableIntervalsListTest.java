...
public class ComparableIntervalsListTest {
    ...
    static {
        interval00 = new ComparableInterval<Double>(OPN, -100.0, +100.0, OPN);
        interval01 = new ComparableInterval<Double>(OPN, neginf, -900.0, OPN);
        interval02 = new ComparableInterval<Double>(OPN, +900.0, posinf, OPN);
        interval03 = new ComparableInterval<Double>(CLS, -700.0, -200.0, CLS);
        interval04 = new ComparableInterval<Double>(CLS, +200.0, +700.0, CLS);
        interval05 = new ComparableInterval<Double>(OPN, -900.0, -500.0, OPN);
        interval06 = new ComparableInterval<Double>(OPN, +500.0, +900.0, OPN);
        interval07 = new ComparableInterval<Double>(OPN, -050.0, +000.0, OPN);
        interval08 = new ComparableInterval<Double>(OPN, +000.0, +050.0, OPN);
    }
    ...
    public void testInclusiveInterval() {
        ...
        expected = new ComparableInterval<Double>(OPN, neginf, posinf, OPN);
        ...
        computed = initial.getInclusiveInterval();
        expected = new ComparableInterval<Double>(CLS, -700.0, +100.0, OPN);
        ...
        computed = initial.getInclusiveInterval();
        expected = new ComparableInterval<Double>(OPN, -900.0, -200.0, CLS);
        ...
        computed = initial.getInclusiveInterval();
        expected = new ComparableInterval<Double>(OPN, -100.0, +100.0, OPN);
    ...
    public void testOverlaps() {
        ...
        interval = new ComparableInterval<Double>(CLS, -40.0, +40.0, CLS);
        assertTrue(intervals.overlaps(interval));

        // Interval is overlapping (on the upper bound side)
        interval = new ComparableInterval<Double>(CLS, -150.0, -50.0, CLS);
        assertTrue(intervals.overlaps(interval));

        // Interval is overlapping (on the lower bound side)
        interval = new ComparableInterval<Double>(CLS, +50.0, +150.0, CLS);
        assertTrue(intervals.overlaps(interval));

        // Interval is not overlapping
        interval = new ComparableInterval<Double>(CLS, -180.0, -120.0, CLS);
        assertTrue(!intervals.overlaps(interval));

        // Interval is not overlapping, but is connected to another interval
        interval = new ComparableInterval<Double>(CLS, -200.0, -100.0, CLS);
        assertTrue(intervals.overlaps(interval));

        // Interval is almost connected, but its endpoint is open
        interval = new ComparableInterval<Double>(OPN, -200.0, -100.0, OPN);
        assertTrue(!intervals.overlaps(interval));
    }
    ...
    public void testIncludes() {
        ...
        interval = new ComparableInterval<Double>(CLS, +20.0, +40.0, CLS);
        ...
        interval = new ComparableInterval<Double>(CLS, -120.0, +0.0, CLS);
        assertTrue(!intervals.includes(interval));

        // Interval is not included, but is connected
        interval = new ComparableInterval<Double>(CLS, -200.0, -120.0, CLS);
        assertTrue(!intervals.includes(interval));

        // Interval is not included, is almost connected, but endpoint is open
        interval = new ComparableInterval<Double>(OPN, -200.0, -120.0, CLS);
        assertTrue(!intervals.includes(interval));
    }
    ...
    public void testMerging() {
        ...
        expected.clear();
        expected.add(new ComparableInterval<Double>(OPN, neginf, -900.0, OPN));
        expected.add(new ComparableInterval<Double>(OPN, -900.0, -200.0, CLS));
        expected.add(new ComparableInterval<Double>(OPN, -100.0, +100.0, OPN));
        expected.add(new ComparableInterval<Double>(CLS, +200.0, +900.0, OPN));
        expected.add(new ComparableInterval<Double>(OPN, +900.0, posinf, OPN));
    ...
    public void testIntersection() {
        ...
        interval = new ComparableInterval<Double>(CLS, -90.0, -80.0, CLS);
        ...
        interval = new ComparableInterval<Double>(CLS, -150.0, -70.0, CLS);
        computed = intervals.getIntersectionWith(interval);

        expected.clear();
        expected.add(new ComparableInterval<Double>(OPN, -100.0, -70.0, CLS));
        ...
        expected.clear();
        expected.add(new ComparableInterval<Double>(CLS, -200.0, -200.0, CLS));
        ...
        interval = new ComparableInterval<Double>(CLS, -20.0, +20.0, CLS);
        computed = intervals.getIntersectionWith(interval);

        expected.clear();
        expected.add(new ComparableInterval<Double>(CLS, -20.0, +20.0, CLS));
