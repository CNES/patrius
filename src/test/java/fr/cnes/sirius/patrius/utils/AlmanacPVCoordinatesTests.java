...
public class AlmanacPVCoordinatesTests {
     ...
     */
    @Test
    public void testGetPVCoordinatesGPS() throws IOException, PatriusException {
        ...
        // Test getNativeFrame
        Assert.assertEquals(FramesFactory.getITRF(), almanacPV.getNativeFrame(null, null));
    }
     ...
     */
    @Test
    public void testGetPVCoordinatesGalileo() throws IOException, PatriusException {
    ...
    public void testSerialization() throws PatriusException {
        ...
        final AlmanacParameter almanac = new GPSAlmanacParameters(61440.0, 840, 2.217106699,
                0.4714012146E-2, 5153.604004, 2.102607542, 0.9627610967, 0.480977878,
                -0.8183198006E-8);

        final AlmanacPVCoordinates almanacPV = new AlmanacPVCoordinates(almanac, 1,
                Constants.GRS80_EARTH_MU, earthAngularVelocity);
        final AlmanacPVCoordinates deserializedAlmanacPV = TestUtils.serializeAndRecover(almanacPV);
