...
public class BentModelTest {
     ...
     * 
     * @description check an exception is thrown if associated BodyPoint is not a EllipsoidPoint
     * 
     * @testPassCriteria an exception is thrown if associated BodyPoint is not a EllipsoidPoint
     */
    @Test
