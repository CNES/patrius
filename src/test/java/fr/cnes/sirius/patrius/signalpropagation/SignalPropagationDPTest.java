...
/**
 * This test validate the {@link SignalPropagationModel} partial derivatives computation by finite
 * difference.
 *
 * @author bonitt
* HISTORY
...
* END-HISTORY
 */
public class SignalPropagationDPTest {
    ...
    /**
     * This test validate the {@link SignalPropagationModel} partial derivatives computation by
     * finite difference.
     *
     * <p>
     * The following partial derivatives are evaluated (for both EMISSION/RECEPTION cases):
     * <ul>
     * <li>The propagation time/duration derivatives wrt the emitter position</li>
     * <li>The propagation time/duration derivatives wrt the receiver position</li>
    ...
    public void derivativesTest() throws PatriusException {
        ...
        final Frame frame = FramesFactory.getCIRF(); // Different from the standard GCRF to observe
                                                     // any frame conversion eventual errors
        final CircularOrbit pvSat = new CircularOrbit(7000.0e3, 0.0, 0.0, MathLib.toRadians(45),
                0.0, MathLib.toRadians(45), PositionAngle.TRUE, frame, this.date, mu);

        // "station" initialization
        final GeodeticPoint coordinates = new GeodeticPoint(MathLib.toRadians(0.),
                MathLib.toRadians(0.), 0.);
        final ExtendedOneAxisEllipsoid earth = new ExtendedOneAxisEllipsoid(
                Constants.GRS80_EARTH_EQUATORIAL_RADIUS, Constants.GRS80_EARTH_FLATTENING,
                FramesFactory.getITRF(), "Earth");
        final TopocentricFrame pvSta = new TopocentricFrame(earth, coordinates, "topo");
        ...
        System.out.println("\n" + "Validating the dPropdPem method:");

        // Emitter = spacecraft
        System.out.println("\n" + "fixedDate: " + FixedDate.RECEPTION);
        dPropdPemValidation(pvSat, pvSta, hSatX, FixedDate.RECEPTION, frame, new double[] {
                -1.0000061458708251, 4.346132787893681E-6, 4.346132787892572E-6 }, new double[] {
                -1.0000061448663473, 4.344619810581207E-6, 4.346249625086784E-6 });
        dPropdPemValidation(pvSat, pvSta, hSatY, FixedDate.RECEPTION, frame, new double[] {
                -1.5725711329839455E-5, -0.9999888793579352, 1.1120642064720949E-5 }, new double[] {
                -1.5725381672382355E-5, -0.9999888781458139, 1.1120922863483429E-5 });
        dPropdPemValidation(pvSat, pvSta, hSatZ, FixedDate.RECEPTION, frame, new double[] {
                -5.629130339368746E-6, 3.980713007303818E-6, -0.9999960192869927 }, new double[] {
                -5.627982318401337E-6, 3.97954136133194E-6, -0.9999960195273161 });

        // Emitter = station
        System.out.println("\n" + "fixedDate: " + FixedDate.EMISSION);
        dPropdPemValidation(pvSta, pvSat, hStaX, FixedDate.EMISSION, frame, new double[] {
                -0.9999938542736637, -4.345338946070969E-6, -4.345338946072071E-6 }, new double[] {
                -0.9999938539694995, -4.342757165431976E-6, -4.344386979937553E-6 });
        dPropdPemValidation(pvSta, pvSat, hStaY, FixedDate.EMISSION, frame, new double[] {
                1.5727410864745292E-5, -1.0000111200738875, -1.1120073887498655E-5 }, new double[] {
                1.572864130139351E-5, -1.0000111209228635, -1.1120224371552467E-5 });
        dPropdPemValidation(pvSta, pvSat, hStaZ, FixedDate.EMISSION, frame, new double[] {
                5.6300263501649355E-6, -3.980713007423329E-6, -1.0000039807130074 }, new double[] {
                5.630310624837875E-6, -3.978610038757324E-6, -1.000003979774192 });

        // ---- Check the propagation time/duration derivatives wrt the receiver position ----
        System.out.println("\n\n" + "Validating the dPropdPrec method:");
        // Receiver = station
        System.out.println("\n" + "fixedDate: " + FixedDate.RECEPTION);
        dPropdPrecValidation(pvSat, pvSta, hStaX, FixedDate.RECEPTION, frame, new double[] {
                1.0000061458708251, -4.346132787893681E-6, -4.346132787892572E-6 }, new double[] {
                1.0000061446335167, -4.345551133155823E-6, -4.346249625086784E-6 });
        dPropdPrecValidation(pvSat, pvSta, hStaY, FixedDate.RECEPTION, frame, new double[] {
                1.5725711329839455E-5, 0.9999888793579352, -1.1120642064720949E-5 }, new double[] {
                1.5724916011095047E-5, 0.9999888809397817, -1.1121155694127083E-5 });
        dPropdPrecValidation(pvSat, pvSta, hStaZ, FixedDate.RECEPTION, frame, new double[] {
                5.629130339368746E-6, -3.980713007303818E-6, 0.9999960192869927 }, new double[] {
                5.627516657114029E-6, -3.97954136133194E-6, 0.9999960197601467 });

        // Receiver = spacecraft
        System.out.println("\n" + "fixedDate: " + FixedDate.EMISSION);
        dPropdPrecValidation(pvSta, pvSat, hSatX, FixedDate.EMISSION, frame, new double[] {
                0.9999938542736637, 4.345338946070969E-6, 4.345338946072071E-6 }, new double[] {
                0.9999938551336527, 4.343688488006592E-6, 4.344386979937553E-6 });
        dPropdPrecValidation(pvSta, pvSat, hSatY, FixedDate.EMISSION, frame, new double[] {
                -1.5727410864745292E-5, 1.0000111200738875, 1.1120073887498655E-5 }, new double[] {
                -1.57281756401062E-5, 1.000011119991541, 1.1120457202196121E-5 });
        dPropdPrecValidation(pvSta, pvSat, hSatZ, FixedDate.EMISSION, frame, new double[] {
                -5.6300263501649355E-6, 3.980713007423329E-6, 1.0000039807130074 }, new double[] {
                -5.630776286125183E-6, 3.978610038757324E-6, 1.0000039795413613 });
        ...
        dTpropdPemValidation(pvSat, pvSta, hSatY, FixedDate.RECEPTION, frame, 2.947288914612528E-9,
                2.947288912924506E-9);
        ...
        dTpropdPemValidation(pvSta, pvSat, hStaY, FixedDate.EMISSION, frame, -2.947372875778584E-9,
                -2.947372901296319E-9);
        ...
        dTpropdPrecValidation(pvSta, pvSat, hSatX, FixedDate.EMISSION, frame,
                1.1517310294236166E-9, 1.1517310438691197E-9);
        dTpropdPrecValidation(pvSta, pvSat, hSatY, FixedDate.EMISSION, frame, 2.947372875778584E-9,
                2.947372901296319E-9);
        ...
        dTpropdTValidation(pvSat, pvSta, hT, FixedDate.RECEPTION, 8.185611713789217E-6,
                8.185611108713076E-6);
        dTpropdTValidation(pvSat, pvSta, hT, FixedDate.EMISSION, 8.185446352397563E-6,
                8.18544574737734E-6);

        // ---- Check the propagation vector derivatives wrt time ----
        System.out.println("\n\n" + "Validating the dPropdT method:");
        dPropdTValidation(pvSat, pvSta, hT, FixedDate.RECEPTION, new double[] { 5793.470333881316,
                -3690.726294572097, -3773.0931309969556 }, new double[] { 5793.469284391031,
                -3690.725560626015, -3773.092398968991 });
        dPropdTValidation(pvSat, pvSta, hT, FixedDate.EMISSION, new double[] { 5793.729849708948,
                -3690.6051522223465, -3772.9738808105617 }, new double[] { 5793.728800130077,
                -3690.6044182954356, -3772.973148805322 });
     ...
     */
    private void dPropdPemValidation(final PVCoordinatesProvider pvEm,
            final PVCoordinatesProvider pvRec, final PVCoordinates hEm, final FixedDate fixedDate,
            final Frame analysisFrame, final double[] expectedVal, final double[] expectedRefVal)
        ...
        final SignalPropagation signal = model.computeSignalPropagation(pvEm, pvRec, this.date,
                fixedDate);
        final SignalPropagation signalPlusHEm = model.computeSignalPropagation(pvEmPlusHEm, pvRec,
                this.date, fixedDate);
        final SignalPropagation signalMinusHEm = model.computeSignalPropagation(pvEmMinusHEm,
                pvRec, this.date, fixedDate);
        ...
        if (hEmPos.getX() != 0.) {
            ...
            Assert.assertEquals(expectedVal[0], analValX, this.validityThreshold);
            Assert.assertEquals(expectedRefVal[0], numValX, this.validityThreshold);
            Assert.assertEquals(expectedVal[1], analValY, this.validityThreshold);
            Assert.assertEquals(expectedRefVal[1], numValY, this.validityThreshold);
            Assert.assertEquals(expectedVal[2], analValZ, this.validityThreshold);
            Assert.assertEquals(expectedRefVal[2], numValZ, this.validityThreshold);
        }
        if (hEmPos.getY() != 0.) {
     ...
     * @throws PatriusException if a problem occurs during PVCoodinates providers manipulations
     */
    private void dPropdPrecValidation(final PVCoordinatesProvider pvEm,
            final PVCoordinatesProvider pvRec, final PVCoordinates hRec, final FixedDate fixedDate,
            final Frame analysisFrame, final double[] expectedVal, final double[] expectedRefVal)
            throws PatriusException {
        ...
        final SignalPropagation signal = model.computeSignalPropagation(pvEm, pvRec, this.date,
                fixedDate);
        final SignalPropagation signalPlusHRec = model.computeSignalPropagation(pvEm,
                pvRecPlusHRec, this.date, fixedDate);
        final SignalPropagation signalMinusHRec = model.computeSignalPropagation(pvEm,
                pvRecMinusHRec, this.date, fixedDate);
     ...
     * @throws PatriusException if a problem occurs during PVCoodinates providers manipulations
     */
    private void dTpropdPemValidation(final PVCoordinatesProvider pvEm,
            final PVCoordinatesProvider pvRec, final PVCoordinates hEm, final FixedDate fixedDate,
            final Frame analysisFrame, final double expectedVal, final double expectedRefVal)
            throws PatriusException {
        ...
        if (hEmPos.getX() != 0.) {
            ...
            Assert.assertEquals(expectedVal, analVal, this.validityThreshold);
            Assert.assertEquals(expectedRefVal, numVal, this.validityThreshold);
        }
        if (hEmPos.getY() != 0.) {
     ...
     * @throws PatriusException if a problem occurs during PVCoodinates providers manipulations
     */
    private void dTpropdPrecValidation(final PVCoordinatesProvider pvEm,
            final PVCoordinatesProvider pvRec, final PVCoordinates hRec, final FixedDate fixedDate,
            final Frame analysisFrame, final double expectedVal, final double expectedRefVal)
            throws PatriusException {
     ...
     * @throws PatriusException if a problem occurs during PVCoodinates providers manipulations
     */
    private void dTpropdTValidation(final PVCoordinatesProvider pvEm,
            final PVCoordinatesProvider pvRec, final double hT, final FixedDate fixedDate,
            final double expectedVal, final double expectedRefVal) throws PatriusException {
        ...
        final SignalPropagation signal = model.computeSignalPropagation(pvEm, pvRec, this.date,
                fixedDate);
        final SignalPropagation signalPlusHT = model.computeSignalPropagation(pvEm, pvRec,
                this.date.shiftedBy(hT), fixedDate);
        final SignalPropagation signalMinusHT = model.computeSignalPropagation(pvEm, pvRec,
                this.date.shiftedBy(-hT), fixedDate);
     ...
     * @throws PatriusException if a problem occurs during PVCoodinates providers manipulations
     */
    private void dPropdTValidation(final PVCoordinatesProvider pvEm,
            final PVCoordinatesProvider pvRec, final double hT, final FixedDate fixedDate,
            final double[] expectedVal, final double[] expectedRefVal) throws PatriusException {
        ...
        Assert.assertEquals(expectedVal[0], analValVector.getX(), this.validityThreshold);
        Assert.assertEquals(expectedRefVal[0], numValVector.getX(), this.validityThreshold);

        Assert.assertEquals(expectedVal[1], analValVector.getY(), this.validityThreshold);
        Assert.assertEquals(expectedRefVal[1], numValVector.getY(), this.validityThreshold);

        Assert.assertEquals(expectedVal[2], analValVector.getZ(), this.validityThreshold);
        Assert.assertEquals(expectedRefVal[2], numValVector.getZ(), this.validityThreshold);
