...
public class VacuumSignalPropagationTest {
    ...
    public void tropoCorrectionTest() throws PatriusException {
        ...
        final VacuumSignalPropagationModel model = new VacuumSignalPropagationModel(EME2000Frame,
            0.001, VacuumSignalPropagationModel.DEFAULT_MAX_ITER);
        final AzoulayModel correction = new AzoulayModel(meteoConditionsProvider, altitude, false);
    ...
    public void tooFewIterationsGetSignalEmissionDatePropagationException() throws PatriusException {
        ...
        final AbsoluteDate sunDateAtEvent = VacuumSignalPropagationModel.getSignalEmissionDate(
            CelestialBodyFactory.getSun(), initialOrbit,
    ...
    public void tooFewIterationsGetSignalReceptionDatePropagationException() throws PatriusException {
        ...
        // get the signal emission date with a too small maxIterSignalPropagation (1)
        final AbsoluteDate sunDateAtEvent = VacuumSignalPropagationModel.getSignalReceptionDate(
            CelestialBodyFactory.getSun(), initialOrbit,
            AbsoluteDate.J2000_EPOCH.shiftedBy(84600.), 1E-12, PropagationDelayType.LIGHT_SPEED,
            FramesFactory.getICRF(), 1);
    }
