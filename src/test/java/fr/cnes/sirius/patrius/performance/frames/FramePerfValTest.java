...
public class FramePerfValTest {
    ...
    public void testPerfITRFtoGCRF() throws PatriusException, IOException, ParseException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (!this.equals(pv, pvRef, 0.1, 0.001)) {
     ...
     */
    private boolean equals(final PVCoordinates pv1, final PVCoordinates pv2, final double eps1, final double eps2) {
     ...
     */
    @Test
    public final void testPerfBuffer() throws PatriusException {
        ...
        final ArrayList<AbsoluteDate> dates1 = new ArrayList<AbsoluteDate>();
        for (int i = 0; i < pointNumber; i++) {
            dates1.add(new AbsoluteDate(refDate, i * gap1));
        }

        // build the series of dates outside of the buffer
        final ArrayList<AbsoluteDate> dates2 = new ArrayList<AbsoluteDate>();
        for (int i = 0; i < pointNumber; i++) {
        ...
        final ArrayList<PVCoordinates> stateVectors = new ArrayList<PVCoordinates>();
