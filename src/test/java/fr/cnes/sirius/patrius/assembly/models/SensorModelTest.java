...
public class SensorModelTest {
    ...
    public final void fieldsOfViewTest() throws PatriusException {
        ...
        final PVCoordinatesProvider mainTarget = new ConstantPVCoordinatesProvider(mainTargetCoordinates, mainFrame);
        ...
        try {
            ...
            wrongInhibitionTargets[0] = new ConstantPVCoordinatesProvider(inhibitionTargetCoordinates1, mainFrame);
        ...
        // Test getNativeFrame
        Assert.assertEquals(assembly.getPart(this.part2).getFrame(), sensorModel.getNativeFrame(null, null));
    }
    ...
    public final void measuresTest() throws PatriusException {
        ...
        PVCoordinatesProvider mainTarget = new ConstantPVCoordinatesProvider(mainTargetCoordinates, mainFrame);
    ...
    public final void lowOrbitTest1() throws PatriusException {
        ...
        final PVCoordinatesProvider mainTarget = new ConstantPVCoordinatesProvider(mainTargetCoordinates,
