...
public class CookModelValTest {
     ...
     */
    @Test
    public void cookModelValidationTest() throws PatriusException {
        ...
        builderCook.addMainPart("Main2");
        builderCook.initMainPartFrame(initialState);
        final Frame facetFrame = builderCook.getPart("Main2").getFrame();
        ...
        builderCook.addProperty(new AeroFacetProperty(facetCook, cn, ct), "Main2");
        builderCook.addProperty(new MassProperty(1000.), "Main2");
