...
public class VehicleTest {
    ...
    public void testCreationAssemblyWithFactors() throws PatriusException {
        ...
        final SolarRadiationPressure srpForce = new SolarRadiationPressure(new MeeusSun(), Constants.SUN_RADIUS,
            new DirectRadiativeModel(assembly));
        final SolarRadiationPressure srpForceMass = new SolarRadiationPressure(new MeeusSun(), Constants.SUN_RADIUS,
            new DirectRadiativeModel(assemblyMass));
        final SolarRadiationPressure srpForceSRP = new SolarRadiationPressure(new MeeusSun(), Constants.SUN_RADIUS,
    ...
    public void testPropagation() throws PatriusException {
        ...
        // Propagator
        final NumericalPropagator propagator = new NumericalPropagator(integrator, state.getFrame(),
    ...
    public SpacecraftState propagate(final boolean addSolarPanels) throws PatriusException {
        ...
        propagator.addForceModel(new DirectBodyAttraction(new NewtonianGravityModel(iniOrbit.getMu())));
