...
public class RFLinkBudgetTest {
     ...
     */
    @Test
    public void testLinkBudget() throws PatriusException {
     ...
     */
    @Test
    public void testRFVisibilityDetection() throws PatriusException {
        ...
        final EventDetector detectorZPlus = new RFVisibilityDetector(linkBudgetModelZplus, linkBudgetThreshold, 2.,
            ...
            /** Serializable UID. */
            private static final long serialVersionUID = 8885801920808534335L;
        ...
        final EventDetector detectorZMoins = new RFVisibilityDetector(linkBudgetModelZMoins, linkBudgetThreshold, 2.,
            1E-6, Action.CONTINUE, Action.CONTINUE){
            /** Serializable UID. */
            private static final long serialVersionUID = -2508189069602771029L;
    ...
    public static void setUpBeforeClass() throws PatriusException, NumberFormatException, IOException {
        ...
        final OneAxisEllipsoid earth = new OneAxisEllipsoid(0.637813600000000E+07,
            1. / 0.298257800000000E+03, FramesFactory.getITRF());

        final EllipsoidPoint point = new EllipsoidPoint(earth, earth.getLLHCoordinatesSystem(), 0.758011794744558,
            0.0261405281982074, 0.256000000000000E+03, "");
