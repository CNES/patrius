...
public class GlobalAeroModelTest {
    ...
    public enum features {
         ...
         * 
         * @coveredRequirements DM-599, DV-VEHICULE_440, DV-VEHICULE_470, DV-VEHICULE_471
         */
        GLOBAL_AERO_MODEL
    }
     ...
     */
    @Test
    public void testMath() throws PatriusException {
     ...
     */
    @Test
    public void testCase1() throws PatriusException, IOException {
     ...
     */
    @Test
    public void testCase2() throws PatriusException, IOException {
     ...
     */
    @Test
    public void testCase3() throws PatriusException, IOException {
     ...
     */
    @Test
    public void testCase3bis() throws PatriusException, IOException {
     ...
     */
    @Test
    public void testDerivatives() throws PatriusException, IOException {
        ...
        final Vector3D accMX =
            drag.computeAcceleration(shiftState(state, new Vector3D(-hPos, 0, 0), Vector3D.ZERO));
        final Vector3D accPX =
            drag.computeAcceleration(shiftState(state, new Vector3D(hPos, 0, 0), Vector3D.ZERO));
        final Vector3D accMY =
            drag.computeAcceleration(shiftState(state, new Vector3D(0, -hPos, 0), Vector3D.ZERO));
        final Vector3D accPY =
            drag.computeAcceleration(shiftState(state, new Vector3D(0, hPos, 0), Vector3D.ZERO));
        final Vector3D accMZ =
            drag.computeAcceleration(shiftState(state, new Vector3D(0, 0, -hPos), Vector3D.ZERO));
        final Vector3D accPZ =
            drag.computeAcceleration(shiftState(state, new Vector3D(0, 0, hPos), Vector3D.ZERO));

        final Vector3D accMVX =
            drag.computeAcceleration(shiftState(state, Vector3D.ZERO, new Vector3D(-hVel, 0, 0)));
        final Vector3D accPVX =
            drag.computeAcceleration(shiftState(state, Vector3D.ZERO, new Vector3D(hVel, 0, 0)));
        final Vector3D accMVY =
            drag.computeAcceleration(shiftState(state, Vector3D.ZERO, new Vector3D(0, -hVel, 0)));
        final Vector3D accPVY =
            drag.computeAcceleration(shiftState(state, Vector3D.ZERO, new Vector3D(0, hVel, 0)));
        final Vector3D accMVZ =
            drag.computeAcceleration(shiftState(state, Vector3D.ZERO, new Vector3D(0, 0, -hVel)));
     ...
     */
    @Test
    public void testException() throws PatriusException, IOException {
        ...
        builder2.addProperty(new AeroProperty(0.4, 17, new AlphaConstant(0.2)), "Main2");
        try {
     ...
     */
    @Test
    public void testWithAttitude() throws PatriusException {
        ...
        final DragCoefficientProvider provider = new DragCoefficientProvider(){
            /** Serializable UID. */
            private static final long serialVersionUID = -1510397978859308175L;
        ...
        final ExtendedAtmosphere atmosphere = new ExtendedAtmosphere(){
            /** Serializable UID. */
            private static final long serialVersionUID = -8476889193097534897L;
     ...
     */
    @Test
    public void testWithAttitude2() throws PatriusException {
        ...
        final DragCoefficientProvider provider = new DragCoefficientProvider(){
            /** Serializable UID. */
            private static final long serialVersionUID = -5550267852421154553L;
        ...
        final ExtendedAtmosphere atmosphere = new ExtendedAtmosphere(){
            /** Serializable UID. */
            private static final long serialVersionUID = -6848208767131826809L;
    ...
    private class MyDragCoefficient implements DragCoefficientProvider {
        /** Serializable UID. */
        private static final long serialVersionUID = -6831929371366409172L;
    ...
    private class MyAtmosphere implements ExtendedAtmosphere {
        /** Serializable UID. */
        private static final long serialVersionUID = -5683277307958784916L;
    ...
    private class MyAtmosphere2 implements ExtendedAtmosphere {
        /** Serializable UID. */
        private static final long serialVersionUID = -6645106140164183341L;
    ...
    private class MyAtmosphere3 implements ExtendedAtmosphere {
        /** Serializable UID. */
        private static final long serialVersionUID = -6240760319556235458L;
