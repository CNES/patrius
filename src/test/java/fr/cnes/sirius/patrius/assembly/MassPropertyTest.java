...
public class MassPropertyTest {
     ...
     */
    @Test
    public void massPropertyTest() throws PatriusException {
        Utils.clear();
    ...
    public void constructorErrorTest() throws PatriusException {
     ...
     */
    @Test(expected = PatriusException.class)
    public void updateMassErrorTest() throws PatriusException {
