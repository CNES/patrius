...
public class PropulsivePropertyTest {
     ...
     */
    @Test
    public void testPropulsiveProperty() {
        ...
        final IDependentVariable<SpacecraftState> ispFunc = new IDependentVariable<SpacecraftState>(){
            /** Serializable UID. */
            private static final long serialVersionUID = 7465098327950022155L;
        ...
        final IDependentVariable<SpacecraftState> thrustFunc = new IDependentVariable<SpacecraftState>(){
            /** Serializable UID. */
            private static final long serialVersionUID = 4743734901281187459L;
        ...
        // Test serialization
        final PropulsiveProperty prop5 = TestUtils.serializeAndRecover(prop2);
