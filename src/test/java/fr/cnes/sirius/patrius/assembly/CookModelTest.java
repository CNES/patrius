...
public class CookModelTest {
     ...
     */
    @Test
    public void testDerivableParameters() {
     ...
     */
    @Test
    public void testCookModelException() throws PatriusException {
    ...
    private class MyAtmosphere implements ExtendedAtmosphere {
        ...
        /** Serializable UID. */
        private static final long serialVersionUID = -3372895567180996993L;
