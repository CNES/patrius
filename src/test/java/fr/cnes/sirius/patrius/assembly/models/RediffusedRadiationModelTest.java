...
public class RediffusedRadiationModelTest {
    ...
    public static void setUpBeforeClass() {
        Report.printClassHeader(RediffusedRadiationModelTest.class.getSimpleName(),
            "Rediffused radiation model");
    }
     ...
     */
    @Test
    public final void radiationPressureAccelerationTest() throws PatriusException {

        Report.printMethodHeader("radiationPressureAccelerationTest",
            "Acceleration and partial derivatives computation", "Math",
        ...
        try {
            ...
            final IPartProperty radIRMainProp = new RadiativeIRProperty(kaIRMain, ksIRMain,
                kdIRMain);
            ...
            final IPartProperty radIRPartProp = new RadiativeIRProperty(kaIRPart, ksIRPart,
                kdIRPart);
            ...
            RediffusedRadiativeModel radiativeModel = new RediffusedRadiativeModel(false, false,
                k0Al, k0Ir, assembly);

            Assert.assertEquals(false, radiativeModel.getFlagAlbedo());

            radiativeModel.setAlbedoAcc(true);
            radiativeModel.setIrAcc(true);
            ...
            final ElementaryFlux flux = new ElementaryFlux(Vector3D.PLUS_I, 1, 2);
            assembly.initMainPartFrame(spacecraftState);
            final Vector3D computedAcc = radiativeModel.rediffusedRadiationPressureAcceleration(
                spacecraftState, flux);

            // Comparison
            final Vector3D expectedAcc = new Vector3D(0.39721897145366364, -0.0360528407265222206,
                0.07210568145304441);
            Assert.assertEquals(expectedAcc.getX(), computedAcc.getX(),
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(expectedAcc.getY(), computedAcc.getY(),
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(expectedAcc.getZ(), computedAcc.getZ(),
                Precision.DOUBLE_COMPARISON_EPSILON);
            ...
            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, k0Al,
                dAccdParam);
            Assert.assertEquals(0.05530178104689572, dAccdParam[0],
                Precision.DOUBLE_COMPARISON_EPSILON);
            ...
            Report.printToReport("Partial derivatives / albedo k0", new double[] {
                0.05530178104689572, 0., 0. }, dAccdParam);

            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, k0Ir,
                dAccdParam);
            Assert.assertEquals(0.25229023544594087, dAccdParam[0],
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(-0.01941456151132052, dAccdParam[1],
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(0.03882912302264104, dAccdParam[2],
                Precision.DOUBLE_COMPARISON_EPSILON);
            ...
            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, kaPart,
                dAccdParam);
            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, kaIRPart,
                dAccdParam);
            Assert.assertEquals(0.2719251895308771, dAccdParam[0],
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(-0.03904951559625673, dAccdParam[1],
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(0.07809903119251346, dAccdParam[2],
                Precision.DOUBLE_COMPARISON_EPSILON);

            Report.printToReport("Partial derivatives / ka", new double[] { 0.2719251895308771,
                -0.03904951559625673, 0.07809903119251346 }, dAccdParam);

            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, kdPart,
                dAccdParam);
            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, kdIRPart,
                dAccdParam);
            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, kdMain,
                dAccdParam);
            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, kdIRMain,
                dAccdParam);
            Assert.assertEquals(-0.17195036823004045, dAccdParam[0],
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(0.5052815383555607, dAccdParam[1],
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(-1.0105630767111213, dAccdParam[2],
                Precision.DOUBLE_COMPARISON_EPSILON);

            Report.printToReport("Partial derivatives / kd", new double[] { -0.17195036823004045,
                0.5052815383555607, -1.0105630767111213 }, dAccdParam);

            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, ksPart,
                dAccdParam);
            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, ksIRPart,
                dAccdParam);
            Assert.assertEquals(-0.15591849535301713, dAccdParam[0],
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(0.4892496654785374, dAccdParam[1],
                Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(-0.9784993309570748, dAccdParam[2],
                Precision.DOUBLE_COMPARISON_EPSILON);

            Report.printToReport("Partial derivatives / ks", new double[] { -0.15591849535301713,
                0.4892496654785374, -0.9784993309570748 }, dAccdParam);

            // derivatives with respect to state parameters
            double[][] dAccdPos = new double[3][3];
            double[][] dAccdVel = new double[3][3];
            radiativeModel.addDAccDStateRediffusedRadiativePressure(spacecraftState, dAccdPos,
                dAccdVel);
            ...
            final RediffusedRadiationPressure force = new RediffusedRadiationPressure(sun,
     ...
     */
    @Test
    public final void radiationPressureAssemblyTest() throws PatriusException {
        ...
        final RediffusedRadiationPressure rediffusedSRP = new RediffusedRadiationPressure(sun, FramesFactory.getGCRF(), 100, 100, emissivityModel, radiativeModel);

        // Attitude law: body center pointing
        final AttitudeProvider attitudeProvider = new BodyCenterPointing();

        // State 1: pos = (0, 0, 7000km)
        final Orbit orbit1 = new KeplerianOrbit(7000000, 0, FastMath.PI / 2., 0, 0, FastMath.PI / 2., PositionAngle.TRUE, FramesFactory.getGCRF(), AbsoluteDate.J2000_EPOCH, Constants.WGS84_EARTH_MU);
     ...
     */
    @Test
    public final void derivativesErrorTest() {
        ...
        try {
            ...
            final RediffusedRadiativeModel radiativeModel = new RediffusedRadiativeModel(false,
                false, k0Al, k0Ir, assembly);
            ...
            radiativeModel.addDAccDParamRediffusedRadiativePressure(spacecraftState, param,
                dAccdParam);
    ...
    public final void sphereTest() {
        ...
        try {
            ...
            final IPartProperty radMainProp = new RadiativeProperty(mainPartAbsCoef,
                mainPartSpeCoef, mainPartDifCoef);
            builder.addProperty(radMainProp, this.mainBody);
            final IPartProperty radIRMainProp = new RadiativeIRProperty(mainPartAbsCoef,
                mainPartSpeCoef, mainPartDifCoef);
            builder.addProperty(radIRMainProp, this.mainBody);
            // adding mass property
            ...
            // creation of the spacecraft with no attitude
            final SpacecraftState spacecraftState = new SpacecraftState(orbit, new Attitude(date,
                referenceFrame, Rotation.IDENTITY, Vector3D.ZERO), new MassModel(assembly));

            // radiative model
            final RediffusedRadiativeModel radiativeModel = new RediffusedRadiativeModel(true,
                false, 1, 1, assembly);
            // compute radiation pressure acceleration
            final ElementaryFlux flux = new ElementaryFlux(Vector3D.PLUS_I, 10, 20);
            assembly.initMainPartFrame(spacecraftState);
            final Vector3D computedAcc = radiativeModel.rediffusedRadiationPressureAcceleration(
                spacecraftState, flux);

            // Comparison
            Assert.assertEquals(8.901179185171081, computedAcc.getX(),
                Precision.DOUBLE_COMPARISON_EPSILON);
            ...
            Report.printToReport("Acceleration", new Vector3D(8.901179185171081, 0., 0.),
                computedAcc);
     ...
     */
    @Test
    public final void rediffusedRadiationPressureAccCylinderTest() throws PatriusException {

        Report.printMethodHeader("rediffusedRadiationPressureAccCylinderTest",
            "Acceleration computation", "Math", Precision.DOUBLE_COMPARISON_EPSILON,
        ...
        final RediffusedRadiativeModel model = new RediffusedRadiativeModel(true, false, albFact,
            0, testAssembly);
        ...
        // Elementary flux
        ElementaryFlux elemFlux = new ElementaryFlux(flux, albPress, irPress);

        // Compute radiation pressure acceleration
        Vector3D radAcc = model
            .rediffusedRadiationPressureAcceleration(shiftedBogusState, elemFlux);
        ...
        flux = toSatRotation.applyTo(flux);
        fluxSat = flux.negate();
        elemFlux = new ElementaryFlux(flux, albPress, irPress);
        ...
        // Create the Assembly
        final Assembly assemblyPanels = this.createTestAssemblyVehicleCylinderWithPanels(radius, heigh,
            mass, area, ka, kd, ks);

        // Rediffused radiative model with albedo and IR
        final RediffusedRadiativeModel modelPanels = new RediffusedRadiativeModel(true, true,
            albFact, irFact, assemblyPanels);
        ...
        final double valueForceAlbN = 2. * (-cosAngle * area * (albPress / mass))
            * (ks * cosAngle + (kd / 3.));
        ...
        final double valueForceIrN = 2. * (-cosAngle * area * (irPress / mass))
            * (ks * cosAngle + (kd / 3.));
     ...
     */
    @Test
    public final void rediffusedRadiationPressureAccParallTest() throws PatriusException {

        Report.printMethodHeader("rediffusedRadiationPressureAccParallTest",
            "Acceleration computation", "Math", Precision.DOUBLE_COMPARISON_EPSILON,
            ComparisonType.ABSOLUTE);
    ...
    public final void boxTest() {
        ...
        try {
            ...
            final SpacecraftState spacecraftState = new SpacecraftState(orbit,
                new Attitude(date, referenceFrame, new Rotation(Vector3D.PLUS_K,
                    -FastMath.PI / 2), Vector3D.ZERO), new MassModel(assembly));
            ...
            // compute radiation pressure acceleration
            final ElementaryFlux flux = new ElementaryFlux(new Vector3D(0., 0., -1.), 10, 20);
            final Vector3D computedAcc = radiativeModel.rediffusedRadiationPressureAcceleration(
                spacecraftState, flux);
            ...
            Assert.assertEquals(0., computedAcc.getY(), Precision.DOUBLE_COMPARISON_EPSILON);
            Assert.assertEquals(-1.7199999999999998, computedAcc.getZ(),
                Precision.DOUBLE_COMPARISON_EPSILON);

            Report.printToReport("Acceleration", new Vector3D(0, 0, -1.7199999999999998),
                computedAcc);
    ...
    public final void error1Test() {
        ...
        try {
            ...
            new RediffusedRadiativeModel(true,
                true, 0, 0, assembly);
            Assert.fail();
     ...
     */
    @Test
    public final void testGetJacobianParameters() throws PatriusException {
        ...
        final double k0Al = 0.568;
        final double k0Ir = 1.857;
        final RediffusedRadiativeModel radiativeModel = new RediffusedRadiativeModel(false, false,
            k0Al, k0Ir, assembly);
    ...
    private Assembly createTestAssemblyVehicleCylinderOnly(final double radius, final double heigh,
                                                           ...
                                                           final double kdIr, final double ksIr)
                                                                                                throws PatriusException {
     ...
     */
    private Assembly
            createTestAssemblyVehicleCylinderWithPanels(final double radius,
                                                        final double heigh, final double mass, final double area,
                                                        final double ka,
                                                        final double kd, final double ks) throws PatriusException {
    ...
    private Assembly createTestAssemblyVehicleParal(final double lenght, final double width,
                                                    ...
                                                    final double kd,
                                                    final double ks, final double kaIr, final double kdIr,
     ...
     */
    @Test
    public final void maneuverMassVariationTest() throws PatriusException {

        // assemblies creation
        final Assembly assembly = this.getAssembly(this.mainBody, this.part2, this.part3);
        final Assembly assemblySM = this.getAssembly("mainBodySM", "part2SM", "part3SM");
        ...
        final RediffusedRadiativeModel radiativeModel = new RediffusedRadiativeModel(false, false,
            k0Al, k0Ir, assembly);
        final RediffusedRadiativeModel radiativeModelSM = new RediffusedRadiativeModel(false,
            false, k0Al, k0Ir, assemblySM);
        radiativeModel.setAlbedoAcc(true);
        radiativeModel.setIrAcc(true);
        radiativeModelSM.setAlbedoAcc(true);
        radiativeModelSM.setIrAcc(true);

        // set up spacecraftState
        final Orbit orbit = new CircularOrbit(7200000.0, -1.0e-5, 2.0e-4, MathLib.toRadians(98.0),
            MathLib.toRadians(123.456), 0.0, PositionAngle.MEAN, FramesFactory.getEME2000(),
            new AbsoluteDate(new DateComponents(2004, 01, 01), new TimeComponents(23, 30,
                00.000), TimeScalesFactory.getUTC()), Constants.EIGEN5C_EARTH_MU);
        ...
        // compute radiation pressure acceleration
        final ElementaryFlux flux = new ElementaryFlux(Vector3D.PLUS_I, 1, 2);
        final Vector3D computedAcc = radiativeModel.rediffusedRadiationPressureAcceleration(state,
            flux);
        final Vector3D computedAccSM = radiativeModelSM.rediffusedRadiationPressureAcceleration(
            state, flux);
    ...
    private Assembly getAssembly(final String nameMain, final String namePart2,
