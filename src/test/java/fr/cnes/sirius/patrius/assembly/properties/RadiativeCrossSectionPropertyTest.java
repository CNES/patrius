...
public class RadiativeCrossSectionPropertyTest {
     ...
     */
    @Test
    public final void testRadiativeCrossSectionProperty() {
     ...
     * @testedFeature {@link features#RADIATIVE_CROSS_SECTION_PROPERTY}
     * 
     * @testedMethod {@link RadiativeCrossSectionProperty#getCrossSection(SpacecraftState, fr.cnes.sirius.patrius.frames.Frame, fr.cnes.sirius.patrius.assembly.IPart, Vector3D)}
     * 
