 ...
 * VERSION::FA:566:02/03/2016:Corrected partial derivatives computation for SRP wrt k0
...
public class RadiationModelTest {
     ...
     */
    private Assembly createAssemblySphereOnly(final double mass,
                                              final double ka,
                                              final double ks,
    ...
    private Assembly createAssemblySphereOnly(final double mass,
                                              final Parameter ka,
                                              final Parameter ks,
                                              final Parameter kd) throws PatriusException {
        final AssemblyBuilder builder = new AssemblyBuilder();
     ...
     * @throws PatriusException
     */
    private Assembly createAssemblyFacetOnly(final double mass,
                                             final double ka,
                                             final double ks,
                                             final double kd) throws PatriusException {
        final AssemblyBuilder builder = new AssemblyBuilder();
     ...
     */
    @Test
    public void illegalAssemblyTest() throws PatriusException {
        final AssemblyBuilder builder = new AssemblyBuilder();
    ...
    public void radiationPressureAccelerationTest() {
        ...
        Report.printMethodHeader("radiationPressureAccelerationTest", "Acceleration computation", "Math",
        ...
        try {
            ...
            final Vector3D computedAcc = radiativeModel.radiationPressureAcceleration(spacecraftState, flux);
            ...
            final Vector3D expectedAcc = new Vector3D(1.0 / (mainPartMass + part2Mass + massyPartMass),
            ...
            final DirectRadiativeModel radiativeModelK0 = new DirectRadiativeModel(assembly, k0_value);

            // compute radiation pressure acceleration
            final Vector3D computedAcck0 = radiativeModelK0.radiationPressureAcceleration(spacecraftState, flux);
    ...
    public void sphereTest() {
        ...
        try {
            ...
            final double mu = 0.39860043770442e+15;
            final Orbit orbit = new CartesianOrbit(pvs, FramesFactory.getGCRF(), new AbsoluteDate(), mu);
            final Attitude attitude = new Attitude(new AbsoluteDate(), FramesFactory.getGCRF(), Rotation.IDENTITY,
                Vector3D.ZERO);
            final SolarRadiationPressure srp1 = new SolarRadiationPressure(Constants.SEIDELMANN_UA, 4.56E-6, sun,
                    6.95E8,
                Constants.GRIM5C1_EARTH_EQUATORIAL_RADIUS, radiativeModel);
            final SpacecraftState sstate = new SpacecraftState(orbit, attitude);
            // compute radiation pressure acceleration
            final Vector3D computedAcc = srp1.computeAcceleration(sstate);

            // Comparison with SphericalSpacecraft model
            // final SphericalSpacecraft sphereSC = new SphericalSpacecraft(25. * FastMath.PI, 0.,
            // 0.6, 0.25, 0.0);
            // final SolarRadiationPressure srp2 = new SolarRadiationPressure(sun,
            // Constants.GRIM5C1_EARTH_EQUATORIAL_RADIUS, sphereSC);
            // compute radiation pressure acceleration
            // final Vector3D expectedAcc = srp2.computeAcceleration(sstate);
     ...
     */
    @Test
    public void radiationPressureAccCylinderTest() throws PatriusException {

        Report.printMethodHeader("radiationPressureAccCylinderTest", "Acceleration computation", "Math",
            Precision.DOUBLE_COMPARISON_EPSILON, ComparisonType.ABSOLUTE);
        ...
        // Create the Assembly
        final Assembly testAssembly = this.createTestAssemblyVehicleCylinderOnly(radius, heigh, mass, ka, ks, kd, kaIr,
            ksIr, kdIr);
        ...
        final Vector3D normalVect = new Vector3D(valueForceN, new Vector3D(-1. / MathLib.sqrt(2.), 0.,
            1. / MathLib.sqrt(2.)));
        ...
        Assert.assertEquals(testAccSat.distance(expectedAcc), 0., Precision.DOUBLE_COMPARISON_EPSILON);
     ...
     */
    @Test
    public void radiationPressureAccParalTest() throws PatriusException {

        Report.printMethodHeader("radiationPressureAccParalTest", "Acceleration computation", "Math",
            Precision.DOUBLE_COMPARISON_EPSILON, ComparisonType.ABSOLUTE);
        ...
        // Facet contribution : compute normal and tangential radiation for the facet
        final double cosAngle = MathLib.cos(3. * FastMath.PI / 4.);
        final double valueForceN = 2. * (-cosAngle * 10. * fluxNorm) * (0.25 * cosAngle - (0.25 / 3.));
     ...
     * @testedMethod {@link SolarRadiationPressure#addDAccDState(SpacecraftState, double[][], double[][])}
     *
    ...
    public void testSpherePDerivatives() throws PatriusException {
        ...
        SolarRadiationPressure srp = new SolarRadiationPressure(sun, rEquat, sc);
        SolarRadiationPressure srp1 = new SolarRadiationPressure(sun, rEquat, sc1);
        SolarRadiationPressure srp2 = new SolarRadiationPressure(sun, rEquat, sc2);
        ...
        // SRP
        srp = new SolarRadiationPressure(sun, rEquat, sc);
        srp1 = new SolarRadiationPressure(sun, rEquat, sc1);
        srp2 = new SolarRadiationPressure(sun, rEquat, sc2);
    ...
    public static void setUpBeforeClass() throws PatriusException {
        ...
        final AbsoluteDate date = new AbsoluteDate(2000, 3, 20, 8, 10, 43.93000000000029, TimeScalesFactory.getTAI());
        final Vector3D pos = new Vector3D(1.5698127651877177E+06, -4.0571199222644530E+06, 5.1323187886121357E+06);
        final Vector3D vel = new Vector3D(2.6780951868939924E+03, -5.2461908201159367E+03, -4.9566405945152592E+03);
        /*
