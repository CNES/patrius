...
public class AzimuthElevationFieldTest {
    ...
    public void elevationMaskFieldCardinalPoints() {
        ...
        final IFieldOfView fov = new AzimuthElevationField(azimuthElevMask, 0.0, maskName);
    ...
    public void elevationMaskFieldFrameXaxisNorthEast() {
        ...
        final AzimuthElevationField fov = new AzimuthElevationField(azimuthElevMask, northToFrameXAxisAngle, maskName);
        ...
        double dirAzimuth = AzimuthElevationCalculator.getAzimuth(direction, northToFrameXAxisAngle);
        ...
        dirAzimuth = AzimuthElevationCalculator.getAzimuth(direction, northToFrameXAxisAngle);
