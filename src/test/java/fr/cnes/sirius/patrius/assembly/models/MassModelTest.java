...
public class MassModelTest {
     ...
     */
    @Test
    public final void advancedMassModelSameFuelTanksForcesAndEventsTestFromInertiaModel() throws PatriusException {
        ...
        final double newComputedMassSameTank = finalState.getMass(this.t1);

        Assert.assertTrue(old > this.model.getMass(this.t1));
        ...
        builder.addProperty(this.i1, this.t1);
     ...
     */
    @Test
    public final void advancedMassModelSameFuelTanksForcesAndEventsTest() throws PatriusException {
        ...
        this.impulse4 = new ImpulseManeuver(new NodeDetector(FramesFactory.getEME2000(), 600, 1e-6, Action.STOP,
                Action.STOP), Vector3D.PLUS_K.scalarMultiply(.1), 250, this.model, this.t1);
     ...
     */
    @Test
    public final void advancedMassModelSameFuelTanksForcesOnlyTest() throws PatriusException {
        ...
        builder.addProperty(tank, this.t1);
        this.model = new MassModel(builder.returnAssembly());
        ...
        builder.addProperty(p1, this.t1);
     ...
     */
    @Test
    public final void advancedMassModelSeparateFuelTanksTest() throws PatriusException {
        ...
        propagator1.setInitialState(new SpacecraftState(orbit, this.model));
        ...
        propagator2.setInitialState(new SpacecraftState(orbit, this.model));
     ...
     */
    @Test
    public final void testGetTotalMassSpacecraftState() throws PatriusException {
