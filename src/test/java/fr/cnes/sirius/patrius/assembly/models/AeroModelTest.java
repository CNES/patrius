...
public class AeroModelTest {
    ...
    private
            void
            createTestAssemblyFacetOnly(final Vector3D facetNormal, final Parameter cn, final Parameter ct)
                                                                                                           throws PatriusException {
        final AssemblyBuilder builder = new AssemblyBuilder();
     ...
     */
    @Test
    public final void testAeroModel() throws PatriusException {
        // create the assembly
    ...
    public final void testAeroModelError() throws PatriusException {
        // create the assembly
     ...
     */
    @Test
    public final void testDragAccelerationSphereOnly() throws PatriusException {
        ...
        double expectedNorm =
            (0.5 * testDensity * 3. * 3. * AeroFacetProperty.DEFAULT_C_N * FastMath.PI * 10. * 10.) / 100.;
        ...
        // in the satellite frame.
        final Vector3D randomVector = (new Vector3D(MathLib.random(), MathLib.random(), MathLib.random()))
            .normalize();
     ...
     */
    @Test
    public final void testDragAccelerationSphereWithPanels() throws PatriusException {
        ...
        Report.printToReport("Acceleration norm",
            MathLib.sqrt(expectedNorm * expectedNorm + expectedTang * expectedTang),
            testAccSat.getNorm());
    }
     ...
     */
    @Test
    public final void testDragAccelerationCylinder() throws PatriusException {
        ...
        // Expected acceleration
        forceFactor = (0.5 * testDensity * velSatNorm * velSatNorm * AeroFacetProperty.DEFAULT_C_N *
            (FastMath.PI * 2. * 2. * MathLib.sqrt(2.) / 2. + 2. * 2. * 10. * MathLib.sqrt(2.) / 2.)) / velSatNorm;
     ...
     */
    @Test
    public final void testDragAccelerationParallelepiped() throws PatriusException {
     ...
     */
    @Test
    public final void testDragAccelerationFacetOnly() throws PatriusException {
        ...
        testAccSat = toSatRotation.applyInverseTo(testAcc);
        Assert.assertEquals(Vector3D.ZERO, testAcc);
        Assert.assertEquals(Vector3D.ZERO, testAccSat);
     ...
     */
    @Test
    public final void comparisonToSphericalSpacecraft() throws PatriusException {
     ...
     */
    @Test
    public final void comparisonToBoxAndSASpacecraft() throws PatriusException {
        ...
        final double dragCoeff = 0.1056;
        final double density = 1.2e-7;
        final PVCoordinatesProvider sun = new BasicPVCoordinatesProvider(
            new PVCoordinates(new Vector3D(1.0e+11, 0.7e+11, 0.), Vector3D.ZERO), FramesFactory.getGCRF());
        ...
        final AssemblyBoxAndSolarArraySpacecraft siriusModel =
            new AssemblyBoxAndSolarArraySpacecraft(xLength, yLength, zLength,
                sun, solarArrayArea, solarArrayAxis, dragCoeff, 0.5, 0.5, 0.);
        ...
        final SpacecraftState state =
            new SpacecraftState(testOrbit, attitude, new MassModel(siriusModel.getAssembly()));
     ...
     */
    @Test
    public final void testDDragAccDParamSphere() throws PatriusException {
        // create the assembly
     ...
     */
    @Test
    public final void testDDragAccDParamFacet() throws PatriusException {
        // create the assembly
        final Parameter cn = new Parameter("C_N", 1.7);
        final Parameter ct = new Parameter("C_T", 2.3);
     ...
     */
    @Test
    public final void testDDragAccDParam() throws PatriusException {
        // create the assembly
        final AssemblyBuilder builder = new AssemblyBuilder();
     ...
     */
    @Test
    public final void testDDragAccDState() throws PatriusException {
     ...
     */
    @Test
    public final void testExceptionDDragAccDState() throws PatriusException {
