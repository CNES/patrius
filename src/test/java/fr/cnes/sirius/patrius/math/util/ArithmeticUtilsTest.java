...
public class ArithmeticUtilsTest {
    ...
    public void testFactorial() {
        for (int i = 1; i < 21; i++) {
            Assert.assertEquals(i + "! ", this.factorial(i), ArithmeticUtils.factorial(i));
            Assert.assertEquals(i + "! ", this.factorial(i), ArithmeticUtils.factorialDouble(i), Double.MIN_VALUE);
            Assert.assertEquals(i + "! ", MathLib.log(this.factorial(i)), ArithmeticUtils.factorialLog(i), 10E-12);
        }
    ...
    private void testAddAndCheckLongFailure(final long a, final long b) {
        try {
    ...
    private void testMulAndCheckLongFailure(final long a, final long b) {
        try {
    ...
    private void testSubAndCheckLongFailure(final long a, final long b) {
        try {
