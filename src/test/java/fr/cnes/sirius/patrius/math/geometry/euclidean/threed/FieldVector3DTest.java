...
public class FieldVector3DTest {
    ...
    public void testConstructors() throws DimensionMismatchException {
        ...
        final FieldVector3D<DerivativeStructure> u = new FieldVector3D<DerivativeStructure>(2,
        ...
        this.checkVector(u, 2 * cosAlpha * cosDelta, 2 * sinAlpha * cosDelta, 2 * sinDelta);
        ...
        this.checkVector(new FieldVector3D<DerivativeStructure>(2, this.createVector(1, 0, 0, 3)),
            2, 0, 0, 2, 0, 0, 0, 2, 0, 0, 0, 2);
        this.checkVector(new FieldVector3D<DerivativeStructure>(new DerivativeStructure(4, 1, 3, 2.0),
            this.createVector(1, 0, 0, 4)),
        ...
        this.checkVector(new FieldVector3D<DerivativeStructure>(new DerivativeStructure[] {
    ...
    public void testEquals() {
        final FieldVector3D<DerivativeStructure> u1 = this.createVector(1, 2, 3, 3);
        final FieldVector3D<DerivativeStructure> v = this.createVector(1, 2, 3 + 10 * Precision.EPSILON, 3);
        ...
        Assert.assertTrue(this.createVector(0, Double.NaN, 0, 3).equals(this.createVector(0, 0, Double.NaN, 3)));
    }

    @Test
    public void testHash() {
        Assert.assertEquals(this.createVector(0, Double.NaN, 0, 3).hashCode(), this.createVector(0, 0, Double.NaN, 3)
            .hashCode());
        final FieldVector3D<DerivativeStructure> u = this.createVector(1, 2, 3, 3);
        final FieldVector3D<DerivativeStructure> v = this.createVector(1, 2, 3 + 10 * Precision.EPSILON, 3);
    ...
    public void testInfinite() {
        Assert.assertTrue(this.createVector(1, 1, Double.NEGATIVE_INFINITY, 3).isInfinite());
        Assert.assertTrue(this.createVector(1, Double.NEGATIVE_INFINITY, 1, 3).isInfinite());
        Assert.assertTrue(this.createVector(Double.NEGATIVE_INFINITY, 1, 1, 3).isInfinite());
        Assert.assertFalse(this.createVector(1, 1, 2, 3).isInfinite());
        Assert.assertFalse(this.createVector(1, Double.NaN, Double.NEGATIVE_INFINITY, 3).isInfinite());
    }

    @Test
    public void testNaN() {
        Assert.assertTrue(this.createVector(1, 1, Double.NaN, 3).isNaN());
        Assert.assertTrue(this.createVector(1, Double.NaN, 1, 3).isNaN());
        Assert.assertTrue(this.createVector(Double.NaN, 1, 1, 3).isNaN());
        Assert.assertFalse(this.createVector(1, 1, 2, 3).isNaN());
        Assert.assertFalse(this.createVector(1, 1, Double.NEGATIVE_INFINITY, 3).isNaN());
    }

    @Test
    public void testToString() {
        Assert.assertEquals("{3; 2; 1}", this.createVector(3, 2, 1, 3).toString());
        final NumberFormat format = new DecimalFormat("0.000", new DecimalFormatSymbols(Locale.US));
        Assert.assertEquals("{3.000; 2.000; 1.000}", this.createVector(3, 2, 1, 3).toString(format));
    }
    ...
    public void testCoordinates() {
        final FieldVector3D<DerivativeStructure> v = this.createVector(1, 2, 3, 3);
    ...
    public void testNorm1() {
        Assert.assertEquals(0.0, this.createVector(0, 0, 0, 3).getNorm1().getReal(), 0);
        Assert.assertEquals(6.0, this.createVector(1, -2, 3, 3).getNorm1().getReal(), 0);
        Assert.assertEquals(1.0, this.createVector(1, -2, 3, 3).getNorm1().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(-1.0, this.createVector(1, -2, 3, 3).getNorm1().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(1.0, this.createVector(1, -2, 3, 3).getNorm1().getPartialDerivative(0, 0, 1), 0);
    }

    @Test
    public void testNorm() {
        final double r = MathLib.sqrt(14);
        Assert.assertEquals(0.0, this.createVector(0, 0, 0, 3).getNorm().getReal(), 0);
        Assert.assertEquals(r, this.createVector(1, 2, 3, 3).getNorm().getReal(), 1.0e-12);
        Assert.assertEquals(1.0 / r, this.createVector(1, 2, 3, 3).getNorm().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(2.0 / r, this.createVector(1, 2, 3, 3).getNorm().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(3.0 / r, this.createVector(1, 2, 3, 3).getNorm().getPartialDerivative(0, 0, 1), 0);
    }

    @Test
    public void testNormSq() {
        Assert.assertEquals(0.0, this.createVector(0, 0, 0, 3).getNormSq().getReal(), 0);
        Assert.assertEquals(14, this.createVector(1, 2, 3, 3).getNormSq().getReal(), 1.0e-12);
        Assert.assertEquals(2, this.createVector(1, 2, 3, 3).getNormSq().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(4, this.createVector(1, 2, 3, 3).getNormSq().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(6, this.createVector(1, 2, 3, 3).getNormSq().getPartialDerivative(0, 0, 1), 0);
    }

    @Test
    public void testNormInf() {
        Assert.assertEquals(0.0, this.createVector(0, 0, 0, 3).getNormInf().getReal(), 0);
        Assert.assertEquals(3.0, this.createVector(1, -2, 3, 3).getNormInf().getReal(), 0);
        Assert.assertEquals(0.0, this.createVector(1, -2, 3, 3).getNormInf().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(0.0, this.createVector(1, -2, 3, 3).getNormInf().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(1.0, this.createVector(1, -2, 3, 3).getNormInf().getPartialDerivative(0, 0, 1), 0);
        Assert.assertEquals(3.0, this.createVector(2, -1, 3, 3).getNormInf().getReal(), 0);
        Assert.assertEquals(0.0, this.createVector(2, -1, 3, 3).getNormInf().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(0.0, this.createVector(2, -1, 3, 3).getNormInf().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(1.0, this.createVector(2, -1, 3, 3).getNormInf().getPartialDerivative(0, 0, 1), 0);
        Assert.assertEquals(3.0, this.createVector(1, -3, 2, 3).getNormInf().getReal(), 0);
        Assert.assertEquals(0.0, this.createVector(1, -3, 2, 3).getNormInf().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(-1.0, this.createVector(1, -3, 2, 3).getNormInf().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(0.0, this.createVector(1, -3, 2, 3).getNormInf().getPartialDerivative(0, 0, 1), 0);
        Assert.assertEquals(3.0, this.createVector(2, -3, 1, 3).getNormInf().getReal(), 0);
        Assert.assertEquals(0.0, this.createVector(2, -3, 1, 3).getNormInf().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(-1.0, this.createVector(2, -3, 1, 3).getNormInf().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(0.0, this.createVector(2, -3, 1, 3).getNormInf().getPartialDerivative(0, 0, 1), 0);
        Assert.assertEquals(3.0, this.createVector(3, -1, 2, 3).getNormInf().getReal(), 0);
        Assert.assertEquals(1.0, this.createVector(3, -1, 2, 3).getNormInf().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(0.0, this.createVector(3, -1, 2, 3).getNormInf().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(0.0, this.createVector(3, -1, 2, 3).getNormInf().getPartialDerivative(0, 0, 1), 0);
        Assert.assertEquals(3.0, this.createVector(3, -2, 1, 3).getNormInf().getReal(), 0);
        Assert.assertEquals(1.0, this.createVector(3, -2, 1, 3).getNormInf().getPartialDerivative(1, 0, 0), 0);
        Assert.assertEquals(0.0, this.createVector(3, -2, 1, 3).getNormInf().getPartialDerivative(0, 1, 0), 0);
        Assert.assertEquals(0.0, this.createVector(3, -2, 1, 3).getNormInf().getPartialDerivative(0, 0, 1), 0);
    }

    @Test
    public void testDistance1() {
        final FieldVector3D<DerivativeStructure> v1 = this.createVector(1, -2, 3, 3);
        final FieldVector3D<DerivativeStructure> v2 = this.createVector(-4, 2, 0, 3);
        Assert.assertEquals(0.0, FieldVector3D
            .distance1(this.createVector(-1, 0, 0, 3), this.createVector(-1, 0, 0, 3))
            .getReal(), 0);
    ...
    public void testDistance() {
        ...
        Assert.assertEquals(0.0,
            FieldVector3D.distance(this.createVector(-1, 0, 0, 3), this.createVector(-1, 0, 0, 3)).getReal(), 0);
    ...
    public void testDistanceSq() {
        ...
        final FieldVector3D<DerivativeStructure> v2 = this.createVector(-4, 2, 0, 3);
        Assert.assertEquals(0.0,
            FieldVector3D.distanceSq(this.createVector(-1, 0, 0, 3), this.createVector(-1, 0, 0, 3))
                .getReal(), 0);
    ...
    public void testDistanceInf() {
        ...
        final FieldVector3D<DerivativeStructure> v2 = this.createVector(-4, 2, 0, 3);
        Assert.assertEquals(0.0,
            FieldVector3D.distanceInf(this.createVector(-1, 0, 0, 3), this.createVector(-1, 0, 0, 3))
                .getReal(), 0);
        ...
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(1, -2, 3, 3), this.createVector(-4, 2, 0, 3)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(1, 3, -2, 3), this.createVector(-4, 0, 2, 3)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(-2, 1, 3, 3), this.createVector(2, -4, 0, 3)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(-2, 3, 1, 3), this.createVector(2, 0, -4, 3)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(3, -2, 1, 3), this.createVector(0, 2, -4, 3)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(3, 1, -2, 3), this.createVector(0, -4, 2, 3)).getReal(),
            1.0e-12);

        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(1, -2, 3, 3), new Vector3D(-4, 2, 0)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(1, 3, -2, 3), new Vector3D(-4, 0, 2)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(-2, 1, 3, 3), new Vector3D(2, -4, 0)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(-2, 3, 1, 3), new Vector3D(2, 0, -4)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(3, -2, 1, 3), new Vector3D(0, 2, -4)).getReal(),
            1.0e-12);
        Assert.assertEquals(5.0,
            FieldVector3D.distanceInf(this.createVector(3, 1, -2, 3), new Vector3D(0, -4, 2)).getReal(),
            1.0e-12);
    ...
    public void testSubtract() {
        FieldVector3D<DerivativeStructure> v1 = this.createVector(1, 2, 3, 3);
        final FieldVector3D<DerivativeStructure> v2 = this.createVector(-3, -2, -1, 3);
        v1 = v1.subtract(v2);
        this.checkVector(v1, 4, 4, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0);

        this.checkVector(v2.subtract(v1), -7, -6, -5, 1, 0, 0, 0, 1, 0, 0, 0, 1);
        this.checkVector(v2.subtract(new Vector3D(4, 4, 4)), -7, -6, -5, 1, 0, 0, 0, 1, 0, 0, 0, 1);
        this.checkVector(v2.subtract(3, v1), -15, -14, -13, 1, 0, 0, 0, 1, 0, 0, 0, 1);
        this.checkVector(v2.subtract(3, new Vector3D(4, 4, 4)), -15, -14, -13, 1, 0, 0, 0, 1, 0, 0, 0, 1);
        this.checkVector(v2.subtract(new DerivativeStructure(3, 1, 2, 3), new Vector3D(4, 4, 4)),
            -15, -14, -13, 1, 0, -4, 0, 1, -4, 0, 0, -3);

        this.checkVector(this.createVector(1, 2, 3, 4).subtract(new DerivativeStructure(4, 1, 3, 5.0),
            this.createVector(3, -2, 1, 4)),
            -14, 12, -2,
            -4, 0, 0, -3,
            0, -4, 0, 2,
            0, 0, -4, -1);
    ...
    public void testAdd() {
        ...
        final FieldVector3D<DerivativeStructure> v2 = this.createVector(-3, -2, -1, 3);
        v1 = v1.add(v2);
        this.checkVector(v1, -2, 0, 2, 2, 0, 0, 0, 2, 0, 0, 0, 2);

        this.checkVector(v2.add(v1), -5, -2, 1, 3, 0, 0, 0, 3, 0, 0, 0, 3);
        this.checkVector(v2.add(new Vector3D(-2, 0, 2)), -5, -2, 1, 1, 0, 0, 0, 1, 0, 0, 0, 1);
        this.checkVector(v2.add(3, v1), -9, -2, 5, 7, 0, 0, 0, 7, 0, 0, 0, 7);
        this.checkVector(v2.add(3, new Vector3D(-2, 0, 2)), -9, -2, 5, 1, 0, 0, 0, 1, 0, 0, 0, 1);
        this.checkVector(v2.add(new DerivativeStructure(3, 1, 2, 3), new Vector3D(-2, 0, 2)),
            -9, -2, 5, 1, 0, -2, 0, 1, 0, 0, 0, 3);

        this.checkVector(this.createVector(1, 2, 3, 4).add(new DerivativeStructure(4, 1, 3, 5.0),
            this.createVector(3, -2, 1, 4)),
            16, -8, 8,
            6, 0, 0, 3,
            0, 6, 0, -2,
    ...
    public void testScalarProduct() {
        FieldVector3D<DerivativeStructure> v = this.createVector(1, 2, 3, 3);
    ...
    public void testVectorialProducts() {
        final FieldVector3D<DerivativeStructure> v1 = this.createVector(2, 1, -4, 3);
        final FieldVector3D<DerivativeStructure> v2 = this.createVector(3, 1, -1, 3);
    ...
    public void testCrossProductCancellation() {
        final FieldVector3D<DerivativeStructure> v1 = this.createVector(9070467121.0, 4535233560.0, 1, 3);
        final FieldVector3D<DerivativeStructure> v2 = this.createVector(9070467123.0, 4535233561.0, 1, 3);
        this.checkVector(FieldVector3D.crossProduct(v1, v2), -1, 2, 1);

        final double scale = MathLib.scalb(1.0, 100);
        final FieldVector3D<DerivativeStructure> big1 = new FieldVector3D<DerivativeStructure>(scale, v1);
        final FieldVector3D<DerivativeStructure> small2 = new FieldVector3D<DerivativeStructure>(1 / scale, v2);
        this.checkVector(FieldVector3D.crossProduct(big1, small2), -1, 2, 1);

    }

    @Test
    public void testAngular() {
        Assert.assertEquals(0, this.createVector(1, 0, 0, 3).getAlpha().getReal(), 1.0e-10);
        Assert.assertEquals(0, this.createVector(1, 0, 0, 3).getDelta().getReal(), 1.0e-10);
        Assert.assertEquals(FastMath.PI / 2, this.createVector(0, 1, 0, 3).getAlpha().getReal(), 1.0e-10);
        Assert.assertEquals(0, this.createVector(0, 1, 0, 3).getDelta().getReal(), 1.0e-10);
        Assert.assertEquals(FastMath.PI / 2, this.createVector(0, 0, 1, 3).getDelta().getReal(), 1.0e-10);

        final FieldVector3D<DerivativeStructure> u = this.createVector(-1, 1, -1, 3);
    ...
    public void testNormalize() throws MathArithmeticException {
        Assert.assertEquals(1.0, this.createVector(5, -4, 2, 3).normalize().getNorm().getReal(), 1.0e-12);
        try {
            this.createVector(0, 0, 0, 3).normalize();
            Assert.fail("an exception should have been thrown");
    ...
    public void testAngle() throws MathArithmeticException {
        Assert.assertEquals(0.22572612855273393616,
            FieldVector3D.angle(this.createVector(1, 2, 3, 3), this.createVector(4, 5, 6, 3)).getReal(),
            1.0e-12);
        Assert.assertEquals(7.98595620686106654517199e-8,
            FieldVector3D.angle(this.createVector(1, 2, 3, 3), this.createVector(2, 4, 6.000001, 3)).getReal(),
            1.0e-12);
        Assert.assertEquals(3.14159257373023116985197793156,
            FieldVector3D.angle(this.createVector(1, 2, 3, 3), this.createVector(-2, -4, -6.000001, 3)).getReal(),
            1.0e-12);
        try {
            FieldVector3D.angle(this.createVector(0, 0, 0, 3), this.createVector(1, 0, 0, 3));
            Assert.fail("an exception should have been thrown");
        } catch (final MathArithmeticException ae) {
            // expected behavior
        }
    ...
    public void testDotProduct() {
        ...
        for (int i = 0; i < 10000; ++i) {
            ...
            final FieldVector3D<DerivativeStructure> uds = this.createVector(ux, uy, uz, 3);
            final FieldVector3D<DerivativeStructure> vds = this.createVector(vx, vy, vz, 3);
    ...
    public void testAccurateCrossProduct() {
        ...
        final FieldVector3D<DerivativeStructure> u1 = this.createVector(-1321008684645961.0 / 268435456.0,
            -5774608829631843.0 / 268435456.0,
            -7645843051051357.0 / 8589934592.0, 3);
        final FieldVector3D<DerivativeStructure> u2 = this.createVector(1796571811118507.0 / 2147483648.0,
            7853468008299307.0 / 2147483648.0,
            2599586637357461.0 / 17179869184.0, 3);
        final FieldVector3D<DerivativeStructure> u3 = this.createVector(12753243807587107.0 / 18446744073709551616.0,
            -2313766922703915.0 / 18446744073709551616.0,
            -227970081415313.0 / 288230376151711744.0, 3);
        final FieldVector3D<DerivativeStructure> cNaive = new FieldVector3D<DerivativeStructure>(u1.getY()
    ...
    public void testCrossProduct() {
        ...
        for (int i = 0; i < 10000; ++i) {
            ...
            this.checkVector(FieldVector3D.crossProduct(uds, vds),
                cNaive.getX(), cNaive.getY(), cNaive.getZ(),
                0, vz - uz, uy - vy,
                uz - vz, 0, vx - ux,
                vy - uy, ux - vx, 0);

            this.checkVector(FieldVector3D.crossProduct(uds, v),
                cNaive.getX(), cNaive.getY(), cNaive.getZ(),
                0, vz, -vy,
                -vz, 0, vx,
                vy, -vx, 0);
    ...
    private void checkVector(final FieldVector3D<DerivativeStructure> v, final double x, final double y,
                             final double z,
