...
public class PolynomialsUtilsTest {
    ...
    public void testFirstChebyshevPolynomials() {
        ...
        checkPolynomial(PolynomialsUtils.createChebyshevPolynomial(7),
                "-7 x + 56 x^3 - 112 x^5 + 64 x^7");
        checkPolynomial(PolynomialsUtils.createChebyshevPolynomial(6),
    ...
    public void testChebyshevDifferentials() {
        for (int k = 0; k < 12; ++k) {
            ...
            final PolynomialFunction Tk1 = Tk0.derivative();
            final PolynomialFunction Tk2 = Tk1.derivative();
    ...
    public void testChebyshevOrthogonality() {
        final UnivariateFunction weight = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = -2280192876279600243L;
    ...
    public void testFirstHermitePolynomials() {
        ...
        checkPolynomial(PolynomialsUtils.createHermitePolynomial(7),
                "-1680 x + 3360 x^3 - 1344 x^5 + 128 x^7");
        checkPolynomial(PolynomialsUtils.createHermitePolynomial(6),
    ...
    public void testHermiteDifferentials() {
        for (int k = 0; k < 12; ++k) {
            ...
            final PolynomialFunction Hk1 = Hk0.derivative();
            final PolynomialFunction Hk2 = Hk1.derivative();
    ...
    public void testHermiteOrthogonality() {
        final UnivariateFunction weight = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = 614863129106196395L;
    ...
    public void testLaguerreDifferentials() {
        for (int k = 0; k < 12; ++k) {
            ...
            final PolynomialFunction Lk1 = Lk0.derivative();
            final PolynomialFunction Lk2 = Lk1.derivative();
    ...
    public void testLaguerreOrthogonality() {
        final UnivariateFunction weight = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = -6315777546352973992L;
    ...
    public void testLegendreDifferentials() {
        for (int k = 0; k < 12; ++k) {
            ...
            final PolynomialFunction Pk1 = Pk0.derivative();
            final PolynomialFunction Pk2 = Pk1.derivative();
    ...
    public void testLegendreOrthogonality() {
        final UnivariateFunction weight = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = 597657316026956351L;
    ...
    public void testJacobiOrthogonality() {
        for (int v = 0; v < 5; ++v) {
            for (int w = v; w < 5; ++w) {
                ...
                final UnivariateFunction weight = new UnivariateFunction(){
                    /** Serializable UID. */
                    private static final long serialVersionUID = 420829690351134974L;
    ...
    private static void checkPolynomial(final PolynomialFunction p, final long denominator,
    ...
    private static void checkPolynomial(final PolynomialFunction p, final String reference) {
    ...
    private static void checkOrthogonality(final PolynomialFunction p1,
        ...
        final UnivariateFunction f = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = -2248569088479683733L;
        ...
        if (p1.getDegree() == p2.getDegree()) {
            ...
            Assert.assertTrue("I(" + p1.getDegree() + ", " + p2.getDegree() + ") = " + dotProduct,
                MathLib.abs(dotProduct) > nonZeroThreshold);
        } else {
            // integral should be zero
            Assert.assertEquals("I(" + p1.getDegree() + ", " + p2.getDegree() + ") = " + dotProduct,
