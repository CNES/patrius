...
public abstract class RandomGeneratorAbstractTest extends RandomDataTest {
    ...
    public void testNextIntDirect() {
        ...
        for (final int n : testValues) {
            ...
            for (int k = 1; k < binCount; k++) {
                expected[k] = (double) this.smallSampleSize *
    ...
    @Override
    // TODO is this supposed to be an override?
    ...
    public void testDoubleDirect() {
        ...
        Assert.assertEquals("Note: This test will fail randomly about 1 in 100 times.",
            0.5, sample.getMean(), MathLib.sqrt(N / 12.0) * 2.576);
        Assert.assertEquals(1.0 / (2.0 * MathLib.sqrt(3.0)),
    ...
    public void testNextInt2() {
        ...
        Assert.assertTrue("Walked too far astray: " + walk + "\nNote: This " +
            ...
            MathLib.abs(walk) < MathLib.sqrt(N) * 2.576);
    }
    ...
    private void checkSameSequence(final RandomGenerator gen1, final RandomGenerator gen2) {
