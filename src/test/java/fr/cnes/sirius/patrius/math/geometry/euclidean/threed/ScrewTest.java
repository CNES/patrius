...
public class ScrewTest {
    ...
    public void testSum() {
        ...
        assertVectors(sd.getTranslation(), Vector3D.MINUS_J.add(Vector3D.MINUS_K), this.eps);
        assertVectors(sd.getRotation(), Vector3D.MINUS_K.add(Vector3D.PLUS_J), this.eps);

        final Screw s3 = new Screw(s1);

        assertVectors(s1.getOrigin(), s3.getOrigin(), 0);
        assertVectors(s1.getTranslation(), s3.getTranslation(), 0);
        assertVectors(s1.getRotation(), s3.getRotation(), 0);
    ...
    public void testDisplace() {
        ...
        assertVectors(sd.getTranslation(), Vector3D.MINUS_J, this.eps);
        assertVectors(sd.getRotation(), Vector3D.PLUS_K, this.eps);
    }
    ...
    public void testGetters() {
        ...
        assertVectors(s.getTranslation(), Vector3D.MINUS_J, this.eps);
        assertVectors(s.getRotation(), Vector3D.MINUS_K, this.eps);
    }
    ...
    public void testToString() {
        ...
        Assert.assertEquals(s.toString(),
            "Screw{Origin{-1.0; 0.0; 0.0},Translation{0.0; -1.0; 0.0},Rotation{0.0; 0.0; -1.0}}");
    }
