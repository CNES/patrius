...
public class QuaternionTest {
    ...
    @Test
    public void testProductQuaternionQuaternion() {
    ...
    @Test
    public void testProductQuaternionVector() {
        ...
        final Vector3D vectorPartRefQxV = (new Vector3D(vector).scalarMultiply(quaternion.getScalarPart()))
            .add(Vector3D
        ...
        final Vector3D vectorPartRefVxQ = (new Vector3D(vector).scalarMultiply(quaternion.getScalarPart()))
            .add(Vector3D
    ...
    @Test
    public void testDotProductQuaternionQuaternion() {
        // expected output
    ...
    @Test
    public void testAddQuaternionQuaternion() {
        // expected outputs
        final double w = 4;
        final double x = -1;
        final double y = 2;
    ...
    @Test
    public void testSubtractQuaternionQuaternion() {
        // expected outputs
        final double w = -2.;
        final double x = 5.;
        final double y = -6.;
    ...
    public void testObjectEquals() {
        ...
        final Quaternion q3 = new Quaternion(one, MathLib.nextUp(one), one, one);
        Assert.assertFalse(q3.equals(q1));

        final Object oo = new Object();
        Assert.assertFalse(q1.equals(oo));
    }

    @Test
    public void testQuaternionEquals() {
    ...
    @Test
    public void testQuaternionEquals2() {
    ...
    @Test
    public void testIsUnitQuaternion() {
    ...
    @Test
    public void testIsPureQuaternion() {
    ...
    public void testPolarForm() {
        ...
        for (int i = 0; i < numberOfTrials; i++) {
            ...
            final Rotation rot = new Rotation(true, q.getQ0(), q.getQ1(), q.getQ2(), q.getQ3());
            final Rotation rotP = new Rotation(true, qP.getQ0(), qP.getQ1(), qP.getQ2(), qP.getQ3());
    ...
    public void testHashcode() {
        final Quaternion q = new Quaternion(1, 2, 3, 4);
        final int expected = -1140355183;
        Assert.assertEquals(expected, q.hashCode());
    }
    ...
    public void testSerialization() {
        ...
        // Random test
        final Well1024a random = new Well1024a(601232124545606121l);
        for (int i = 0; i < 1000; ++i) {
            final double a = 10000 * random.nextDouble();
            final double b = 10000 * random.nextDouble();
            final double c = 10000 * random.nextDouble();
            final double d = 10000 * random.nextDouble();
            final Quaternion q = new Quaternion(a, b, c, d);
            TestUtils.checkSerializedEquality(q);
        }

        // Test constants
        TestUtils.checkSerializedEquality(Quaternion.IDENTITY);
        TestUtils.checkSerializedEquality(Quaternion.ZERO);
        TestUtils.checkSerializedEquality(Quaternion.I);
        TestUtils.checkSerializedEquality(Quaternion.J);
        TestUtils.checkSerializedEquality(Quaternion.K);
    }
}
