...
public final class TestUtils {
     ...
     */
    public static final double[] loadDoubleArrayFromFile(final String classpathFileName) throws IOException {
     ...
     * @throws IOException if an error occurs while reading.
     */
    public static final double[][] loadDoubleMatrixFromFile(final String classpathFileName,
            final char fieldSeparator) throws IOException {
     ...
     * @throws IOException if an error occurs while reading.
     */
    public static String[][] getAllValuesFromAFile(final String classpathFileName, final char delimiter)
            throws IOException {
