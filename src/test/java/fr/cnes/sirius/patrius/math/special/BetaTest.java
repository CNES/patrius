...
/**
 * @version $Id: BetaTest.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class BetaTest {

    private void testRegularizedBeta(final double expected, final double x,
                                     final double a, final double b) {
        final double actual = Beta.regularizedBeta(x, a, b);
        TestUtils.assertEquals(expected, actual, 10e-15);
    }

    private void testLogBeta(final double expected, final double a, final double b) {
    ...
    public void testRegularizedBetaNanPositivePositive() {
        this.testRegularizedBeta(Double.NaN, Double.NaN, 1.0, 1.0);
    }

    @Test
    public void testRegularizedBetaPositiveNanPositive() {
        this.testRegularizedBeta(Double.NaN, 0.5, Double.NaN, 1.0);
    }

    @Test
    public void testRegularizedBetaPositivePositiveNan() {
        this.testRegularizedBeta(Double.NaN, 0.5, 1.0, Double.NaN);
    }

    @Test
    public void testRegularizedBetaNegativePositivePositive() {
        this.testRegularizedBeta(Double.NaN, -0.5, 1.0, 2.0);
    }
    ...
    public void testRegularizedBetaZeroPositivePositive() {
        this.testRegularizedBeta(0.0, 0.0, 1.0, 2.0);
    }

    @Test
    public void testRegularizedBetaPositiveZeroPositive() {
        this.testRegularizedBeta(Double.NaN, 0.5, 0.0, 2.0);
    }

    @Test
    public void testRegularizedBetaPositivePositiveZero() {
        this.testRegularizedBeta(Double.NaN, 0.5, 1.0, 0.0);
    }

    @Test
    public void testRegularizedBetaPositivePositivePositive() {
        this.testRegularizedBeta(0.75, 0.5, 1.0, 2.0);
    }

    @Test
    public void testLogBetaNanPositive() {
        this.testLogBeta(Double.NaN, Double.NaN, 2.0);
    }

    @Test
    public void testLogBetaPositiveNan() {
        this.testLogBeta(Double.NaN, 1.0, Double.NaN);
    }

    @Test
    public void testLogBetaNegativePositive() {
        this.testLogBeta(Double.NaN, -1.0, 2.0);
    }
    ...
    public void testLogBetaZeroPositive() {
        this.testLogBeta(Double.NaN, 0.0, 2.0);
    }

    @Test
    public void testLogBetaPositiveZero() {
        this.testLogBeta(Double.NaN, 1.0, 0.0);
    }

    @Test
    public void testLogBetaPositivePositive() {
        this.testLogBeta(-0.693147180559945, 1.0, 2.0);
    }

    /**
     * Reference data for the {@link Gamma#logGammaSum(double, double)} function. This data was generated with the
     * following
    ...
    public void testLogGammaSum() {
        ...
        for (final double[] ref : LOG_GAMMA_SUM_REF) {
            ...
            final double tol = ulps * MathLib.ulp(expected);
    ...
    private static double logGammaMinusLogGammaSum(final double a, final double b) {
        return Beta.logGammaMinusLogGammaSum(a, b);
    }
    ...
    private static double sumDeltaMinusDeltaSum(final double a,
                                                final double b) {
        return Beta.sumDeltaMinusDeltaSum(a, b);
    }
