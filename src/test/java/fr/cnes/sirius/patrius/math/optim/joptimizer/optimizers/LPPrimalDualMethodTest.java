...
import fr.cnes.sirius.patrius.math.optim.joptimizer.optimizers.AbstractLPOptimizationRequestHandler;
import fr.cnes.sirius.patrius.math.optim.joptimizer.optimizers.LPOptimizationRequest;
import fr.cnes.sirius.patrius.math.optim.joptimizer.optimizers.LPOptimizationResponse;
import fr.cnes.sirius.patrius.math.optim.joptimizer.optimizers.LPPrimalDualMethod;
...
public class LPPrimalDualMethodTest extends TestCase {
     ...
     */
    public void testDummy() throws PatriusException {
    }
    ...
    public void testCGhAb1() throws PatriusException, IOException {
        ...
        final double[] c = TestUtils.loadDoubleArrayFromFile(pathLP + cS + problemId + txt);
        final double[][] g = TestUtils.loadDoubleMatrixFromFile(pathLP + gS + problemId + txt, space.charAt(0));
        final double[] h = TestUtils.loadDoubleArrayFromFile(pathLP + hS + problemId + txt);
        final double[][] a = TestUtils.loadDoubleMatrixFromFile(pathLP + aS + problemId + txt, space.charAt(0));
        final double[] b = TestUtils.loadDoubleArrayFromFile(pathLP + bS + problemId + txt);
        final double expectedvalue = TestUtils.loadDoubleArrayFromFile(pathLP + val + problemId + txt)[0];
    ...
    public void testCGhAbLbUb2() throws PatriusException, IOException {
        ...
        final double[][] a = TestUtils.loadDoubleMatrixFromFile(pathLP + aS + problemId + txt, space.charAt(0));
        final double[] b = TestUtils.loadDoubleArrayFromFile(pathLP + bS + problemId + txt);
        final double[] lb = TestUtils.loadDoubleArrayFromFile(pathLP + lbS + problemId + txt);
        final double[] ub = TestUtils.loadDoubleArrayFromFile(pathLP + ubS + problemId + txt);
        final double[] expectedSol = TestUtils.loadDoubleArrayFromFile(pathLP + solS + problemId + txt);
        final double expectedvalue = TestUtils.loadDoubleArrayFromFile(pathLP + val + problemId + txt)[0];
    ...
    public void testCGhAbLbUb7() throws PatriusException, IOException {
        ...
        final double[][] a = TestUtils.loadDoubleMatrixFromFile(pathLP + aS + problemId + txt, space.charAt(0));
        final double[] b = TestUtils.loadDoubleArrayFromFile(pathLP + bS + problemId + txt);
        double[] lb = TestUtils.loadDoubleArrayFromFile(pathLP + lbS + problemId + txt);
        double[] ub = TestUtils.loadDoubleArrayFromFile(pathLP + ubS + problemId + txt);
        final double[] expectedSol = TestUtils.loadDoubleArrayFromFile(pathLP + solS + problemId + txt);
        final double expectedvalue = TestUtils.loadDoubleArrayFromFile(pathLP + val + problemId + txt)[0];
