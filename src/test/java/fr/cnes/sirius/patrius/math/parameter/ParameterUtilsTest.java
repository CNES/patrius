...
public class ParameterUtilsTest {
    ...
    /**
     * Tests the method:<br>
     * {@linkplain ParameterUtils#addFieldIfAbsentToParameters(IParameterizable, FieldDescriptor, Object)}
     */
    @Test
    public void testAddFieldIfAbsentToParameterizable() {
        IParameterizable parameterizable;
        ParameterDescriptor expected;
    ...
    /**
     * Tests the method:<br>
     * {@linkplain ParameterUtils#addFieldIfAbsentToParameters(Collection, FieldDescriptor, Object)}
     */
    @Test
    public void testAddFieldIfAbsentToParameters() {
        List<Parameter> parameters;
        ParameterDescriptor expected;
    ...
    /**
     * Tests the method:<br>
     * {@linkplain ParameterUtils#addFieldIfAbsentToParameterDescriptors(Collection, FieldDescriptor, Object)}
     */
    @Test
    public void testAddFieldIfAbsentToParameterDescriptors() {
        List<ParameterDescriptor> parameterDescriptors;
        ParameterDescriptor expected;
    ...
    /**
     * Tests the method:<br>
     * {@linkplain ParameterUtils#removeFieldFromParameters(IParameterizable, FieldDescriptor)}
     */
    @Test
    public void testRemoveFieldFromParameterizable() {
        ...
        final Parameter parameter3 = new Parameter(parameterDescriptor3, 4.7);
        final List<Parameter> parameters = Arrays.asList(parameter1, parameter2, parameter3);
        final IParameterizable parameterizable = new SimpleParameterizable(parameters);

        ParameterUtils.removeFieldFromParameters(parameterizable, DATE);
        Assert.assertFalse(parameterDescriptor1.contains(DATE));
        Assert.assertFalse(parameterDescriptor2.contains(DATE));
        Assert.assertFalse(parameterDescriptor3.contains(DATE));

        ParameterUtils.removeFieldFromParameters(parameterizable, ID);
        Assert.assertFalse(parameterDescriptor1.contains(ID));
        Assert.assertFalse(parameterDescriptor2.contains(ID));
        Assert.assertTrue(parameterDescriptor3.contains(ID)); // Immutable
    }

    /**
     * Tests the method:<br>
     * {@linkplain ParameterUtils#removeFieldFromParameters(Collection, FieldDescriptor)}
     */
    @Test
    public void testRemoveFieldFromParameters() {
        final ParameterDescriptor parameterDescriptor1 = new ParameterDescriptor();
        parameterDescriptor1.addField(ID, "SAT1");
        parameterDescriptor1.addField(COORDINATE, CartesianCoordinate.X);
        parameterDescriptor1.addField(DATE, AbsoluteDate.J2000_EPOCH);
        ...
        ParameterUtils.removeFieldFromParameters(parameters, DATE);
        Assert.assertFalse(parameterDescriptor1.contains(DATE));
        Assert.assertFalse(parameterDescriptor2.contains(DATE));
        Assert.assertFalse(parameterDescriptor3.contains(DATE));

        ParameterUtils.removeFieldFromParameters(parameters, ID);
        Assert.assertFalse(parameterDescriptor1.contains(ID));
        Assert.assertFalse(parameterDescriptor2.contains(ID));
        Assert.assertTrue(parameterDescriptor3.contains(ID)); // Immutable
    }
