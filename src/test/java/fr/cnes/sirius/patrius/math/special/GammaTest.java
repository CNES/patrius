...
/**
 * @version $Id: GammaTest.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class GammaTest {
    private void testRegularizedGamma(final double expected, final double a, final double x) {
        final double actualP = Gamma.regularizedGammaP(a, x);
        final double actualQ = Gamma.regularizedGammaQ(a, x);
    ...
    public void testDigammaSmallArgs() {
        ...
        final double[] expected = { -10.423754940411076795, -100.56088545786867450, -1000.5755719318103005,
            ...
            -1.0000000000057721566e11,
            -1.0000000000005772157e12, -1.0000000000000577216e13, -1.0000000000000057722e14,
            -1.0000000000000005772e15, -1e+16,
            -1e+17, -1e+18, -1e+19, -1e+20, -1e+21, -1e+22, -1e+23, -1e+24, -1e+25, -1e+26,
            -1e+27, -1e+28, -1e+29, -1e+30 };
        for (double n = 1; n < 30; n++) {
            this.checkRelativeError(String.format("Test %.0f: ", n), expected[(int) (n - 1)],
                Gamma.digamma(MathLib.pow(10.0, -n)), 1e-8);
        }
    }
    ...
    /**
     * <p>
     * Reference values for the {@link Gamma#invGamma1pm1(double)} method. These values were generated with the
     * following <a href="http://maxima.sourceforge.net/">Maxima</a> script
     * </p>
     * 
     * <pre>
     * kill(all);
    ...
    private void checkRelativeError(final String msg, final double expected, final double actual,
                                    final double tolerance) {

        Assert.assertEquals(msg, expected, actual, MathLib.abs(tolerance * actual));
    }
}
