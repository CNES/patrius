...
public class PolygonsSetTest {
    ...
    public void testEmpty() {
        ...
        final PolygonsSet set = this.buildSet(vertices);
        Assert.assertEquals(Double.POSITIVE_INFINITY, set.getSize(), 0.);
        this.checkVertices(set.getVertices(), vertices);
    }
    ...
    public void testOpenLoop() {
        ...
        for (final Vector2D[] vertice : vertices) {
            ...
            for (int j = 0; j < l - 1; ++j) {
                edges.add(this.buildSegment(vertice[j], vertice[(j + 1) % l]));
            }
        }
    ...
    public void testSimplyConnected() {
        ...
        this.checkPoints(Region.Location.INSIDE, set, new Vector2D[] {
        ...
        this.checkPoints(Region.Location.OUTSIDE, set, new Vector2D[] {
        ...
        this.checkPoints(Region.Location.BOUNDARY, set, new Vector2D[] {
    ...
    public void testUnlimitedSubHyperplane() {
        ...
        final PolygonsSet set1 = this.buildSet(vertices1);
        ...
        final PolygonsSet set2 = this.buildSet(vertices2);

        final PolygonsSet set =
            (PolygonsSet) new RegionFactory<Euclidean2D>().union(set1.copySelf(),
                set2.copySelf());
        this.checkVertices(set1.getVertices(), vertices1);
        this.checkVertices(set2.getVertices(), vertices2);
        this.checkVertices(set.getVertices(), new Vector2D[][] {
            new Vector2D[] {
                new Vector2D(0.0, 0.0),
    ...
    public void testBug20040520() {
        ...
        final BSPTree<Euclidean2D> a8 =
            new BSPTree<Euclidean2D>(this.buildLine(new Vector2D(0.85, -0.25),
                new Vector2D(0.85, 0.05)),
                a2, a7, null);
        final BSPTree<Euclidean2D> a9 =
            new BSPTree<Euclidean2D>(this.buildLine(new Vector2D(0.90, 0.05),
                new Vector2D(0.90, -0.50)),
                a8, new BSPTree<Euclidean2D>(Boolean.FALSE), null);

        final BSPTree<Euclidean2D> b0 =
            new BSPTree<Euclidean2D>(this.buildSegment(new Vector2D(0.92, -0.12),
        ...
        final BSPTree<Euclidean2D> b1 =
            new BSPTree<Euclidean2D>(this.buildHalfLine(new Vector2D(0.92, -0.08),
                new Vector2D(0.90, -0.10),
                true),
                new BSPTree<Euclidean2D>(Boolean.FALSE), b0, null);
        final BSPTree<Euclidean2D> b2 =
            new BSPTree<Euclidean2D>(this.buildSegment(new Vector2D(0.92, -0.18),
                new Vector2D(0.92, -0.12)),
                new BSPTree<Euclidean2D>(Boolean.FALSE), new BSPTree<Euclidean2D>(Boolean.TRUE),
                null);
        final BSPTree<Euclidean2D> b3 =
            new BSPTree<Euclidean2D>(this.buildSegment(new Vector2D(0.85, -0.15),
                new Vector2D(0.90, -0.20)),
                new BSPTree<Euclidean2D>(Boolean.FALSE), b2, null);
        final BSPTree<Euclidean2D> b4 =
            new BSPTree<Euclidean2D>(this.buildSegment(new Vector2D(0.95, -0.15),
                new Vector2D(0.85, -0.05)),
                b1, b3, null);
        ...
        final BSPTree<Euclidean2D> b6 =
            new BSPTree<Euclidean2D>(this.buildLine(new Vector2D(0.0, -1.10),
        ...
        this.checkPoints(Region.Location.INSIDE, c, new Vector2D[] {
        ...
        this.checkPoints(Region.Location.OUTSIDE, c, new Vector2D[] {
        ...
        this.checkVertices(c.getVertices(),
            new Vector2D[][] {
            new Vector2D[] {
                new Vector2D(0.85, -0.15),
                new Vector2D(0.90, -0.20),
    ...
    public void testBug20041003() {
        ...
        final BSPTree<Euclidean2D> node1 =
            new BSPTree<Euclidean2D>(new SubLine(l[0],
                new IntervalsSet(this.intersectionAbscissa(l[0], l[1]),
                    this.intersectionAbscissa(l[0], l[2]))),
        ...
        final BSPTree<Euclidean2D> node2 =
            new BSPTree<Euclidean2D>(new SubLine(l[1],
                new IntervalsSet(this.intersectionAbscissa(l[1], l[2]),
                    this.intersectionAbscissa(l[1], l[3]))),
                node1, new BSPTree<Euclidean2D>(Boolean.FALSE), null);
        final BSPTree<Euclidean2D> node3 =
            new BSPTree<Euclidean2D>(new SubLine(l[2],
                new IntervalsSet(this.intersectionAbscissa(l[2], l[3]),
    ...
    public void testMinMaxSize() {
        ...
        this.checkVertices(vertices, arrayVertices1);
    ...
    public void testSort() {
        ...
        this.checkVertices(polygonSortedTrigo.getVertices(), sortedVerticesTrigo);
        ...
        this.checkVertices(polygonSortedClockWise.getVertices(), sortedVerticesClockWise);

        // Polygons created with sortedVerticesTrigo or sortedVerticesClockWise should give the same results
        Assert.assertTrue(this.checkPolygonsEquality(polygonSortedTrigo, polygonSortedClockWise));
        ...
        this.checkVertices(polygonCrossingBorders.getVertices(), verticesCrossingBorders);
        ...
        this.checkVertices(polygonSortedTrigo.getVertices(), verticesSortedTrigo);
        Assert.assertEquals(EnumPolygon.CONVEX, polygonSortedTrigo.getClassification());
        ...
        this.checkVertices(polygonSortedClock.getVertices(), verticesSortedTrigo);

        // Polygons created with sortedVerticesTrigo or sortedVerticesClockWise should give the same results
        Assert.assertTrue(this.checkPolygonsEquality(polygonSortedTrigo, polygonSortedClock));
        Assert.assertTrue(this.checkPolygonsEquality(polygonSortedTrigo, polygonCrossingBorders));
        ...
        this.checkVertices(polygonCrossingBorders2.getVertices(), verticesCrossingBorders2);
        ...
        this.checkVertices(polygonSortedTrigo2.getVertices(), verticesSortedTrigo2);
        ...
        this.checkVertices(polygonSortedCW.getVertices(), verticesSortedCW);

        // Polygons created with sortedVerticesTrigo or sortedVerticesClockWise should give the same results
        Assert.assertTrue(this.checkPolygonsEquality(polygonSortedTrigo2, polygonSortedCW));
        Assert.assertTrue(this.checkPolygonsEquality(polygonSortedTrigo2, polygonCrossingBorders2));
    }
    ...
    public void testCheckPolygonSet() {
        ...
        final ArrayList<SubHyperplane<Euclidean2D>> edges4 = new ArrayList<SubHyperplane<Euclidean2D>>();
        for (int i = 0; i < vertices.length; ++i) {
            final int l = vertices4[i].length;
            for (int j = 0; j < l; ++j) {
                edges4.add(this.buildSegment(vertices4[i][j], vertices4[i][(j + 1) % l]));
            }
        }
    ...
    private boolean checkPolygonsEquality(final PolygonsSet p1, final PolygonsSet p2) {
    ...
    private PolygonsSet buildSet(final Vector2D[][] vertices) {
        final ArrayList<SubHyperplane<Euclidean2D>> edges = new ArrayList<SubHyperplane<Euclidean2D>>();
        for (final Vector2D[] vertice : vertices) {
            final int l = vertice.length;
            for (int j = 0; j < l; ++j) {
    ...
    private SubHyperplane<Euclidean2D> buildLine(final Vector2D start, final Vector2D end) {
        return new Line(start, end).wholeHyperplane();
    }

    private double intersectionAbscissa(final Line l0, final Line l1) {
        final Vector2D p = l0.intersection(l1);
        return (l0.toSubSpace(p)).getX();
    }

    private SubHyperplane<Euclidean2D> buildHalfLine(final Vector2D start, final Vector2D end,
    ...
    private SubHyperplane<Euclidean2D> buildSegment(final Vector2D start, final Vector2D end) {
        final Line line = new Line(start, end);
    ...
    private void checkPoints(final Region.Location expected, final PolygonsSet set,
    ...
    private boolean checkInSegment(final Vector2D p,
    ...
    private void checkVertices(final Vector2D[][] rebuiltVertices,
            ...
            for (int j = 0; j < rebuiltVertice.length; ++j) {
                ...
                for (final Vector2D[] loop : vertices) {
                    ...
                    for (int l = 0; (!inSegment) && (l < length); ++l) {
                        inSegment = this.checkInSegment(p, loop[l], loop[(l + 1) % length], 1.0e-10);
                    }
                }
