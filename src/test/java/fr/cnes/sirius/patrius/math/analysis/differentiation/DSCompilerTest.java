...
public class DSCompilerTest {
    ...
    public void testMultiplicationRules() {
        ...
        final Map<String, String> referenceRules = new HashMap<>();
        ...
        for (int i = 0; i < 5; ++i) {
            for (int j = 0; j < 4; ++j) {
                ...
                for (int k = 0; k < multIndirection.length; ++k) {
                    final String product = ordersToString(compiler.getPartialDerivativeOrders(k),
                        "(f*g)", "x", "y", "z", "t");
    ...
    private static void checkIndices(final int[] indices, final int... expected) {
    ...
    private static String orderToString(final int order, final String functionName, final String parameterName) {
        if (order == 0) {
            return functionName;
        } else if (order == 1) {
    ...
    private static
        String
            ordersToString(final int[] orders, final String functionName, final String... parametersNames) {
