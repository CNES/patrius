...
public final class MatrixUtilsTest {
    ...
    public void testcreateFieldMatrix() {
        Assert.assertEquals(new Array2DRowFieldMatrix<>(asFraction(this.testData)),
            MatrixUtils.createFieldMatrix(asFraction(this.testData)));
        Assert.assertEquals(new Array2DRowFieldMatrix<>(FractionField.getInstance(),
    ...
    public void testCreateRowFieldMatrix() {
        Assert.assertEquals(MatrixUtils.createRowFieldMatrix(asFraction(this.row)),
            new Array2DRowFieldMatrix<>(asFraction(this.rowMatrix)));
        Assert.assertEquals(MatrixUtils.createRowFieldMatrix(this.fractionRow),
            new Array2DRowFieldMatrix<>(this.fractionRowMatrix));
        try {
    ...
    public void testCreateColumnFieldMatrix() {
        Assert.assertEquals(MatrixUtils.createColumnFieldMatrix(asFraction(this.col)),
            new Array2DRowFieldMatrix<>(asFraction(this.colMatrix)));
        Assert.assertEquals(MatrixUtils.createColumnFieldMatrix(this.fractionCol),
            new Array2DRowFieldMatrix<>(this.fractionColMatrix));
     ...
     */
    protected static void checkIdentityMatrix(final RealMatrix m) {
     ...
     * Verifies that the matrix is an identity matrix
     */
    protected static void checkIdentityFieldMatrix(final FieldMatrix<Fraction> m) {
        for (int i = 0; i < m.getRowDimension(); i++) {
            for (int j = 0; j < m.getColumnDimension(); j++) {
                if (i == j) {
    ...
    public void testBigFractionConverter() {
        ...
        final FieldMatrix<BigFraction> m = new Array2DRowFieldMatrix<>(bfData, false);
    ...
    public void testFractionConverter() {
        ...
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(fData, false);
