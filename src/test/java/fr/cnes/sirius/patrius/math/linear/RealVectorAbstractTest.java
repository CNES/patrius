...
public abstract class RealVectorAbstractTest {
    ...
    public RealVectorAbstractTest() {
         ...
         * implementations).
         */
        final double x = this.getPreferredEntryValue();
        final double y = x + 1d;
        final double z = y + 1d;
    ...
    public void testGetDimension() {
        ...
        Assert.assertEquals(data1.length, this.create(data1).getDimension());
        final double y = x + 1;
        final double[] data2 = { y, y, y, y };
        Assert.assertEquals(data2.length, this.create(data2).getDimension());
    }
    ...
    public void testGetEntry() {
        ...
        final RealVector v = this.create(data);
    ...
    public void testSetEntry() {
        ...
        final RealVector actual = this.create(data);
    ...
    public void testAddToEntry() {
        ...
        final RealVector actual = this.create(data1);
    ...
    public void testAppendVector() {
        ...
        this.doTestAppendVector("same type", this.create(data1), this.create(data2), 0d);
        this.doTestAppendVector("mixed types", this.create(data1), this.createAlien(data2), 0d);
    }
    ...
    public void testAppendScalar() {
        ...
        this.doTestAppendScalar("", this.create(data), 1d, 0d);
        this.doTestAppendScalar("", this.create(data), x, 0d);
    }
    ...
    public void testGetSubVector() {
        ...
        final RealVector actual = this.create(data).getSubVector(index, n);
    ...
    public void testGetSubVectorInvalidIndex1() {
        final int n = 10;
        this.create(new double[n]).getSubVector(-1, 2);
    }

    @Test(expected = OutOfRangeException.class)
    public void testGetSubVectorInvalidIndex2() {
        final int n = 10;
        this.create(new double[n]).getSubVector(n, 2);
    }

    @Test(expected = OutOfRangeException.class)
    public void testGetSubVectorInvalidIndex3() {
        final int n = 10;
        this.create(new double[n]).getSubVector(0, n + 1);
    }

    @Test(expected = NotPositiveException.class)
    public void testGetSubVectorInvalidIndex4() {
        final int n = 10;
        this.create(new double[n]).getSubVector(3, -2);
    }
    ...
    public void testSetSubVectorSameType() {
        ...
        final RealVector actual = this.create(expected);
        final int index = 2;
        actual.setSubVector(index, this.create(sub));
    ...
    public void testSetSubVectorMixedType() {
        ...
        final RealVector actual = this.create(expected);
        final int index = 2;
        actual.setSubVector(index, this.createAlien(sub));
    ...
    public void testIsNaN() {
        final RealVector v = this.create(new double[] { 0, 1, 2 });
    ...
    private void doTestEbeBinaryOperation(final BinaryOperation op, final boolean mixed) {
        ...
        final RealVector v1 = this.create(data1);
        final RealVector v2 = mixed ? this.createAlien(data2) : this.create(data2);
    ...
    private void doTestEbeBinaryOperationDimensionMismatch(final BinaryOperation op) {
        ...
        switch (op) {
            case ADD:
                this.create(new double[n]).add(this.create(new double[n + 1]));
                break;
            case SUB:
                this.create(new double[n]).subtract(this.create(new double[n + 1]));
                break;
            default:
                throw new AssertionError("unexpected value");
        }
    ...
    public void testAddSameType() {
        this.doTestEbeBinaryOperation(BinaryOperation.ADD, false);
    }

    @Test
    public void testAddMixedTypes() {
        this.doTestEbeBinaryOperation(BinaryOperation.ADD, true);
    }
    ...
    public void testSubtractSameType() {
        this.doTestEbeBinaryOperation(BinaryOperation.SUB, false);
    }

    @Test
    public void testSubtractMixedTypes() {
        this.doTestEbeBinaryOperation(BinaryOperation.SUB, true);
    }
    ...
    public void testEbeMultiplySameType() {
        this.doTestEbeBinaryOperation(BinaryOperation.MUL, false);
    }

    @Ignore("ebeMultiply(RealVector) is known to be faulty (MATH-803) and is deprecated.")
    @Test
    public void testEbeMultiplyMixedTypes() {
        this.doTestEbeBinaryOperation(BinaryOperation.MUL, true);
    }
    ...
    public void testEbeDivideSameType() {
        this.doTestEbeBinaryOperation(BinaryOperation.DIV, false);
    }

    @Ignore("ebeDivide(RealVector) is known to be faulty (MATH-803) and is deprecated.")
    @Test
    public void testEbeDivideMixedTypes() {
        this.doTestEbeBinaryOperation(BinaryOperation.DIV, true);
    }
    ...
    private void doTestGetDistance(final boolean mixed) {
        ...
        final RealVector v2;
        if (mixed) {
            v2 = this.createAlien(data2);
        } else {
            v2 = this.create(data2);
        }
    ...
    private void doTestMapBinaryOperation(final BinaryOperation op, final boolean inPlace) {
        ...
        for (final double d : this.values) {
            ...
            final RealVector v = this.create(this.values);
            final RealVector actual;
            if (inPlace) {
                switch (op) {
                    case ADD:
    ...
    @Test
    public void testMap() {
        final UnivariateFunction[] functions = this.createFunctions();
    ...
    private void doTestOuterProduct(final boolean mixed) {
        ...
        final RealVector u = this.create(dataU);
    ...
    public void testProjectionDimensionMismatch() {
        final RealVector v1 = this.create(new double[4]);
        final RealVector v2 = this.create(new double[5]);
        v2.set(1.0);
        v1.projection(v2);
    }
    ...
    public void testToArray() {
        final double[] data = this.create(this.values).toArray();
    ...
    private void doTestCombineDimensionMismatch(final boolean inPlace, final boolean mixed) {
        final RealVector v1 = this.create(new double[10]);
        final RealVector v2;
        if (mixed) {
            v2 = this.createAlien(new double[15]);
        } else {
            v2 = this.create(new double[15]);
        }
        if (inPlace) {
    ...
    public void testCosineLeftNullVector() {
        final RealVector v = this.create(new double[] { 0, 0, 0 });
        final RealVector w = this.create(new double[] { 1, 0, 0 });
        v.cosine(w);
    }
    ...
    public void testCosineDimensionMismatch() {
        final RealVector v = this.create(new double[] { 1, 2, 3 });
        final RealVector w = this.create(new double[] { 1, 2, 3, 4 });
        v.cosine(w);
    }
    ...
    public void testMinMax() {
        final RealVector v1 = this.create(new double[] { 0, -6, 4, 12, 7 });
        ...
        final RealVector v2 = this.create(new double[] { Double.NaN, 3, Double.NaN, -2 });
        ...
        final RealVector v3 = this.create(new double[] { Double.NaN, Double.NaN });
        ...
        final RealVector v4 = this.create(new double[0]);
    ...
    public void testWalkInDefaultOrderPreservingVisitor2() {
        final RealVector v = this.create(new double[5]);
        final RealVectorPreservingVisitor visitor;
        visitor = new RealVectorPreservingVisitor(){
