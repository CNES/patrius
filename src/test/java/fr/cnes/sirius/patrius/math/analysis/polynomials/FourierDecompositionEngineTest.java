...
public class FourierDecompositionEngineTest {
     ...
     * @output nothing
     * 
     * @testPassCriteria fails if function is null, if period is <= 0 and if the period isnt the
     *                   functions period.
     ...
     * @output nothing
     * 
     * @testPassCriteria values of decomposed function are the same as reference ones. depending on
     *                   integrator
     *                   parameters, precision varies. Something close to 1e-14 is set for standard
     *                   functions 1 is set
     *                   for the square function, to take into account the <a
     *                   href="http://en.wikipedia.org/wiki/Gibbs_phenomenon">Gibbs phenomenon</a>. <br>
     *                   A validation of the computed coefficients is also undertaken. Coefficients
     *                   are validated to
     *                   1e-14.
     * 
     * @referenceVersion 1.2
    ...
    public void testDecompose() {
        ...
        checkApproximation(this.result, MAXEPS);
        check(this.result, MAXEPS, FType.COS);
     ...
     * The cosine coefficient should be null. The 2*k-1 order (k >= 1) sine coefficient should be
     * equal to : <code>4 / (pi * (2*k -1)</code> and other should be equal to 0.
     * 
     * @param approx
     ...
     * 
     * @see <a href="http://en.wikipedia.org/wiki/Square_wave#Examining_the_square_wave">Square
     *      waves approximation</a>
     */
    private static void check(final FourierSeriesApproximation approx, final double eps,
            final FType type) {
     ...
     *        threshold
     */
    private static void checkApproximation(final FourierSeriesApproximation f, final double d) {
    ...
    public void setUp() {
        ...
        this.function1 = new UnivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 2370448185571684503L;
        ...
        this.function2 = new UnivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = -3806926127185670092L;
        ...
        this.function3 = new UnivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 8762571565015166204L;
        ...
        this.function4 = new UnivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 3072124374781435820L;
    ...
    // *
    // */
    // public void writeFiles(final FourierSeriesApproximation f, final String label) throws
    // IOException {
    //
