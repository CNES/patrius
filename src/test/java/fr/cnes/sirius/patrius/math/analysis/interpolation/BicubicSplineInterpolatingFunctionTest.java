...
public final class BicubicSplineInterpolatingFunctionTest {
    ...
    public void testPreconditions() {
        ...
        new BicubicSplineInterpolatingFunction(xval, yval, zval, zval, zval, zval);
    ...
    /**
     * Added TU : test the no data case for the constructor of
     * {@link BicubicSplineInterpolatingFunction}.
     */
    @Test
    public void testPreconditionsNoDataCase() {
        try {
            final BivariateFunction bcf = new BicubicSplineInterpolatingFunction(new double[0],
                    new double[1], new double[0][0], new double[0][0], new double[0][0],
                    new double[0][0]);
        ...
        try {
            final BivariateFunction bcf = new BicubicSplineInterpolatingFunction(new double[1],
                    new double[0], new double[0][0], new double[0][0], new double[0][0],
                    new double[0][0]);
            Assert.fail("expecting NoDataException but got : " + bcf);
        } catch (final NoDataException ex) {
            // expected
        ...
        try {
            final BivariateFunction bcf = new BicubicSplineInterpolatingFunction(new double[1],
                    new double[1], new double[1][0], new double[0][0], new double[0][0],
                    new double[0][0]);
            Assert.fail("expecting NoDataException but got : " + bcf);
        } catch (final NoDataException ex) {
            // expected
    ...
    public void testPlane() {
        ...
        final BivariateFunction f = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 1905097767137774795L;
    ...
    /**
     * Added TU : test the limit cases of {@link BicubicSplineInterpolatingFunction} when the
    ...
    public void testPlaneLimitCases() {
        ...
        final BivariateFunction f = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = -980517581355111685L;
    ...
    public void testParaboloid() {
        ...
        final BivariateFunction f = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 7736131969245128265L;
        ...
        final BivariateFunction dfdX = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = -1453740050524423685L;
        ...
        final BivariateFunction dfdY = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 3727756541868014966L;
    ...
    public void testParaboloidLimitCases() {
        ...
        final BivariateFunction f = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = -7927234756615600480L;
        ...
        final BivariateFunction dfdX = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 3250188245405012221L;
        ...
        final BivariateFunction dfdY = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = -6783506709799487049L;
    ...
    public void testSplinePartialDerivatives() {
        ...
        // create 5 BicubicSplineFunction for coverage purpuses (when method partialDerivative? is
        // called,
        ...
        derivative = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = -3259516048348133141L;
        ...
        derivative = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = -4844924819877272037L;
        ...
        Assert.assertEquals("dFdY", derivative.value(x, y), f2.partialDerivativeY().value(x, y),
                tol);

        derivative = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 2670155765975261160L;
        ...
        Assert.assertEquals("d2FdX2", derivative.value(x, y), f3.partialDerivativeXX().value(x, y),
                tol);

        derivative = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 5907318824936732242L;
        ...
        Assert.assertEquals("d2FdY2", derivative.value(x, y), f4.partialDerivativeYY().value(x, y),
                tol);

        derivative = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 4637768966827810846L;
     ...
     * data.
     * <p>
     * f(x, y) = 5 - 3 x + 2 y - x y + 2 x<sup>2</sup> - 3 y<sup>2</sup> + 4 x<sup>2</sup> y - x
     * y<sup>2</sup> - 3 x<sup>3</sup> + y<sup>3</sup>
     */
    @Test
    public void testMatchingPartialDerivatives() {
        ...
        final BivariateFunction f = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = -7062129422795469515L;
            ...
            public double value(final double x, final double y) {
                ...
                return 5 - 3 * x + 2 * y - x * y + 2 * x2 - 3 * y2 + 4 * x2 * y - x * y2 - 3 * x3
                        + y3;
            }
        };
        ...
        final BivariateFunction dfdX = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 7602349139463831007L;
        ...
        final BivariateFunction dfdY = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 6560803957716703220L;
        ...
        final BivariateFunction d2fdXdY = new BivariateFunction() {
            /** Serializable UID. */
            private static final long serialVersionUID = 2993285126025547902L;
        ...
        final BicubicSplineInterpolatingFunction bcf = new BicubicSplineInterpolatingFunction(val,
                val, fval, dFdX, dFdY, d2FdXdY);
    ...
    /**
     * @description Evaluate the {@link BicubicSplineFunction bicubic spline function} serialization
     *              / deserialization process.
     *
     * @testPassCriteria The bicubic spline function can be serialized and deserialized.
     */
    @Test
    public void testBicubicSplineFunctionSerialization() {
        ...
        final BicubicSplineFunction fct = new BicubicSplineFunction(coeff);
        final BicubicSplineFunction deserializedFct = TestUtils.serializeAndRecover(fct);

        for (double x = 0.; x <= 1.; x += 0.25) {
            for (double y = 0.; y <= 1.; y += 0.25) {
                Assert.assertEquals(fct.value(x, y), deserializedFct.value(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeX().value(x, y), deserializedFct
                        .partialDerivativeX().value(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeY().value(x, y), deserializedFct
                        .partialDerivativeY().value(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeXX().value(x, y), deserializedFct
                        .partialDerivativeXX().value(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeYY().value(x, y), deserializedFct
                        .partialDerivativeYY().value(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeXY().value(x, y), deserializedFct
                        .partialDerivativeXY().value(x, y), 1e-13);
            }
        }
    }

    /**
     * @description Evaluate the {@link BicubicSplineInterpolatingFunction bicubic spline
     *              interpolation function} serialization / deserialization process.
     *
     * @testPassCriteria The bicubic spline interpolation function can be serialized and
     *                   deserialized.
     */
    @Test
    public void testBicubicSplineInterpolatingFunctionSerialization() {

        final double[] xval = new double[] { 3, 4, 5, 6.5 };
        final double[] yval = new double[] { -4, -3, -1, 2.5 };
        final double[][] zval = new double[xval.length][yval.length];

        final BicubicSplineInterpolatingFunction fct = new BicubicSplineInterpolatingFunction(xval,
                yval, zval, zval, zval, zval);
        final BicubicSplineInterpolatingFunction deserializedFct = TestUtils
                .serializeAndRecover(fct);

        for (double x = 3.; x <= 6.5; x += 0.5) {
            for (double y = -4.; y <= 2.5; y += 0.5) {
                Assert.assertEquals(fct.value(x, y), deserializedFct.value(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeX(x, y),
                        deserializedFct.partialDerivativeX(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeY(x, y),
                        deserializedFct.partialDerivativeY(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeXX(x, y),
                        deserializedFct.partialDerivativeXX(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeYY(x, y),
                        deserializedFct.partialDerivativeYY(x, y), 1e-13);
                Assert.assertEquals(fct.partialDerivativeXY(x, y),
                        deserializedFct.partialDerivativeXY(x, y), 1e-13);
            }
        }
    }
}
