...
public final class EmpiricalDistributionTest extends RealDistributionAbstractTest {
    ...
    public void testSerialization() {
        ...
        EmpiricalDistribution dist2 = TestUtils.serializeAndRecover(dist);
        verifySame(dist, dist2);

        // Loaded
        this.empiricalDistribution2.load(this.dataArray);
        dist2 = TestUtils.serializeAndRecover(this.empiricalDistribution2);
        verifySame(this.empiricalDistribution2, dist2);
    }
    ...
    private static void verifySame(final EmpiricalDistribution d1, final EmpiricalDistribution d2) {
    ...
    public void testDensityIntegrals() {
        ...
        final UnivariateFunction d = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = -5504124050487571813L;
     ...
     */
    private static int findBin(final double x) {
     ...
     * standard deviation.
     */
    private static RealDistribution findKernel(final double lower, final double upper) {
        if (lower < 1) {
