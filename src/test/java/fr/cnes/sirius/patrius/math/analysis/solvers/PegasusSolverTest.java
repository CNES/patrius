 ...
 * 
 * @version $Id: PegasusSolverTest.java 18108 2017-10-04 06:45:27Z bignon $
 */
public final class PegasusSolverTest extends BaseSecantSolverAbstractTest {
    /** {@inheritDoc} */
    @Override
    protected UnivariateSolver getSolver() {
        // This call done for code coverage only
        final PegasusSolver unused = new PegasusSolver(1.);
