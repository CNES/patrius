...
public class BracketFinderTest {
    ...
    public void testCubicMin() {
        ...
        final UnivariateFunction func = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = 3784230548941113839L;
    ...
    public void testCubicMax() {
        ...
        final UnivariateFunction func = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = 7037047878850055573L;
    ...
    public void testMinimumIsOnIntervalBoundary() {
        final UnivariateFunction func = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = -8939572343989671929L;
    ...
    public void testIntervalBoundsOrdering() {
        final UnivariateFunction func = new UnivariateFunction(){
            /** Serializable UID. */
            private static final long serialVersionUID = 8046560791910321112L;
