...
public class CovarianceTest {
    ...
    public void testLongly() {
        ...
        TestUtils.assertEquals("covariance matrix", this.createRealMatrix(rData, 7, 7), covarianceMatrix, 10E-9);
    ...
    public void testInsufficientData() {
        ...
        final RealMatrix matrix = new Array2DRowRealMatrix(new double[][] { { 0 }, { 1 } });
        try {
    ...
    public void testConsistency() {
        ...
        final RealMatrix repeatedColumns = new Array2DRowRealMatrix(47, 3);
        for (int i = 0; i < 3; i++) {
            repeatedColumns.setColumnMatrix(i, matrix.getColumnMatrix(0));
        }
        final RealMatrix repeatedCovarianceMatrix = new Covariance(repeatedColumns).getCovarianceMatrix();
        final double columnVariance = variance.evaluate(matrix.getColumn(0));
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
