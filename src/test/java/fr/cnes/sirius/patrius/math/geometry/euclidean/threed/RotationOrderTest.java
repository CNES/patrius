...
public class RotationOrderTest {
    ...
    public void testName() {
        ...
        for (final RotationOrder order : orders) {
            Assert.assertEquals(getFieldName(order), order.toString());
        }

    }

    private static String getFieldName(final RotationOrder order) {
        try {
    ...
    public void testEqualsAndHashCode() {
        ...
        // New instance
        final RotationOrder instance = RotationOrder.XYZ;
        ...
        final RotationOrder other = RotationOrder.YXY;
