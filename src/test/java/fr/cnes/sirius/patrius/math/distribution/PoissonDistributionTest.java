 ...
 * 
 * @version $Id: PoissonDistributionTest.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class PoissonDistributionTest extends IntegerDistributionAbstractTest {
    ...
    public double[] makeInverseCumulativeTestPoints() {
        final IntegerDistribution dist = this.getDistribution();
    ...
    public void testLargeMeanCumulativeProbability() {
        ...
        while (mean <= 10000000.0) {
            ...
            double p = Double.NaN;
            final double sigma = MathLib.sqrt(mean);
            while (x >= 0) {
                try {
    ...
    private void checkProbability(final PoissonDistribution dist, final int x) {
