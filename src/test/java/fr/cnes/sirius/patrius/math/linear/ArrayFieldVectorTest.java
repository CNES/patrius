...
public class ArrayFieldVectorTest {
    ...
    public void testConstructors() {
        ...
        final ArrayFieldVector<Fraction> v0 = new ArrayFieldVector<Fraction>(FractionField.getInstance());
        Assert.assertEquals(0, v0.getDimension());

        final ArrayFieldVector<Fraction> v1 = new ArrayFieldVector<Fraction>(FractionField.getInstance(), 7);
        Assert.assertEquals(7, v1.getDimension());
        Assert.assertEquals(new Fraction(0), v1.getEntry(6));

        final ArrayFieldVector<Fraction> v2 = new ArrayFieldVector<Fraction>(5, new Fraction(123, 100));
        Assert.assertEquals(5, v2.getDimension());
        Assert.assertEquals(new Fraction(123, 100), v2.getEntry(4));

        final ArrayFieldVector<Fraction> v3 = new ArrayFieldVector<Fraction>(FractionField.getInstance(), this.vec1);
        Assert.assertEquals(3, v3.getDimension());
        Assert.assertEquals(new Fraction(2), v3.getEntry(1));

        final ArrayFieldVector<Fraction> v4 =
            new ArrayFieldVector<Fraction>(FractionField.getInstance(), this.vec4, 3, 2);
        Assert.assertEquals(2, v4.getDimension());
        Assert.assertEquals(new Fraction(4), v4.getEntry(0));
        try {
            new ArrayFieldVector<Fraction>(this.vec4, 8, 3);
            Assert.fail("MathIllegalArgumentException expected");
        } catch (final MathIllegalArgumentException ex) {
            // expected behavior
        }

        final FieldVector<Fraction> v5_i = new ArrayFieldVector<Fraction>(this.dvec1);
        Assert.assertEquals(9, v5_i.getDimension());
        Assert.assertEquals(new Fraction(9), v5_i.getEntry(8));

        final ArrayFieldVector<Fraction> v5 = new ArrayFieldVector<Fraction>(this.dvec1);
        Assert.assertEquals(9, v5.getDimension());
        Assert.assertEquals(new Fraction(9), v5.getEntry(8));

        final ArrayFieldVector<Fraction> v6 = new ArrayFieldVector<Fraction>(this.dvec1, 3, 2);
        Assert.assertEquals(2, v6.getDimension());
        Assert.assertEquals(new Fraction(4), v6.getEntry(0));
        try {
            new ArrayFieldVector<Fraction>(this.dvec1, 8, 3);
            Assert.fail("MathIllegalArgumentException expected");
        } catch (final MathIllegalArgumentException ex) {
            // expected behavior
        }

        final ArrayFieldVector<Fraction> v7 = new ArrayFieldVector<Fraction>(v1);
        Assert.assertEquals(7, v7.getDimension());
        Assert.assertEquals(new Fraction(0), v7.getEntry(6));

        final FieldVectorTestImpl<Fraction> v7_i = new FieldVectorTestImpl<Fraction>(this.vec1);

        final ArrayFieldVector<Fraction> v7_2 = new ArrayFieldVector<Fraction>(v7_i);
        Assert.assertEquals(3, v7_2.getDimension());
        Assert.assertEquals(new Fraction(2), v7_2.getEntry(1));

        final ArrayFieldVector<Fraction> v8 = new ArrayFieldVector<Fraction>(v1, true);
        ...
        final ArrayFieldVector<Fraction> v8_2 = new ArrayFieldVector<Fraction>(v1, false);
        ...
        final ArrayFieldVector<Fraction> v9 = new ArrayFieldVector<Fraction>(v1, v3);
    ...
    public void testDataInOut() {
        ...
        final ArrayFieldVector<Fraction> v1 = new ArrayFieldVector<Fraction>(this.vec1);
        final ArrayFieldVector<Fraction> v2 = new ArrayFieldVector<Fraction>(this.vec2);
        final ArrayFieldVector<Fraction> v4 = new ArrayFieldVector<Fraction>(this.vec4);
        final FieldVectorTestImpl<Fraction> v2_t = new FieldVectorTestImpl<Fraction>(this.vec2);
    ...
    public void testMapFunctions() {
        ...
        final Fraction[] result_mapSubtractToSelf = { new Fraction(-1), new Fraction(0), new Fraction(1) };
        ...
        final Fraction[] result_mapMultiplyToSelf = { new Fraction(2), new Fraction(4), new Fraction(6) };
        ...
        final Fraction[] result_mapDivide = { new Fraction(1, 2), new Fraction(1), new Fraction(3, 2) };
        ...
        final Fraction[] result_mapDivideToSelf = { new Fraction(1, 2), new Fraction(1), new Fraction(3, 2) };
        ...
        final Fraction[] result_mapInvToSelf = { new Fraction(1), new Fraction(1, 2), new Fraction(1, 3) };
    ...
    public void testBasicFunctions() {
        final ArrayFieldVector<Fraction> v1 = new ArrayFieldVector<Fraction>(this.vec1);
        final ArrayFieldVector<Fraction> v2 = new ArrayFieldVector<Fraction>(this.vec2);
        new ArrayFieldVector<Fraction>(this.vec_null);
        ...
        final FieldVectorTestImpl<Fraction> vt2 = new FieldVectorTestImpl<Fraction>(this.vec2);
        ...
        final Fraction[] result_ebeMultiply_2 = { new Fraction(4), new Fraction(10), new Fraction(18) };
        ...
        final Fraction[] result_ebeDivide = { new Fraction(1, 4), new Fraction(2, 5), new Fraction(1, 2) };
        ...
        final Fraction[] result_ebeDivide_2 = { new Fraction(1, 4), new Fraction(2, 5), new Fraction(1, 2) };
        ...
        final Fraction[] result_projection = { new Fraction(128, 77), new Fraction(160, 77), new Fraction(192, 77) };
        ...
        final Fraction[] result_projection_2 = { new Fraction(128, 77), new Fraction(160, 77), new Fraction(192, 77) };
    ...
    public void testMisc() {
        final ArrayFieldVector<Fraction> v1 = new ArrayFieldVector<Fraction>(this.vec1);
        final ArrayFieldVector<Fraction> v4 = new ArrayFieldVector<Fraction>(this.vec4);
        final FieldVector<Fraction> v4_2 = new ArrayFieldVector<Fraction>(this.vec4);
    ...
    public void testSerial() {
        final ArrayFieldVector<Fraction> v = new ArrayFieldVector<Fraction>(this.vec1);
    ...
    public void testZeroVectors() {
        ...
        Assert.assertEquals(0,
            new ArrayFieldVector<Fraction>(FractionField.getInstance(), new Fraction[0]).getDimension());
        Assert.assertEquals(0,
            new ArrayFieldVector<Fraction>(FractionField.getInstance(), new Fraction[0], true).getDimension());
        Assert.assertEquals(0,
            new ArrayFieldVector<Fraction>(FractionField.getInstance(), new Fraction[0], false).getDimension());

    }

    @Test
    public void testOuterProduct() {
        final ArrayFieldVector<Fraction> u = new ArrayFieldVector<Fraction>(FractionField.getInstance(),
            new Fraction[] { new Fraction(1),
                new Fraction(2),
                new Fraction(-3) });
        final ArrayFieldVector<Fraction> v = new ArrayFieldVector<Fraction>(FractionField.getInstance(),
    ...
    public void testConstructorsdnull() {
        ...
        try {
            new ArrayFieldVector<Fraction>(d);
            Assert.fail();
        ...
        try {
            new ArrayFieldVector<Fraction>(field, d);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
        ...
        try {
            new ArrayFieldVector<Fraction>(d, copyArray);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
        ...
        try {
            new ArrayFieldVector<Fraction>(field, d, copyArray);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
        ...
        try {
            new ArrayFieldVector<Fraction>(d, 1, 1);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
        ...
        try {
            new ArrayFieldVector<Fraction>(field, d, 1, 1);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
        ...
        try {
            new ArrayFieldVector<Fraction>(v);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
        ...
        try {
            new ArrayFieldVector<Fraction>(v2);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
        ...
        try {
            new ArrayFieldVector<Fraction>(v2, copyArray);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
        ...
        try {
            new ArrayFieldVector<Fraction>(v2, v2);
            Assert.fail();
        } catch (final NullArgumentException ex) {
            // expected behavior
        }
    ...
    public void testNumberIsTooLargeException9thConstructor() {
        ...
        final Field<Fraction> field = FractionField.getInstance();
        new ArrayFieldVector<Fraction>(field, d2, 1, 1);
    }
