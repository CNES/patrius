...
public final class BlockRealMatrixTest {
    ...
    public void testCopyFunctions() {
        ...
        final BlockRealMatrix m1 = createRandomMatrix(r, 47, 83);
    ...
    public void testAdd() {
        ...
        // Add to entry
        m.addToEntry(0, 0, 10.);
        Assert.assertEquals(this.testData[0][0] + 10, m.getEntry(0, 0), 0.);
    }
    ...
    public void testPlusMinus() {
        ...
        assertClose(m.subtract(m2), m2.scalarMultiply(-1d).add(m), this.entryTolerance);
        try {
        ...
        for (int i = 0; i < blockData.length; i++) {
            for (int j = 0; j < blockData[i].length; j++) {
                Assert.assertEquals(this.testData[i][j] - blockData[i][j], result.getEntry(i, j),
                        this.eps);
            }
        }
    ...
    public void testMultiply() {
        ...
        final BlockRealMatrix m2 = new BlockRealMatrix(this.testData2);
        assertClose(m.multiply(mInv), identity, this.entryTolerance);
        assertClose(mInv.multiply(m), identity, this.entryTolerance);
        assertClose(m.multiply(identity), m, this.entryTolerance);
        assertClose(identity.multiply(mInv), mInv, this.entryTolerance);
        assertClose(m2.multiply(identity), m2, this.entryTolerance);
        try {
    ...
    public void testMultiply2() {
        ...
        assertClose(m3.multiply(m4), m5, this.entryTolerance);
    }
    ...
    public void testScalarAdd() {
        ...
        assertClose(new BlockRealMatrix(this.testDataPlus2), m.scalarAdd(2d), this.entryTolerance);
    }
    ...
    public void testOperate() {
        RealMatrix m = new BlockRealMatrix(this.id);
        assertClose(this.testVector, m.operate(this.testVector), this.entryTolerance);
        assertClose(this.testVector, m.operate(new ArrayRealVector(this.testVector)).toArray(),
            this.entryTolerance);
    ...
    public void testOperateLarge() {
        ...
        final RealMatrix m1 = createRandomMatrix(random, p, q);
        final RealMatrix m2 = createRandomMatrix(random, q, r);
    ...
    public void testTranspose() {
        ...
        assertClose(mIT, mTI, this.normTolerance);
        m = new BlockRealMatrix(this.testData2);
        final RealMatrix mt = new BlockRealMatrix(this.testData2T);
        assertClose(mt, m.transpose(), this.normTolerance);
    }
    ...
    public void testPremultiplyVector() {
        RealMatrix m = new BlockRealMatrix(this.testData);
        assertClose(m.preMultiply(this.testVector), this.preMultTest, this.normTolerance);
        assertClose(m.preMultiply(new ArrayRealVector(this.testVector).toArray()),
    ...
    public void testPremultiply() {
        ...
        final RealMatrix m4 = new BlockRealMatrix(this.d4);
        final RealMatrix m5 = new BlockRealMatrix(this.d5);
        assertClose(m4.preMultiply(m3), m5, this.entryTolerance);

        final BlockRealMatrix m = new BlockRealMatrix(this.testData);
        final BlockRealMatrix mInv = new BlockRealMatrix(this.testDataInv);
        final BlockRealMatrix identity = new BlockRealMatrix(this.id);
        assertClose(m.preMultiply(mInv), identity, this.entryTolerance);
        assertClose(mInv.preMultiply(m), identity, this.entryTolerance);
        assertClose(m.preMultiply(identity), m, this.entryTolerance);
        assertClose(identity.preMultiply(mInv), mInv, this.entryTolerance);
        try {
    ...
    public void testGetVectors() {
        final RealMatrix m = new BlockRealMatrix(this.testData);
        assertClose(m.getRow(0), this.testDataRow1, this.entryTolerance);
        assertClose(m.getColumn(2), this.testDataCol3, this.entryTolerance);
        try {
            m.getRow(10);
    ...
    public void testGetColumnVector() {
        final RealMatrix m = new BlockRealMatrix(this.subTestData);
        final RealVector mColumn1 = columnToVector(this.subColumn1);
        final RealVector mColumn3 = columnToVector(this.subColumn3);
    ...
    public void testGetColumn() {
        final RealMatrix m = new BlockRealMatrix(this.subTestData);
        final double[] mColumn1 = columnToArray(this.subColumn1);
        final double[] mColumn3 = columnToArray(this.subColumn3);
    ...
    private static double[] columnToArray(final double[][] column) {
        final double[] data = new double[column.length];
        for (int i = 0; i < data.length; ++i) {
            data[i] = column[i][0];
        }
    ...
    private static void checkArrays(final double[] expected, final double[] actual) {
    ...
    protected static void
            assertClose(final RealMatrix m, final RealMatrix n, final double tolerance) {
        Assert.assertTrue(m.subtract(n).getNorm() < tolerance);
    }

    /** verifies that two vectors are close (sup norm) */
    protected static void assertClose(final double[] m, final double[] n, final double tolerance) {
    ...
    private static BlockRealMatrix createRandomMatrix(final Random r, final int rows,
            final int columns) {
