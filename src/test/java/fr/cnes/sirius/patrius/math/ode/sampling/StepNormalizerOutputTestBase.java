...
public abstract class StepNormalizerOutputTestBase
     ...
     */
    private static double[] getArray(final double[] a, final int offsetL, final int offsetR) {
    ...
    public void testIncNeither()
        ...
        final double[] exp = getArray(this.getExpInc(), this.getO()[0][0], this.getO()[0][1]);
    ...
    public void testIncNeitherRev()
                                   throws DimensionMismatchException, NumberIsTooSmallException,
                                   MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpIncRev(), this.getO()[1][0], this.getO()[1][1]);
    ...
    public void testIncFirst()
                              throws DimensionMismatchException, NumberIsTooSmallException,
                              MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpInc(), this.getO()[2][0], this.getO()[2][1]);
    ...
    public void testIncFirstRev()
                                 throws DimensionMismatchException, NumberIsTooSmallException,
                                 MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpIncRev(), this.getO()[3][0], this.getO()[3][1]);
    ...
    public void testIncLast()
                             throws DimensionMismatchException, NumberIsTooSmallException,
                             MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpInc(), this.getO()[4][0], this.getO()[4][1]);
    ...
    public void testIncLastRev()
                                throws DimensionMismatchException, NumberIsTooSmallException,
                                MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpIncRev(), this.getO()[5][0], this.getO()[5][1]);
    ...
    public void testIncBoth()
                             throws DimensionMismatchException, NumberIsTooSmallException,
                             MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpInc(), this.getO()[6][0], this.getO()[6][1]);
    ...
    public void testIncBothRev()
                                throws DimensionMismatchException, NumberIsTooSmallException,
                                MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpIncRev(), this.getO()[7][0], this.getO()[7][1]);
    ...
    public void testMulNeither()
                                throws DimensionMismatchException, NumberIsTooSmallException,
                                MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpMul(), this.getO()[8][0], this.getO()[8][1]);
    ...
    public void testMulNeitherRev()
                                   throws DimensionMismatchException, NumberIsTooSmallException,
                                   MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpMulRev(), this.getO()[9][0], this.getO()[9][1]);
    ...
    public void testMulFirst()
                              throws DimensionMismatchException, NumberIsTooSmallException,
                              MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpMul(), this.getO()[10][0], this.getO()[10][1]);
    ...
    public void testMulFirstRev()
                                 throws DimensionMismatchException, NumberIsTooSmallException,
                                 MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpMulRev(), this.getO()[11][0], this.getO()[11][1]);
    ...
    public void testMulLast()
                             throws DimensionMismatchException, NumberIsTooSmallException,
                             MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpMul(), this.getO()[12][0], this.getO()[12][1]);
    ...
    public void testMulLastRev()
                                throws DimensionMismatchException, NumberIsTooSmallException,
                                MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpMulRev(), this.getO()[13][0], this.getO()[13][1]);
    ...
    public void testMulBoth()
                             throws DimensionMismatchException, NumberIsTooSmallException,
                             MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpMul(), this.getO()[14][0], this.getO()[14][1]);
    ...
    public void testMulBothRev()
                                throws DimensionMismatchException, NumberIsTooSmallException,
                                MaxCountExceededException, NoBracketingException {
        final double[] exp = getArray(this.getExpMulRev(), this.getO()[15][0], this.getO()[15][1]);
