...
public final class BlockFieldMatrixTest {
    ...
    public void testDimensions() {
        final BlockFieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.testData);
        final BlockFieldMatrix<Fraction> m2 = new BlockFieldMatrix<>(this.testData2);
    ...
    public void testCopyFunctions() {
        ...
        final BlockFieldMatrix<Fraction> m1 = createRandomMatrix(r, 47, 83);
        final BlockFieldMatrix<Fraction> m2 = new BlockFieldMatrix<>(m1.getData());
        Assert.assertEquals(m1, m2);
        final BlockFieldMatrix<Fraction> m3 = new BlockFieldMatrix<>(this.testData);
        final BlockFieldMatrix<Fraction> m4 = new BlockFieldMatrix<>(m3.getData());
    ...
    public void testAdd() {
        final BlockFieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.testData);
        final BlockFieldMatrix<Fraction> mInv = new BlockFieldMatrix<>(this.testDataInv);
    ...
    public void testPlusMinus() {
        final BlockFieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.testData);
        final BlockFieldMatrix<Fraction> m2 = new BlockFieldMatrix<>(this.testDataInv);
        TestUtils.assertEquals(m.subtract(m2), m2.scalarMultiply(new Fraction(-1)).add(m));
        try {
            m.subtract(new BlockFieldMatrix<>(this.testData2));
    ...
    public void testMultiply() {
        final BlockFieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.testData);
        final BlockFieldMatrix<Fraction> mInv = new BlockFieldMatrix<>(this.testDataInv);
        final BlockFieldMatrix<Fraction> identity = new BlockFieldMatrix<>(this.id);
        final BlockFieldMatrix<Fraction> m2 = new BlockFieldMatrix<>(this.testData2);
        ...
        try {
            m.multiply(new BlockFieldMatrix<>(this.bigSingular));
            Assert.fail("Expecting illegalArgumentException");
        } catch (final MathIllegalArgumentException ex) {
            // expected
        }
 ...
 new BlockFieldMatrix<>(FractionField.getInstance(), 37, 41);
    ...
    public void testMultiply2() {
        final FieldMatrix<Fraction> m3 = new BlockFieldMatrix<>(this.d3);
        final FieldMatrix<Fraction> m4 = new BlockFieldMatrix<>(this.d4);
        final FieldMatrix<Fraction> m5 = new BlockFieldMatrix<>(this.d5);
    ...
    public void testTrace() {
        FieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.id);
        Assert.assertEquals(new Fraction(3), m.getTrace());
        m = new BlockFieldMatrix<>(this.testData2);
        try {
            m.getTrace();
    ...
    public void testScalarAdd() {
        final FieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.testData);
        TestUtils.assertEquals(new BlockFieldMatrix<>(this.testDataPlus2),
    ...
    public void testOperate() {
        ...
        TestUtils.assertEquals(this.testVector, m.operate(new ArrayFieldVector<>(this.testVector))
                .toArray());
        m = new BlockFieldMatrix<>(this.bigSingular);
        try {
    ...
    public void testOperateLarge() {
        ...
        final FieldMatrix<Fraction> m1 = createRandomMatrix(random, p, q);
        final FieldMatrix<Fraction> m2 = createRandomMatrix(random, q, r);
    ...
    public void testMath209() {
        final FieldMatrix<Fraction> a = new BlockFieldMatrix<>(new Fraction[][] {
            { new Fraction(1), new Fraction(2) },
    ...
    public void testTranspose() {
        FieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.testData);
        ...
        m = new BlockFieldMatrix<>(this.testData2);
        final FieldMatrix<Fraction> mt = new BlockFieldMatrix<>(this.testData2T);
    ...
    public void testPremultiply() {
        ...
        try {
            m.preMultiply(new BlockFieldMatrix<>(this.bigSingular));
            Assert.fail("Expecting illegalArgumentException");
        } catch (final MathIllegalArgumentException ex) {
            // ignored
        }
    ...
    public void testExamples() {
        ...
        final FieldMatrix<Fraction> m = new BlockFieldMatrix<>(matrixData);
        ...
        final FieldMatrix<Fraction> n = new BlockFieldMatrix<>(matrixData2);
        // Now multiply m by n
        ...
        final FieldMatrix<Fraction> coefficients = new BlockFieldMatrix<>(coefficientsData);
    ...
    public void testGetSubMatrix() {
        final FieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.subTestData);
 ...
 new BlockFieldMatrix<>(FractionField.getInstance(),
                n - 4, n - 4).scalarAdd(new Fraction(1));
    ...
    public void testGetRowMatrix() {
        final FieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.subTestData);
        final FieldMatrix<Fraction> mRow0 = new BlockFieldMatrix<>(this.subRow0);
        final FieldMatrix<Fraction> mRow3 = new BlockFieldMatrix<>(this.subRow3);
 ...
 new BlockFieldMatrix<>(FractionField.getInstance(), n, n);
        final FieldMatrix<Fraction> sub =
 new BlockFieldMatrix<>(FractionField.getInstance(), 1, n)
    ...
    public void testGetColumnMatrix() {
        final FieldMatrix<Fraction> m = new BlockFieldMatrix<>(this.subTestData);
        final FieldMatrix<Fraction> mColumn1 = new BlockFieldMatrix<>(this.subColumn1);
        final FieldMatrix<Fraction> mColumn3 = new BlockFieldMatrix<>(this.subColumn3);
 ...
 new BlockFieldMatrix<>(FractionField.getInstance(), n, n);
        final FieldMatrix<Fraction> sub =
 new BlockFieldMatrix<>(FractionField.getInstance(), n, 1)
                .scalarAdd(new Fraction(1));
    ...
    public void testGetSetRowVectorLarge() {
        final int n = 3 * BlockFieldMatrix.BLOCK_SIZE;
        final FieldMatrix<Fraction> m = new BlockFieldMatrix<>(FractionField.getInstance(), n, n);
        final FieldVector<Fraction> sub = new ArrayFieldVector<>(n, new Fraction(1));
    ...
    public void testEqualsAndHashCode() {
        ...
        Assert.assertFalse(m.equals(new BlockFieldMatrix<>(this.bigSingular)));
    }
 ...
 new BlockFieldMatrix<>(new Fraction[][] {
    ...
    private static BlockFieldMatrix<Fraction> createRandomMatrix(final Random r, final int rows,
            final int columns) {
