...
public class DerivativeStructureTest {
    ...
    public void testVariable() {
        for (int maxOrder = 1; maxOrder < 5; ++maxOrder) {
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 0, 1.0),
                1.0, 1.0, 0.0, 0.0);
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 1, 2.0),
                2.0, 0.0, 1.0, 0.0);
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 2, 3.0),
                3.0, 0.0, 0.0, 1.0);
        }
    }
    ...
    public void testConstant() {
        for (int maxOrder = 1; maxOrder < 5; ++maxOrder) {
            this.checkF0F1(new DerivativeStructure(3, maxOrder, FastMath.PI),
    ...
    public void testCreateConstant() {
        ...
        this.checkEquals(a.getField().getOne().multiply(2.5), b, 1.0e-15);
    }

    @Test
    public void testPrimitiveAdd() {
        for (int maxOrder = 1; maxOrder < 5; ++maxOrder) {
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 0, 1.0).add(5), 6.0, 1.0, 0.0, 0.0);
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 1, 2.0).add(5), 7.0, 0.0, 1.0, 0.0);
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 2, 3.0).add(5), 8.0, 0.0, 0.0, 1.0);
        }
    }
    ...
    public void testPrimitiveSubtract() {
        for (int maxOrder = 1; maxOrder < 5; ++maxOrder) {
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 0, 1.0).subtract(5), -4.0, 1.0, 0.0, 0.0);
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 1, 2.0).subtract(5), -3.0, 0.0, 1.0, 0.0);
            this.checkF0F1(new DerivativeStructure(3, maxOrder, 2, 3.0).subtract(5), -2.0, 0.0, 0.0, 1.0);
        }
    }
            ...
            for (int n = 0; n < 10; ++n) {
                ...
                if (n == 0) {
                    for (final DerivativeStructure ds : list) {
                        this.checkEquals(ds.getField().getOne(), ds.pow(n), 1.0e-15);
                    }
                } else if (n == 1) {
                    for (final DerivativeStructure ds : list) {
    ...
    public void testField() {
        for (int maxOrder = 1; maxOrder < 5; ++maxOrder) {
            final DerivativeStructure x = new DerivativeStructure(3, maxOrder, 0, 1.0);
            this.checkF0F1(x.getField().getZero(), 0.0, 0.0, 0.0, 0.0);
            this.checkF0F1(x.getField().getOne(), 1.0, 0.0, 0.0, 0.0);
    ...
    public void testSerialization() {
        final DerivativeStructure a = new DerivativeStructure(3, 2, 0, 1.3);
        final DerivativeStructure b = (DerivativeStructure) TestUtils.serializeAndRecover(a);
        Assert.assertEquals(a.getFreeParameters(), b.getFreeParameters());
        Assert.assertEquals(a.getOrder(), b.getOrder());
        this.checkEquals(a, b, 1.0e-15);
    }

    private void checkF0F1(final DerivativeStructure ds, final double value, final double... derivatives) {
    ...
    private void checkEquals(final DerivativeStructure ds1, final DerivativeStructure ds2, final double epsilon) {
