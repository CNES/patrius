 ...
 * composed of {@link MultivariateNormalDistribution
...
public class MixtureMultivariateNormalDistributionTest {
    ...
    public void testDensities() {
        ...
        final List<Pair<Double, MultivariateNormalDistribution>> components =
            MixtureMultivariateNormalDistribution.createComponents(weights, means, covariances);
        final MixtureMultivariateNormalDistribution d =
            new MixtureMultivariateNormalDistribution(new Well19937c(), components);
    ...
    public void testSampling() {
        ...
        final double[][] correctSamples = this.getCorrectSamples();
