...
public class CombinatoricsUtilsTest {
    ...
    public void testFactorial() {
        for (int i = 1; i < 21; i++) {
            Assert.assertEquals(i + "! ", CombinatoricsUtilsTest.factorial(i), CombinatoricsUtils.factorial(i));
            Assert.assertEquals(i + "! ", CombinatoricsUtilsTest.factorial(i), CombinatoricsUtils.factorialDouble(i), Double.MIN_VALUE);
            Assert.assertEquals(i + "! ", MathLib.log(CombinatoricsUtilsTest.factorial(i)), CombinatoricsUtils.factorialLog(i), 10E-12);
        }
