...
public class DBSCANClustererTest {
    ...
    public void testCluster() {
        ...
        final DBSCANClusterer<EuclideanDoublePoint> transformer = new DBSCANClusterer<>(2.0, 5);
    ...
    public void testSingleLink() {
        ...
        final DBSCANClusterer<EuclideanIntegerPoint> clusterer = new DBSCANClusterer<>(3, 3);
        final List<Cluster<EuclideanIntegerPoint>> clusters = clusterer.cluster(Arrays.asList(points));
    ...
    public void testNullDataset() {
        final DBSCANClusterer<EuclideanDoublePoint> clusterer = new DBSCANClusterer<>(2.0, 5);
