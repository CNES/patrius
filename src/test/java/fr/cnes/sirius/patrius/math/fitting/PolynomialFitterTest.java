...
public class PolynomialFitterTest {
    ...
    public void testMath798() {
        ...
        final double[] lm = this.doMath798(new LevenbergMarquardtOptimizer(checker), maxEval, init);
        final double[] gn = this.doMath798(new GaussNewtonOptimizer(checker), maxEval, init);
    ...
    public void testMath798WithToleranceTooLow() {
        ...
        this.doMath798(new GaussNewtonOptimizer(checker), maxEval, init);
    }
     ...
     */
    private double[] doMath798(final MultivariateVectorOptimizer optimizer,
                               final int maxEval,
                               final double[] init) {
