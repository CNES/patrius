...
public class CholeskyDecompositionTest {
    ...
    public void testDiagonalMatrix() {
        ...
        final double[] data1 = { 1., 3.4, 2.8 };
        final double[][] data2 = { { data1[0], 0, 0 }, { 0, data1[1], 0 }, { 0, 0, data1[2] } };

        final DiagonalMatrix diag = new DiagonalMatrix(data1);
    ...
    public void testInverse() {
        final RealMatrix matrix = MatrixUtils.createRealMatrix(this.testData);
        final RealMatrix inv = new CholeskyDecomposition(matrix).getSolver().getInverse();
