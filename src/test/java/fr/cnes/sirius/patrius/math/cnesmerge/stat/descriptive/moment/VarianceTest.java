...
public class VarianceTest {
    ...
    public void testEvaluateDoubleArray() {
     ...
     */
    @Test
    public void testEvaluateDoubleArrayDoubleArrayIntInt() {
     ...
     */
    @Test
    public void testEvaluateDoubleArrayDoubleIntInt() {
        final double[] values = { 2.0 };
        final Variance variance = new Variance();
     ...
     */
    @Test
    public void testEvaluateDoubleArrayDoubleArrayDoubleIntInt() {
        final double[] values = { 2.0 };
        final double[] weights = { 12.0 };
        final Variance variance = new Variance();
     ...
     */
    @Test
    public void testIsBiasCorrected() {
        final Variance variance = new Variance();
