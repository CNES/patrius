...
public class AbstractRealMatrixTest {
    ...
    /**
     * Tests the method that returns the diagonal vector of the matrix.
     *
     * <p>
     * Tested method:<br>
     * {@linkplain AbstractRealMatrix#getDiagonal()}
     * </p>
     */
    @Test
    public void testGetDiagonal() {
        ...
        final double[][] data1 = { { -5.06431, 3.92955, -5.02609, -0.52662 },
            { -9.80586, -0.06692, 3.51117, -9.38936 },
            { 7.31116, 4.01831, 9.29466, 5.45151 },
            { -0.67706, -2.38185, 5.11011, -9.05432 } };
        final RealMatrix matrix1 = new SimpleMatrix(data1);

        final double[] expectedDiagonal = new double[] { -5.06431, -0.06692, 9.29466, -9.05432 };
        Assert.assertTrue(Arrays.equals(expectedDiagonal, matrix1.getDiagonal()));

        // Test with a non-square matrix
        final double[][] data2 = { { -5.06431, 3.92955, -5.02609, -0.52662 },
            { -9.80586, -0.06692, 3.51117, -9.38936 },
            { 7.31116, 4.01831, 9.29466, 5.45151 },
            { -0.67706, -2.38185, 5.11011, -9.05432 },
            { 7.12084, -9.88894, 5.69452, 8.92780 },
            { -5.93043, -2.52412, 2.69914, -0.78720 } };
        final RealMatrix matrix2 = new SimpleMatrix(data2);
