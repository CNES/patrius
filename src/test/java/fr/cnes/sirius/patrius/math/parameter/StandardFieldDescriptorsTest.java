...
public class StandardFieldDescriptorsTest {
     ...
     */
    @BeforeClass
    public static void initPatrius() throws PatriusException, URISyntaxException {
        ...
        final String folder =
            new File(ClassLoader.getSystemResource("regular-dataPBASE" + File.separator).toURI()).getAbsolutePath();
    ...
    public void testForceModel() throws PatriusException {
        ...
        final ThirdBodyAttraction force = new ThirdBodyAttraction(CelestialBodyFactory.getEarth().getGravityModel());
