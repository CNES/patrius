 ...
 * 
 * @version $Id: FourthMomentTest.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class FourthMomentTest extends StorelessUnivariateStatisticAbstractTest {
    ...
    public double expectedValue() {
        // Coverage of the FourthMoment(FourthMoment) constructor:
        this.stat = new FourthMoment();
        new FourthMoment(this.stat);
