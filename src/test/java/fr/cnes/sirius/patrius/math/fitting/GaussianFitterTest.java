 ...
 * 
 * @since 2.2
 * @version $Id: GaussianFitterTest.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class GaussianFitterTest {
    ...
    /**
     * Adds the specified points to specified <code>GaussianFitter</code> instance.
     * 
     * @param points
     *        data points where first dimension is a point index and
     ...
     *        corresponding to Y
     * @param fitter
     *        fitter to which the points in <code>points</code> should be
     *        added as observed points
     */
    protected static void addDatasetToGaussianFitter(final double[][] points,
