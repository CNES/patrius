...
public class Array2DRowFieldMatrixTest {
    ...
    public void testNotStrictlyPositiveExceptionConstructor() {
        new Array2DRowFieldMatrix<>(FractionField.getInstance(), 3, -1);
    }
    ...
    public void testNumberIsTooSmallExceptionCheckSubMatrixIndex() {
        final Array2DRowFieldMatrix<Fraction> m =
            new Array2DRowFieldMatrix<>(FractionField.getInstance(), 3, 3);
    ...
    public void testConstructor6() {
        ...
        final Array2DRowFieldMatrix<Fraction> m =
            new Array2DRowFieldMatrix<>(FractionField.getInstance(), d, true);
    ...
    public void testConstructor6Rows() {
        ...
        // tests if (nRows == 0)
        final Fraction[][] d = new Fraction[][] {};
        new Array2DRowFieldMatrix<>(FractionField.getInstance(), d, false);
    }
    ...
    public void testSetSubMatrixRows() {
        ...
        final Array2DRowFieldMatrix<Fraction> m2 = new Array2DRowFieldMatrix<>(FractionField.getInstance());
        // tests if (nRows == 0) {
        final Fraction[][] d = new Fraction[][] {};
