...
public class BigFractionTest {
    ...
    private void assertFraction(final int expectedNumerator, final int expectedDenominator, final BigFraction actual) {
    ...
    private void assertFraction(final long expectedNumerator, final long expectedDenominator, final BigFraction actual) {
    ...
    public void testConstructor() {
        ...
        this.assertFraction(0, 1, new BigFraction(0.00000000000001, 1.0e-5, 100));
        ...
        this.assertFraction(3602879701896487l, 9007199254740992l, new BigFraction(0.40000000000001));
        this.assertFraction(1055531162664967l, 70368744177664l, new BigFraction(15.0000000000001));
        try {
            new BigFraction(null, BigInteger.ONE);
            Assert.fail("Expecting NullArgumentException");
        } catch (final NullArgumentException npe) {
            // expected
        }
        try {
    ...
    public void testGoldenRatio() {
        ...
        new BigFraction((1 + MathLib.sqrt(5)) / 2, 1.0e-12, 25);
    }

    // MATH-179
    @Test
    public void testDoubleConstructor() throws ConvergenceException {
        this.assertFraction(1, 2, new BigFraction((double) 1 / (double) 2, 1.0e-5, 100));
        this.assertFraction(1, 3, new BigFraction((double) 1 / (double) 3, 1.0e-5, 100));
        this.assertFraction(2, 3, new BigFraction((double) 2 / (double) 3, 1.0e-5, 100));
        this.assertFraction(1, 4, new BigFraction((double) 1 / (double) 4, 1.0e-5, 100));
        this.assertFraction(3, 4, new BigFraction((double) 3 / (double) 4, 1.0e-5, 100));
        this.assertFraction(1, 5, new BigFraction((double) 1 / (double) 5, 1.0e-5, 100));
        this.assertFraction(2, 5, new BigFraction((double) 2 / (double) 5, 1.0e-5, 100));
        this.assertFraction(3, 5, new BigFraction((double) 3 / (double) 5, 1.0e-5, 100));
        this.assertFraction(4, 5, new BigFraction((double) 4 / (double) 5, 1.0e-5, 100));
        this.assertFraction(1, 6, new BigFraction((double) 1 / (double) 6, 1.0e-5, 100));
        this.assertFraction(5, 6, new BigFraction((double) 5 / (double) 6, 1.0e-5, 100));
        this.assertFraction(1, 7, new BigFraction((double) 1 / (double) 7, 1.0e-5, 100));
        this.assertFraction(2, 7, new BigFraction((double) 2 / (double) 7, 1.0e-5, 100));
        this.assertFraction(3, 7, new BigFraction((double) 3 / (double) 7, 1.0e-5, 100));
        this.assertFraction(4, 7, new BigFraction((double) 4 / (double) 7, 1.0e-5, 100));
        this.assertFraction(5, 7, new BigFraction((double) 5 / (double) 7, 1.0e-5, 100));
        this.assertFraction(6, 7, new BigFraction((double) 6 / (double) 7, 1.0e-5, 100));
        this.assertFraction(1, 8, new BigFraction((double) 1 / (double) 8, 1.0e-5, 100));
        this.assertFraction(3, 8, new BigFraction((double) 3 / (double) 8, 1.0e-5, 100));
        this.assertFraction(5, 8, new BigFraction((double) 5 / (double) 8, 1.0e-5, 100));
        this.assertFraction(7, 8, new BigFraction((double) 7 / (double) 8, 1.0e-5, 100));
        this.assertFraction(1, 9, new BigFraction((double) 1 / (double) 9, 1.0e-5, 100));
        this.assertFraction(2, 9, new BigFraction((double) 2 / (double) 9, 1.0e-5, 100));
        this.assertFraction(4, 9, new BigFraction((double) 4 / (double) 9, 1.0e-5, 100));
        this.assertFraction(5, 9, new BigFraction((double) 5 / (double) 9, 1.0e-5, 100));
        this.assertFraction(7, 9, new BigFraction((double) 7 / (double) 9, 1.0e-5, 100));
        this.assertFraction(8, 9, new BigFraction((double) 8 / (double) 9, 1.0e-5, 100));
        this.assertFraction(1, 10, new BigFraction((double) 1 / (double) 10, 1.0e-5, 100));
        this.assertFraction(3, 10, new BigFraction((double) 3 / (double) 10, 1.0e-5, 100));
        this.assertFraction(7, 10, new BigFraction((double) 7 / (double) 10, 1.0e-5, 100));
        this.assertFraction(9, 10, new BigFraction((double) 9 / (double) 10, 1.0e-5, 100));
        this.assertFraction(1, 11, new BigFraction((double) 1 / (double) 11, 1.0e-5, 100));
        this.assertFraction(2, 11, new BigFraction((double) 2 / (double) 11, 1.0e-5, 100));
        this.assertFraction(3, 11, new BigFraction((double) 3 / (double) 11, 1.0e-5, 100));
        this.assertFraction(4, 11, new BigFraction((double) 4 / (double) 11, 1.0e-5, 100));
        this.assertFraction(5, 11, new BigFraction((double) 5 / (double) 11, 1.0e-5, 100));
        this.assertFraction(6, 11, new BigFraction((double) 6 / (double) 11, 1.0e-5, 100));
        this.assertFraction(7, 11, new BigFraction((double) 7 / (double) 11, 1.0e-5, 100));
        this.assertFraction(8, 11, new BigFraction((double) 8 / (double) 11, 1.0e-5, 100));
        this.assertFraction(9, 11, new BigFraction((double) 9 / (double) 11, 1.0e-5, 100));
        this.assertFraction(10, 11, new BigFraction((double) 10 / (double) 11, 1.0e-5, 100));
    }
    ...
    public void testEpsilonLimitConstructor() throws ConvergenceException {
        ...
        this.assertFraction(8, 13, new BigFraction(0.6152, 1.0e-3, 100));
    ...
    public void testCompareTo() {
        final BigFraction first = new BigFraction(1, 2);
        final BigFraction second = new BigFraction(1, 3);
        final BigFraction third = new BigFraction(1, 2);
        ...
        final BigFraction pi1 = new BigFraction(1068966896, 340262731);
        final BigFraction pi2 = new BigFraction(411557987, 131002976);
    ...
    public void testIntValue() {
        final BigFraction first = new BigFraction(1, 2);
        final BigFraction second = new BigFraction(3, 2);
    ...
    public void testConstructorDouble() {
        ...
        this.assertFraction(6004799503160661l, 18014398509481984l, new BigFraction(1.0 / 3.0));
        this.assertFraction(6124895493223875l, 36028797018963968l, new BigFraction(17.0 / 100.0));
        this.assertFraction(1784551352345559l, 562949953421312l, new BigFraction(317.0 / 100.0));
        this.assertFraction(-1, 2, new BigFraction(-0.5));
        this.assertFraction(-6004799503160661l, 18014398509481984l, new BigFraction(-1.0 / 3.0));
        this.assertFraction(-6124895493223875l, 36028797018963968l, new BigFraction(17.0 / -100.0));
        this.assertFraction(-1784551352345559l, 562949953421312l, new BigFraction(-317.0 / 100.0));
        for (final double v : new double[] { Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY }) {
            try {
                new BigFraction(v);
    ...
    @Test
    public void testAbs() {
        final BigFraction a = new BigFraction(10, 21);
        final BigFraction b = new BigFraction(-10, 21);
        final BigFraction c = new BigFraction(10, -21);
    ...
    @Test
    public void testAdd() {
        final BigFraction a = new BigFraction(1, 2);
        final BigFraction b = new BigFraction(2, 3);
    ...
    public void testDivide() {
        ...
        try {
            f1.divide(BigInteger.ZERO);
            Assert.fail("expecting MathArithmeticException");
        } catch (final MathArithmeticException ex) {
        }
        try {
            f1.divide((BigInteger) null);
            Assert.fail("expecting NullArgumentException");
        } catch (final NullArgumentException ex) {
        }
    ...
    public void testMultiply() {
        ...
        final BigFraction f1 = new BigFraction(Integer.MAX_VALUE, 1);
        final BigFraction f2 = new BigFraction(Integer.MIN_VALUE, Integer.MAX_VALUE);
    ...
    public void testSubtract() {
        ...
        // Longs
        Assert.assertEquals(BigFraction.ZERO, f.subtract(1L));
    ...
    public void testGetReducedFraction() {
        final BigFraction threeFourths = new BigFraction(3, 4);
    ...
    public void testPow() {
        ...
        Assert.assertEquals(1., new BigFraction(2, 3).pow(0.), 0.);
    ...
    public void testMath340() {
        final BigFraction fractionA = new BigFraction(0.00131);
        final BigFraction fractionB = new BigFraction(.37).reciprocal();
        final BigFraction errorResult = fractionA.multiply(fractionB);
        final BigFraction correctResult = new BigFraction(fractionA.getNumerator().multiply(fractionB.getNumerator()),
    ...
    {
        final BigFraction zeroFourths = new BigFraction(0, 4);
        final BigFraction threeFourths = new BigFraction(3, 4);
        final BigFraction four = new BigFraction(4, 1);
        Assert.assertEquals("0", zeroFourths.toString());
        Assert.assertEquals("3 / 4", threeFourths.toString());
        Assert.assertEquals("1", BigFraction.ONE.toString());
