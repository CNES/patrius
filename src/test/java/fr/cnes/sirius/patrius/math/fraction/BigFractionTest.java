...
public class BigFractionTest {
    ...
    private static void assertFraction(final int expectedNumerator, final int expectedDenominator,
            final BigFraction actual) {
    ...
    private static void assertFraction(final long expectedNumerator,
            final long expectedDenominator, final BigFraction actual) {
