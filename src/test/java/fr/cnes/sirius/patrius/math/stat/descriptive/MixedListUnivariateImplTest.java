...
public final class MixedListUnivariateImplTest {
    ...
    public void testN0andN1Conditions() {
        final DescriptiveStatistics u = new ListUnivariateImpl(new ArrayList<Object>(), this.transformers);
    ...
    public void testSkewAndKurtosis() {
        final ListUnivariateImpl u =
            new ListUnivariateImpl(new ArrayList<Object>(), this.transformers);
    ...
    public void testProductAndGeometricMean() {
        final ListUnivariateImpl u = new ListUnivariateImpl(new ArrayList<Object>(), this.transformers);
        u.setWindowSize(10);
