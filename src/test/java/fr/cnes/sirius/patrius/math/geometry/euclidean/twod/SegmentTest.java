...
public class SegmentTest {
    ...
    public void testDistance() {
        ...
        final Segment segment = new Segment(start, end);
    ...
    public void testIntersection() {
        ...
        final Segment segment1 = new Segment(start1, end1);

        // No intersection
        final Vector2D start2 = new Vector2D(2, 1);
        final Vector2D end2 = new Vector2D(3, 2);
        final Segment segment2 = new Segment(start2, end2);
        ...
        final Segment segment3 = new Segment(start3, end3);
        ...
        final Segment segment4 = new Segment(start4, end4);
        ...
        final Segment segment5 = new Segment(start5, end5);
        ...
        final Segment segment6 = new Segment(start6, end6);
        ...
        final Segment segment7 = new Segment(start7, end7);
    ...
    /**
     * FA-3275: intersection with vertical line should be as expected (simple math case).
     */
    @Test
    public void testFA3275() {
        final Vector2D horizontalVector = new Vector2D(1, 0);
        final Vector2D VerticalVector = new Vector2D(0, 1);

        final Segment horizontalSegment = new Segment(horizontalVector, horizontalVector.negate());
        final Segment verticalSegment = new Segment(VerticalVector, VerticalVector.negate());
        final Vector2D intersect = horizontalSegment.getIntersection(verticalSegment);
        Assert.assertEquals(0., intersect.getX(), 0.);
        Assert.assertEquals(0., intersect.getY(), 0.);
    }
}
