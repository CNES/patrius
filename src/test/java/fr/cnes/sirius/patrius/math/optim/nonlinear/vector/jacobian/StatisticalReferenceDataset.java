...
public abstract class StatisticalReferenceDataset {
    ...
    /**
     * The starting values. {@code startingValues[j][i]} is the value of the {@code i}-th parameter in the {@code j}-th
        ...
        public ModelFunction getModelFunction() {
            return new ModelFunction(new MultivariateVectorFunction(){
                ...
                public double[] value(final double[] a) {
                    final int n = StatisticalReferenceDataset.this.getNumObservations();
                    final double[] yhat = new double[n];
                    for (int i = 0; i < n; i++) {
                        yhat[i] =
                            StatisticalReferenceDataset.this.getModelValue(StatisticalReferenceDataset.this.getX(i), a);
                    }
                    return yhat;
                }
            });
        ...
        public ModelFunctionJacobian getModelFunctionJacobian() {
            return new ModelFunctionJacobian(new MultivariateMatrixFunction(){
                ...
                public double[][] value(final double[] a)
                    ...
                    for (int i = 0; i < n; i++) {
                        j[i] =
                            StatisticalReferenceDataset.this.getModelDerivatives(
                                StatisticalReferenceDataset.this.getX(i), a);
                    }
                    return j;
                }
            });
    ...
    public double[][] getData() {
        return new double[][] {
            MathArrays.copyOf(this.x), MathArrays.copyOf(this.y)
        };
    }
    ...
    public double[] getParameters() {
        return MathArrays.copyOf(this.a);
    }
    ...
    public double[] getParametersStandardDeviations() {
        return MathArrays.copyOf(this.sigA);
    }
    ...
    public double[] getStartingPoint(final int i) {
        return MathArrays.copyOf(this.startingValues[i]);
    }
    ...
    /**
     * <p>
     * Parses the specified text lines, and extracts the indices of the first and last lines of the data defined by the
     * specified {@code key}. This key must be one of
     * </p>
     * <ul>
    ...
    private static int[] findLineNumbers(final String key,
        ...
        for (final String text : lines) {
            final boolean flag = text.contains(key) && text.contains("lines") &&
