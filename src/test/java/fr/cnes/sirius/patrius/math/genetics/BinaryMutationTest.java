...
public class BinaryMutationTest {
    ...
    public void testMutate() {
        final BinaryMutation mutation = new BinaryMutation();

        // stochastic testing :)
        for (int i = 0; i < 20; i++) {
            final DummyBinaryChromosome original =
                new DummyBinaryChromosome(BinaryChromosome.randomBinaryRepresentation(10));
            final DummyBinaryChromosome mutated = (DummyBinaryChromosome) mutation.mutate(original);
