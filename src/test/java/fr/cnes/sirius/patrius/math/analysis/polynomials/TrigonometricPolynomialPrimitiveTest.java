...
public class TrigonometricPolynomialPrimitiveTest {
    ...
    public enum features {
         ...
         * 
         * @featureDescription Add, subtract, multiply, divide TrigonometricPolynomialPrimitive by
         *                     scalars. Test
         *                     negate()
         * 
         * @coveredRequirements DV-CALCUL_30, DV-CALCUL_40
     ...
     *              check the correctness of the constructor. Nominal case as well as degraded cases
     *              are
     *              checked.
     * 
     ...
     * 
     * @testPassCriteria No exception is raised for nominal cases, a MathIllegalArgumentException is
     *                   raised for degraded
     *                   cases.
     * 
    ...
    public void testConstructor() {
        ...
        final TrigonometricPolynomialFunction trigoPol = new TrigonometricPolynomialFunction(a0, a,
                b);
    ...
    public void testScalarOperations() {
        ...
        final TrigonometricPolynomialFunction trigoPol1 = new TrigonometricPolynomialFunction(a0,
                a, b);
        final PolynomialFunction linPol1 = new PolynomialFunction(l);

        final TrigonometricPolynomialPrimitive myPol1 = new TrigonometricPolynomialPrimitive(
                linPol1, trigoPol1);

        // Addition
        areExtendedPolynomialsEqual(myPol1.scalarAdd(2), new TrigonometricPolynomialPrimitive(
                linPol1, trigoPol1.scalarAdd(2)));
        areExtendedPolynomialsEqual(myPol1.scalarAdd(2), new TrigonometricPolynomialPrimitive(
                linPol1.add(new PolynomialFunction(new double[] { 2 })), trigoPol1));

        // Subtraction
        areExtendedPolynomialsEqual(myPol1.scalarSubtract(2), new TrigonometricPolynomialPrimitive(
                linPol1, trigoPol1.scalarSubtract(2)));
        areExtendedPolynomialsEqual(myPol1.scalarSubtract(2), new TrigonometricPolynomialPrimitive(
                linPol1.subtract(new PolynomialFunction(new double[] { 2 })), trigoPol1));

        // Multiplication
        areExtendedPolynomialsEqual(
                myPol1.scalarMultiply(2),
                new TrigonometricPolynomialPrimitive(linPol1.multiply(new PolynomialFunction(
                        new double[] { 2 })), trigoPol1.scalarMultiply(2)));

        // Division
        areExtendedPolynomialsEqual(
                myPol1.scalarDivide(2),
                new TrigonometricPolynomialPrimitive(linPol1.multiply(new PolynomialFunction(
                        new double[] { .5 })), trigoPol1.scalarDivide(2)));
        try {
    ...
    public void testOperations() {
        ...
        final TrigonometricPolynomialFunction trigoPol2 = new TrigonometricPolynomialFunction(a0,
                a, b);
        final PolynomialFunction linPol2 = new PolynomialFunction(l);

        final TrigonometricPolynomialPrimitive myPol2 = new TrigonometricPolynomialPrimitive(
                linPol2, trigoPol2);
        ...
        final TrigonometricPolynomialFunction trigoPolRef = new TrigonometricPolynomialFunction(a0,
                a, b);
        final PolynomialFunction linPolRef = new PolynomialFunction(l);

        final TrigonometricPolynomialPrimitive myPolRef = new TrigonometricPolynomialPrimitive(
                linPolRef, trigoPolRef);
        ...
        areExtendedPolynomialsEqual(
                new TrigonometricPolynomialPrimitive(linPol1, trigoPol1.add(trigoPol2)),
                myPol1.add(trigoPol2));
        areExtendedPolynomialsEqual(
                new TrigonometricPolynomialPrimitive(linPol1, trigoPol1.subtract(trigoPol2)),
                myPol1.subtract(trigoPol2));

        // add and subtract PolynomialFunction
        areExtendedPolynomialsEqual(new TrigonometricPolynomialPrimitive(linPol1.add(linPol2),
                trigoPol1), myPol1.add(linPol2));
        areExtendedPolynomialsEqual(new TrigonometricPolynomialPrimitive(linPol1.subtract(linPol2),
                trigoPol1), myPol1.subtract(linPol2));
    }
    ...
    public void testGetters() {
        ...
        areLinearPolynomialsEqual(linPol1.add(new PolynomialFunction(new double[] { 1 })),
                myPol1.getLinearPolynomial());
        areTrigonometricPolynomialsEqual(trigoPol1.scalarSubtract(a0),
                myPol1.getTrigonometricPolynomial());
    }
    ...
    public void testValue() {
        ...
        final TrigonometricPolynomialPrimitive myPol = new TrigonometricPolynomialPrimitive(linPol,
                trigoPol);

        final double x = 4;

        final double expectedPolVal = -2 + MathLib.cos(x) + 2 * MathLib.sin(2 * x) + 1.1 - 2 * x
                + 3 * x * x + 4 * x * x * x;
        Assert.assertEquals(expectedPolVal, myPol.value(x), EPS);

        final double expectedPolDev = -Math.sin(x) + 4 * MathLib.cos(2 * x) - 2 + 6 * x + 12 * x
                * x;
        ...
        Assert.assertEquals("6 + 24 x - 1 cos(1 x) - 8 sin(2 x)", myPol.polynomialDerivative(2)
                .toString());
    }
    ...
    public static void areExtendedPolynomialsEqual(final TrigonometricPolynomialPrimitive pol1,
        ...
        areTrigonometricPolynomialsEqual(pol1.getTrigonometricPolynomial(),
                pol2.getTrigonometricPolynomial());
    }
     ...
     * @since 1.1
     */
    protected static void areLinearPolynomialsEqual(final PolynomialFunction pol1,
            final PolynomialFunction pol2) {

        // same degree
        Assert.assertEquals(pol1.getDegree(), pol2.getDegree());
        // same coefficients
        Assert.assertArrayEquals(pol1.getCoefficients(), pol2.getCoefficients(), EPS);
    }

    /**
     * @description Evaluate the trigonometric polynomial primitive serialization / deserialization
     *              process.
     *
     * @testPassCriteria The trigonometric polynomial primitive can be serialized and deserialized.
     */
    @Test
    public void testSerialization() {
        ...
        final TrigonometricPolynomialPrimitive p = new TrigonometricPolynomialPrimitive(linPol,
                trigoPol);
