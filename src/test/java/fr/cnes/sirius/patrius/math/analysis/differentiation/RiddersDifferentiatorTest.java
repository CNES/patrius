...
public class RiddersDifferentiatorTest {
     ...
     */
    @Test
    public final void testDifferentiateFunctions() {
     ...
     */
    @Test
    public final void testFourierSeries() {
        final double a0 = 1;
    ...
    public final void testPolynomialFunction() {
        ...
        // Ridders differentiator:
        double expected = function.derivative().value(8.568);
        ...
        expected = function.derivative().value(0.25);
        actual = differentiator1.differentiate(0.25, function);
        Assert.assertEquals(0, MathLib.abs((expected - actual) / expected), 1E-10);
        expected = function.derivative().value(-156.3);
        actual = differentiator1.differentiate(-156.3, function);
        Assert.assertEquals(0, MathLib.abs((expected - actual) / expected), 1E-10);
        // New interface
        expected = function.derivative().value(8.568);
