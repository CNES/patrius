...
public class NPointCrossoverTest {
    ...
    public void testCrossover() {
        ...
        final int order = 3;
        final NPointCrossover<Integer> npc = new NPointCrossover<>(order);
    ...
    private static int detectCrossoverPoints(final BinaryChromosome p1, final BinaryChromosome p2,
                                             final BinaryChromosome c) {
        int crossovers = 0;
