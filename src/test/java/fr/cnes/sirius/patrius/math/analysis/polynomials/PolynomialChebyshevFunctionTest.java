...
public final class PolynomialChebyshevFunctionTest {
    ...
    public void testConstructor() {
        ...
        Assert.assertEquals(4, f2.degree());
    ...
    public void testAddition() {
        ...
        final PolynomialChebyshevFunction fctCheb1 =
            ChebyshevDecompositionEngine.interpolateChebyshevFunction(function1, 50, this.basicStart, this.basicEnd);
        ...
        final PolynomialChebyshevFunction fctCheb2 =
            ChebyshevDecompositionEngine.interpolateChebyshevFunction(function2, 50, this.basicStart, this.basicEnd);
    ...
    public void test1stDegreeDerivative() {
        ...
        final PolynomialChebyshevFunction fctCheb =
            ChebyshevDecompositionEngine.interpolateChebyshevFunction(function, 50, this.basicStart, this.basicEnd);
