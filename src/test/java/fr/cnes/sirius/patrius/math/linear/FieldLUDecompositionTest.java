...
public class FieldLUDecompositionTest {
    ...
    public void testDimensions() {
        final FieldMatrix<Fraction> matrix = new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.testData);
        final FieldLUDecomposition<Fraction> LU = new FieldLUDecomposition<>(matrix);
    ...
    public void testPAEqualLU() {
        FieldMatrix<Fraction> matrix = new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.testData);
        ...
        matrix = new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.testDataMinus);
        ...
        matrix = new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.singular);
        lu = new FieldLUDecomposition<>(matrix);
        ...
        matrix = new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.bigSingular);
        lu = new FieldLUDecomposition<>(matrix);
        Assert.assertFalse(lu.getSolver().isNonSingular());
        Assert.assertNull(lu.getL());
        Assert.assertNull(lu.getU());
    ...
    public void testLLowerTriangular() {
        final FieldMatrix<Fraction> matrix =
            new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.testData);
        final FieldMatrix<Fraction> l = new FieldLUDecomposition<>(matrix).getL();
    ...
    public void testUUpperTriangular() {
        final FieldMatrix<Fraction> matrix =
            new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.testData);
        final FieldMatrix<Fraction> u = new FieldLUDecomposition<>(matrix).getU();
    ...
    public void testPPermutation() {
        final FieldMatrix<Fraction> matrix =
            new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.testData);
        final FieldMatrix<Fraction> p = new FieldLUDecomposition<>(matrix).getP();
    ...
    public void testSingular() {
        FieldLUDecomposition<Fraction> lu =
            new FieldLUDecomposition<>(new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.testData));
        Assert.assertTrue(lu.getSolver().isNonSingular());
        lu = new FieldLUDecomposition<>(new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.singular));
        Assert.assertFalse(lu.getSolver().isNonSingular());
        lu = new FieldLUDecomposition<>(new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.bigSingular));
        Assert.assertFalse(lu.getSolver().isNonSingular());
    }
    ...
    public void testMatricesValues1() {
        ...
        final FieldMatrix<Fraction> lRef =
            new Array2DRowFieldMatrix<>(FractionField.getInstance(), new Fraction[][] {
    ...
    public void testMatricesValues2() {
        final FieldLUDecomposition<Fraction> lu =
            new FieldLUDecomposition<>(new Array2DRowFieldMatrix<>(FractionField.getInstance(), this.luData));
        final FieldMatrix<Fraction> lRef =
            new Array2DRowFieldMatrix<>(FractionField.getInstance(), new Fraction[][] {
                { new Fraction(1), new Fraction(0), new Fraction(0) },
