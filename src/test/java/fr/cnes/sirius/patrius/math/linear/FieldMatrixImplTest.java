...
public final class FieldMatrixImplTest {
    ...
    public void testDimensions() {
        final Array2DRowFieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.testData);
        final Array2DRowFieldMatrix<Fraction> m2 = new Array2DRowFieldMatrix<>(this.testData2);
    ...
    public void testCopyFunctions() {
        final Array2DRowFieldMatrix<Fraction> m1 = new Array2DRowFieldMatrix<>(this.testData);
        final Array2DRowFieldMatrix<Fraction> m2 = new Array2DRowFieldMatrix<>(m1.getData());
        Assert.assertEquals(m2, m1);
        final Array2DRowFieldMatrix<Fraction> m3 = new Array2DRowFieldMatrix<>(this.testData);
        final Array2DRowFieldMatrix<Fraction> m4 = new Array2DRowFieldMatrix<>(m3.getData(), false);
    ...
    public void testAdd() {
        final Array2DRowFieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.testData);
        final Array2DRowFieldMatrix<Fraction> mInv = new Array2DRowFieldMatrix<>(this.testDataInv);
    ...
    public void testPlusMinus() {
        final Array2DRowFieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.testData);
        final Array2DRowFieldMatrix<Fraction> m2 = new Array2DRowFieldMatrix<>(this.testDataInv);
        TestUtils.assertEquals(m.subtract(m2), m2.scalarMultiply(new Fraction(-1)).add(m));
        try {
            m.subtract(new Array2DRowFieldMatrix<>(this.testData2));
    ...
    public void testMultiply() {
        final Array2DRowFieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.testData);
        final Array2DRowFieldMatrix<Fraction> mInv = new Array2DRowFieldMatrix<>(this.testDataInv);
        final Array2DRowFieldMatrix<Fraction> identity = new Array2DRowFieldMatrix<>(this.id);
        final Array2DRowFieldMatrix<Fraction> m2 = new Array2DRowFieldMatrix<>(this.testData2);
        ...
        try {
            m.multiply(new Array2DRowFieldMatrix<>(this.bigSingular));
            Assert.fail("Expecting illegalArgumentException");
        } catch (final MathIllegalArgumentException ex) {
            // ignored
        }
    ...
    public void testMultiply2() {
        final FieldMatrix<Fraction> m3 = new Array2DRowFieldMatrix<>(this.d3);
        final FieldMatrix<Fraction> m4 = new Array2DRowFieldMatrix<>(this.d4);
        final FieldMatrix<Fraction> m5 = new Array2DRowFieldMatrix<>(this.d5);
        TestUtils.assertEquals(m3.multiply(m4), m5);
    }

    @Test
    public void testPower() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.testData);
        final FieldMatrix<Fraction> mInv = new Array2DRowFieldMatrix<>(this.testDataInv);
        final FieldMatrix<Fraction> mPlusInv = new Array2DRowFieldMatrix<>(this.testDataPlusInv);
        final FieldMatrix<Fraction> identity = new Array2DRowFieldMatrix<>(this.id);
        ...
        try {
            final FieldMatrix<Fraction> mNotSquare = new Array2DRowFieldMatrix<>(this.testData2T);
            mNotSquare.power(2);
    ...
    public void testTrace() {
        FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.id);
        Assert.assertEquals("identity trace", new Fraction(3), m.getTrace());
        m = new Array2DRowFieldMatrix<>(this.testData2);
        try {
            m.getTrace();
            Assert.fail("Expecting NonSquareMatrixException");
        } catch (final NonSquareMatrixException ex) {
    ...
    public void testScalarAdd() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.testData);
        TestUtils.assertEquals(new Array2DRowFieldMatrix<>(this.testDataPlus2),
    ...
    public void testOperate() {
        ...
        TestUtils.assertEquals(this.testVector, m.operate(new ArrayFieldVector<>(this.testVector))
                .toArray());
        m = new Array2DRowFieldMatrix<>(this.bigSingular);
        try {
    ...
    public void testMath209() {
        final FieldMatrix<Fraction> a = new Array2DRowFieldMatrix<>(new Fraction[][] {
            { new Fraction(1), new Fraction(2) }, { new Fraction(3), new Fraction(4) },
            { new Fraction(5), new Fraction(6) }
        }, false);
    ...
    public void testTranspose() {
        FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.testData);
        final FieldMatrix<Fraction> mIT = new FieldLUDecomposition<>(m).getSolver().getInverse()
                .transpose();
        final FieldMatrix<Fraction> mTI = new FieldLUDecomposition<>(m.transpose()).getSolver()
                .getInverse();
        TestUtils.assertEquals(mIT, mTI);
        m = new Array2DRowFieldMatrix<>(this.testData2);
        final FieldMatrix<Fraction> mt = new Array2DRowFieldMatrix<>(this.testData2T);
    ...
    public void testPremultiplyVector() {
        ...
        TestUtils.assertEquals(m.preMultiply(new ArrayFieldVector<>(this.testVector).getData()),
            this.preMultTest);
        m = new Array2DRowFieldMatrix<>(this.bigSingular);
        try {
    ...
    public void testPremultiply() {
        ...
        try {
            m.preMultiply(new Array2DRowFieldMatrix<>(this.bigSingular));
            Assert.fail("Expecting illegalArgumentException");
        } catch (final MathIllegalArgumentException ex) {
            // ignored
        }
    ...
    public void testExamples() {
        ...
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(matrixData);
        ...
        final FieldMatrix<Fraction> n = new Array2DRowFieldMatrix<>(matrixData2);
        // Now multiply m by n
        final FieldMatrix<Fraction> p = m.multiply(n);
        Assert.assertEquals(2, p.getRowDimension());
        Assert.assertEquals(2, p.getColumnDimension());
        // Invert p
        final FieldMatrix<Fraction> pInverse = new FieldLUDecomposition<>(p).getSolver()
                .getInverse();
        ...
        final FieldMatrix<Fraction> coefficients = new Array2DRowFieldMatrix<>(coefficientsData);
    ...
    public void testGetSubMatrix() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.subTestData);
        checkGetSubMatrix(m, this.subRows23Cols00, 2, 3, 0, 0);
        checkGetSubMatrix(m, this.subRows00Cols33, 0, 0, 3, 3);
        checkGetSubMatrix(m, this.subRows01Cols23, 0, 1, 2, 3);
        checkGetSubMatrix(m, this.subRows02Cols13, new int[] { 0, 2 }, new int[] { 1, 3 });
        checkGetSubMatrix(m, this.subRows03Cols12, new int[] { 0, 3 }, new int[] { 1, 2 });
        checkGetSubMatrix(m, this.subRows03Cols123, new int[] { 0, 3 }, new int[] { 1, 2, 3 });
        checkGetSubMatrix(m, this.subRows20Cols123, new int[] { 2, 0 }, new int[] { 1, 2, 3 });
        checkGetSubMatrix(m, this.subRows31Cols31, new int[] { 3, 1 }, new int[] { 3, 1 });
        checkGetSubMatrix(m, this.subRows31Cols31, new int[] { 3, 1 }, new int[] { 3, 1 });
    ...
    private static void checkGetSubMatrix(final FieldMatrix<Fraction> m,
            final Fraction[][] reference,
    ...
    public void testCopySubMatrix() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.subTestData);
        checkCopy(m, this.subRows23Cols00, 2, 3, 0, 0);
        checkCopy(m, this.subRows00Cols33, 0, 0, 3, 3);
        checkCopy(m, this.subRows01Cols23, 0, 1, 2, 3);
        checkCopy(m, this.subRows02Cols13, new int[] { 0, 2 }, new int[] { 1, 3 });
        checkCopy(m, this.subRows03Cols12, new int[] { 0, 3 }, new int[] { 1, 2 });
        checkCopy(m, this.subRows03Cols123, new int[] { 0, 3 }, new int[] { 1, 2, 3 });
        checkCopy(m, this.subRows20Cols123, new int[] { 2, 0 }, new int[] { 1, 2, 3 });
        checkCopy(m, this.subRows31Cols31, new int[] { 3, 1 }, new int[] { 3, 1 });
        checkCopy(m, this.subRows31Cols31, new int[] { 3, 1 }, new int[] { 3, 1 });
    ...
    private static void checkCopy(final FieldMatrix<Fraction> m, final Fraction[][] reference,
                           final int startRow, final int endRow, final int startColumn, final int endColumn) {
        try {
            ...
            if (reference != null) {
                Assert.assertEquals(new Array2DRowFieldMatrix<>(reference),
                        new Array2DRowFieldMatrix<>(sub));
            } else {
    ...
    public void testGetRowMatrix() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.subTestData);
        final FieldMatrix<Fraction> mRow0 = new Array2DRowFieldMatrix<>(this.subRow0);
        final FieldMatrix<Fraction> mRow3 = new Array2DRowFieldMatrix<>(this.subRow3);
    ...
    public void testGetColumnMatrix() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.subTestData);
        final FieldMatrix<Fraction> mColumn1 = new Array2DRowFieldMatrix<>(this.subColumn1);
        final FieldMatrix<Fraction> mColumn3 = new Array2DRowFieldMatrix<>(this.subColumn3);
    ...
    public void testGetRowVector() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.subTestData);
        final FieldVector<Fraction> mRow0 = new ArrayFieldVector<>(this.subRow0[0]);
        final FieldVector<Fraction> mRow3 = new ArrayFieldVector<>(this.subRow3[0]);
    ...
    public void testGetColumnVector() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.subTestData);
        final FieldVector<Fraction> mColumn1 = columnToVector(this.subColumn1);
        final FieldVector<Fraction> mColumn3 = columnToVector(this.subColumn3);
    ...
    private static FieldVector<Fraction> columnToVector(final Fraction[][] column) {
    ...
    public void testGetRow() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.subTestData);
        checkArrays(this.subRow0[0], m.getRow(0));
        checkArrays(this.subRow3[0], m.getRow(3));
        try {
            m.getRow(-1);
            Assert.fail("Expecting OutOfRangeException");
        } catch (final OutOfRangeException ex) {
    ...
    public void testSetRow() {
        ...
        checkArrays(this.subRow3[0], m.getRow(0));
        try {
    ...
    public void testGetColumn() {
        final FieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.subTestData);
        final Fraction[] mColumn1 = columnToArray(this.subColumn1);
        final Fraction[] mColumn3 = columnToArray(this.subColumn3);
    ...
    private static Fraction[] columnToArray(final Fraction[][] column) {
        final Fraction[] data = new Fraction[column.length];
        for (int i = 0; i < data.length; ++i) {
            data[i] = column[i][0];
        }
    ...
    private static void checkArrays(final Fraction[] expected, final Fraction[] actual) {
    ...
    public void testEqualsAndHashCode() {
        ...
        Assert.assertFalse(m.equals(new Array2DRowFieldMatrix<>(this.bigSingular)));
    }

    @Test
    public void testToString() {
        Array2DRowFieldMatrix<Fraction> m = new Array2DRowFieldMatrix<>(this.testData);
    ...
    public void testSetSubMatrix() {
        ...
        final Array2DRowFieldMatrix<Fraction> m2 = new Array2DRowFieldMatrix<>(
 ...
 new Array2DRowFieldMatrix<>(FractionField.getInstance(), rows,
                columns);
    ...
    protected static void splitLU(final FieldMatrix<Fraction> lu,
    ...
    protected static FieldMatrix<Fraction> permuteRows(final FieldMatrix<Fraction> matrix,
