 ...
 * 
 * @version $Id: SecondMomentTest.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class SecondMomentTest extends StorelessUnivariateStatisticAbstractTest {
    ...
    public UnivariateStatistic getUnivariateStatistic() {
        // Coverage of the SecondMoment(SecondMoment) constructor:
        this.stat = new SecondMoment();
        new SecondMoment(this.stat);
