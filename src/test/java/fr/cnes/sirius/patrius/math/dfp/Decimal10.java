...
public class Decimal10 extends DfpDec {
    ...
    public Dfp newInstance() {
        return new Decimal10(this.getField());
    }

    @Override
    public Dfp newInstance(final byte x) {
        return new Decimal10(this.getField(), x);
    }
    ...
    public Dfp newInstance(final String s) {
        return new Decimal10(this.getField(), s);
    }

    @Override
    public Dfp newInstance(final byte sign, final byte nans) {
        return new Decimal10(this.getField(), sign, nans);
    }
