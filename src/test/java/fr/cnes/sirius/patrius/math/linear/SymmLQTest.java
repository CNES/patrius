...
public class SymmLQTest {
    ...
    public void saundersTest(final int n, final boolean goodb,
        ...
        final double pertm = MathLib.abs(pertbn);
    ...
    public void testSolveSaunders1() {
        this.saundersTest(1, false, false, 0., 0.);
    }

    @Test
    public void testSolveSaunders2() {
        this.saundersTest(2, false, false, 0., 0.);
    }

    @Test
    public void testSolveSaunders3() {
        this.saundersTest(1, false, true, 0., 0.);
    }

    @Test
    public void testSolveSaunders4() {
        this.saundersTest(2, false, true, 0., 0.);
    }

    @Test
    public void testSolveSaunders5() {
        this.saundersTest(5, false, true, 0., 0.);
    }

    @Test
    public void testSolveSaunders6() {
        this.saundersTest(5, false, true, 0.25, 0.);
    }

    @Test
    public void testSolveSaunders7() {
        this.saundersTest(50, false, false, 0., 0.);
    }

    @Test
    public void testSolveSaunders8() {
        this.saundersTest(50, false, false, 0.25, 0.);
    }

    @Test
    public void testSolveSaunders9() {
        this.saundersTest(50, false, true, 0., 0.10);
    }

    @Test
    public void testSolveSaunders10() {
        this.saundersTest(50, false, true, 0.25, 0.10);
    }

    @Test
    public void testSolveSaunders11() {
        this.saundersTest(1, true, false, 0., 0.);
    }

    @Test
    public void testSolveSaunders12() {
        this.saundersTest(2, true, false, 0., 0.);
    }

    @Test
    public void testSolveSaunders13() {
        this.saundersTest(1, true, true, 0., 0.);
    }

    @Test
    public void testSolveSaunders14() {
        this.saundersTest(2, true, true, 0., 0.);
    }

    @Test
    public void testSolveSaunders15() {
        this.saundersTest(5, true, true, 0., 0.);
    }

    @Test
    public void testSolveSaunders16() {
        this.saundersTest(5, true, true, 0.25, 0.);
    }

    @Test
    public void testSolveSaunders17() {
        this.saundersTest(50, true, false, 0., 0.);
    }

    @Test
    public void testSolveSaunders18() {
        this.saundersTest(50, true, false, 0.25, 0.);
    }

    @Test
    public void testSolveSaunders19() {
        this.saundersTest(50, true, true, 0., 0.10);
    }

    @Test
    public void testSolveSaunders20() {
        this.saundersTest(50, true, true, 0.25, 0.10);
    }
