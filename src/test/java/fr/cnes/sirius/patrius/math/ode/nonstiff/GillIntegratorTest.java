...
public class GillIntegratorTest {
    ...
    public void testDecreasingSteps()
        ...
        for (final TestProblemAbstract problem : problems) {
            ...
            for (int i = 5; i < 10; ++i) {
                ...
                final FirstOrderIntegrator integ = new GillIntegrator(step);
                ...
                if (i > 5) {
                    Assert.assertTrue(valueError < 1.01 * MathLib.abs(previousValueError));
                }
    ...
    public void testUnstableDerivative()
        ...
        final FirstOrderIntegrator integ = new GillIntegrator(0.3);
    ...
    private static class KeplerStepHandler implements StepHandler {
        ...
        public void
            ...
            if (isLast) {
                ...
                Assert.assertTrue(this.maxError > 0.001);
            }
        }
