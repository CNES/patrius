...
public class ComplexTest {
    ...
    public void testSerial() {
        ...
        final Complex ncmplx = TestUtils.serializeAndRecover(this.oneNaN);
        Assert.assertEquals(this.nanZero, ncmplx);
        Assert.assertTrue(ncmplx.isNaN());
        final Complex infcmplx = TestUtils.serializeAndRecover(this.infInf);
        ...
        final TestComplex ntcmplx = TestUtils.serializeAndRecover(new TestComplex(this.oneNaN));
        Assert.assertEquals(this.nanZero, ntcmplx);
        Assert.assertTrue(ntcmplx.isNaN());
        final TestComplex inftcmplx = TestUtils.serializeAndRecover(new TestComplex(this.infInf));
