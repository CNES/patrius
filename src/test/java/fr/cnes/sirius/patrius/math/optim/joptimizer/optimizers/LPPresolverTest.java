...
public class LPPresolverTest extends TestCase {
    ...
    public void testFromFile1() throws IOException, PatriusException {
        ...
        final double[] c = TestUtils.loadDoubleArrayFromFile(this.presolvingS + this.cS + problemId + this.txt);
        final double[][] a = TestUtils.loadDoubleMatrixFromFile(this.presolvingS + this.aS + problemId + this.txt,
            this.space.charAt(0));
        final double[] b = TestUtils.loadDoubleArrayFromFile(this.presolvingS + this.bS + problemId + this.txt);
        final double[] lb = TestUtils.loadDoubleArrayFromFile(this.presolvingS + this.lbS + problemId + this.txt);
        final double[] ub = TestUtils.loadDoubleArrayFromFile(this.presolvingS + this.ubS + problemId + this.txt);
        double s = 0;
        try {
            s = TestUtils.loadDoubleArrayFromFile(this.presolvingS + this.sS + problemId + this.txt)[0];
        } catch (final IOException e) {
        }
        final double[] expectedSolution = TestUtils.loadDoubleArrayFromFile(this.presolvingS + this.solS + problemId
                + this.txt);
        final double expectedValue = TestUtils.loadDoubleArrayFromFile(this.presolvingS + this.val + problemId
                + this.txt)[0];
        double expectedTolerance = TestUtils
            .loadDoubleArrayFromFile(this.presolvingS + this.tol + problemId + this.txt)[0];
     ...
     */
    private void doPresolving(final double[] c, final double[][] a, final double[] b, final double[] lb,
                              final double[] ub,
                              final double s, final double[] expectedSolution, final double expectedValue,
                              final double expectedTolerance)
    ...
    public void testWithZeroA() throws IOException {
        ...
        final double[] c = TestUtils.loadDoubleArrayFromFile(this.presolvingS + this.cS + problemId + this.txt);
        final double[][] a1 = TestUtils.loadDoubleMatrixFromFile(this.presolvingS + this.aS + problemId + this.txt,
            this.space.charAt(0));
     ...
     */
    public void testInfeasibleProb() {
        final double[] c = { 1, 2, -3 };
    ...
    public void testInfeasibleProb4() {
        ...
        final double[] b = { 10, 5 };
        final double[] lb = { Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY,
