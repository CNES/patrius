...
public class ConstantSpinSlewValTest {
     ...
     */
    @Test
    public final void testSimpleCase() throws PatriusException {
     ...
     */
    @Test
    public final void testGeneralCase() throws PatriusException {
     ...
     */
    @Test
    public final void testSmallAngleCase() throws PatriusException {
     ...
     */
    @Test
    public final void testLargeAngleCase() throws PatriusException {
     ...
     */
    @Test
    public final void testSequence() throws PatriusException {
        ...
        final StrictAttitudeLegsSequence sequence = new StrictAttitudeLegsSequence<AttitudeLeg>();
        ...
        this.compareAttitudes(att1, slerp.getAttitude(slerp.getTimeInterval().getLowerData(), gcrf),
            EPS);
        ...
        this.compareAttitudes(att2, slerp.getAttitude(slerp.getTimeInterval().getUpperData(), gcrf),
            EPS);

        // the attitude at the beginning of the constant spin slew given by the constant spin slew and the sequence are
        // equal with an allowed error of
        // 1e-14 due to the computation errors
        this.compareAttitudes(slerp.getAttitude(slerp.getTimeInterval().getLowerData(), gcrf),
            sequence.getAttitude(leo, slerp.getTimeInterval().getLowerData(), gcrf),
            EPS);
        ...
        // 1e-14 due to the computation errors
        this.compareAttitudes(slerp.getAttitude(slerp.getTimeInterval().getUpperData(), gcrf),
            sequence.getAttitude(leo, slerp.getTimeInterval().getUpperData(), gcrf),
            EPS);
    }
     ...
     *        : threshold
     */
    private void compareAttitudes(final Attitude expected, final Attitude actual, final double threshold) {
        ...
        final boolean eqRot = this.eqNullRot(expected.getRotation(), actual.getRotation(), threshold);
     ...
     * @return true or false
     */
    private boolean eqNullRot(final Rotation a,
