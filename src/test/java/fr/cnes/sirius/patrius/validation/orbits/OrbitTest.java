...
public class OrbitTest {
     ...
     */
    @Test
    public void Cartesian2CircularEquatorial() {
     ...
     */
    @Test
    public void Cartesian2Circular() {
        ...
        assertAngleEqualsRelative(orbit.getI(), 1.4383940777710431, this.epsilonNonReg, expected_i,
            this.epsilonAngle,
            "Cartesian2Circular_I");
        assertAngleEqualsRelative(orbit.getRightAscensionOfAscendingNode(), -0.6154592667225562,
            this.epsilonNonReg,
            expected_raan, this.epsilonAngle, "Cartesian2Circular_raan");
        assertAngleEqualsRelative(orbit.getAlphaM(), -3.000124312020019, this.epsilonNonReg, expected_alphaM,
            this.epsilonAngle,
     ...
     */
    @Test
    public void Cartesian2Keplerian() {
        ...
        assertAngleEqualsRelative(orbit.getI(), 0.12218209622090577, this.epsilonNonReg, expected_i,
            this.epsilonAngle,
            "Cartesian2Keplerian_I");
        assertAngleEqualsRelative(orbit.getPerigeeArgument(), 3.0990904101667147, this.epsilonNonReg, expected_w,
            this.epsilonAngle, "Cartesian2Keplerian_w");
        assertAngleEqualsRelative(orbit.getRightAscensionOfAscendingNode(), 2.322310109799988, this.epsilonNonReg,
            expected_W, this.epsilonAngle, "Cartesian2Keplerian_W");
        assertAngleEqualsRelative(orbit.getMeanAnomaly(), -3.054295530889249, this.epsilonNonReg, expected_M,
            this.epsilonAngle,
     ...
     */
    @Test
    public void Circular2Cartesian() {
     ...
     */
    @Test
    public void CircularEquatorial2Cartesian() {
     ...
     */
    @Test
    public void CircularEquatorial2Keplerian() {
        ...
        assertAngleEqualsRelative(kOrbit.getI(), 1.6690116855391711E-4, this.epsilonNonReg, expected_i,
            this.epsilonAngle,
            "CircularEquatorial2Keplerian_I");
        assertAngleEqualsRelative(kOrbit.getPerigeeArgument(), 2.4109420470904794, this.epsilonNonReg,
            expected_aop,
            this.epsilonAngle, "CircularEquatorial2Keplerian_w");
        assertAngleEqualsRelative(kOrbit.getRightAscensionOfAscendingNode(), -0.7684506335910435,
            this.epsilonAngle,
            expected_raan, this.epsilonAngle, "CircularEquatorial2Keplerian_W");
        assertAngleEqualsRelative(kOrbit.getMeanAnomaly(), -2.625676720679058, this.epsilonNonReg, expected_M,
            this.epsilonAngle,
     ...
     */
    @Test
    public void Circular2Keplerian() {
        ...
        assertAngleEqualsRelative(kOrbit.getI(), 1.7233, this.epsilonNonReg, expected_i, this.epsilonAngle,
            "Circular2Keplerian_I");
        assertAngleEqualsRelative(kOrbit.getPerigeeArgument(), 1.7839273545992698, this.epsilonNonReg,
            expected_aop,
            this.epsilonAngle, "Circular2Keplerian_w");
        assertAngleEqualsRelative(kOrbit.getRightAscensionOfAscendingNode(), 1.5745, this.epsilonNonReg,
            expected_raan,
            this.epsilonAngle, "Circular2Keplerian_W");
        assertAngleEqualsRelative(kOrbit.getMeanAnomaly(), -1.2113273545992698, this.epsilonNonReg, expected_M,
     ...
     */
    @Test
    public void Keplerian2Cartesian() {
    ...
    public void Keplerian2CartesianAnomalyOutOfRange() throws IllegalArgumentException {
        // Case #3...
        // . awaited output values
     ...
     */
    @Test
    public void Keplerian2CircularEquatorial() {
        ...
        assertAngleEqualsRelative(cOrbit.getLM(), 4.162032999999999, this.epsilonNonReg, expected_LM,
            this.epsilonAngle,
     ...
     */
    @Test
    public void Keplerian2Circular() {
        ...
        assertAngleEqualsRelative(cOrbit.getI(), 0.122138, this.epsilonNonReg, expected_i, this.epsilonAngle,
            "Keplerian2Circular_I");
        assertAngleEqualsRelative(cOrbit.getRightAscensionOfAscendingNode(), 1.00681, this.epsilonNonReg,
            expected_raan,
            this.epsilonAngle, "Keplerian2Circular_raan");
        assertAngleEqualsRelative(cOrbit.getAlphaM(), 3.1552229999999994, this.epsilonNonReg, expected_alphaM,
            this.epsilonAngle,
     ...
     */
    @Test
    public void Keplerian2Equinoctial() {
        ...
        assertAngleEqualsRelative(eOrbit.getLM(), 4.162032999999999, this.epsilonNonReg, expected_lm,
            this.epsilonAngle,
     ...
     */
    @Test
    public void Equinoctial2Keplerian() throws PatriusException {
        ...
        assertAngleEqualsRelative(kOrbit1.getI(), 3.3380233362093515E-4, this.epsilonNonReg, expected_i1,
            this.epsilonAngle,
            "Equinoctial2Keplerian_I");
        assertAngleEqualsRelative(kOrbit1.getPerigeeArgument(), 2.4109420470912184, this.epsilonNonReg,
            expected_aop1,
            this.epsilonAngle, "Equinoctial2Keplerian_w");
        assertAngleEqualsRelative(kOrbit1.getRightAscensionOfAscendingNode(), -0.7684506335910435,
            this.epsilonNonReg,
            expected_raan1, this.epsilonAngle, "Equinoctial2Keplerian_W");
        assertAngleEqualsRelative(kOrbit1.getMeanAnomaly(), 3.6575085864998247, this.epsilonNonReg, expected_M1,
        ...
        validate.assertEqualsWithRelativeTolerance(kOrbit2.getE(), 1.1028331696136094E-4, this.epsilonNonReg,
            expected_e2,
            this.epsilonE, "Equinoctial2Keplerian_E");
        assertAngleEqualsRelative(kOrbit2.getI(), 0.0, this.epsilonNonReg, expected_i2, this.epsilonAngle,
            "Equinoctial2Keplerian_I");

        boolean testFail = false;
        try {
            assertAngleEqualsRelative(kOrbit2.getPerigeeArgument(), 2.625676720680361, this.epsilonNonReg,
                expected_aop2,
                this.epsilonAngle, "Equinoctial2Keplerian_w");
            testFail = true;
        ...
        assertAngleEqualsRelative(kOrbit2.getRightAscensionOfAscendingNode(), -0.0, this.epsilonNonReg,
            expected_raan2,
            this.epsilonAngle, "Equinoctial2Keplerian_W");
        assertAngleEqualsRelative(kOrbit2.getTrueAnomaly(), 3.6575085864998247, this.epsilonNonReg, expected_M2,
            this.epsilonAngle, "Equinoctial2Keplerian_M");
        ...
        assertAngleEqualsRelative(kOrbit3.getI(), 3.3380233362093515E-4, this.epsilonNonReg, expected_i3,
            this.epsilonAngle,
            "Equinoctial2Keplerian_I");

        testFail = false;
        try {
            assertAngleEqualsRelative(kOrbit3.getPerigeeArgument(), -3.346293905146258, this.epsilonNonReg,
                expected_aop3,
                this.epsilonAngle, "Equinoctial2Keplerian_w");
        } catch (final AssertionError e) {
            // handle exception
        ...
        assertAngleEqualsRelative(kOrbit3.getRightAscensionOfAscendingNode(), -0.7684506335910434,
            this.epsilonNonReg,
            expected_raan3, this.epsilonAngle, "Equinoctial2Keplerian_W");

        testFail = false;
        try {
            assertAngleEqualsRelative(kOrbit3.getMeanAnomaly(), 3.1315592315577145, this.epsilonNonReg,
                expected_M3,
                this.epsilonAngle, "Equinoctial2Keplerian_M");
        } catch (final AssertionError e) {
            // handle exception
        ...
        validate.assertEquals(kOrbit4.getE(), 5.81549013445668E-17, this.epsilonNonReg, expected_e4, this.epsilonE,
            "Equinoctial2Keplerian_E");
        assertAngleEqualsRelative(kOrbit4.getI(), 0.0, this.epsilonNonReg, expected_i4, this.epsilonAngle,
            "Equinoctial2Keplerian_I");

        testFail = false;
        try {
            assertAngleEqualsRelative(kOrbit4.getPerigeeArgument(), -1.5707963267948966, this.epsilonNonReg,
                expected_aop4,
                this.epsilonAngle, "Equinoctial2Keplerian_w");
        } catch (final AssertionError e) {
            // handle exception
        ...
        testFail = false;
        try {
            assertAngleEqualsRelative(kOrbit4.getRightAscensionOfAscendingNode(), 0.0, this.epsilonNonReg,
                expected_raan4,
                this.epsilonAngle, "Equinoctial2Keplerian_W");
        } catch (final AssertionError e) {
            // handle exception
        ...
        testFail = false;
        try {
            assertAngleEqualsRelative(kOrbit4.getMeanAnomaly(), 1.5707963267948966, this.epsilonNonReg,
                expected_M4,
                this.epsilonAngle, "Equinoctial2Keplerian_M");
        } catch (final AssertionError e) {
            // handle exception
     ...
     */
    @Test
    public void testEquatorialRetrogadeOrbit() {
     ...
     */
    @Test
    public void testgetJacobianWrtParameters() throws PatriusException {
     ...
     */
    @Test
    public void testConstructorOrbit() throws IllegalArgumentException, PatriusException {
     ...
     */
    @Test
    public void testNonInertialFrame() throws IllegalArgumentException, PatriusException {
     ...
     */
    @Test
    public void testFT2082() throws IllegalArgumentException, PatriusException {
     ...
     */
    @Test
    public void testFT2468() throws IllegalArgumentException {
    ...
    private static <T> List<Pair<T, T>> generatePermutations(final List<T> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            for (int j = 0; j <= i; j++) {
                out.add(new Pair<>(list.get(i), list.get(j)));
            }
        }
        return out;
    }
