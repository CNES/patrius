...
public class SimpleNumericalPropagationTest {
     ...
     */
    @Test
    public void simplePropagationTest() throws PatriusException, IOException, ParseException {
        /*
        ...
        final JPLCelestialBodyLoader loader = new JPLCelestialBodyLoader(UNXP2000_405,
            EphemerisType.SUN);
        ...
        // e) Newtonian attraction
        final ForceModel newtonianAttraction = new DirectBodyAttraction(new NewtonianGravityModel(propag.getMu()));
        propag.addForceModel(newtonianAttraction);
