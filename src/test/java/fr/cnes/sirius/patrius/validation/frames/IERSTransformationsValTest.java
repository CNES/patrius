...
public class IERSTransformationsValTest {
     ...
     */
    @Test
    public void testTransformationsIERS() throws PatriusException {
     ...
     */
    @Test
    public void testStressTransformationsIERS() throws PatriusException {
        // date of the bulletin
        final AbsoluteDate date = new AbsoluteDate(new DateComponents(2009, 10, 31), new TimeComponents(06, 26, 00),
            TimeScalesFactory.getUTC());
        ...
        assertTrue(orekitPvtotalReverse.getVelocity().distance(vITRF) < 1.2e-6);
    }
     ...
     */
    @Test
    public void testTransformationTIRFtoCIRF() throws PatriusException {
        /*
