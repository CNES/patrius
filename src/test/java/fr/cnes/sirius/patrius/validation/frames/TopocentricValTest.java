...
public class TopocentricValTest {
     ...
     */
    @Test
    public final void testTransformFromPVToTopocentric() throws PatriusException {

        // North topocentric frame
        final GeodeticPoint point = new GeodeticPoint(MathLib.toRadians(43.604482), MathLib.toRadians(1.443962), 0.);
        final TopocentricFrame topoNorth = new TopocentricFrame(this.earthSpheric, point, 0., this.northFrame);
        ...
        // elevation angle
        System.out.println(topoCoordPV.getElevation());
     ...
     */
    @Test
    public final void testTransformFromTopocentricToPV() throws PatriusException {
     ...
     */
    @Test
    public final void testTransformationLimitCaseTopocentric() {
     ...
     */
    @Test
    public final void testTransformationLimitCaseCardan() {
     ...
     */
    @Test
    public final void testTransformationPVtoCardan() throws PatriusException {

        System.out.println("testTransformationPVtoCardan");
        ...
        // Rates
        System.out.println(XangleRate);
        System.out.println(YangleRate);
        System.out.println(rangeRate);
     ...
     */
    @Test
    public final void testTransformationCardantoPV() throws PatriusException {

        System.out.println("testTransformationCardantoPV");
     ...
     */
    @Test
    public final void testTransformationPVToCardanDegrade1() throws PatriusException {

        System.out.println("testTransformationPVToCardanDegrade1");
     ...
     */
    @Test
    public final void testTransformationPVToCardanDegrade2() throws PatriusException {

        System.out.println("testTransformationPVToCardanDegrade2");
        ...
        // North topocentric frame
        final GeodeticPoint point = new GeodeticPoint(MathLib.toRadians(43.604482), MathLib.toRadians(1.443962), 0.);
        final TopocentricFrame topoNor = new TopocentricFrame(this.earthSpheric, point, 0., this.northFrame);
     ...
     */
    @Test
    public final void testTransformationPositionToCardan() throws PatriusException {

        System.out.println("testTransformationPositionToCardan");
     ...
     */
    @Test
    public final void testTransformationCardanToPosition() throws PatriusException {

        System.out.println("testTransformationCardanToPosition");
     ...
     */
    @Test
    public final void testTransformationPositionToCardanDegrade1() throws PatriusException {

        System.out.println("testTransformationPositionToCardanDegrade1");
     ...
     */
    @Test
    public final void testTransformationPositionToCardanDegrade2() throws PatriusException {

        System.out.println("testTransformationPositionToCardanDegrade2");
    ...
    public void testDelevation() throws PatriusException {
        ...
        final GeodeticPoint groundPoint = new GeodeticPoint(MathLib.toRadians(0.),
                MathLib.toRadians(0.), 0.);
        final TopocentricFrame topoFrame = new TopocentricFrame(this.earthSpheric, groundPoint,
                "lon 0 lat 0");
        ...
        final GeodeticPoint targetPoint = new GeodeticPoint(MathLib.toRadians(5.),
                MathLib.toRadians(5.), 800_000.);
        final Vector3D extPoint = this.earthSpheric.transform(targetPoint);
        ...
        // Print the output on each axis
        System.out.println("Frame = " + itrf.toString());
        System.out.println("dElevX: " + compUtils(dElev.getX(), numValX));
        System.out.println("dElevY: " + compUtils(dElev.getY(), numValY));
        System.out.println("dElevZ: " + compUtils(dElev.getZ(), numValZ));
    ...
    public void testDazimuth() throws PatriusException {
        ...
        // Print the output on each axis
        System.out.println("Frame = " + itrf.toString());
        System.out.println("dAzimX: " + compUtils(dAzim.getX(), numValX));
        System.out.println("dAzimY: " + compUtils(dAzim.getY(), numValY));
        System.out.println("dAzimZ: " + compUtils(dAzim.getZ(), numValZ));
    ...
    private static String compUtils(final double val, final double refVal) {
        // To display the accurate values for non regression
        // return (", " + val + ", " + refVal);
        // To display an ergonomic results summary
