...
public class ClassPathCrawlerTest {
    ...
    public void testFeedOrekitException() throws PatriusException {
     ...
     */
    @Test(expected = PatriusException.class)
    public void feedFailsOnURI() throws MalformedURLException, URISyntaxException, PatriusException {
