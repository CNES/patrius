...
import fr.cnes.sirius.patrius.events.detectors.AlignmentDetector;
...
public class AlignmentDetectorTest {
     ...
     */
    @Test
    public void testAlignmentDetectordoubleOrbitPVCdouble() throws PatriusException {
     ...
     */
    @Test
    public void testAlignmentDetectorSimpleGetters() throws PatriusException {
        final double expectedThr = 0.001232;
     ...
     */
    @Test
    public void testAlignment2() throws PatriusException {
     ...
     *              AlignmentDetector is based on an orbit in an inertial frame.
     * 
     * @testedMethod {@link AlignmentDetector#g(SpacecraftState)}
     * @throws PatriusException
     */
