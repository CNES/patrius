...
public class GroundMaskElevationDetectorTest {
     ...
     */
    @Test
    public final void testGroundMaskElevationDetectorDoubleDoubleFrame() throws PatriusException {
     ...
     */
    @Test
    public final void testGroundMaskElevationDetectorDoubleDoubleDoubleFrame() throws PatriusException {
        final double expectedMaxCheck = 543.21;
