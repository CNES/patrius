...
public class GravityFieldFactoryTest {
     ...
     */
    @Test
    public void testAddDefaultPotentialCoefficientsReaders() throws IOException, ParseException, PatriusException {
    ...
    public void testErrorCase() throws IOException, ParseException, PatriusException {
        // removes any existing reader, so that we can recreate them
        GravityFieldFactory.clearPotentialCoefficientsReaders();
