...
public class EclipseDetectorTest {
     ...
     */
    @Test
    public final void testEclipseDetectorCtor3() throws PatriusException {
     ...
     */
    @Test
    public final void testEclipseDetectorMiscGetters() throws PatriusException {
    ...
    public void testGetters() throws PatriusException {
        ...
        Assert.assertEquals(
            120000.0,
            detector.getOccultingRadiusProvider().getLocalRadius(new Vector3D(1, 1, 1), FramesFactory.getGCRF(),
                AbsoluteDate.J2000_EPOCH, CelestialBodyFactory.getSun()), 0);
    }
}
