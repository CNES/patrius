...
public class NadirPointingTest {
    ...
    public class NadirPointingClassTest extends NadirPointing {
        ...
        public void test() throws PatriusException {
            ...
            sample.add(NadirPointingTest.nadirRef(
                ...
                this.getBodyShape(), getBodyFrame()));
            sample.add(NadirPointingTest.nadirRef(new TimeStampedPVCoordinates(NadirPointingTest.this.date,
                pvProvh), refToBody, getBodyShape(),
                this.getBodyFrame()));
            sample.add(NadirPointingTest.nadirRef(
     ...
     */
    @Test
    public void testCollision() throws PatriusException {
