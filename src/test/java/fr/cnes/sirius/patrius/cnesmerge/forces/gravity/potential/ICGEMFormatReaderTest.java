...
public class ICGEMFormatReaderTest {
    ...
    public final void testCorruptedFile3() throws IOException, ParseException, PatriusException {
     ...
     */
    @Test(expected = PatriusException.class)
    public final void testCorruptedFile7() throws IOException, ParseException, PatriusException {
        Utils.setDataRoot(POTDIR);
