...
public class ElevationDetectorTest {
     ...
     */
    @Test
    public final void testElevationDetectorDoubleDoubleDoubleFrame() throws PatriusException {
     ...
     */
    @Test
    public final void testElevationDetectorDoubleDoubleFrame() throws PatriusException {
        final double expectedMaxCheck = 543.21;
