...
public class MNTTest {
    ...
    public final void benchMarkTest() throws PatriusException, IOException, URISyntaxException {
        ...
        final String fullName = FacetBodyShape.class.getClassLoader().getResource(modelFile).toURI().getPath();
        double t0 = System.currentTimeMillis();
        final FacetBodyShape body = new FacetBodyShape("", FramesFactory.getITRF(), new MyPVCoordinatesProvider(), EllipsoidType.INNER_SPHERE, new ObjMeshLoader(fullName));
