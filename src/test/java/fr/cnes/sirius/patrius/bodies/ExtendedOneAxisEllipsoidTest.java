...
public class ExtendedOneAxisEllipsoidTest {
     ...
     * @testedFeature {@link features#SPHEROID_BODY_SHAPE}
     * 
     * @testedMethod {@link ExtendedOneAxisEllipsoid#getLocalRadius(Vector3D, Frame, AbsoluteDate, PVCoordinatesProvider)}
     * 
     ...
     */
    @Test
    public final void testOutOfBoundAcosLocalRadius() throws PatriusException {
        final ExtendedOneAxisEllipsoid ellipsoid = new ExtendedOneAxisEllipsoid(6378137.0,
            (6378137.0 - 6356752.314245179) / 6378137.0,
        ...
        final PVCoordinatesProvider occultedBody = new PVCoordinatesProvider(){
            ...
            public PVCoordinates getPVCoordinates(final AbsoluteDate date, final Frame frame) throws PatriusException {
                // Occulted body radius does not matter
                return new PVCoordinates(new Vector3D(1, 2, 3), Vector3D.ZERO);
            }
        };
        try {
            ellipsoid.getLocalRadius(pos, FramesFactory.getGCRF(), new AbsoluteDate(366803769, 0.5980079787259456),
                occultedBody);
