...
.getInertialFrame(
    ...
    public void testConstantsJPL() throws PatriusException {
        ...
        final JPLCelestialBodyLoader loader = new JPLCelestialBodyLoader(
                ...
                EphemerisType.SUN);
        Assert.assertEquals(149597870691.0,
            ((JPLHistoricEphemerisLoader) loader.getEphemerisLoader()).getLoadedAstronomicalUnit(), 0.1);
        Assert.assertEquals(81.30056, ((JPLHistoricEphemerisLoader) loader.getEphemerisLoader()).getLoadedEarthMoonMassRatio(),
            1.0e-8);
    }
    ...
    public void testConstantsInpop() throws PatriusException {
        ...
        Assert.assertEquals(149597870691.0,
            ((JPLHistoricEphemerisLoader) loader.getEphemerisLoader()).getLoadedAstronomicalUnit(), 0.1);
        Assert.assertEquals(81.30057, ((JPLHistoricEphemerisLoader) loader.getEphemerisLoader()).getLoadedEarthMoonMassRatio(),
            1.0e-8);
    }
    ...
    public void testEndianness() throws PatriusException {
        ...
        Assert.assertEquals(1.0,
            ((JPLHistoricEphemerisLoader) loaderInpopTCBBig.getEphemerisLoader()).getLoadedConstant("TIMESC"), 1.0e-10);
        ...
        final CelestialBody bodysInpopTCBLittle = loaderInpopTCBLittle
            .loadCelestialBody(CelestialBodyFactory.MARS);
        Assert.assertEquals(1.0,
            ((JPLHistoricEphemerisLoader) loaderInpopTCBLittle.getEphemerisLoader()).getLoadedConstant("TIMESC"), 1.0e-10);
    ...
    public void testInpopvsJPL() throws PatriusException {
        ...
        Assert.assertEquals(0.0,
            ((JPLHistoricEphemerisLoader) loaderInpopTDBBig.getEphemerisLoader()).getLoadedConstant("TIMESC"), 1.0e-10);
        final JPLCelestialBodyLoader loaderInpopTCBBig = new JPLCelestialBodyLoader(
            "^inpop.*_TCB_.*_bigendian\\.dat$", type);
        final CelestialBody bodysInpopTCBBig = loaderInpopTCBBig
            .loadCelestialBody(CelestialBodyFactory.MARS);
    ...
    public void testCoverage() throws PatriusException {
        ...
        Assert.assertEquals(Double.NaN, ((JPLHistoricEphemerisLoader) loader.getEphemerisLoader()).getLoadedConstant("Mock"),
            0.0);
        ...
        for (final Body body : Body.values()) {
            ...
            if (type.equals(EphemerisType.EARTH_MOON)
                ...
                final PVCoordinatesProvider provider = new ConstantPVCoordinatesProvider(pv,
                    ...
                    expected = expectedShape.getApparentRadius(new ConstantPVCoordinatesProvider(posInInertialFrame.scalarMultiply(2.5), celestialBody.getInertialFrame(IAUPoleModelType.CONSTANT)),
                    date, provider, PropagationDelayType.INSTANTANEOUS);
                actual = defaultShape.getApparentRadius(new ConstantPVCoordinatesProvider(posInInertialFrame.scalarMultiply(2.5), celestialBody.getInertialFrame(IAUPoleModelType.CONSTANT)),
                    date, provider, PropagationDelayType.INSTANTANEOUS);
