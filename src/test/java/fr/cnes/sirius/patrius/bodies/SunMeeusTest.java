...
public class SunMeeusTest {
    ...
    public void testTransformation() throws PatriusException {
        Assert.assertNotNull(this.sun.getInertialFrame(IAUPoleModelType.CONSTANT).getTransformTo(
            FramesFactory.getEME2000(),
            AbsoluteDate.J2000_EPOCH));
        Assert.assertNotNull(this.sun.getRotatingFrame(IAUPoleModelType.TRUE).getTransformTo(
            FramesFactory.getEME2000(),
            AbsoluteDate.J2000_EPOCH));
    }
    ...
    public void testGetShape() throws PatriusException {
        ...
        actual = actualShape.getApparentRadius(new ConstantPVCoordinatesProvider(posInFrame.scalarMultiply(5),
            bodyInertialFrame), date, provider, PropagationDelayType.INSTANTANEOUS);
        ...
        final BodyPoint[] intersections = actualShape.getIntersectionPoints(line2, bodyInertialFrame, date);
        final BodyPoint[] expectedInter = expectedShape.getIntersectionPoints(line2, bodyInertialFrame, date);
        ...
        Assert.assertEquals(intersections[intersections.length - 1].getPosition(),
            expectedInter[expectedInter.length - 1].getPosition());
    }
    ...
    public void testSetShape() throws PatriusException {
        ...
        // the new body shape
        final BodyShape newShape = new OneAxisEllipsoid(this.radius * 1.05, 0.01, bodyRotatingFrame, "sun modified");
    ...
    public void testAttractionModel() {
        ...
        final GravityModel model = this.sun.getGravityModel();
        ...
        this.sun.setGravityModel(newModel);
        ...
        Assert.assertEquals(1.5 * mu, this.sun.getGravityModel().getMu(), 0.);
    }
