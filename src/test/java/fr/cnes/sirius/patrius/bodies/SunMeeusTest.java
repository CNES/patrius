...
public class SunMeeusTest {
    ...
    public void testTransformation() throws PatriusException {
        Assert.assertNotNull(sun.getInertialFrameConstantModel().getTransformTo(FramesFactory.getEME2000(),
            AbsoluteDate.J2000_EPOCH));
        Assert.assertNotNull(sun.getRotatingFrameTrueModel().getTransformTo(FramesFactory.getEME2000(),
            AbsoluteDate.J2000_EPOCH));
    }
    ...
    public void testGetShape() throws PatriusException {
    	...
    	final Frame bodyRotatingFrame = sun.getRotatingFrameTrueModel();
    	final Frame bodyInertialFrame = sun.getInertialFrameConstantModel();
    ...
    public void testAttractionModel(){
        ...
        final AbstractAttractionModel model = sun.getAttractionModel();
