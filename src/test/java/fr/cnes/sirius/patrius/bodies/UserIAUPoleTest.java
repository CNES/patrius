...
public class UserIAUPoleTest {
    ...
    public void testUserIAUPoleNTMercury() throws PatriusException {
        ...
        // Reference
        final CelestialBodyIAUOrientation reference = IAUPoleFactory.getIAUPole(PredefinedEphemerisType.MERCURY);
        // Build actual
    ...
    public void testUserIAUPoleNTJupiter() throws PatriusException {
        ...
        // Reference
        final CelestialBodyIAUOrientation reference = IAUPoleFactory.getIAUPole(PredefinedEphemerisType.JUPITER);
        // Build actual
        // Alpha 0
        final List<UnivariateDifferentiableFunction> alpha0fDays = new ArrayList<>();
    ...
    public void testUserIAUPoleDerivativesJupiter() throws PatriusException {
        // Build Jupiter
        final CelestialBodyIAUOrientation jupiter = IAUPoleFactory.getIAUPole(PredefinedEphemerisType.JUPITER);
