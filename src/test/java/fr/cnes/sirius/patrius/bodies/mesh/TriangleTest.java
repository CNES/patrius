...
public class TriangleTest {
     ...
     * @testType UT
     * 
     * @description check that the triangle ID is as expected.
     * 
     * @testPassCriteria triangle ID is as expected
     * 
    ...
    public void triangleIdTest() {
        ...
        final int triangleId = 7;
        final Triangle triangle = new Triangle(triangleId, v1, v2, v3);

        Assert.assertEquals(triangleId, triangle.getID());
    }

    /**
     * @testType UT
     * 
     * @description check that intersection point between a ray and a triangle is properly performed in any possible
     *              situation.
     * 
    ...
    public void constructionTest() {
        ...
        final Triangle triangle = new Triangle(1, v1, v2, v3);
        final Triangle triangle2 = new Triangle(2, v1, v2, v4);
        final Triangle triangle3 = new Triangle(3, v1, v5, v4);
        final Triangle triangle4 = new Triangle(4, v6, v5, v4);
        ...
        Assert.assertEquals(MathLib.sqrt(5) / 3, triangle.getSphereRadius(), 0.);
    ...
    public void intersectionTest() {
        // Initialization
        final Triangle triangle = new Triangle(1, new Vertex(0, new Vector3D(0, 0, 0)),
    ...
    public void visibilityTest() {
        // Initialization
        final Triangle triangle = new Triangle(1, new Vertex(0, new Vector3D(0, 0, 0.6)),
     ...
     * @testType UT
     * 
     * @description check computation of closest point to point
     * 
     * @testPassCriteria closest point is as expected (reference: math, threshold: 1E-15)
     * 
     ...
     */
    @Test
    public void closestPointToVector3DTest() {
        // Initialization
        final Vertex v1 = new Vertex(1, new Vector3D(0, 0, 1));
        final Vertex v2 = new Vertex(2, new Vector3D(1, 1, 1));
        final Vertex v3 = new Vertex(3, new Vector3D(0, 2, 1));
        final Triangle triangle = new Triangle(0, v1, v2, v3);

        // Checks various configurations
        // Projection in triangle
        Assert.assertEquals(0., Vector3D.distance(new Vector3D(0.5, 1, 1), triangle.closestPointTo(new Vector3D(0.5, 1, 1))), 0.);
        // On edge
        Assert.assertEquals(0., Vector3D.distance(new Vector3D(0.5, 0.5, 1), triangle.closestPointTo(new Vector3D(1, 0, 1))), 1E-15);
        // Outside edge
        Assert.assertEquals(0., Vector3D.distance(new Vector3D(0., 0., 1), triangle.closestPointTo(new Vector3D(-2, -1, 1))), 0.);
        Assert.assertEquals(0., Vector3D.distance(new Vector3D(1., 1., 1), triangle.closestPointTo(new Vector3D(2, 2, 1))), 0.);
        // On vertex
        Assert.assertEquals(0., Vector3D.distance(new Vector3D(0, 2, 1), triangle.closestPointTo(new Vector3D(0, 2, 0))), 0.);
    }

    /**
     * @testType UT
     * 
     * @description test toString method of {@link Triangle}
     * 
    ...
    public void testToString() {
        final Vertex v1 = new Vertex(1001, new Vector3D(0, 0, 1));
        final Vertex v2 = new Vertex(1002, new Vector3D(1, 1, 1));
        final Vertex v3 = new Vertex(1003, new Vector3D(0, 2, 1));
