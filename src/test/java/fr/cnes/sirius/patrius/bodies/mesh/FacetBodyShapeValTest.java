...
public class FacetBodyShapeValTest {
    ...
    public static void setUpBeforeClass() throws PatriusException, URISyntaxException {
        ...
        body1 = new FacetBodyShape("", celestialBody1.getRotatingFrameTrueModel(), EllipsoidType.INNER_SPHERE,
        ...
        celestialBody2 = new UserCelestialBody("", CelestialBodyFactory.getMoon(), 0, IAUPoleFactory.getIAUPole(null),
            FramesFactory.getGCRF(), null);
        body2 = new FacetBodyShape("", celestialBody2.getRotatingFrameTrueModel(), EllipsoidType.INNER_SPHERE, loader3);
     ...
     * 
     * @testPassCriteria distance from line to body is properly computed (reference: math, absolute threshold: 80m, limited because method distanceTo() is not exact)
     * 
     * @referenceVersion 4.6
     * 
     * @nonRegressionVersion 4.6
     ...
     * 
     * @testPassCriteria distance from sub-line to body is properly computed (reference: math, absolute threshold: 550m, limited because method distanceTo() is not exact)
     * 
    ...
    public void apparentRadiusTest() throws PatriusException {
        ...
        // Non-regression only
        Assert.assertEquals(13945.933828586069, apparentRadiusLS, 0.);
    }
