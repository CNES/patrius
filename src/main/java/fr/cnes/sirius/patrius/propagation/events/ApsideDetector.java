...
public class ApsideDetector extends AbstractDetector {
    ...
    private final Action actionAtApogee;

    /** Action performed at perigee detection. */
    private final Action actionAtPerigee;
    ...
    public ApsideDetector(final double maxCheck, final double threshold, final Action actionApogee,
        ...
        super(PERIGEE_APOGEE, maxCheck, threshold);
        this.actionAtApogee = actionApogee;
        this.actionAtPerigee = actionPerigee;
        this.removeAtApogeeFlag = removeApogee;
        this.removeAtPerigeeFlag = removePerigee;
    }
     ...
     * 
     * @return action at perigee detection
     */
    public Action getActionAtPerigee() {
     ...
     * 
     * @return action at apogee detection
     */
    public Action getActionAtApogee() {
     ...
     * 
     * @return true if detection is removed after perigee detection
     */
     ...
     * 
     * @return true if detection is removed after apogee detection
     */
    ...
    public EventDetector copy() {
        ...
        if (this.getSlopeSelection() == PERIGEE) {
            result = new ApsideDetector(this.getSlopeSelection(), this.getMaxCheckInterval(), this.getThreshold(),
                this.actionAtPerigee, this.removeAtPerigeeFlag);
        } else if (this.getSlopeSelection() == APOGEE) {
            result = new ApsideDetector(this.getSlopeSelection(), this.getMaxCheckInterval(), this.getThreshold(),
                this.actionAtApogee, this.removeAtApogeeFlag);
        } else {
            result = new ApsideDetector(this.getMaxCheckInterval(), this.getThreshold(), this.actionAtApogee,
                this.actionAtPerigee, this.removeAtApogeeFlag, this.removeAtPerigeeFlag);
        }
        return result;
    }
}
