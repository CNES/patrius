...
public abstract class AbstractPropagator implements Propagator{
    ...
    private SpacecraftState resetState(final SpacecraftState resetState) throws PatriusException {
        ...
        if (this.attitudeProviderByDefault == null) {
            ...
            attitudeProvForce = this.attitudeProviderForces;
            attitudeProvEvent = this.attitudeProviderEvents;
        } else {
            // single attitude treatment
            attitudeProvForce = this.attitudeProviderByDefault;
        }
    ...
    protected SpacecraftState basicPropagate(final AbsoluteDate date) throws PropagationException {
        try {
            ...
            // Assign the correct attitude providers
            AttitudeProvider attitudeProvForces = null;
            AttitudeProvider attitudeProvEvents = null;
            if (this.attitudeProviderByDefault == null) {
                // If single attitude treatment
                attitudeProvForces = this.attitudeProviderForces;
                attitudeProvEvents = this.attitudeProviderEvents;
            } else {
                // If two attitudes treatment
                attitudeProvForces = this.attitudeProviderByDefault;
            }

            // compute additional states
            if (this.additionalStateProviders != null && !this.additionalStateProviders.isEmpty()) {
                final SpacecraftState temp = new SpacecraftState(attitudeProvForces, attitudeProvEvents, orbit);
                ...
                return new SpacecraftState(attitudeProvForces, attitudeProvEvents, orbit,
                        additionalStates);
            }
