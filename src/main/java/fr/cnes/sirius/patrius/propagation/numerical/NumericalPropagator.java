 ...
 * {@link fr.cnes.sirius.patrius.propagation.analytical.KeplerianPropagator KeplerianPropagator} class would perhaps be
 * more effective.
 * </p>
 * <p>
 ...
 * e<sub>y</sub>, i, &Omega;, &alpha;<sub>M</sub> or &alpha;<sub>E</sub> or &alpha;<sub>v</sub>) 
...
public class NumericalPropagator implements Propagator, Observer {
    ...
    public NumericalPropagator(final FirstOrderIntegrator integratorIn) {
        ...
        this.addEquationsAndTolerances = new ArrayList<AdditionalEquationsAndTolerances>();
    ...
    public void addForceModel(final ForceModel model) {
        ...
        if (model instanceof AttractionModel && !(model instanceof ThirdBodyAttraction)) {
            ...
            this.setMu(((AttractionModel) model).getMu());
    ...
    private SpacecraftState propagate(final AbsoluteDate tEnd,
        ...
        try {
            ...
            if (integrator instanceof CowellIntegrator) {
                ((CowellIntegrator) integrator).setMapper(new SecondOrderMapper(addEquationsAndTolerances));
            ...
            for (final ForceModel forceModel : this.forceModels) {
                forceModel.checkData(initialState.getDate(), tEnd);
            }
    ...
    private void expandToleranceArray() {
        if (this.integrator instanceof AdaptiveStepsizeIntegrator) {
            ...
            this.resizeArray((AdaptiveStepsizeIntegrator) this.integrator, n,
    ...
    private void resetToleranceArray() {
        if (this.integrator instanceof AdaptiveStepsizeIntegrator) {
            ...
            this.resizeArray((AdaptiveStepsizeIntegrator) this.integrator, n, null, null);
        }
    }
     ...
     */
    private void resizeArray(final AdaptiveStepsizeIntegrator integ, final int newSize,
    ...
    private class DifferentialEquations implements FirstOrderDifferentialEquations, SecondOrderDifferentialEquations,
        ...
        public void computeSecondDerivatives(final double t,
            ...
            try {
                ...
                final AbsoluteDate currentDate = NumericalPropagator.this.referenceDate.shiftedBy(t);
                // Build state
                final double[] x = ((CowellIntegrator) integrator).getMapper().buildFullState(y, yDot);
                if (NumericalPropagator.this.attitudeProviderByDefault == null) {
                    NumericalPropagator.this.currentState =
