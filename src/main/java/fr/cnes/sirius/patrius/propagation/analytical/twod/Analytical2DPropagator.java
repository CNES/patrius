...
/**
 * This class propagates an analytical 2D orbit model and extends the {@link AbstractPropagator}
 * class. Thus, this
...
public class Analytical2DPropagator extends AbstractPropagator implements MeanOsculatingElementsProvider {
    ...
    public Analytical2DPropagator(final AttitudeProvider attitudeProvider, final Analytical2DOrbitModel model,
        ...
        try {
            ...
            final SpacecraftState state = new SpacecraftState(this.getAttitudeProvider(), orbit,
                    this.orbitModel.getMassModel());
