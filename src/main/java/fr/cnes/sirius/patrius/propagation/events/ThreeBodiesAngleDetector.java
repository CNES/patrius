...
public class ThreeBodiesAngleDetector extends AbstractDetector implements MultiEventDetector {
    ...
    public double g(final SpacecraftState state) throws PatriusException {
        ...
        final PVCoordinates p1 = (this.body1 == null) ? state.getPVCoordinates() : this.body1
            .getPVCoordinates(state.getDate(), state.getFrame());
        final PVCoordinates p2 = (this.body2 == null) ? state.getPVCoordinates() : this.body2
            .getPVCoordinates(state.getDate(), state.getFrame());
        final PVCoordinates p3 = (this.body3 == null) ? state.getPVCoordinates() : this.body3
            .getPVCoordinates(state.getDate(), state.getFrame());
