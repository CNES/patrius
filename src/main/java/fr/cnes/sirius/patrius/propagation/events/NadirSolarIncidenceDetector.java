...
public class NadirSolarIncidenceDetector extends AbstractDetector {
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        // spacecraft position
        final Vector3D satPos = s.getPVCoordinates(this.inEarth.getBodyFrame()).getPosition();

        // nadir point
        final GeodeticPoint satGeo = this.inEarth.transform(satPos, this.inEarth.getBodyFrame(), s.getDate());
        ...
        final AbsoluteDate sunDate = getSignalEmissionDate(inSun, s, getThreshold(), getPropagationDelayType());
