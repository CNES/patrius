...
public class NadirSolarIncidenceDetector extends AbstractDetector {
    ...
    public double g(final SpacecraftState state) throws PatriusException {
        ...
        // nadir point
        final BodyPoint satPoint = this.inBodyShape.buildPoint(satPos, this.inBodyShape.getBodyFrame(),
    ...
    public EventDetector copy() {
        final NadirSolarIncidenceDetector res = new NadirSolarIncidenceDetector(this.getSlopeSelection(),
            this.incidenceRef, this.inBodyShape, this.getMaxCheckInterval(), this.getThreshold(), this.actionAtEntry,
