...
public class MultiNumericalPropagator implements MultiPropagator, Observer, Serializable {
    ...
    private final Map<String, NewtonianAttractionModel> newtonianAttraction;
    ...
    public MultiNumericalPropagator(final FirstOrderIntegrator integrator) {
        ...
        this.newtonianAttraction = new HashMap<>();
        this.stateVector = new double[SpacecraftState.ORBIT_DIMENSION];
    ...
    public void setIntegrator(final FirstOrderIntegrator integrator) {
        ...
        if (integrator instanceof AdaptiveStepsizeIntegrator) {
            this.orbitDefaultAbsoluteTolerance = storeAbsoluteDefaultTolerance((AdaptiveStepsizeIntegrator) integrator);
            this.orbitDefaultRelativeTolerance = storeRelativeDefaultTolerance((AdaptiveStepsizeIntegrator) integrator);
        }
    ...
    public void setMu(final double mu, final String satId) {
        ...
        this.newtonianAttraction.put(satId, new NewtonianAttractionModel(frame, mu));
    }
    ...
    public void setOrbitFrame(final String satId, final Frame frame) throws PatriusException {
        if (frame.isPseudoInertial()) {
            ...
            this.newtonianAttraction.put(satId, new NewtonianAttractionModel(frame, this.newtonianAttraction.get(satId)
                .getMuParameter()));
    ...
    public void addForceModel(final ForceModel model, final String satId) {
        ...
        if (model instanceof AbstractAttractionModel) {
            ...
            this.setMu(((AbstractAttractionModel) model).getMu(), satId);
     ...
     */
    public NewtonianAttractionModel getNewtonianAttractionForceModel(final String satId) {
        this.checkSatId(satId);
        ...
        for (final Entry<String, SpacecraftState> entry : this.initialStates.entrySet()) {
            ...
            if (this.propagationFrameMap.get(key) == null) {
                ...
                if (this.initialStates.get(key).getFrame().isPseudoInertial()) {
                    ...
                    this.newtonianAttraction.put(key, new NewtonianAttractionModel(this.initialStates.get(key)
                        .getFrame(), this.newtonianAttraction.get(key).getMuParameter()));
                } else {
