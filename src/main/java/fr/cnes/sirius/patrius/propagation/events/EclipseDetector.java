 ...
 * (default is signal being instantaneous). It can be taken only if the occulted body
 * is defined through a {@link PVCoordinatesProvider} and not an {@link IDirection}.
 * </p>
 * 
...
public class EclipseDetector extends AbstractDetector {
    ...
    public double g(final SpacecraftState state) throws PatriusException {
        ...
        final AbsoluteDate occultingDate = getSignalEmissionDate(this.occultingBody, state.getOrbit(), state.getDate());
        ...
        if (this.isOccultedPVProvDefined) {
            ...
            if (this.occultedBody == null) {
                this.occultedBody = new PVCoordinatesProvider(){
                    ...
                    public PVCoordinates getPVCoordinates(final AbsoluteDate date, final Frame frame)
                        ...
                        return ((ITargetDirection) EclipseDetector.this.occultedDirection).getTargetPVCoordinates(date,
                            frame);
                    }
            ...
            occultedDate = getSignalEmissionDate(this.occultedBody, state.getOrbit(), state.getDate());
        ...
        final double occultingRadius = this.occultingRadiusProvider.getApparentRadius(state.getOrbit(),
                state.getDate(), this.occultedBody, getPropagationDelayType());
