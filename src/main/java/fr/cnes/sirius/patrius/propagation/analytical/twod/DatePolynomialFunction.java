...
public class DatePolynomialFunction implements UnivariateDateFunction {
    ...
    public double value(final AbsoluteDate date) {
        ...
        final double[] dtp = computeDtPowers(date, this.originDate, this.polynomialCoefficients.length - 1);
     ...
     */
    private static double[] computeDtPowers(final AbsoluteDate date, final AbsoluteDate origin, final int order) {
