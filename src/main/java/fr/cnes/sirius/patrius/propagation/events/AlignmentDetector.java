...
public class AlignmentDetector extends AbstractDetector {
    ...
    private final Action actionAtAlignmentStart;

    /** Action performed when the alignment end. */
    private final Action actionAtAlignmentEnd;
    ...
    public AlignmentDetector(final Orbit orbit, final PVCoordinatesProvider bodyIn,
        ...
        this.actionAtAlignmentStart = actionStart;
        this.actionAtAlignmentEnd = actionEnd;
        this.removeAtAlignmentStart = removeStart;
        this.removeAtAlignmentEnd = removeEnd;
    }
    ...
    public Action eventOccurred(final SpacecraftState s, final boolean increasing,
        ...
        return increasing ? this.actionAtAlignmentStart : this.actionAtAlignmentEnd;
    }
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        final Vector3D pb = this.body.getPVCoordinates(s.getDate(), s.getFrame()).getPosition();
        // Computation
    ...
    public EventDetector copy() {
        return new AlignmentDetector(this.body, this.alignAngle, this.getMaxCheckInterval(), this.getThreshold(),
            this.actionAtAlignmentStart, this.actionAtAlignmentEnd, this.removeAtAlignmentStart,
            this.removeAtAlignmentEnd);
    }
}
