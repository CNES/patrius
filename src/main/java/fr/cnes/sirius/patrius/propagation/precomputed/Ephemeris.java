...
public class Ephemeris extends AbstractPropagator implements BoundedPropagator {
    ...
    public Ephemeris(final List<SpacecraftState> states, final int interpolationPoints) {
        ...
        // set up cache
        final TimeStampedGenerator<SpacecraftState> generator = new TimeStampedGenerator<SpacecraftState>() {
            /** Serializable UID. */
            private static final long serialVersionUID = -860945345267377507L;
        ...
        this.cache = new TimeStampedCache<>(interpolationPoints,
