...
public class DihedralFieldOfViewDetector extends AbstractDetector {
    ...
    private final Action actionAtFovEntry;

    /** Action performed at fov exit. */
    private final Action actionAtFovExit;
    ...
    public DihedralFieldOfViewDetector(final PVCoordinatesProvider pvTarget,
        ...
        this.actionAtFovEntry = entry;
        this.actionAtFovExit = exit;
        this.removeAtFovEntry = removeEntry;
        this.removeAtFovExit = removeExit;
    ...
    public Action eventOccurred(final SpacecraftState s, final boolean increasing,
        ...
        return increasing ? this.actionAtFovEntry : this.actionAtFovExit;
    }
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        final AbsoluteDate targetDate = getSignalEmissionDate(targetPVProvider, s, getThreshold(),
    ...
    public EventDetector copy() {
        try {
            final DihedralFieldOfViewDetector res = new DihedralFieldOfViewDetector(this.targetPVProvider,
                    new Vector3D(1., this.center), this.normalCenterPlane1, this.halfAperture1,
                    this.normalCenterPlane2, this.halfAperture2, this.getMaxCheckInterval(), this.actionAtFovEntry,
                    this.actionAtFovExit);
