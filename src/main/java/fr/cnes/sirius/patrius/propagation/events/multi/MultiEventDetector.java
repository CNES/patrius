...
/**
 * <p>
 * This interface is copied from {@link fr.cnes.sirius.patrius.propagation.events.EventDetector} and adapted to multi
 * propagation.
 * </p>
 * <p>
...
public interface MultiEventDetector {
     ...
     */
    void init(final Map<String, SpacecraftState> s0, final AbsoluteDate t);
     ...
     * returns {@link fr.cnes.sirius.patrius.propagation.events.EventDetector.Action#STOP}. As the interpolator may be
     ...
     * @return one of {@link fr.cnes.sirius.patrius.propagation.events.EventDetector.Action#STOP},
     *         {@link fr.cnes.sirius.patrius.propagation.events.EventDetector.Action#RESET_STATE},
     *         {@link fr.cnes.sirius.patrius.propagation.events.EventDetector.Action#RESET_DERIVATIVES},
     ...
     * {@link fr.cnes.sirius.patrius.propagation.events.EventDetector.Action#RESET_STATE} indicator. It allows the user
     ...
     * {@link fr.cnes.sirius.patrius.propagation.events.EventDetector.Action#RESET_STATE} indicator, this function will
