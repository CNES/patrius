...
public class ApparentElevationDetector extends AbstractDetector {
    ...
    public ApparentElevationDetector(final double elevationIn, final TopocentricFrame topoIn,
        ...
        this.topo = topoIn;
        this.actionAtRaising = raisingAction;
        this.actionAtSetting = settingAction;
        this.removeAtRaising = raisingRemove;
        this.removeAtSetting = settingRemove;
    }
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        final AbsoluteDate recDate = getSignalReceptionDate(this.topo, s, getThreshold(), getPropagationDelayType());

        final double trueElevation = this.topo.getElevation(s.getPVCoordinates().getPosition(),
            s.getFrame(), recDate);
    ...
    public EventDetector copy() {
        final ApparentElevationDetector result = new ApparentElevationDetector(this.elevation, this.topo,
            ...
            this.removeAtRaising, this.removeAtSetting);
