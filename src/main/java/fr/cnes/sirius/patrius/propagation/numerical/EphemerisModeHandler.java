...
class EphemerisModeHandler implements ModeHandler, StepHandler {
    ...
    public void initialize(final OrbitType orbit, final PositionAngle angle,
        ...
        // Initialize array
        this.initializedReference = new ArrayList<AbsoluteDate>();
        this.initializedReference.add(reference);
        this.initializedFrame = frame;
        this.initializedMu = mu;
        // Initialize array
        this.models = new ArrayList<ContinuousOutputModel>();
    ...
    public BoundedPropagator getEphemeris() {
        try {
            ...
            final List<AbsoluteDate> startDates = new ArrayList<AbsoluteDate>();
            final List<AbsoluteDate> minDates = new ArrayList<AbsoluteDate>();
            final List<AbsoluteDate> maxDates = new ArrayList<AbsoluteDate>();
            ...
            // Return result
            return new IntegratedEphemeris(startDates, minDates, maxDates,
                this.orbitType, this.angleType, this.attitudeForcesProvider,
                this.attitudeEventsProvider, this.addStateInfos,
                this.models, this.initializedFrame, this.initializedMu);
