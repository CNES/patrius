...
public class Analytical2DOrbitModel implements Serializable, MeanOsculatingElementsProvider {
    ...
    protected Orbit osc2mean(final Orbit orbit, final int[] orders) throws PatriusException {
        ...
        // Initialization
        final CircularOrbit osculatingOrbit = new CircularOrbit(convertFrame(orbit, FramesFactory.getCIRF()));
        ...
        final double[] tol = { this.threshold * (1. + MathLib.abs(osculatingOrbit.getA())),
            this.threshold * (1. + MathLib.abs(osculatingOrbit.getCircularEx())),
            this.threshold * (1. + MathLib.abs(osculatingOrbit.getCircularEy())),
            this.threshold * (1. + MathLib.abs(osculatingOrbit.getI())),
            this.threshold * (1. + MathLib.abs(osculatingOrbit.getRightAscensionOfAscendingNode())),
     ...
     */
    private static Orbit convertFrame(final Orbit orbit, final Frame outputFrame) throws PatriusException {
        Orbit res = orbit;
