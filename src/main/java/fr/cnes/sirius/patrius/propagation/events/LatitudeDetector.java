...
public class LatitudeDetector extends AbstractDetector {
    ...
    private final Action actionAtIncreasing;

    /** Action performed when g decreasing. */
    private final Action actionAtDecreasing;
    ...
    public LatitudeDetector(final double latitudeToDetect, final BodyShape earth,
        ...
        this.actionAtIncreasing = increasing;
        this.actionAtDecreasing = decreasing;
        this.removeAtIncreasing = removeIncreasing;
        this.removeAtDecreasing = removeDecreasing;
    }
    ...
    public LatitudeDetector(final double latitudeToDetect, final BodyShape earth,
        ...
        if (slopeType == UP) {
            ...
            this.removeAtIncreasing = remove;
            ...
            this.removeAtDecreasing = remove;
        } else {
            this.actionAtIncreasing = action;
            this.actionAtDecreasing = action;
            this.removeAtIncreasing = remove;
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        final GeodeticPoint geoPoint = this.earthShape.transform(s.getPVCoordinates().getPosition(),
    ...
    public EventDetector copy() {
        return new LatitudeDetector(this.latToDetect, this.earthShape, this.getMaxCheckInterval(), this.getThreshold(),
            this.actionAtIncreasing, this.actionAtDecreasing, this.removeAtIncreasing, this.removeAtDecreasing);
    }
}
