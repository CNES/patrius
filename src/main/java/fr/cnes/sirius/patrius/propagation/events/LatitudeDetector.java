 ...
 * fr.cnes.sirius.patrius.propagation.events.EventDetector.Action) LatitudeDetector} :
...
public class LatitudeDetector extends AbstractDetector {
     ...
     *        constructor
     *        {@link LatitudeDetector#LatitudeDetector(double, BodyShape, double, double, EventDetector.Action,
