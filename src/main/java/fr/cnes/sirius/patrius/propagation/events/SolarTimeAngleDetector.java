...
public class SolarTimeAngleDetector extends AbstractDetector {
    ...
    public double g(final SpacecraftState state) throws PatriusException {
        ...
        final Vector3D sat = state.getPVCoordinates().getPosition();
        ...
        final Vector3D sunP = this.sun.getPVCoordinates(sunDate, state.getFrame()).getPosition();
        final Vector3D n = state.getPVCoordinates().getMomentum().normalize();
