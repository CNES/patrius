...
public class GroundMaskElevationDetector extends AbstractDetector {
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        final double azimuth = this.topo.getAzimuth(s.getPVCoordinates().getPosition(), s.getFrame(),
                recDate);
        return this.topo.getElevation(s.getPVCoordinates().getPosition(), s.getFrame(), recDate)
