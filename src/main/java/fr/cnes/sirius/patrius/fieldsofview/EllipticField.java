...
public final class EllipticField implements IFieldOfView {
    ...
    public EllipticField(final String name, final Vector3D origin, final Vector3D mainDirection,
        ...
        this.sanityCheck(angleA, angleB);
     ...
     */
    private void sanityCheck(final double angleA, final double angleB) {
        // angle aperture test
        ...
        this.sanityCheck2(angleA, angleB);
    }
     ...
     *        the angular aperture along semi minor axis
     */
    private void sanityCheck2(final double angleA, final double angleB) {
