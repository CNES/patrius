...
public class SP3File implements OrbitFile, Serializable {
    ...
    public SP3File() {
        this.satellites = new ArrayList<SatelliteInformation>();
        this.satelliteInfo = new HashMap<String, SatelliteInformation>();
        this.satelliteCoords = new HashMap<String, List<SatelliteTimeCoordinate>>();
    }
