...
public class KeplerianParameters extends AbstractOrbitalParameters {
     ...
     * "Procedures for  solving Kepler's Equation", A. W. Odell and R. H. Gooding, Celestial
     ...
     * @param meanAnomaly the mean anomaly (rad)
     * @param eccentricity the eccentricity of the orbit
     * @return the eccentric anomaly (rad)
     */
    public static double solveKeplerEquationEccentricAnomaly(final double meanAnomaly, final double eccentricity) {
        // Create keplerian parameters with only the mean anomaly and the eccentricity as input
        // (other parameters are useless to solve the equation, thus set to zero)
        final KeplerianParameters keplerianParameters = new KeplerianParameters(0, eccentricity, 0, 0, 0, meanAnomaly,
                PositionAngle.MEAN, 0.);
        // Call a local method to solve the equation and return the eccentric anomaly
        return keplerianParameters.meanToEllipticEccentric(meanAnomaly);
    }
