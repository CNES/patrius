 ...
 */
public enum ApsisRadiusCoordinate implements OrbitalCoordinate {
    ...
    private static final ApsisRadiusCoordinate[] VALUES = values();
     ...
     */
    private ApsisRadiusCoordinate(final int index) {
     ...
     */
    public static ApsisRadiusCoordinate valueOf(final int stateVectorIndex,
            final PositionAngle positionAngle) {
        final ApsisRadiusCoordinate coordinateType;
