 ...
 */
public enum AlternateEquinoctialCoordinate implements OrbitalCoordinate {
    ...
    private static final AlternateEquinoctialCoordinate[] VALUES = values();
     ...
     */
    private AlternateEquinoctialCoordinate(final int index) {
     ...
     */
    public static AlternateEquinoctialCoordinate valueOf(final int stateVectorIndex,
            final PositionAngle positionAngle) {
        final AlternateEquinoctialCoordinate coordinateType;
