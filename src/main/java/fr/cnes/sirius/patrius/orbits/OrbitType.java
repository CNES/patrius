...
public enum OrbitType {
    ...
    CARTESIAN {
        ...
        /** {@inheritDoc} */
        @Override
        public CartesianOrbit convertOrbit(final Orbit initOrbit, final Frame frame) throws PatriusException {
        ...
        /** {@inheritDoc} */
        @Override
        public CartesianOrbit mapArrayToOrbit(final double[] stateVector, final PositionAngle type,
    ...
    CIRCULAR {
        ...
        /** {@inheritDoc} */
        @Override
        public CircularOrbit convertOrbit(final Orbit initOrbit, final Frame frame) throws PatriusException {
        ...
        /** {@inheritDoc} */
        @Override
        public CircularOrbit mapArrayToOrbit(final double[] stateVector, final PositionAngle type,
                final AbsoluteDate date, final double mu, final Frame frame) {
    ...
    EQUINOCTIAL {
        ...
        /** {@inheritDoc} */
        @Override
        public EquinoctialOrbit convertOrbit(final Orbit initOrbit, final Frame frame) throws PatriusException {
        ...
        /** {@inheritDoc} */
        @Override
        public EquinoctialOrbit mapArrayToOrbit(final double[] stateVector, final PositionAngle type,
                final AbsoluteDate date, final double mu, final Frame frame) {
    ...
    ALTERNATE_EQUINOCTIAL {
        /** {@inheritDoc} */
        @Override
        public AlternateEquinoctialOrbit convertType(final Orbit orbit) {
            return (orbit.getType() == this) ? (AlternateEquinoctialOrbit) orbit : new AlternateEquinoctialOrbit(orbit);
        }

        /** {@inheritDoc} */
        @Override
        public AlternateEquinoctialOrbit convertOrbit(final Orbit initOrbit, final Frame frame)
        ...
        /** {@inheritDoc} */
        @Override
        public AlternateEquinoctialOrbit mapArrayToOrbit(final double[] stateVector, final PositionAngle type,
                final AbsoluteDate date, final double mu, final Frame frame) {
    ...
    APSIS {
        /** {@inheritDoc} */
        @Override
        public ApsisOrbit convertType(final Orbit orbit) {
            return (orbit.getType() == this) ? (ApsisOrbit) orbit : new ApsisOrbit(orbit);
        }

        /** {@inheritDoc} */
        @Override
        public ApsisOrbit convertOrbit(final Orbit initOrbit, final Frame frame) throws PatriusException {
        ...
        /** {@inheritDoc} */
        @Override
        public ApsisOrbit mapArrayToOrbit(final double[] stateVector, final PositionAngle type,
                final AbsoluteDate date, final double mu, final Frame frame) {
    ...
    EQUATORIAL {
        /** {@inheritDoc} */
        @Override
        public EquatorialOrbit convertType(final Orbit orbit) {
            return (orbit.getType() == this) ? (EquatorialOrbit) orbit : new EquatorialOrbit(orbit);
        }

        /** {@inheritDoc} */
        @Override
        public EquatorialOrbit convertOrbit(final Orbit initOrbit, final Frame frame) throws PatriusException {
        ...
        /** {@inheritDoc} */
        @Override
        public EquatorialOrbit mapArrayToOrbit(final double[] stateVector, final PositionAngle type,
                final AbsoluteDate date, final double mu, final Frame frame) {
    ...
    KEPLERIAN {
        ...
        /** {@inheritDoc} */
        @Override
        public KeplerianOrbit convertOrbit(final Orbit initOrbit, final Frame frame) throws PatriusException {
        ...
        /** {@inheritDoc} */
        @Override
        public KeplerianOrbit mapArrayToOrbit(final double[] stateVector, final PositionAngle type,
                final AbsoluteDate date, final double mu, final Frame frame) {
