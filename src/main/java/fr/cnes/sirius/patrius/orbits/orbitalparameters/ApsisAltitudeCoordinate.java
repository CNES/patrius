...
public enum ApsisAltitudeCoordinate implements OrbitalCoordinate {
    ...
    /** Altitude of the periapsis. */
    PERIAPSIS_ALTITUDE(0),

    /** Altitude of the apoapsis. */
    APOAPSIS_ALTITUDE(1),
     ...
     */
    private ApsisAltitudeCoordinate(final int index) {
     ...
     */
    public static ApsisAltitudeCoordinate valueOf(final int stateVectorIndex,
            final PositionAngle positionAngle) {
        final ApsisAltitudeCoordinate coordinateType;
