...
public class AbsoluteDateInterval extends ComparableInterval<AbsoluteDate> {
    ...
    public AbsoluteDateInterval(final IntervalEndpointType lowerEndpointIn,
        ...
        if (!this.adIntervalIsOK(lowerEndpointIn, lowerDataIn, upperDataIn, upperEndpointIn)) {
     ...
     */
    private boolean adIntervalIsOK(final IntervalEndpointType lowerEndpointIn,
    ...
    public String toString(final AbsoluteDate date) {
        ...
        final ComparableInterval<Double> interval = new ComparableInterval<Double>(
    ...
    public List<AbsoluteDate> getDateList(final double step) {
        ...
        // New list of dates
        final List<AbsoluteDate> dateList = new ArrayList<AbsoluteDate>((int) (this.getDuration() / step));
