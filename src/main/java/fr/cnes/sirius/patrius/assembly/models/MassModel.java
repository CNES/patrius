...
public class MassModel implements MassProvider {
    ...
    /** Map for equations */
    private final Map<String, MassEquation> eqs = new ConcurrentHashMap<String, MassEquation>();
    /** Map for mass properties */
    private final Map<String, MassProperty> prs = new ConcurrentHashMap<String, MassProperty>();
    /** Parts names. */
    ...
    public MassModel(final Assembly assembly) {
        String temp;
        this.partsNames = new ArrayList<String>();
