 ...
 * 
 */
public final class PropulsiveProperty implements IPartProperty {
    ...
    public PropulsiveProperty(final Parameter inThrust, final Parameter inIsp) {
        ...
        this.thrustFunction = new IDependentVariable<SpacecraftState>(){
            /** Serializable UID. */
            private static final long serialVersionUID = 7474120817691601858L;
        ...
        this.ispFunction = new IDependentVariable<SpacecraftState>(){
            /** Serializable UID. */
            private static final long serialVersionUID = -1895051029982192925L;
