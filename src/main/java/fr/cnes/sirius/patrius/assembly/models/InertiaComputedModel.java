...
public class InertiaComputedModel implements IInertiaModel {
    ...
    private final Map<String, IInertiaProperty> prs = new TreeMap<String, IInertiaProperty>();

    /** Map of parts with inertia prop */
    @SuppressWarnings("PMD.UseConcurrentHashMap")
    private final Map<String, MassEquation> eqs = new TreeMap<String, MassEquation>();

    /** List of parts name */
    private final List<String> partsNames = new ArrayList<String>();
