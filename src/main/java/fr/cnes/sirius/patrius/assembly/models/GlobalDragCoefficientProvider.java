...
public class GlobalDragCoefficientProvider implements DragCoefficientProvider {
    ...
    public GlobalDragCoefficientProvider(final INTERP method,
        ...
        checkConsistency(aeroData);

        // Get azimuths, elevations and s factors possible values
        final SortedSet<Double> az = new TreeSet<>();
        final SortedSet<Double> elev = new TreeSet<>();
        final SortedSet<Double> sFact = new TreeSet<>();
     ...
     */
    private static void checkConsistency(final double[][] aeroData) throws PatriusException {
