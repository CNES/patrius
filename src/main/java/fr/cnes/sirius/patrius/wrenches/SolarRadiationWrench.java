...
public class SolarRadiationWrench extends Parameterizable implements WrenchModel {
     ...
     */
    public SolarRadiationWrench(final PVCoordinatesProvider sunBody, final GeometricBodyShape shape,
    ...
    public SolarRadiationWrench(final double distance, final double pressure, final double sunRadius,
        ...
        final GeometricBodyShape shape, final RadiationWrenchSensitive spacecraftModel) {
    ...
    protected double computeRawP(final SpacecraftState s) throws PatriusException {
        ...
        final SolarRadiationPressureEllipsoid prs = new SolarRadiationPressureEllipsoid(this.sun, this.earthModel,
                null);
        return MathLib.divide(this.sunPressure.getValue() * this.sunDistance.getValue()
            * this.sunDistance.getValue()
                * prs.getLightningRatio(satSunVector, this.earthModel, position, frame, date), r2);
    }
