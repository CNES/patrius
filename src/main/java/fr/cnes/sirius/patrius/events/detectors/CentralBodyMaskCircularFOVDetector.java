 ...
 * </p>
 * <p>
 * This class handles central body as a {@link BodyShape ellipsoid}.
 * </p>
 * <p>
 * The default implementation behaviour is to
 * {@link fr.cnes.sirius.patrius.events.EventDetector.Action#STOP stop} propagation when the target is in
 ...
 * </p>
 * 
 * @see Propagator#addEventDetector(fr.cnes.sirius.patrius.events.EventDetector)
 * @see BodyShape
 * @see IEllipsoid
 * @see EclipseDetector
...
public class CentralBodyMaskCircularFOVDetector extends AbstractSignalPropagationDetector {
     ...
     * <p>
     * The default implementation behaviour is to
     * {@link fr.cnes.sirius.patrius.events.EventDetector.Action#STOP stop} propagation when the target is
     * visible.
     * </p>
     * 
    ...
    public void init(final SpacecraftState s0, final AbsoluteDate t) {
        ...
        this.eclipseDetector.setPropagationDelayType(getPropagationDelayType(), getInertialFrame());
        this.circularFOVDetector.setPropagationDelayType(getPropagationDelayType(), getInertialFrame());
    }
