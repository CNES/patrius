 ...
 * 
 */
public class SensorVisibilityDetector extends AbstractSignalPropagationDetector {
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        for (int i = 1; i <= length; i++) {
            final AbsoluteDate inhibitionDate =
                getSignalEmissionDate(this.sensor.getInhibitionTarget(i - 1), s.getOrbit(), s.getDate());
            ...
            inhibitAngle = MathLib.max(inhibitAngle, this.sensor.getInhibitTargetCenterToFieldAngle(inhibitionDate, i)
                    + targetAngularRadius);
        ...
        final double bodyMaskingDistance = this.sensor.celestialBodiesMaskingDistance(s.getDate(), targetDate,
            getPropagationDelayType(), LinkType.DOWNLINK);

        // spacecrafts maskings
        final double spacecraftsMaskingDistance = this.sensor.spacecraftsMaskingDistance(s.getDate(), targetDate,
                getPropagationDelayType(), LinkType.DOWNLINK);
    ...
    public EventDetector copy() {
        final SensorVisibilityDetector res = new SensorVisibilityDetector(this.sensor, getMaxCheckInterval(),
