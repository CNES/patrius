...
public class ExtremaSightAxisDetector extends AbstractDetector {
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        if (this.vehicle == null) {
            ...
            final AbsoluteDate targetDate = getSignalEmissionDate(targetPoint, s, getThreshold(),
    ...
    public EventDetector copy() {
        ...
        if (this.vehicle == null) {
            result = new ExtremaSightAxisDetector(this.targetPoint, new Vector3D(this.sightAxis.getX(),
                ...
                this.actionMIN, this.actionMAX, this.removeMIN, this.removeMAX);
        } else {
            result = new ExtremaSightAxisDetector(this.targetPoint, this.vehicle, this.sensorName,
                this.getMaxCheckInterval(), this.getThreshold(), this.actionMIN, this.actionMAX, this.removeMIN,
                this.removeMAX);
        }
