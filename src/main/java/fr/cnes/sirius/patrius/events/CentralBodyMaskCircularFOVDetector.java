...
public class CentralBodyMaskCircularFOVDetector extends AbstractDetector {
    ...
    public void init(final SpacecraftState s0, final AbsoluteDate t) {
        ...
        eclipseDetector.setPropagationDelayType(getPropagationDelayType(), getInertialFrame());
        circularFOVDetector.setPropagationDelayType(getPropagationDelayType(), getInertialFrame());
    }
