 ...
 * {@link fr.cnes.sirius.patrius.events.EventDetector.Action#CONTINUE continue} propagation at min detection
 * and to {@link fr.cnes.sirius.patrius.events.EventDetector.Action#CONTINUE continue} propagation at max
...
public class ExtremaGenericDetector<D extends EventDetector> extends AbstractDetector {
     ...
     * <p>
     * The default implementation behavior is to
     * {@link fr.cnes.sirius.patrius.events.EventDetector.Action#CONTINUE continue} propagation at min
     * detection and to {@link fr.cnes.sirius.patrius.events.EventDetector.Action#CONTINUE continue}
     ...
     * one, in order to detect all the extrema, included these shortly after interval beginning or shortly before
     * interval end:
     * <ul>
     ...
     * </ul>
     * The detection of events will take place in the enlarged time interval, therefore there may be some events
     * detected outside the given input time interval.<br>
     * <br>
     *
     * @param eventsLogger
    ...
    public SpacecraftState logExtremaEventsOverTimeInterval(final CodedEventsLogger eventsLogger,
        ...
        final CodingEventDetector extremaCoder = new GenericCodingEventDetector(this, "MIN", "MAX");
