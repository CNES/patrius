 ...
 * <ul>
 * <li>
 * {@link #NodeDetector(Frame, int, double, double, fr.cnes.sirius.patrius.events.EventDetector.Action)
 * NodeDetector} : the defined action is performed at ascending OR/AND descending node depending on slope selection
 * defined.
 * <li>
 * {@link #NodeDetector(Frame, double, double, fr.cnes.sirius.patrius.events.EventDetector.Action,
