...
public class StationToSatMutualVisibilityDetector extends AbstractDetectorWithTropoCorrection {
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        final AbsoluteDate targetDate = getSignalEmissionDate(inSensorSpacecraft.getMainTarget(), s.getOrbit(),
        ...
        final Vector3D correctedVector = this.getCorrectedVector(s, LinkType.DOWNLINK);
