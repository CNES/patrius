...
/**
 * <p>
 * This class is copied from {@link CodedEventsLogger} and adapted to multi propagation.
 * </p>
 * <p>
...
public class MultiCodedEventsLogger {
    ...
    public Map<MultiCodingEventDetector, CodedEventsList> buildCodedEventListMap() {
        ...
        final Map<MultiCodingEventDetector, CodedEventsList> map = new ConcurrentHashMap<>();
    ...
    public Map<MultiCodingEventDetector, PhenomenaList>
        ...
        // processed.
        final Set<MultiCodingEventDetector> validDetectors = new HashSet<>();
        ...
        final Map<MultiCodingEventDetector, PhenomenaList> phenomMap = new ConcurrentHashMap<>();
     ...
     * 
     */
    private static PhenomenaList buildPhenomenaListFromEvents(final Map<String, SpacecraftState> states,
        ...
        for (int i = 0; i < listSize; i++) {
            ...
            final Phenomenon phenomenon = buildPhenomenonFromEvents(dateStart, dateEnd, multiEvent, formerEvent,
                curEvent, listSize, i);
            if (phenomenon != null) {
    ...
    public static final class MultiLoggedCodedEvent implements TimeStamped, Comparable<MultiLoggedCodedEvent> {
         ...
         *         internal date of the specified MultiLoggedCodedEvent. When the dates are the same, returns 1.
         */
        @Override
        ...
        public boolean equals(final Object object) {
            ...
            if (object == this) {
                ...
                // Same object type
                final MultiLoggedCodedEvent other = (MultiLoggedCodedEvent) object;
