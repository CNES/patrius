 ...
 * continue} propagation when entering the visibility zone and to
 * {@link fr.cnes.sirius.patrius.events.EventDetector.Action#STOP stop} propagation when exiting the visibility zone.
 * </p>
 * <p>
...
public class SatToSatMutualVisibilityDetector extends AbstractSignalPropagationDetector implements MultiEventDetector {
     ...
     * entering the visibility zone and to {@link fr.cnes.sirius.patrius.events.EventDetector.Action#STOP
