...
public class SatToSatMutualVisibilityDetector extends AbstractDetector implements
    ...
    private double g(final SpacecraftState main, final SpacecraftState second)
        ...
        // Get emission date 
        final AbsoluteDate firstEmissionDate = getSignalEmissionDate(main.getOrbit(), second, getThreshold(),
                getPropagationDelayType());
        final AbsoluteDate secondEmissionDate = getSignalEmissionDate(second.getOrbit(), main, getThreshold(),
                getPropagationDelayType());
