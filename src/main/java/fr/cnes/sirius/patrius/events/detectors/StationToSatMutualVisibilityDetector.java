 ...
 * continue} propagation when entering the eclipse and to
 * {@link fr.cnes.sirius.patrius.events.EventDetector.Action#STOP stop} propagation when exiting the eclipse. This can
 ...
 * Default linktype is {@link LinkType#DOWNLINK}.
 * </p>
 * 
...
public class StationToSatMutualVisibilityDetector extends AbstractStationToSatDetector {
     ...
     * entering the eclipse and to {@link fr.cnes.sirius.patrius.events.EventDetector.Action#STOP stop}
    ...
    public StationToSatMutualVisibilityDetector(final SensorModel sensorModel1,
        ...
        super(station, correctionModel, sensorModel1, withMasking, maxCheck, threshold, entry, exit, removeEntry,
                removeExit, EventDetector.INCREASING_DECREASING, linkTypeIn);
    }
    ...
    public StationToSatMutualVisibilityDetector(final SensorModel sensorModel1,
        ...
        super(new GeometricStationAntenna(topoFrame, azimElevMask), correctionModel, sensorModel1, false, maxCheck,
                threshold, entry, exit, removeEntry, removeExit, EventDetector.INCREASING_DECREASING, linkTypeIn);
    }
    ...
    public double g(final SpacecraftState state) throws PatriusException {
        // Update satellite frames tree
        getAssembly().updateMainPartFrame(state);

        // Angular distance in station sensor
        ...
        // Mutual visibility
        return MathLib.min(angularRadiusInSpacecraftSensor, angularDistanceInStationSensor);
    }
