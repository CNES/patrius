 ...
 * <ul>
 * <li>
 * {@link #ExtremaThreeBodiesAngleDetector(String, String, String, int, double, double, EventDetector.Action)
 * ExtremaThreeBodiesAngleDetector}: the defined action is performed at maximal OR/AND minimal angle depending on slope
 * selection defined.
 * <li>
...
public class ExtremaThreeBodiesAngleDetector extends AbstractDetector implements MultiEventDetector {
    ...
    public ExtremaThreeBodiesAngleDetector(final PVCoordinatesProvider firstBody,
                                           ...
                                           final PVCoordinatesProvider thirdBody,
    ...
    public ExtremaThreeBodiesAngleDetector(final PVCoordinatesProvider firstBody,
        ...
        super(MIN_MAX, maxCheck, threshold, actionMin, actionMax, removeMin, removeMax);
    ...
    public ExtremaThreeBodiesAngleDetector(final PVCoordinatesProvider bodyA,
        ...
        this.body1 = body(bodyA, bodyB, bodyC, 1);
        this.body2 = body(bodyA, bodyB, bodyC, 2);
        this.body3 = body(bodyA, bodyB, bodyC, 3);
     ...
     * @since 3.0
     */
    private static PVCoordinatesProvider body(final PVCoordinatesProvider bodyA, final PVCoordinatesProvider bodyB,
                                              final BodyOrder bodyC, final int bodyNb) {
     ...
     */
    @SuppressWarnings("PMD.ShortMethodName")
    private static double g(final PVCoordinates p1, final PVCoordinates p2, final PVCoordinates p3)
        throws PatriusException {
     ...
     * @param s1 : The first SpacecraftState
     * @param s2 : The second SpacecraftState
     * @param s3 : The third SpacecraftState
     * @return the first common pseudo inertial ancestor between the frames of 3 SpacecraftStates
     */
    public Frame findFirstCommonPseudoInertial(SpacecraftState s1, SpacecraftState s2, SpacecraftState s3) {
