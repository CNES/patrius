 ...
 * <p>
 * The default implementation behavior is to {@link fr.cnes.sirius.patrius.events.EventDetector.Action#STOP
 ...
 * 
 * @see EventDetector
 * @see fr.cnes.sirius.patrius.events.detectors.ExtremaThreeBodiesAngleDetector
 * 
 * @author chabaudp
 * 
 * @version $Id$
...
public class ExtremaSightAxisDetector extends AbstractSignalPropagationDetector {
    ...
    public ExtremaSightAxisDetector(final PVCoordinatesProvider target,
        ...
        this(MIN_MAX, target, sightAxisDirection, maxCheck, threshold, actionMin, actionMax, removeMin, removeMax);
    }
     ...
     * frame origin and direction of the sight axis vector3D.
     * <p>
     * The default behavior is to {@link fr.cnes.sirius.patrius.events.EventDetector.Action#STOP stop}
    ...
    public ExtremaSightAxisDetector(final PVCoordinatesProvider target, final Assembly assembly,
        ...
        final Action actionMin, final Action actionMax, final boolean removeMin,
        final boolean removeMax) {
        this(MIN_MAX, target, assembly, partName, maxCheck, threshold, actionMin, actionMax, removeMin, removeMax);
    }
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        if (this.vehicle == null) {
            ...
            p1 = transform.transformPVCoordinates(this.targetPoint.getPVCoordinates(targetDate, s.getFrame()));
            ...
            final SensorProperty payloadSensorProperty = (SensorProperty) (payload.getProperty(PropertyType.SENSOR));
        ...
        return -(MathLib.divide(pos1Vel3 + pos3Vel1, norm1 * norm3) - MathLib.divide(pos1Pos3, pos1Pos1 * pos3Pos3)
                * (MathLib.divide(pos1Vel1 * norm3, norm1) + MathLib.divide(pos3Vel3 * norm1, norm3)));
    }
    ...
    public EventDetector copy() {
        ...
        if (this.vehicle == null) {
            result = new ExtremaSightAxisDetector(getSlopeSelection(), this.targetPoint, this.sightAxis,
                getMaxCheckInterval(), getThreshold(), this.actionAtEntry, this.actionAtExit, this.removeAtEntry,
                this.removeAtExit);
        } else {
            result = new ExtremaSightAxisDetector(getSlopeSelection(), this.targetPoint, this.vehicle, this.sensorName,
                getMaxCheckInterval(), getThreshold(), this.actionAtEntry, this.actionAtExit, this.removeAtEntry,
                this.removeAtExit);
        }
