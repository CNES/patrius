...
public class SensorVisibilityDetector extends AbstractDetector {
    ...
    public double g(final SpacecraftState s) throws PatriusException {
        ...
        final AbsoluteDate targetDate = getSignalEmissionDate(this.sensor.getMainTarget(), s.getOrbit(), s.getDate());
        ...
        final double bodyMaskingDistance = this.sensor.celestialBodiesMaskingDistance(
                s.getDate(), targetDate, getPropagationDelayType(), LinkType.DOWNLINK);
