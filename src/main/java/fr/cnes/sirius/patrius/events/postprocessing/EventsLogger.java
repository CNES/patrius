...
public class EventsLogger implements Serializable {
    ...
    public static final class LoggedEvent implements Serializable {
         ...
         * </p>
         * 
         * @param datationChoice
         *        Datation choice
         * @return event date matching the datation choice and the provided event date
        ...
        public AbsoluteDate getEventDate(final DatationChoice datationChoice) throws PatriusException {
            ...
            AbsoluteDate eventDate = null;
            if (this.detector instanceof SignalPropagationWrapperDetector) {
                // Cast the detector
                ...
                // Not an SignalPropagationWrapperDetector : no emitter/receiver date management (instantaneous)
                eventDate = eventDateTemp;
            }
    ...
    private class LoggingWrapper implements EventDetector {
        ...
        public boolean filterEvent(final SpacecraftState state,
                                   ...
                                   final boolean forward) throws PatriusException {
            return this.detector.filterEvent(state, increasing, forward);
        }
    }
}
