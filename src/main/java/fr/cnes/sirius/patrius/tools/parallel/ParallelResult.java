 ...
 * @author cardosop
 * 
 * @version $Id: ParallelResult.java 17578 2017-05-10 12:20:20Z bignon $
 * 
 * @since 1.2
 * 
 */
public interface ParallelResult {
     ...
     * Unlike the regular equals() method, this forces
     * the implementation to provide an explicit implementation.
     * 
     * @param other other parallel result
     * 
     * @return true when the two implementations are equal, false otherwise
     */
    boolean resultEquals(final ParallelResult other);
