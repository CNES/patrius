...
public class ParallelRunner {
    ...
    private final List<TaskFactoryHolder> holders = new ArrayList<>();

    /** Map between factories and tasks. */
    private final Map<TaskFactoryHolder, List<ParallelTask>> taskMap = new HashMap<>();
    ...
    public boolean runAll() throws InterruptedException {
        ...
        // when complete.
        final List<ParallelTask> allTasks = new ArrayList<>();
    ...
    private void feedTaskMap(final TaskFactoryHolder pickedHolder, final ParallelTask newTask) {
        ...
        if (!this.taskMap.containsKey(pickedHolder)) {
            ...
            final List<ParallelTask> newList = new ArrayList<>();
            // Add to the map
