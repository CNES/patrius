...
public class MillerUpdatingRegression implements UpdatingMultipleLinearRegression {
        ...
        for (int i = 0; i < x.length; i++) {
            ...
            for (int k = i + 1; k < this.nvars; k++) {
                ...
                if (di == 0.0) {
                    ...
                    this.r[nextr] = smartAdd(di * this.r[nextr], (w2 * xi) * xk) / dpi;
                }
                ++nextr;
            }
            xk = y;
            ...
            if (di == 0.0) {
                ...
                this.rhs[i] = smartAdd(di * this.rhs[i], wxi * xk) / dpi;
            }
        }
    ...
    private static double smartAdd(final double a, final double b) {
