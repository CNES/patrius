 ...
 * The {@link #converged(int,Pair,Pair) converged} method will also return {@code true} if the number of iterations has
 * been set (see {@link #SimplePointChecker(double,double,int) this constructor}).
 * 
 * @param <T>
 *        Type of the (point, value) pair.
 *        The type of the "value" part of the pair (not used by this class).
 * 
 * @version $Id: SimplePointChecker.java 18108 2017-10-04 06:45:27Z bignon $
 * @since 3.0
 */
