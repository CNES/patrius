...
public class NonLinearConjugateGradientOptimizer
    ...
    protected PointValuePair doOptimize() {
        ...
        while (true) {
            ...
            final double uB = findUpperBound(lsf, 0, this.initialStep);
     ...
     */
    private static double findUpperBound(final UnivariateFunction f,
    ...
    private class LineSearchFunction implements UnivariateFunction {
        /** Serializable UID. */
        private static final long serialVersionUID = 1821135765295071483L;
        /** Current point. */
