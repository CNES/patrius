...
public class FieldVector3D<T extends RealFieldElement<T>> implements Serializable {
    ...
    public FieldVector3D<T> add(final T factor, final Vector3D v) {
        return new FieldVector3D<T>(this.x.add(factor.multiply(v.getX())),
    ...
    public FieldVector3D<T> add(final double factor, final Vector3D v) {
        return new FieldVector3D<T>(this.x.add(factor * v.getX()),
    ...
    public FieldVector3D<T> subtract(final T factor, final Vector3D v) {
        return new FieldVector3D<T>(this.x.subtract(factor.multiply(v.getX())),
    ...
    public FieldVector3D<T> subtract(final double factor, final Vector3D v) {
        return new FieldVector3D<T>(this.x.subtract(factor * v.getX()),
    ...
    public FieldVector3D<T> orthogonal() {
        ...
        if (MathLib.abs(this.x.getReal()) <= threshold) {
            ...
            res = new FieldVector3D<T>(inverse.getField().getZero(),
            ...
            res = new FieldVector3D<T>(inverse.multiply(this.z).negate(),
            ...
            res = new FieldVector3D<T>(inverse.multiply(this.y),
    ...
    public FieldVector3D<T> crossProduct(final FieldVector3D<T> v) {
        return new FieldVector3D<T>(this.x.linearCombination(this.y, v.z, this.z.negate(), v.y),
    ...
    public FieldVector3D<T> crossProduct(final Vector3D v) {
        return new FieldVector3D<T>(this.x.linearCombination(v.getZ(), this.y, -v.getY(), this.z),
