...
public class Gaussian implements UnivariateDifferentiableFunction {
    ...
    /** Serializable UID. */
    private static final long serialVersionUID = 6899698604009838548L;
    ...
    public static class Parametric implements ParametricUnivariateFunction {
        ...
        private static void validateParameters(final double[] param) {
            ...
            if (param.length != 3) {
                throw new DimensionMismatchException(PatriusMessages.INVALID_NUMBER_OF_PARAMETERS, 3, param.length);
            }
            if (param[2] <= 0) {
