 ...
 * </p>
 * 
 * @version $Id: BisectionSolver.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class BisectionSolver extends AbstractUnivariateSolver {

    /** Serializable UID. */
    private static final long serialVersionUID = -2892618016014620100L;
    ...
    protected double doSolve() {
        ...
        while (true) {
            ...
            if (MathLib.abs(max - min) <= absoluteAccuracy) {
                // OK, solution found
                m = UnivariateSolverUtils.midpoint(min, max);
                return m;
            }
