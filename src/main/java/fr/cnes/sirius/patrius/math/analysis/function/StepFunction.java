...
public class StepFunction implements UnivariateFunction {
    /** Serializable UID. */
    private static final long serialVersionUID = 7855074922786256197L;
    /** Abscissae. */
    ...
    public StepFunction(final double[] x,
        ...
        if (y.length != x.length) {
            throw new DimensionMismatchException(PatriusMessages.INCOMPATIBLE_ARRAYS_DIMENSIONS, x.length, y.length);
        }
