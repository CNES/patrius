 ...
 * 
 * @version $Id: Erf.java 18108 2017-10-04 06:45:27Z bignon $
 */
@SuppressWarnings("PMD.ShortClassName")
public final class Erf {

    /** Value beyond which Erf(x) returns limit value. */
    private static final double ERF_THRESHOLD = 40;
     ...
     * 
     * <p>
     * This implementation computes erf(x) using the {@link Gamma#regularizedGammaP(double, double, double, int)
     * regularized gamma function}, following <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3)
     * </p>
     * 
     * <p>
    ...
    public static double erf(final double x) {
        if (MathLib.abs(x) > ERF_THRESHOLD) {
            return x > 0 ? 1 : -1;
        }
    ...
    public static double erfInv(final double x) {
        ...
        double w = - MathLib.log((1.0 - x) * (1.0 + x));
        // Initialization
        double p;
     ...
     * 
     * <p>
     * This implementation computes erfc(x) using the {@link Gamma#regularizedGammaQ(double, double, double, int)
     * regularized gamma function}, following <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3).
     * </p>
     * 
     * <p>
