...
public class ZipfDistribution extends AbstractIntegerDistribution {
    ...
    public double probability(final int x) {
        ...
        return (1.0 / MathLib.pow(x, this.exponent)) / generalizedHarmonic(this.numberOfElements, this.exponent);
    }
    ...
    public double cumulativeProbability(final int x) {
        ...
        if (x <= 0) {
            ...
            res =
                generalizedHarmonic(x, this.exponent)
                        / generalizedHarmonic(this.numberOfElements, this.exponent);
        }
        return res;
    }
