...
import fr.cnes.sirius.patrius.math.optim.AbstractConvergenceChecker;
import fr.cnes.sirius.patrius.math.util.MathLib;

/**
 * Simple implementation of the {@link fr.cnes.sirius.patrius.math.optim.AbstractConvergenceChecker} interface
 ...
 * this constructor}).
 * 
 * @version $Id: SimpleUnivariateValueChecker.java 18108 2017-10-04 06:45:27Z bignon $
 * @since 3.1
 */
public class SimpleUnivariateValueChecker
     ...
     * iterations will never cause {@link #converged(int,UnivariatePointValuePair,UnivariatePointValuePair)} to return
     * {@code true}.
     */
    private static final int ITERATION_CHECK_DISABLED = -1;
    /**
     * Number of iterations after which the {@link #converged(int,UnivariatePointValuePair,UnivariatePointValuePair)}
