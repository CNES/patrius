 ...
 * 
 * @version $Id: DfpField.java 18108 2017-10-04 06:45:27Z bignon $
 * @since 2.2
 */
@SuppressWarnings({"PMD.NullAssignment", "NonThreadSafeSingleton" })
public class DfpField implements Field<Dfp> {
     ...
     * <p>
     * Note that since the {@link Dfp} class uses 10000 as its radix, each radix digit is equivalent to 4 decimal
     * digits. This implies that asking for 13, 14, 15 or 16 decimal digits will really lead to a 4 radix 10000 digits
     * in all cases.
     * </p>
     * 
     * @param decimalDigits
    ...
    public void setIEEEFlags(final int flags) {
        final int cond = FLAG_INVALID | FLAG_DIV_ZERO | FLAG_OVERFLOW;
        this.ieeeFlags = flags & (cond | FLAG_UNDERFLOW | FLAG_INEXACT);
    }
    ...
    public void setIEEEFlagsBits(final int bits) {
        final int cond = FLAG_INVALID | FLAG_DIV_ZERO | FLAG_OVERFLOW;
        this.ieeeFlags |= bits & (cond | FLAG_UNDERFLOW | FLAG_INEXACT);
    }
