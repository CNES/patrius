...
public final class StatUtils {
    ...
    /**
     * Compute maximum value of absolute value of array of doubles
     *
     * @param data
     *        Array of doubles
     * @return Maximum value of absolute value of array of doubles
     */
    public static double maxAbs(final double[] data) {
        return MathLib.max(MathLib.abs(StatUtils.max(data)), MathLib.abs(StatUtils.min(data)));
