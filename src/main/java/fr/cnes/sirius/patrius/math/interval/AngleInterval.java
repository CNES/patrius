...
public final class AngleInterval extends AbstractInterval implements Serializable {
    ...
    public AngleInterval(final IntervalEndpointType lowerEndPointIn,
        ...
        // Validity test
        if (angleIntervalIsOk((upperAngleIn + lowerAngleIn) / 2.0, (upperAngleIn - lowerAngleIn), lowerEndPointIn,
                upperEndPointIn)) {
    ...
    public AngleInterval(final double referenceIn,
        ...
        // Validity test
        if (angleIntervalIsOk(referenceIn, lengthIn, lowerEndPointIn, upperEndPointIn)) {
     ...
     * @since 1.0
     */
    private static boolean angleIntervalIsOk(final double referenceIn,
            final double lengthIn,
        ...
        if (intervalIsOk) {
            intervalIsOk = angleIntervalLengthIsOK(lengthIn, lowerEndPoint, upperEndPoint);
        }
     ...
     */
    private static boolean angleIntervalLengthIsOK(final double lengthIn,
            final IntervalEndpointType lowerEndPoint,
            final IntervalEndpointType upperEndPoint) {
        boolean intervalIsOk = true;
