...
public class LPPrimalDualMethod extends AbstractLPOptimizationRequestHandler {
    ...
    public int optimize() throws PatriusException {
        ...
        standardLPRequest.setLb(AlgebraUtils.replaceValues(standardLb, lpConverter.getUnboundedLBValue(),
            this.minLBValue));
        // substitute not-double numbers
        standardLPRequest.setUb(AlgebraUtils.replaceValues(standardUb, lpConverter.getUnboundedUBValue(),
            this.maxUBValue));
        ...
        // optimization
        final LPPrimalDualMethod opt = new LPPrimalDualMethod(this.minLBValue, this.maxUBValue);
    ...
    protected int optimizePresolvedStandardLP() throws PatriusException {
        ...
        while (true) {
            ...
            final RealVector[] sol = this.kktSolver.solve();
     ...
     * @return result
     */
    private static double getSurrogateDualityGap(final RealVector fiX, final RealVector l) {
     ...
     * @return result
     */
    private static RealVector rCent(final RealVector fiX, final RealVector l, final double t) {
            ...
            if (super.getLb() == null) {
                ...
                for (int i = 0; i < super.getLb().getDimension(); i++) {
                    ...
                    if (lbi < this.minLBValue) {
                        ...
                        this.limitedLb.setEntry(i, lbi);
                    }
                }
            }
        }
        return this.limitedLb; // Return lower bounds for the problem
    }
            ...
            if (super.getUb() == null) {
                ...
                for (int i = 0; i < super.getUb().getDimension(); i++) {
                    ...
                    if (this.maxUBValue < ubi) {
                        ...
                        this.limitedUb.setEntry(i, ubi);
                    }
                }
            }
        }
        return this.limitedUb; // Return upper bounds for the problem
    }
     ...
     * @return true/false
     */
    protected static boolean isLbUnbounded(final Double lb) {
     ...
     * @return true/false
     */
    protected static boolean isUbUnbounded(final Double ub) {
