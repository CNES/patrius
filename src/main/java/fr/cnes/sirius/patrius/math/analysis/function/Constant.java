 ...
 * 
 * @since 3.0
 * @version $Id: Constant.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class Constant implements UnivariateDifferentiableFunction {

    /** Serializable UID. */
    private static final long serialVersionUID = 7730471695383610000L;
     ...
     *        Constant.
     */
    public Constant(final double cIn) {
        this.c = cIn;
    }
