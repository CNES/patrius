...
public class EmpiricalDistribution extends AbstractRealDistribution {
    ...
    public double density(final double x) {
        ...
        final RealDistribution kernel = getKernel(this.binStats.get(binIndex));
    ...
    public double inverseCumulativeProbability(final double p) {
        ...
        // Return result
        final RealDistribution kernel = getKernel(this.binStats.get(i));
     ...
     */
    private static RealDistribution getKernel(final SummaryStatistics bStats) {
