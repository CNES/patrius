...
public class HypergeometricDistribution extends AbstractIntegerDistribution {
    ...
    public double cumulativeProbability(final int x) {
        ...
        final int[] domain = getDomain(this.populationSize, this.numberOfSuccesses, this.sampleSize);
        if (x < domain[0]) {
            ret = 0.0;
        } else if (x >= domain[1]) {
            ret = 1.0;
     ...
     */
    private static int[] getDomain(final int n, final int m, final int k) {
     ...
     */
    private static int getLowerDomain(final int n, final int m, final int k) {
     ...
     */
    private static int getUpperDomain(final int m, final int k) {
