 ...
 * <ul>
 * <li>
 * the first one is in a node-oriented way using the {@link BSPTree#getPlus}, {@link BSPTree#getMinus} and
 * {@link BSPTree#getParent} methods. Terminal nodes without associated {@link SubHyperplane sub-hyperplanes} can be
 * visited this way, there is no constraint in the visit order, and it is possible to visit either all nodes or only a
 * subset of the nodes</li>
 * <li>
 ...
 * @see SubHyperplane
 * 
 * @version $Id: BSPTreeVisitor.java 18108 2017-10-04 06:45:27Z bignon $
 * @since 3.0
 */
public interface BSPTreeVisitor<S extends Space> {
     ...
     * visit. It is guaranteed that this method will be called before {@link #visitInternalNode visitInternalNode} for a
     ...
     * @return desired visit order, must be one of {@link Order#PLUS_MINUS_SUB}, {@link Order#PLUS_SUB_MINUS},
     *         {@link Order#MINUS_PLUS_SUB}, {@link Order#MINUS_SUB_PLUS}, {@link Order#SUB_PLUS_MINUS},
     *         {@link Order#SUB_MINUS_PLUS}
     */
     ...
     * <p>
     * It is guaranteed that this method will be called after {@link #visitOrder visitOrder} has been called for a given
