 ...
 */
public class BracketingNthOrderBrentSolver extends AbstractUnivariateSolver implements
     ...
     */
    private static double guessX(final double targetY, final double[] x, final double[] y,
