 ...
 * <p>
 * Matrix element indexing is 0-based -- e.g., <code>getEntry(0, 0)</code> returns the element in the first row, first
 * column of the matrix.
 * </p>
 * 
 * @param <T>
 *        the type of the field elements
 * @version $Id: FieldMatrix.java 18108 2017-10-04 06:45:27Z bignon $
 */
public interface FieldMatrix<T extends FieldElement<T>> extends AnyMatrix {
     ...
     * <p>
     * Column order starts at upper left and iterating through all elements of a column from top to bottom before going
     * to the topmost element of the next column.
     * </p>
     * 
     * @param visitor
     *        visitor used to process all matrix entries
     ...
     * <p>
     * The fastest walking order depends on the exact matrix class. It may be different from traditional row or column
     * orders.
     * </p>
     * 
     * @param visitor
