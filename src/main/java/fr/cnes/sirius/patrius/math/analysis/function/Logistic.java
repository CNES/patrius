...
public class Logistic implements UnivariateDifferentiableFunction {
    ...
    /** Serializable UID. */
    private static final long serialVersionUID = -931817074376538510L;
    /** Lower asymptote. */
    ...
    public static class Parametric implements ParametricUnivariateFunction {
        ...
        private static void validateParameters(final double[] param) {
            ...
            if (param.length != 6) {
                throw new DimensionMismatchException(PatriusMessages.INVALID_NUMBER_OF_PARAMETERS, 6, param.length);
            }
            if (param[5] <= 0) {
