...
public class MicrosphereInterpolatingFunction
    ...
    public MicrosphereInterpolatingFunction(final double[][] xval,
        ...
        for (int i = 0; i < xval.length; ++i) {
            ...
            if (xvalI.length != dimension) {
                throw new DimensionMismatchException(PatriusMessages.DIFFERENT_ROWS_LENGTHS, xvalI.length, dimension);
            }
     ...
     */
    private static double cosAngle(final RealVector v, final RealVector w) {
