...
public class DescriptiveStatistics implements StatisticalSummary, Serializable {
    ...
    public synchronized void setPercentileImpl(final UnivariateStatistic percentileImplIn) {
        try {
            percentileImplIn.getClass().getMethod(SET_QUANTILE_METHOD_NAME,
                new Class[] { Double.TYPE }).invoke(percentileImplIn,
                new Object[] { Double.valueOf(HALF_PERCENT) });
            ...
            // Exception in method access
            throw new MathIllegalArgumentException(
                PatriusMessages.PERCENTILE_IMPLEMENTATION_CANNOT_ACCESS_METHOD,
                SET_QUANTILE_METHOD_NAME, percentileImplIn.getClass().getName());
