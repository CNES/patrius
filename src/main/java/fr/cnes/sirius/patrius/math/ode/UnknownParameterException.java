 ...
 * 
 * @since 3.1
 * @version $Id: UnknownParameterException.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class UnknownParameterException extends MathIllegalArgumentException {
     ...
     *        parameter name.
     */
    public UnknownParameterException(final String nameIn) {
        super(PatriusMessages.UNKNOWN_PARAMETER);
        this.name = nameIn;
    }
