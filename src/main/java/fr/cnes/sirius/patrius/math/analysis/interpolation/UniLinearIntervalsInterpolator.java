 ...
 * @version $Id: UniLinearIntervalsInterpolator.java 17603 2017-05-18 08:28:32Z bignon $
 * @since 2.3
 * 
 */
public final class UniLinearIntervalsInterpolator implements UnivariateInterpolator {
     ...
     */
    @Override
    public UniLinearIntervalsFunction interpolate(final double[] xval, final double[] fval) {
        return new UniLinearIntervalsFunction(xval, fval);
    }
