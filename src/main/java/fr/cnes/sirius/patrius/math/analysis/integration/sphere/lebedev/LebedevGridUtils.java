...
public final class LebedevGridUtils {
    ...
    static {
        ...
        final Map<Integer, Integer> availableRules = new LinkedHashMap<>();
    ...
    static {
        // Store rules
        final Map<Integer, Integer> unavailableRules = new LinkedHashMap<>();
    ...
    public static List<LebedevGrid> getAvailableGrids() {
        final List<LebedevGrid> grids = new ArrayList<>();
    ...
    private static List<LebedevGridPoint> ld0006() {
        ...
        final double b = 0.;
        final double w;
        final List<LebedevGridPoint> list = new ArrayList<>();
