...
public final class LebedevGridUtils {
    ...
    static {
        // Static initialisation of all the rules
        final Map<Integer, Integer> availableRules = new LinkedHashMap<Integer, Integer>();

        availableRules.put(3, 6);
        availableRules.put(5, 14);
        availableRules.put(7, 26);
        availableRules.put(9, 38);
        availableRules.put(11, 50);
        availableRules.put(13, 74);
        availableRules.put(15, 86);
        availableRules.put(17, 110);
        availableRules.put(19, 146);
        availableRules.put(21, 170);
        availableRules.put(23, 194);
        availableRules.put(25, 230);
        availableRules.put(27, 266);
        availableRules.put(29, 302);
        availableRules.put(31, 350);
        availableRules.put(35, 434);
        availableRules.put(41, 590);
        availableRules.put(47, 770);
        availableRules.put(53, 974);
        availableRules.put(59, 1202);
        availableRules.put(65, 1454);
        availableRules.put(71, 1730);
        availableRules.put(77, 2030);
        availableRules.put(83, 2354);
        availableRules.put(89, 2702);
        availableRules.put(95, 3074);
        availableRules.put(101, 3470);
        availableRules.put(107, 3890);
        availableRules.put(113, 4334);
        availableRules.put(119, 4802);
        availableRules.put(125, 5294);
        availableRules.put(131, 5810);

        AVAILABLE_RULES = Collections.unmodifiableMap(availableRules);
    }

    static {
        // Store rules
        final Map<Integer, Integer> unavailableRules = new LinkedHashMap<Integer, Integer>();

        unavailableRules.put(33, 386);
        unavailableRules.put(37, 482);
        unavailableRules.put(39, 530);
        unavailableRules.put(43, 650);
        unavailableRules.put(45, 698);
        unavailableRules.put(49, 830);
        unavailableRules.put(51, 890);
        unavailableRules.put(55, 1046);
        unavailableRules.put(57, 1118);
        unavailableRules.put(61, 1274);
        unavailableRules.put(63, 1358);
        unavailableRules.put(67, 1538);
        unavailableRules.put(69, 1622);
        unavailableRules.put(73, 1814);
        unavailableRules.put(75, 1910);
        unavailableRules.put(79, 2126);
        unavailableRules.put(81, 2222);
        unavailableRules.put(85, 2450);
        unavailableRules.put(87, 2558);
        unavailableRules.put(91, 2810);
        unavailableRules.put(93, 2930);
        unavailableRules.put(97, 3182);
        unavailableRules.put(99, 3314);
        unavailableRules.put(103, 3590);
        unavailableRules.put(105, 3722);
        unavailableRules.put(109, 4010);
        unavailableRules.put(111, 4154);
        unavailableRules.put(115, 4466);
        unavailableRules.put(117, 4610);
        unavailableRules.put(121, 4934);
        unavailableRules.put(123, 5090);
        unavailableRules.put(127, 5438);
        unavailableRules.put(129, 5606);

        UNAVAILABLE_RULES = Collections.unmodifiableMap(unavailableRules);
    }

    /**
     * List of available orders for Lebedev's rule, mapped to their corresponding number of points.
     */
    public final static Map<Integer, Integer> AVAILABLE_RULES;

    /**
     * List of existing but unavailable orders for Lebedev's rule, mapped to their corresponding
     * number of points.
     */
    public final static Map<Integer, Integer> UNAVAILABLE_RULES;
     ...
     * @return Retrieve order from number of points
     */
    public static Integer retrieveOrder(final Integer nbPoints) {
        for (final Entry<Integer, Integer> entry : AVAILABLE_RULES.entrySet()) {
            if (entry.getValue().equals(nbPoints)) {
                return entry.getKey();
            }
        }
        return null;
     ...
     * 
     * @return all the available grids
     */
    public static List<LebedevGrid> getAvailableGrids() {
        final List<LebedevGrid> grids = new ArrayList<LebedevGrid>();

        for (final int order : AVAILABLE_RULES.keySet()) {
            final LebedevGrid grid = lebedevGridByOrder(order);
            grids.add(grid);
        }
     ...
     * <p>
     * Only a certain set of such rules are available through this function. The available orders and the corresponding
     * number of points are listed in AVAILABLE_RULES.
     * </p>
     * <p>
     * <b>Original author ():</b></br> Dmitri Laikov (13 September 2010)</br>
     * </p>
     *
     * @param order the order of the rule
     *
     * @return a Lebedev grid
     */
    public static LebedevGrid lebedevGridByOrder(final int order) {
        if (!AVAILABLE_RULES.containsKey(order)) {
            final String msg = String.format("Unsupported order (%d)", order);
            throw new IllegalStateException(msg);
        }

        final int nbPoints = AVAILABLE_RULES.get(order);
        return lebedevGridByNumberOfPoints(nbPoints);
    }
     ...
     * </p>
     *
     * @param nbPoints the number of points of the rule
     *
     * @return a Lebedev grid
     */
    public static LebedevGrid lebedevGridByNumberOfPoints(final int nbPoints) {
        final List<LebedevGridPoint> gridPoints;
        ...
        switch (nbPoints) {
            ...
            case 5810:
                ...
                break;
            default:
                final String msg = String.format("Unsupported number of points (%d)", nbPoints);
                throw new IllegalStateException(msg);
        }

        if (!AVAILABLE_RULES.containsValue(nbPoints)) {
            final String msg = String.format("Unsupported number of points (%d)", nbPoints);
            throw new IllegalStateException(msg);
        }

        return new LebedevGrid(gridPoints);
    }
    ...
    private static List<LebedevGridPoint> ld0006() {
        ...
        final double b = 0.;
        final double w;
        final List<LebedevGridPoint> list = new ArrayList<LebedevGridPoint>();

        w = 0.1666666666666667;
        list.addAll(LebedevGenOH.genOH(1, a, b, w));
    ...
    private static List<LebedevGridPoint> ld0014() {
        ...
        list.addAll(LebedevGenOH.genOH(3, a, b, w));
    ...
    private static List<LebedevGridPoint> ld0026() {
        ...
        list.addAll(LebedevGenOH.genOH(2, a, b, w));
    ...
    private static List<LebedevGridPoint> ld0038() {
        ...
        list.addAll(LebedevGenOH.genOH(5, a, b, w));
    ...
    private static List<LebedevGridPoint> ld0050() {
        ...
        list.addAll(LebedevGenOH.genOH(4, a, b, w));
    ...
    private static List<LebedevGridPoint> ld0146() {
        ...
        list.addAll(LebedevGenOH.genOH(6, a, b, w));
