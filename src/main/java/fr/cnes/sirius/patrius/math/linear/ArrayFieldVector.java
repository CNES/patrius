...
public class ArrayFieldVector<T extends FieldElement<T>> implements FieldVector<T>, Serializable {
    ...
    public ArrayFieldVector(final FieldVector<T> v1, final FieldVector<T> v2) {
        ...
        this.data = MathArrays.buildArray(this.field, v1Data.length + v2Data.length);
    ...
    public FieldMatrix<T> outerProduct(final FieldVector<T> v) {
        try {
            ...
            final FieldMatrix<T> out = new Array2DRowFieldMatrix<>(this.field, m, n);
            for (int i = 0; i < m; i++) {
                for (int j = 0; j < n; j++) {
    ...
    public FieldVector<T> getSubVector(final int index, final int n) {
        ...
        final ArrayFieldVector<T> out = new ArrayFieldVector<>(this.field, n);
        try {
