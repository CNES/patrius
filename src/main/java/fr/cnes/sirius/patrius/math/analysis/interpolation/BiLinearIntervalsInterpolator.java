 ...
 * @version $Id: BiLinearIntervalsInterpolator.java 17603 2017-05-18 08:28:32Z bignon $
 * @since 2.3
 * 
 */
public final class BiLinearIntervalsInterpolator implements BivariateGridInterpolator {
     ...
     * 
     * @param xval
     *        abscissas for the interpolation points.
     * @param yval
     *        ordinates for the interpolation points.
     * @param fval
     *        function values for the interpolation points.
     * @return a function which interpolates the dataset.
     */
    @Override
    public BiLinearIntervalsFunction interpolate(final double[] xval, final double[] yval, final double[][] fval) {
        return new BiLinearIntervalsFunction(xval, yval, fval);
    }
