 ...
 * 
 * @since 3.0
 * @version $Id: NonSquareMatrixException.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class NonSquareMatrixException extends DimensionMismatchException {
     ...
     *        Column dimension.
     */
    public NonSquareMatrixException(final int wrong,
        final int expected) {
        super(PatriusMessages.NON_SQUARE_MATRIX, wrong, expected);
    }
}
