...
public class MixtureMultivariateNormalDistribution
     ...
     * {@link org.apache.commons.math3.random.Well19937c Well19937c} as random generator to be used for sampling only
    ...
    public static List<Pair<Double, MultivariateNormalDistribution>> createComponents(final double[] weights,
        ...
        final List<Pair<Double, MultivariateNormalDistribution>> mvns = new ArrayList<Pair<Double,
