...
public interface DatePolynomialFunctionInterface extends UnivariateDateFunction {
    ...
    /**
     * Get the time as double corresponding to the given {@link AbsoluteDate}.
     *
     * @param date
    ...
    /**
     * Get the {@link AbsoluteDate} corresponding to the given time as double.
     *
     * @param time
     ...
     *
     * @param date0 the date of interest
