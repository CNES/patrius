...
public class BSPTree<S extends Space> {
    ...
    public BSPTree<S> copySelf() {
        ...
        return new BSPTree<>(this.cut.copySelf(), this.plus.copySelf(), this.minus.copySelf(),
            this.attribute);
    }
    ...
    public BSPTree<S> split(final SubHyperplane<S> sub) {
        ...
        if (this.cut == null) {
            return new BSPTree<>(sub, this.copySelf(),
        ...
        switch (sub.side(cHyperplane)) {
            case PLUS:
                ...
                if (this.cut.side(sHyperplane) == Side.PLUS) {
                    splitP.plus =
                        new BSPTree<>(this.cut.copySelf(), splitP.plus, this.minus.copySelf(), this.attribute);
                    splitP.plus.condense();
                    splitP.plus.parent = splitP;
                } else {
                    splitP.minus =
                        new BSPTree<>(this.cut.copySelf(), splitP.minus, this.minus.copySelf(), this.attribute);
            ...
            case MINUS:
                ...
                if (this.cut.side(sHyperplane) == Side.PLUS) {
                    splitM.plus =
                        new BSPTree<>(this.cut.copySelf(), this.plus.copySelf(), splitM.plus, this.attribute);
                    splitM.plus.condense();
                    splitM.plus.parent = splitM;
                } else {
                    splitM.minus =
                        new BSPTree<>(this.cut.copySelf(), this.plus.copySelf(), splitM.minus, this.attribute);
            ...
            case BOTH:
                ...
                final BSPTree<S> splitB =
                    new BSPTree<>(sub, this.plus.split(subParts.getPlus()), this.minus.split(subParts.getMinus()),
                        null);
            ...
            default:
                return cHyperplane.sameOrientationAs(sHyperplane) ?
                    new BSPTree<>(sub, this.plus.copySelf(), this.minus.copySelf(), this.attribute) :
                    new BSPTree<>(sub, this.minus.copySelf(), this.plus.copySelf(), this.attribute);
        }
    }
