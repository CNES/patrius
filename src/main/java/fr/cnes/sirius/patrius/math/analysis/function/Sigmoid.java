...
public class Sigmoid implements UnivariateDifferentiableFunction {
    ...
    /** Serializable UID. */
    private static final long serialVersionUID = -3843619468098412543L;
    ...
    public static class Parametric implements ParametricUnivariateFunction {
        ...
        private static void validateParameters(final double[] param) {
            ...
            if (param.length != 2) {
                throw new DimensionMismatchException(PatriusMessages.INVALID_NUMBER_OF_PARAMETERS, 2, param.length);
            }
        }
    }
}
