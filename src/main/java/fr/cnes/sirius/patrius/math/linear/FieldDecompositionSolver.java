 ...
 * </p>
 * <p>
 * Some solvers like {@link FieldLUDecomposition} can only find the solution for square matrices and when the solution
 * is an exact linear solution, i.e. when ||A &times; X - B|| is exactly 0. Other solvers can also find solutions with
 ...
 * @version $Id: FieldDecompositionSolver.java 18108 2017-10-04 06:45:27Z bignon $
 * @since 2.0
 */
