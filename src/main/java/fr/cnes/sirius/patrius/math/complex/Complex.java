...
public class Complex implements FieldElement<Complex>, Serializable {
    ...
    public Complex add(final Complex addend) {
        ...
        return this.createComplex(this.real + addend.getReal(),
    ...
    public Complex divide(final Complex divisor) {
        ...
        if (MathLib.abs(c) < MathLib.abs(d)) {
            ...
            return this.createComplex((this.real * q + this.imaginary) / denominator,
                (this.imaginary * q - this.real) / denominator);
        } else {
            final double q = d / c;
            final double denominator = d * q + c;
            return this.createComplex((this.imaginary * q + this.real) / denominator,
    ...
    public Complex divide(final double divisor) {
        ...
        return this.createComplex(this.real / divisor,
    ...
    public Complex multiply(final Complex factor) {
        ...
        if (this.isNaNFlag || factor.isNaNFlag) {
            ...
            res = this.createComplex(this.real * factor.real - this.imaginary * factor.imaginary,
    ...
    public Complex multiply(final int factor) {
        ...
        if (this.isNaNFlag) {
            ...
            res = this.createComplex(this.real * factor, this.imaginary * factor);
        }
        return res;
    }
    ...
    public Complex subtract(final Complex subtrahend) {
        ...
        return this.createComplex(this.real - subtrahend.getReal(),
    ...
    public Complex atan() {
        ...
        return this.add(I).divide(I.subtract(this)).log()
            .multiply(I.divide(this.createComplex(2.0, 0.0)));
    }
    ...
    public Complex cos() {
        ...
        final double[] sincos = MathLib.sinAndCos(real);
        final double sin = sincos[0];
        final double cos = sincos[1];
        final double[] sinhcosh = MathLib.sinhAndCosh(imaginary);
        final double sinh = sinhcosh[0];
        final double cosh = sinhcosh[1];
        return this.createComplex(cos * cosh, -sin * sinh);
    }
    ...
    public Complex cosh() {
        ...
        final double[] sincos = MathLib.sinAndCos(imaginary);
        final double sin = sincos[0];
        final double cos = sincos[1];
        final double[] sinhcosh = MathLib.sinhAndCosh(real);
        final double sinh = sinhcosh[0];
        final double cosh = sinhcosh[1];
        return this.createComplex(cosh * cos, sinh * sin);
    }
    ...
    public Complex exp() {
        ...
        return this.createComplex(expReal * cos, expReal * sin);
    }
    ...
    public Complex log() {
        ...
        return this.createComplex(MathLib.log(this.abs()),
    ...
    public Complex sin() {
        ...
        final double sinh = sinhcosh[0];
        final double cosh = sinhcosh[1];
        return this.createComplex(sin * cosh, cos * sinh);
    }
    ...
    public Complex sinh() {
        ...
        final double sinh = sinhcosh[0];
        final double cosh = sinhcosh[1];
        return this.createComplex(sinh * cos, cosh * sin);
    }
    ...
    public Complex sqrt() {
        ...
        if (this.real >= 0.0) {
            ...
            return this.createComplex(MathLib.abs(this.imaginary) / (2.0 * t),
    ...
    public Complex tan() {
        ...
        return this.createComplex(sin / d, sinh / d);
    }
    ...
    public Complex tanh() {
        ...
        return this.createComplex(sinh / d, sin / d);
    }
