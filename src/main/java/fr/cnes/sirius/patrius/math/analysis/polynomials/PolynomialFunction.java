...
public class PolynomialFunction implements UnivariateDifferentiableFunction, Serializable {
    ...
    public DerivativeStructure value(final DerivativeStructure t) {
        ...
        DerivativeStructure result =
            new DerivativeStructure(t.getFreeParameters(), t.getOrder(), this.coefficients[n - 1]);
        for (int j = n - 2; j >= 0; j--) {
    ...
    public PolynomialFunction add(final PolynomialFunction p) {
        ...
        System.arraycopy((this.coefficients.length < p.coefficients.length) ?
            p.coefficients : this.coefficients,
            lowLength,
    ...
    public PolynomialFunction subtract(final PolynomialFunction p) {
        ...
        if (this.coefficients.length < p.coefficients.length) {
            ...
            System.arraycopy(this.coefficients, lowLength, newCoefficients, lowLength,
                highLength - lowLength);
        }
