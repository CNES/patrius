 ...
 * <em>Pegasus</em> method however, should converge much faster than the original <em>Regula Falsi</em> method.
 * Furthermore, this implementation of the <em>Pegasus</em> method should not suffer from the same implementation issues
 * as the <em>Regula
 * Falsi</em> method, which may fail to convergence in certain cases. Also, the <em>Pegasus</em> method should converge
 * faster than the {@link IllinoisSolver <em>Illinois</em>} method, another <em>Regula
 ...
 * <em>The "Pegasus" method for computing the root of an equation</em>, BIT Numerical Mathematics, volume 12, number 4,
 * pages 503-508, Springer, 1972.
 * </p>
 * 
 * @since 3.0
 * @version $Id: PegasusSolver.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class PegasusSolver extends BaseSecantSolver {

    /** Serializable UID. */
    private static final long serialVersionUID = -6315384445114292036L;
