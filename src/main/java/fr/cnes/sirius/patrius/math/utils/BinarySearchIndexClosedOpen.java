 ...
 * </p>
 * The interval convention is set to {@link ISearchIndex.SearchIndexIntervalConvention#CLOSED_OPEN}.
 * 
 * @concurrency immutable
 * 
 * @author Sophie Laurens
 * @version $Id: BinarySearchIndexClosedOpen.java 17583 2017-05-10 13:05:10Z bignon $
 * @since 2.3.1
 * 
 */
public class BinarySearchIndexClosedOpen extends AbstractSearchIndex {
     ...
     */
    public BinarySearchIndexClosedOpen(final double[] tab2) {
        super(tab2);
    }

    /**
     * Returns the index of x in a tab with a dichotomy / BinarySearch algorithm under
     * the convention {@link ISearchIndex.SearchIndexIntervalConvention#CLOSED_OPEN}.
     * 
     * @param x
     *        : the value to search.
    ...
    public int getIndex(final double x) {
        return SearchIndexLibrary.binarySearchClosedOpen(this.tab, x, this.iMin, this.iMax);
    }
    ...
    public int getIndex(final double x, final int iMin2, final int iMax2) {
        return SearchIndexLibrary.binarySearchClosedOpen(this.tab, x, iMin2, iMax2);
    }
