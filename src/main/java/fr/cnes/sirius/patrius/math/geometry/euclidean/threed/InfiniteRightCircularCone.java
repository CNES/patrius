...
public final class InfiniteRightCircularCone implements InfiniteCone, Serializable {
    ...
    private double[] alphaIntersections(final double[] lineOrigin, final double[] lineDirection) {
        ...
        if ((MathLib.abs(a) < EPS)
            ...
            solution = alphaSolver(a, b, c, lineOrigin, lineDirection);
        }
     ...
     */
    private static double[] alphaSolver(final double a, final double b, final double c, final double[] lineOrigin,
        ...
        if (MathLib.abs(det) < EPS) {
            ...
            // enum type
            final ZIntersects intersects = zIntersects(zIntersect1b, zIntersect2b);
     ...
     */
    private static ZIntersects zIntersects(final boolean z1, final boolean z2) {
    ...
    public Vector3D[] closestPointTo(final Line line) {
        ...
        if (this.intersects(line)) {
            ...
            // Line intersects, return intersection with lowest abscissa on line
