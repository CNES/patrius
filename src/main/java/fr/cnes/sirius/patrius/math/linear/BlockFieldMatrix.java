...
public class BlockFieldMatrix<T extends FieldElement<T>> extends AbstractFieldMatrix<T> implements Serializable {
    ...
    public FieldMatrix<T> copy() {
        ...
        final BlockFieldMatrix<T> copied = new BlockFieldMatrix<>(this.getField(), this.rows, this.columns);
    ...
    public FieldMatrix<T> add(final FieldMatrix<T> m) {
        try {
            ...
            final BlockFieldMatrix<T> out = new BlockFieldMatrix<>(this.getField(), this.rows, this.columns);
    ...
    public FieldMatrix<T> multiply(final FieldMatrix<T> m) {
        try {
            ...
            final BlockFieldMatrix<T> out = new BlockFieldMatrix<>(this.getField(), this.rows, m.getColumnDimension());
    ...
    public BlockFieldMatrix<T> multiply(final BlockFieldMatrix<T> m) {
        ...
        final BlockFieldMatrix<T> out = new BlockFieldMatrix<>(this.getField(), this.rows, m.columns);
        final T zero = this.getField().getZero();
    ...
    public FieldMatrix<T> getSubMatrix(final int startRow, final int endRow,
        ...
        final BlockFieldMatrix<T> out =
            new BlockFieldMatrix<>(this.getField(), endRow - startRow + 1, endColumn - startColumn + 1);
    ...
    public FieldMatrix<T> getRowMatrix(final int row) {
        ...
        final BlockFieldMatrix<T> out = new BlockFieldMatrix<>(this.getField(), 1, this.columns);
    ...
    public FieldMatrix<T> getColumnMatrix(final int column) {
        ...
        final BlockFieldMatrix<T> out = new BlockFieldMatrix<>(this.getField(), this.rows, 1);
    ...
    public FieldMatrix<T> transpose() {
        final int nRows = this.getRowDimension();
        final int nCols = this.getColumnDimension();
        final BlockFieldMatrix<T> out = new BlockFieldMatrix<>(this.getField(), nCols, nRows);
