...
public class GaussianFitter extends CurveFitter<Gaussian.Parametric> {
    ...
    public static class ParameterGuesser {
         ...
         */
        private double interpolateXAtY(final WeightedObservedPoint[] points,
                                       final int startIdx,
                                       final int idxStep,
                                       final double y) {
            if (idxStep == 0) {
         ...
         *         range of the specified {@code points}.
         */
        private WeightedObservedPoint[] getInterpolationPointsForY(final WeightedObservedPoint[] points,
                                                                   final int startIdx,
                                                                   final int idxStep,
                                                                   final double y) {
            if (idxStep == 0) {
         ...
         */
        private boolean isBetween(final double value,
