...
public class MultivariateSummaryStatistics
     ...
     */
    private static double[] getResults(final StorelessUnivariateStatistic[] stats) {
    ...
    public String toString() {
        ...
        append(outBuffer, this.getMin(), "min: ", separator, suffix);
        append(outBuffer, this.getMax(), "max: ", separator, suffix);
        append(outBuffer, this.getMean(), "mean: ", separator, suffix);
        append(outBuffer, this.getGeometricMean(), "geometric mean: ", separator, suffix);
        append(outBuffer, this.getSumSq(), "sum of squares: ", separator, suffix);
        append(outBuffer, this.getSumLog(), "sum of logarithms: ", separator, suffix);
        append(outBuffer, this.getStandardDeviation(), "standard deviation: ", separator, suffix);
     ...
     *        text suffix
     */
    private static void append(final StringBuilder buffer, final double[] data,
    ...
    private void checkDimension(final int dimension) {
        if (dimension != this.k) {
            throw new DimensionMismatchException(PatriusMessages.INCOMPATIBLE_STATISTICS_DIMENSION, this.k, dimension);
        }
    }
