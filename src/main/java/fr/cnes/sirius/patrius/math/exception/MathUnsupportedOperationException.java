 ...
 * It is used for all the exceptions that have the semantics of the standard {@link UnsupportedOperationException}, but
 * must also provide a localized
 * message.
 * 
 * @since 2.2
 * @version $Id: MathUnsupportedOperationException.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class MathUnsupportedOperationException extends UnsupportedOperationException
    ...
    public MathUnsupportedOperationException() {
        this(PatriusMessages.UNSUPPORTED_OPERATION);
    }
     ...
     *        Arguments.
     */
    public MathUnsupportedOperationException(final Localizable pattern,
        final Object... args) {
        super();
