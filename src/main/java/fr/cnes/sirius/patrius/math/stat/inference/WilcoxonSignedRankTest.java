...
public class WilcoxonSignedRankTest {
     ...
     * @return z = y - x
     */
    private static double[] calculateDifferences(final double[] x, final double[] y) {
     ...
     */
    private static double[] calculateAbsoluteDifferences(final double[] z) {
     ...
     */
    private static double calculateExactPValue(final double wMax, final int n) {
     ...
     */
    private static double calculateAsymptoticPValue(final double wMin, final int n) {
