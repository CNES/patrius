 ...
 */
public final class TrigonometricPolynomialPrimitive implements UnivariateDifferentiableFunction {
    ...
    private static TrigonometricPolynomialPrimitive polynomialDerivative(
        ...
        return new TrigonometricPolynomialPrimitive(poly.getLinearPolynomial().derivative(),
