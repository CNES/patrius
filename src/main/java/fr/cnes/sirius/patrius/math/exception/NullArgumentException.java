 ...
 * 
 * @since 2.2
 * @version $Id: NullArgumentException.java 18108 2017-10-04 06:45:27Z bignon $
 */
public class NullArgumentException extends MathIllegalArgumentException {
    ...
    public NullArgumentException() {
        this(PatriusMessages.NULL_NOT_ALLOWED);
    }
     ...
     */
    public NullArgumentException(final Localizable pattern,
