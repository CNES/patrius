...
public abstract class EmbeddedRungeKuttaIntegrator
        ...
        do {
            ...
            while (error >= 1.0) {
                ...
                if (forward) {
                    if (this.stepStart + this.stepSize > t) {
                        ...
                        this.stepSize = avoidOvershoot(stepStart, t, stepSize, forward);
                    }
                } else {
                    if (this.stepStart + this.stepSize < t) {
                        this.stepSize = t - this.stepStart;
            ...
            if (!this.isLastStep) {
                ...
                if (filteredNextIsLast) {
                    ...
                    hNew = avoidOvershoot(stepStart, t, hNew, forward);
                }
    ...
    protected void initIntegration(final double t0, final double[] y0, final double t) {
        ...
        final List<Integer> estimateErrorList = new ArrayList<Integer>();
