...
public interface BodyShape extends PVCoordinatesProvider {
     ...
     */
    static final double DIRECTION_FACTOR = 1e14;
     ...
     *            if line cannot be converted to body frame
     */
    default Vector3D[] closestPointTo(final Line line, final Frame frame, final AbsoluteDate date)
        throws PatriusException {
     ...
     *         [1]) expressed as {@link Vector3D}
     */
    Vector3D[] closestPointTo(final Line line);
}
