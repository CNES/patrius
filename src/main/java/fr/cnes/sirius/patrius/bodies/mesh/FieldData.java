...
/**
 * Data container for {@link FacetBodyShape} field data. Field data are data related to a {@link FacetBodyShape}
...
public class FieldData {
    ...
    public FieldData(final AbsoluteDate date,
        ...
        // Compute contour
        final List<GeodeticPoint> contourTmp = new ArrayList<>();
        final Map<Vertex, Integer> verticesMap = new HashMap<>();
        for (final Triangle triangle : visibleTriangles) {
