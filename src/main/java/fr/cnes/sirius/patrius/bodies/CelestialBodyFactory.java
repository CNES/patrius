 ...
 * <ul>Data are automatically loaded based on provided {@link CelestialBodyLoader}.</ul>
 * <ul>User can provide its own implementation of these loaders and provide them using 
 * {@link #addCelestialBodyLoader(String, CelestialBodyLoader)}.</ul>
 ...
 * <ul>List of loaders can be cleared and reordered using {@link #clearCelestialBodyLoaders()}.</ul>
 * </p>
 * <p>
 ...
 * Once loaded, data are stored in static variables and are used to retrieve planetary bodies through the 
 * various available getters.
 * </p>
 * 
...
public final class CelestialBodyFactory {
    ...
    private static final Map<String, List<CelestialBodyLoader>> LOADERS_MAP = new ConcurrentHashMap<>();
    ...
    public static void addDefaultCelestialBodyLoader(final String name,
        ...
        if (name.equals(SOLAR_SYSTEM_BARYCENTER)) {
            loader = new JPLCelestialBodyLoader(supportedNames,
                EphemerisType.SOLAR_SYSTEM_BARYCENTER);
        } else if (name.equals(SUN)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.SUN);
        } else if (name.equals(MERCURY)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.MERCURY);
        } else if (name.equals(VENUS)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.VENUS);
        } else if (name.equals(EARTH_MOON)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.EARTH_MOON);
        } else if (name.equals(EARTH)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.EARTH);
        } else if (name.equals(MOON)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.MOON);
        } else if (name.equals(MARS)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.MARS);
        } else if (name.equals(JUPITER)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.JUPITER);
        } else if (name.equals(SATURN)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.SATURN);
        } else if (name.equals(URANUS)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.URANUS);
        } else if (name.equals(NEPTUNE)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.NEPTUNE);
        } else if (name.equals(PLUTO)) {
            loader =
                new JPLCelestialBodyLoader(supportedNames, EphemerisType.PLUTO);
        }
