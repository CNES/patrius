 ...
 *
 * HISTORY
 * VERSION:4.9.3:FA:FA-3269:20/04/2023:[PATRIUS] Resolution probleme CelestialBodyFactory
 ...
 * <ul>
 * <li>{@link JPLEphemeridesLoader}: JPL DE ephemeris (see above for all accepted formats)</li>
 * <li>{@link JPLEphemeridesLoader}: IMCCE INPOP ephemeris (see above for all accepted formats)</li>
 * </ul>
 * There is no included data in PATRIUS by default. <br/>
 * Once loaded, data are stored in static variables and are used to retrieve planetary bodies.
 * </p>
 * 
...
public final class CelestialBodyFactory {
    ...
    private static final Map<String, CopyOnWriteArrayList<CelestialBodyLoader>> LOADERS_MAP =
        new ConcurrentHashMap<String, CopyOnWriteArrayList<CelestialBodyLoader>>();
    ...
    public static void addCelestialBodyLoader(final String name, final CelestialBodyLoader loader) {
        ...
        if (loaders == null) {
            loaders = new CopyOnWriteArrayList<CelestialBodyLoader>();
