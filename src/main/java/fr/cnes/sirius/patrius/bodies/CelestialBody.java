...
public interface CelestialBody extends PVCoordinatesProvider {
     ...
     * <p>
     * <b>Warning: </b>Inertiality of such frame depends on its definition and on its use: if related {@link IAUPole}
     ...
     *            if frame cannot be retrieved
     */
    CelestialBodyFrame getInertialFrame(IAUPoleModelType iauPole) throws PatriusException;
     ...
     *            if frame cannot be retrieved
     */
    CelestialBodyFrame getRotatingFrame(IAUPoleModelType iauPole) throws PatriusException;
