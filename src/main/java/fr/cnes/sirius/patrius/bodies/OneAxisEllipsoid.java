...
public class OneAxisEllipsoid implements EllipsoidBodyShape {
     ...
     */
    private static final double DIRECTION_FACTOR = 1e14;
    ...
    public double getApparentRadius(final PVCoordinatesProvider pvObserver,
        ...
        if (MathLib.abs(1 - this.g2) > Precision.DOUBLE_COMPARISON_EPSILON) {
            ...
            // Compute sphereX, sphereY and sphereZ
    ...
    public Vector3D[] closestPointTo(final Line line, final Frame frame, final AbsoluteDate date)
        ...
        final Line lineBodyFrame = this.frameTransformLine(line, frame, date);
        
        // Compute points thanks to the method of the ellipsoid
        return this.ellipsoid.closestPointTo(lineBodyFrame);
    }
}
