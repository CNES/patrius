 ...
 * for instance.
 */
public enum GlobalIAUPoleType {

    /** Constant part only (transformation between ICRF and inertially-oriented frame). */
    CONSTANT {
        /** {@inheritDoc} */
        @Override
        boolean accept(final IAUPoleType type) {
            return type.equals(IAUPoleType.CONSTANT);
        }
    },
    ...
    CONSTANT_SECULAR {
        ...
        @Override
        boolean accept(final IAUPoleType type) {
            return type.equals(IAUPoleType.CONSTANT) || type.equals(IAUPoleType.SECULAR);
        }
    },
     ...
     */
    abstract boolean accept(final IAUPoleType type);
}
