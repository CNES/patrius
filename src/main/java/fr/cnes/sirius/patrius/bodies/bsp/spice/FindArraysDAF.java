 ...
 * The main function of these methods is to allow the
...
public final class FindArraysDAF {
    ...
    /**
     * Boolean indicating if it is the first time calling any of the methods
     ...
     */
    private static List<DafState> statePool = new LinkedList<DafState>();
    /**
     * Read Access method
     */
     ...
     * @throws PatriusException if there is a problem with the SPICE algorithm
     * @throws IOException if there is a problem reading the first record of the file
     */
    public static void beginForwardSearch(final int handle) throws PatriusException {
        ...
        // open DAFs.
        if (first) {
            openSetDAF = new ArrayList<Integer>(SpiceCommon.FILE_TABLE_SIZE);
            first = false;
        }
        ...
        // At this point, either found is false, or state points to a
        ...
        // At this point, either the first element in the stateTable contains
        // the information about the current DAF, or we are going to add it.
        ...
        state.setLastSummaryRecord(ReadDoublePrecisionDAF.getContentSummaryRecord(handle, 
                                                                                  fr.getForward(), 
                                                                                  0, 
                                                                                  LASTWORD, 
                                                                                  fnd));
     ...
     * @throws PatriusException if there is a problem finding the file or reading it.
     * @throws IOException if there is a problem opening the random access file.
     */
     ...
     * @throws PatriusException if the access mode is not correct or the DAF associated to the handle 
    ...
    public static void selectDaf(final int handle) throws PatriusException {
        ...
        // Either FND is false, or STATE is the state in the state table of
        // the DAF specified by HANDLE.
     ...
     * @throws PatriusException if there is a problem in the SPICE algorithm
     */
     ...
     * @throws PatriusException if there is a problem accessing/reading the current file.
     */
     ...
     * @throws PatriusException if there is a problem while reading the file
     */
     ...
     * @throws IOException problem while reading a character record
     * @throws PatriusException if there is a problem in regarding the SPICE algorithm
     */
     ...
     * @param record Record number of character record.
     * @return Character record.
     * @throws IOException if there is a problem reading the file
     * @throws PatriusException if the access method is not correct
     */
    public static String readCharacterRecordDaf(final int handle,
            final int record) throws PatriusException {
