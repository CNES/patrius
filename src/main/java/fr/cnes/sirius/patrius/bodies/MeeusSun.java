...
public class MeeusSun extends AbstractCelestialBody {
    ...
    public enum MODEL {
        ...
        STANDARD(STANDARD_MEAN_LONGITUDE_0, STANDARD_MEAN_LONGITUDE_1, STANDARD_MEAN_LONGITUDE_2,
                ...
                STANDARD_SUN_CENTER_21, STANDARD_SUN_CENTER_30, DISTANCE_SUN_EARH *
                    Constants.JPL_SSD_ASTRONOMICAL_UNIT, FramesFactory.getEODFrame(true), 0.),
    ...
    public MeeusSun(final MODEL model) {
        ...
        this.setShape(new OneAxisEllipsoid(SUN_RADIUS, 0., this
            .getRotatingFrameTrueModel(), "Sun"));
    }
     ...
     * Note that it is not possible to build this Sun from the CelestialBodyFactory.
     * </p>
     * See "Astronomical Algorithms", chapter 24 "Solar Coordinates", Jean Meeus, 1991.
     * This class allows the use of three different Meeus model : the standard Meeus model, the STELA one and
     * the on board model (used for CERES mission for instance).
     ...
     * transform to speed up computation during the integration process if Stela model have been chosen. As this
     * transform varies slowly through time, it has been shown it is not necessary to recompute it every time. Warning:
     * these methods should not be used in a stand-alone use (unless you known what you are doing). There are two
     * methods:
     * <ul>
    ...
    private class MeeusSunEphemeris implements CelestialBodyEphemeris {
        ...
        public PVCoordinates getPVCoordinates(final AbsoluteDate date, final Frame frame) throws PatriusException {
            ...
            double l0 =
                meeusModel.meanLongitude0 + meeusModel.meanLongitude1 * t + meeusModel.meanLongitude2 * t2;
            ...
            double c = (meeusModel.sunCenter10 + meeusModel.sunCenter11 * t + meeusModel.sunCenter12 * t2)
                * MathLib.sin(m)
                + (meeusModel.sunCenter20 + meeusModel.sunCenter21 * t) * MathLib.sin(2 * m)
            ...
            final double e =
                meeusModel.eccentricity0 + meeusModel.eccentricity1 * t + meeusModel.eccentricity2 * t2;
            ...
            final double epsSun =
                meeusModel.obliquity0 + meeusModel.obliquity1 * t + meeusModel.obliquity2 * t2
