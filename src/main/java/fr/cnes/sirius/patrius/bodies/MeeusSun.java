 ...
 * <p>
 * This class contains methods to store {@link #getInertialEquatorFrame()} to integration frame (CIRF) transform to
 ...
 * <ul>
 * <li>{@link #updateTransform(AbsoluteDate, Frame)}: store transform from {@link #getInertialEquatorFrame()} to
...
public class MeeusSun extends AbstractCelestialBody {
    ...
    /** Cached transform from {@link #getInertialEquatorFrame()} to integration frame (CIRF). */
    ...
    public MeeusSun(final MODEL model) {
        ...
        this.setShape(new ExtendedOneAxisEllipsoid(SUN_RADIUS, 0., this
            .getTrueRotatingFrame(), "Sun"));
    }
    ...
    public PVCoordinates getPVCoordinates(final AbsoluteDate date, final Frame frame) throws PatriusException {
        ...
        if (this.meeusModel == MODEL.STELA) {
            ...
            if (cachedTransform == null) {
                ...
                transform = this.getICRF().getParent().getTransformTo(frame, date);
            } else {
