 ...
 * {@link StarConvexBodyShape} interface by adding getters to access the spheroid parameters.
 * </p>
 *
...
public interface EllipsoidBodyShape extends StarConvexBodyShape {
     ...
     * @throws PatriusException if the GeodeticPoint cannot be retrieved
     */
