...
public class UserIAUPole implements IAUPole {
    ...
    public Vector3D getPole(final AbsoluteDate date,
        ...
        return new Vector3D(getValue(coefficients.getAlpha0Coeffs(), date, iauPoleType), getValue(
                coefficients.getDelta0Coeffs(), date, iauPoleType));
    }
    ...
    public double getPrimeMeridianAngle(final AbsoluteDate date,
            final GlobalIAUPoleType iauPoleType) {
        return getValue(coefficients.getWCoeffs(), date, iauPoleType);
    }
    ...
    public Vector3D getPoleDerivative(final AbsoluteDate date,
            final GlobalIAUPoleType iauPoleType) {
        // Alpha, delta
        final double alpha = getValue(coefficients.getAlpha0Coeffs(), date, iauPoleType);
        final double delta = getValue(coefficients.getDelta0Coeffs(), date, iauPoleType);
        final double alphap = getDerivative(coefficients.getAlpha0Coeffs(), date, iauPoleType);
        final double deltap = getDerivative(coefficients.getDelta0Coeffs(), date, iauPoleType);
    ...
    public double getPrimeMeridianAngleDerivative(final AbsoluteDate date,
            final GlobalIAUPoleType iauPoleType) {
        return getDerivative(coefficients.getWCoeffs(), date, iauPoleType);
    }
