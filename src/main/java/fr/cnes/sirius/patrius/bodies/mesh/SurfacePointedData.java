...
/**
 * Data container for {@link FacetCelestialBody} surface data. A surface data is a {@link FacetCelestialBody} surface
 * data derived from a date and a body point (incidence, solar incidence, distance, etc.).
 * 
...
public class SurfacePointedData {
    ...
    /**
     * Constructor.
     * @param body facet celestial body
     * @param date date
     ...
     */
    public SurfacePointedData(final FacetCelestialBody body,
        ...
        this.intersection = body.getIntersection(line, position, frame, date);
