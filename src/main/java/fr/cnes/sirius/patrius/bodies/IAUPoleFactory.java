 ...
 * Coordinates and Rotational Elements of the Planets and Satellites (WGCCRE). Note that these value differ from
 * earliest reports (before 2005).
 * </p>
 * 
 * <p>
 * By default, IAU pole data for planetary bodies (including Sun and Moon) are available in PATRIUS through use of
 * method {@link #getIAUPole(EphemerisType)}. Data come from the IAU 2009 working group Technical Note (see above).
 * </p>
...
public final class IAUPoleFactory {
    ...
    static {
        ...
        poleData = new HashMap<JPLEphemeridesLoader.EphemerisType, IAUPole>();
    ...
    private static IAUPole buildGeneric(final String body) {
        ...
        alpha0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(body
                + ".alpha0_deg") }), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
        ...
        delta0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(body
                + ".delta0_deg") }), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
        ...
        w0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(body
                + ".w0_deg") }), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
    ...
    private static IAUPole buildMercury() {
        // Alpha 0
        final List<IAUPoleFunction> alpha0List = new ArrayList<IAUPoleFunction>();
        alpha0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(MERCURY
                + ".alpha0_deg") }), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
        ...
        // Delta 0
        final List<IAUPoleFunction> delta0List = new ArrayList<IAUPoleFunction>();
        delta0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(MERCURY
                + ".delta0_deg") }), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
        ...
        // W
        final List<IAUPoleFunction> w0List = new ArrayList<IAUPoleFunction>();
        w0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(MERCURY
                + ".w0_deg") }), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(MERCURY + ".w1_degperday") }), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MERCURY + ".m1_coef_deg", MERCURY
                + ".m1_0_deg", MERCURY + ".m1_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MERCURY + ".m2_coef_deg", MERCURY
                + ".m2_0_deg", MERCURY + ".m2_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MERCURY + ".m3_coef_deg", MERCURY
                + ".m3_0_deg", MERCURY + ".m3_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MERCURY + ".m4_coef_deg", MERCURY
                + ".m4_0_deg", MERCURY + ".m4_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MERCURY + ".m5_coef_deg", MERCURY
                + ".m5_0_deg", MERCURY + ".m5_1_degperday"), IAUTimeDependency.DAYS));
        final IAUPoleCoefficients1D wCoeffs = new IAUPoleCoefficients1D(w0List);
    ...
    private static IAUPole buildJupiter() {
        // Alpha 0
        final List<IAUPoleFunction> alpha0List = new ArrayList<IAUPoleFunction>();
        alpha0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(JUPITER
                + ".alpha0_deg") }), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(JUPITER + ".alpha1_degpercentury") }), IAUTimeDependency.CENTURIES));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(JUPITER + ".alpha_ja_coef_deg",
                JUPITER + ".ja0_deg", JUPITER + ".ja1_degpercentury"), IAUTimeDependency.CENTURIES));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(JUPITER + ".alpha_jb_coef_deg",
                JUPITER + ".jb0_deg", JUPITER + ".jb1_degpercentury"), IAUTimeDependency.CENTURIES));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(JUPITER + ".alpha_jc_coef_deg",
                JUPITER + ".jc0_deg", JUPITER + ".jc1_degpercentury"), IAUTimeDependency.CENTURIES));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(JUPITER + ".alpha_jd_coef_deg",
                JUPITER + ".jd0_deg", JUPITER + ".jd1_degpercentury"), IAUTimeDependency.CENTURIES));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(JUPITER + ".alpha_je_coef_deg",
                JUPITER + ".je0_deg", JUPITER + ".je1_degpercentury"), IAUTimeDependency.CENTURIES));
        final IAUPoleCoefficients1D alpha0Coeffs = new IAUPoleCoefficients1D(alpha0List);

        // Delta 0
        final List<IAUPoleFunction> delta0List = new ArrayList<IAUPoleFunction>();
        delta0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(JUPITER
                + ".delta0_deg") }), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(JUPITER + ".delta1_degpercentury") }), IAUTimeDependency.CENTURIES));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(JUPITER + ".delta_ja_coef_deg",
                JUPITER + ".ja0_deg", JUPITER + ".ja1_degpercentury"), IAUTimeDependency.CENTURIES));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(JUPITER + ".delta_jb_coef_deg",
                JUPITER + ".jb0_deg", JUPITER + ".jb1_degpercentury"), IAUTimeDependency.CENTURIES));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(JUPITER + ".delta_jc_coef_deg",
                JUPITER + ".jc0_deg", JUPITER + ".jc1_degpercentury"), IAUTimeDependency.CENTURIES));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(JUPITER + ".delta_jd_coef_deg",
                JUPITER + ".jd0_deg", JUPITER + ".jd1_degpercentury"), IAUTimeDependency.CENTURIES));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(JUPITER + ".delta_je_coef_deg",
                JUPITER + ".je0_deg", JUPITER + ".je1_degpercentury"), IAUTimeDependency.CENTURIES));
        final IAUPoleCoefficients1D delta0Coeffs = new IAUPoleCoefficients1D(delta0List);

        // W
        final List<IAUPoleFunction> w0List = new ArrayList<IAUPoleFunction>();
        w0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(JUPITER
                + ".w0_deg") }), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
    ...
    private static IAUPole buildMoon() {
        ...
        // Alpha 0
        final List<IAUPoleFunction> alpha0List = new ArrayList<IAUPoleFunction>();
        alpha0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(MOON
                + ".alpha0_deg") }), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(MOON + ".alpha1_degpercentury") }), IAUTimeDependency.CENTURIES));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".alpha_e0_deg", MOON
                + ".e0_0_deg", MOON + ".e0_1_degperday"), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".alpha_e1_deg", MOON
                + ".e1_0_deg", MOON + ".e1_1_degperday"), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".alpha_e2_deg", MOON
                + ".e2_0_deg", MOON + ".e2_1_degperday"), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".alpha_e3_deg", MOON
                + ".e3_0_deg", MOON + ".e3_1_degperday"), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".alpha_e5_deg", MOON
                + ".e5_0_deg", MOON + ".e5_1_degperday"), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".alpha_e9_deg", MOON
                + ".e9_0_deg", MOON + ".e9_1_degperday"), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".alpha_e12_deg", MOON
                + ".e12_0_deg", MOON + ".e12_1_degperday"), IAUTimeDependency.DAYS));
        final IAUPoleCoefficients1D alpha0Coeffs = new IAUPoleCoefficients1D(alpha0List);

        // Delta 0
        final List<IAUPoleFunction> delta0List = new ArrayList<IAUPoleFunction>();
        delta0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(MOON
                + ".delta0_deg") }), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(MOON + ".delta1_degpercentury") }), IAUTimeDependency.CENTURIES));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(MOON + ".delta_e0_deg", MOON
                + ".e0_0_deg", MOON + ".e0_1_degperday"), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(MOON + ".delta_e1_deg", MOON
                + ".e1_0_deg", MOON + ".e1_1_degperday"), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(MOON + ".delta_e2_deg", MOON
                + ".e2_0_deg", MOON + ".e2_1_degperday"), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(MOON + ".delta_e3_deg", MOON
                + ".e3_0_deg", MOON + ".e3_1_degperday"), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(MOON + ".delta_e5_deg", MOON
                + ".e5_0_deg", MOON + ".e5_1_degperday"), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(MOON + ".delta_e6_deg", MOON
                + ".e6_0_deg", MOON + ".e6_1_degperday"), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(MOON + ".delta_e9_deg", MOON
                + ".e9_0_deg", MOON + ".e9_1_degperday"), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(MOON + ".delta_e12_deg", MOON
                + ".e12_0_deg", MOON + ".e12_1_degperday"), IAUTimeDependency.DAYS));
        final IAUPoleCoefficients1D delta0Coeffs = new IAUPoleCoefficients1D(delta0List);

        // W
        final List<IAUPoleFunction> w0List = new ArrayList<IAUPoleFunction>();
        w0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(MOON
                + ".w0_deg") }), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(MOON + ".w1_degperday"), get(MOON + ".w_d2_degperday2") }), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e0_deg", MOON
                + ".e0_0_deg", MOON + ".e0_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e1_deg", MOON
                + ".e1_0_deg", MOON + ".e1_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e2_deg", MOON
                + ".e2_0_deg", MOON + ".e2_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e3_deg", MOON
                + ".e3_0_deg", MOON + ".e3_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e4_deg", MOON
                + ".e4_0_deg", MOON + ".e4_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e5_deg", MOON
                + ".e5_0_deg", MOON + ".e5_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e6_deg", MOON
                + ".e6_0_deg", MOON + ".e6_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e7_deg", MOON
                + ".e7_0_deg", MOON + ".e7_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e8_deg", MOON
                + ".e8_0_deg", MOON + ".e8_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e9_deg", MOON
                + ".e9_0_deg", MOON + ".e9_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e10_deg", MOON
                + ".e10_0_deg", MOON + ".e10_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e11_deg", MOON
                + ".e11_0_deg", MOON + ".e11_1_degperday"), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(MOON + ".w_e12_deg", MOON
                + ".e12_0_deg", MOON + ".e12_1_degperday"), IAUTimeDependency.DAYS));
        final IAUPoleCoefficients1D wCoeffs = new IAUPoleCoefficients1D(w0List);
    ...
    private static IAUPole buildNeptune() {
        // Alpha 0
        final List<IAUPoleFunction> alpha0List = new ArrayList<IAUPoleFunction>();
        alpha0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(NEPTUNE
                + ".alpha0_deg") }), IAUTimeDependency.DAYS));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(NEPTUNE + ".alpha1_degpercentury") }), IAUTimeDependency.CENTURIES));
        alpha0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createSineFunction(NEPTUNE + ".alpha_coef_deg",
                NEPTUNE + ".n0_deg", NEPTUNE + ".n1_degpercentury"), IAUTimeDependency.CENTURIES));
        final IAUPoleCoefficients1D alpha0Coeffs = new IAUPoleCoefficients1D(alpha0List);

        // Delta 0
        final List<IAUPoleFunction> delta0List = new ArrayList<IAUPoleFunction>();
        delta0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(NEPTUNE
                + ".delta0_deg") }), IAUTimeDependency.DAYS));
        delta0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(NEPTUNE + ".delta1_degpercentury") }), IAUTimeDependency.CENTURIES));
        delta0List.add(new IAUPoleFunction(IAUPoleType.HARMONICS, createCosineFunction(NEPTUNE + ".delta_coef_deg",
                NEPTUNE + ".n0_deg", NEPTUNE + ".n1_degpercentury"), IAUTimeDependency.CENTURIES));
        final IAUPoleCoefficients1D delta0Coeffs = new IAUPoleCoefficients1D(delta0List);

        // W
        final List<IAUPoleFunction> w0List = new ArrayList<IAUPoleFunction>();
        w0List.add(new IAUPoleFunction(IAUPoleType.CONSTANT, createPolynomialFunction(new double[] { get(NEPTUNE
                + ".w0_deg") }), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createPolynomialFunction(new double[] { 0,
                get(NEPTUNE + ".w1_degperday") }), IAUTimeDependency.DAYS));
        w0List.add(new IAUPoleFunction(IAUPoleType.SECULAR, createSineFunction(NEPTUNE + ".w_coef_deg", NEPTUNE
     ...
     * <p>
     * This implementation defines directions such that the inertially oriented and body oriented frames are identical
     * and aligned with GCRF. It is used for example to define the ICRF.
     * </p>
     */
