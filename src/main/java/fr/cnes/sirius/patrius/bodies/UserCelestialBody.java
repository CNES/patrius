...
public class UserCelestialBody extends AbstractCelestialBody {
    ...
    public UserCelestialBody(final String name, final PVCoordinatesProvider aPVCoordinateProvider,
                             final AbstractAttractionModel attractionModelIn, final IAUPole iauPole,
                             final Frame parentFrame, final BodyShape shapeIn) {
        super(name, attractionModelIn, iauPole, parentFrame);
    ...
    public UserCelestialBody(final String name, final PVCoordinatesProvider aPVCoordinateProvider,
        ...
        this(name, aPVCoordinateProvider, new NewtonianAttractionModel(parentFrame, gm), iauPole, parentFrame, shapeIn);
    }
    ...
    public String toString() {
        ...
        builder.append("- Ephemeris origin: " + this.pvCoordinateProvider.toString() + " ("
                + this.pvCoordinateProvider.getClass() + ")");
