...
public class PerigeeAltitudeDetector extends AbstractDetector {
    ...
    public PerigeeAltitudeDetector(final double altitudeIn, final double earthRadiusIn) {
        ...
        this.actionAtAscending = Action.CONTINUE;
        this.actionAtDescending = Action.STOP;
    ...
    public PerigeeAltitudeDetector(final double maxCheck, final double threshold,
        ...
        this.removeAtAscending = removeAscending;
        this.removeAtDescending = removeDescending;
    }
    ...
    public Action eventOccurred(final SpacecraftState s, final boolean increasing,
        ...
        return increasing ? this.actionAtAscending : this.actionAtDescending;
    }
    ...
    public EventDetector copy() {
        return new PerigeeAltitudeDetector(this.getMaxCheckInterval(), this.getThreshold(), this.altitude,
            this.earthRadius, this.orbitConverter, this.actionAtAscending, this.actionAtDescending,
            this.removeAtAscending, this.removeAtDescending);
    }
}
