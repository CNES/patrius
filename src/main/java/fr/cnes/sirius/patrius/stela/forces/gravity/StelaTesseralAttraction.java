...
public final class StelaTesseralAttraction extends AbstractStelaLagrangeContribution {
    ...
    public StelaTesseralAttraction(final PotentialCoefficientsProvider provider,
        ...
        this.quadsList = new ArrayList<TesseralQuad>();
    ...
    public double[] computePerturbation(final StelaEquinoctialOrbit orbit) throws PatriusException {
        ...
        for (int i = 0; i < this.quadsList.size(); i++) {
            ...
            final double[] f = this.computeF(orbit, quad);

            // 2. Compute eccentricity function
            final double[] g = this.computeEccentricityFunction(orbit, quad);
    ...
    protected double[] computeF(final StelaEquinoctialOrbit orbit, final TesseralQuad quad) {
        ...
        final double fx = this.computeFx(alpha, beta, mPrime, a, b, hTab, ix, iy, absh, ixiycdiv2, ixiypd);
        final double fy = this.computeFy(alpha, beta, mSecond, a, b, dTab, ix, iy, absh, ixiycdiv2, ixiypd);
        final double dFxdix =
            this.computeFxdix(c, alpha, beta, mPrime, a, b, hTab, ix, iy, absh, ixiycdiv2, ixiycm1div2,
                ixiypd, ixiypddix);
        final double dFxdiy =
            this.computeFxdiy(c, alpha, beta, mPrime, a, b, hTab, ix, iy, absh, ixiycdiv2, ixiycm1div2,
                ixiypd, ixiypddiy);
        final double dFydix =
            this.computeFydix(c, alpha, beta, mSecond, a, b, dTab, ix, iy, absh, ixiycdiv2, ixiycm1div2,
                ixiypd, ixiypddix);
        final double dFydiy =
            this.computeFydiy(c, alpha, beta, mSecond, a, b, dTab, ix, iy, absh, ixiycdiv2, ixiycm1div2,
                ixiypd, ixiypddiy);
     ...
     */
    private double computeFx(final int alpha, final int beta, final int mPrime, final double a, final double[] b,
                             final double[] h, final double ix, final double iy, final int absh,
                             final double ixiycdiv2,
                             final double[] ixiypd) {
     ...
     */
    private double computeFy(final int alpha, final int beta, final int mSecond, final double a, final double[] b,
                             final double[] d, final double ix, final double iy, final int absh,
                             final double ixiycdiv2,
                             final double[] ixiypd) {
     ...
     */
    private double computeFxdix(final int c, final int alpha, final int beta, final int mPrime, final double a,
     ...
     */
    private double computeFxdiy(final int c, final int alpha, final int beta, final int mPrime, final double a,
                                final double[] b, final double[] h, final double ix, final double iy, final int absh,
                                final double ixiycdiv2, final double ixiycm1div2, final double[] ixiypd,
     ...
     */
    private double computeFydix(final int c, final int alpha, final int beta, final int mSecond, final double a,
     ...
     */
    private double computeFydiy(final int c, final int alpha, final int beta, final int mSecond, final double a,
                                final double[] b, final double[] d, final double ix, final double iy, final int absh,
                                final double ixiycdiv2, final double ixiycm1div2, final double[] ixiypd,
                                final double[] ixiypddiy) {
        // compute t1, t2, t3
