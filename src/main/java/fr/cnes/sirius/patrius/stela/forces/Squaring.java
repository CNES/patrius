...
public final class Squaring {
    ...
    public static double[][]
            computeSquaringPoints(final int numPoints, final StelaEquinoctialOrbit orbit,
                                  final double startPoint, final double endPoint) throws PatriusException {
     ...
     *         thrown if number of points is not odd
     */
    public static StelaEquinoctialOrbit[]
            computeSquaringPointsEccentric(final int numPoints,
