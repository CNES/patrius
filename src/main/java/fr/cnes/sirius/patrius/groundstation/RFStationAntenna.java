...
public class RFStationAntenna implements PVCoordinatesProvider, Serializable {
    ...
    public RFStationAntenna(final TopocentricFrame inTopoFrame, final double inMeritFactor,
        ...
        this.atmLossFunction = this.computeInterpolatingFunction(this.atmosphericLoss);
        this.pointLossFunction = this.computeInterpolatingFunction(this.pointingLoss);
    }
     ...
     */
    private UnivariateFunction computeInterpolatingFunction(final double[][] lossMatrix) {
    ...
    public final double getAtmosphericLoss(final double elevation) {
        return this.computeLoss(elevation, this.atmosphericLoss, this.atmLossFunction);
    }
    ...
    public final double getPointingLoss(final double elevation) {
        return this.computeLoss(elevation, this.pointingLoss, this.pointLossFunction);
    }
     ...
     */
    private double computeLoss(final double elevation, final double[][] lossMatrix,
