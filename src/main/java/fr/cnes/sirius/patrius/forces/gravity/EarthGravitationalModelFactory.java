 ...
 * 
 * @see BalminoAttractionModel
 * @see CunninghamAttractionModel
 * @see DrozinerAttractionModel
...
public final class EarthGravitationalModelFactory {
     ...
     * @since 3.4
     */
    public static ForceModel getGravitationalModel(final GravityFieldNames potentialFileName,
     ...
     * @since 3.4
     */
    public static ForceModel getBalmino(final GravityFieldNames potentialFileName, final String filename,
        ...
        return new BalminoAttractionModel(FramesFactory.getITRF(), provider.getAe(), provider.getMu(), provider.getC(n,
     ...
     * @since 3.4
     */
    public static ForceModel getCunningham(final GravityFieldNames potentialFileName, final String filename,
                                           final int n, final int m,
                                           final boolean missingCoefficientsAllowed)
        throws IOException, ParseException,
        PatriusException {
        final PotentialCoefficientsProvider provider = getModel(potentialFileName, filename,
            missingCoefficientsAllowed);
        return new CunninghamAttractionModel(FramesFactory.getITRF(), provider.getAe(), provider.getMu(),
     ...
     * @since 3.4
     */
    public static ForceModel getDroziner(final GravityFieldNames potentialFileName, final String filename,
                                         final int n, final int m,
                                         final boolean missingCoefficientsAllowed)
        throws IOException, ParseException,
        PatriusException {
        final PotentialCoefficientsProvider provider = getModel(potentialFileName, filename,
            missingCoefficientsAllowed);
        return new DrozinerAttractionModel(FramesFactory.getITRF(), provider.getAe(), provider.getMu(), provider.getC(
