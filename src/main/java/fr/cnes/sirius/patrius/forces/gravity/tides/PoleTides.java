    ...
    public void updateCoefficientsCandS(final AbsoluteDate date) throws PatriusException {
        ...
        if (this.solidContributionFlag || this.oceanicContributionFlag) {
            ...
            if (this.solidContributionFlag) {
                ...
                final double dc21 = -1.333e-9 * (m1 + 0.0115 * m2);
                final double ds21 = -1.333e-9 * (m2 - 0.0115 * m1);
            ...
            if (this.oceanicContributionFlag) {
                // Delta on coefficients C21 and S21
                final double dc21 = -2.1778e-10 * (m1 + 0.01724 * m2);
                final double ds21 = -1.7232e-10 * (m2 - 0.03365 * m1);
                this.coefficientsC[2][1] += dc21;
                this.coefficientsS[2][1] += ds21;
            }
        }
