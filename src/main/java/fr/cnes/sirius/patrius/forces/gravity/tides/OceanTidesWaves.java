...
final class OceanTidesWaves {
     ...
     */
    private static final TreeMap<Double, Double> HEIGHTS_P = new TreeMap<Double, Double>();
    /**
     * Wave heights data - secondary
     */
    private static final TreeMap<Double, Double> HEIGHTS_S = new TreeMap<Double, Double>();
    /**
     * Wave names data - main
     */
    private static final TreeMap<String, Double> NAMES_P = new TreeMap<String, Double>();
