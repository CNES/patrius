 ...
 */
public class DrozinerAttractionModel extends Parameterizable implements ForceModel, GradientModel,
    AttractionModel {
    ...
    public DrozinerAttractionModel(final Frame centralBodyFrameIn,
        ...
        this.centralBodyFrame = centralBodyFrameIn;
        this.k = 1.;
    ...
    public Vector3D computeAcceleration(final SpacecraftState state) throws PatriusException {
        ...
        final Transform bodyToInertial = this.centralBodyFrame.getTransformTo(state.getFrame(),
            state.getDate());
        ...
        Vector3D gamma = GravityToolbox.computeDrozinerAcceleration(pv, this.centralBodyFrame, this.c, this.s,
    ...
    public final Vector3D computeAcceleration(final PVCoordinates pv, final AbsoluteDate date)
                                                                                              throws PatriusException {
        return GravityToolbox.computeDrozinerAcceleration(pv, this.centralBodyFrame, this.c,
