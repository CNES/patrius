...
public abstract class AbstractTides extends JacobiansParameterizable implements ForceModel, GradientModel,
    ...
    public Vector3D computeAcceleration(final PVCoordinates pv, final Frame frame,
        ...
        final Transform fromBodyFrame = this.bodyFrame.getTransformTo(frame, date);
        final Transform toBodyFrame = fromBodyFrame.getInverse();
        final Vector3D positionInBodyFrame = toBodyFrame.transformPosition(pv.getPosition());
        return GravityToolbox.computeBalminoAcceleration(positionInBodyFrame, this.coefficientsC,
    ...
    public final void addDAccDState(final SpacecraftState s,
        ...
        if (this.computeGradientPosition()) {
            ...
            final double[][] dAdP = GravityToolbox.computeDAccDPos(positionInBodyFrame, this.paramAe.getValue(),
