...
public class ForceModelsData {
    ...
    private SolarRadiationPressure solarRadiationPressure;
     ...
     * @param solarRadiationPressureIn model of the solar radiation pressure
    ...
    public ForceModelsData(final ForceModel earthPotentialAttractionModelIn,
                           ...
                           final SolarRadiationPressure solarRadiationPressureIn,
        ...
        this.solarRadiationPressure = solarRadiationPressureIn;
    ...
    public void updateAssembly(final Assembly assembly) throws PatriusException {
        ...
        if (this.solarRadiationPressure != null) {
            this.solarRadiationPressure = new SolarRadiationPressure(this.solarRadiationPressure, assembly);
        }
     ...
     */
    public SolarRadiationPressure getSolarRadiationPressure() {
        return this.solarRadiationPressure;
    }

    /**
     * @param srp the solar radiation pressure to set
     */
    public void setSolarRadiationPressure(final SolarRadiationPressure srp) {
        this.solarRadiationPressure = srp;
    }
    ...
    public List<ForceModel> getForceModelsList() {
        ...
        addModel(this.earthPotentialAttractionModel, forceModelList);
        addModel(this.solarRadiationPressure, forceModelList);
        addModel(this.rediffusedRadiationPressure, forceModelList);
        addModel(this.moonThirdBodyAttraction, forceModelList);
        addModel(this.sunThirdBodyAttraction, forceModelList);
        addModel(this.venusThirdBodyAttraction, forceModelList);
        addModel(this.marsThirdBodyAttraction, forceModelList);
        addModel(this.jupiterThirdBodyAttraction, forceModelList);
        addModel(this.oceanTides, forceModelList);
        addModel(this.terrestrialTides, forceModelList);
        addModel(this.dragForce, forceModelList);
        addModel(this.coriolisRelativisticEffect, forceModelList);
        addModel(this.lenseThirringRelativisticEffect, forceModelList);
        addModel(this.schwarzschildRelativisticEffect, forceModelList);
     ...
     */
    private static void addModel(final ForceModel force, final List<ForceModel> list) {
        if (force != null) {
            list.add(force);
        }
    }
