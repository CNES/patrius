...
public class VariablePotentialAttractionModel extends JacobiansParameterizable implements ForceModel,
    ...
    public VariablePotentialAttractionModel(final Frame centralBodyFrame,
        ...
        initStaticData(provider, this.setData, this.cDataNormed, this.sDataNormed, this.cData, this.sData, this.d,
            this.o);
        if (this.computeGradientPosition()) {
            initStaticData(provider, this.setPDData, this.cPDDataNormed, this.sPDDataNormed, this.cPDData,
     ...
     *        order
     */
    private static void initStaticData(final VariablePotentialCoefficientsProvider provider,
