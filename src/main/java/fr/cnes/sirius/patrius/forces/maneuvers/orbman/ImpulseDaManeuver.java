...
public class ImpulseDaManeuver extends ImpulseManeuver implements ImpulseParKepManeuver {
     ...
     */
    public ImpulseDaManeuver(final EventDetector inTrigger, final double da, final double isp,
     ...
     */
    public ImpulseDaManeuver(final EventDetector inTrigger, final double da, final PropulsiveProperty engine,
    ...
    public void computeDV(final SpacecraftState state) {
        ...
        this.deltaVSat = new Vector3D(vAfter - vBefore, 0., 0.);
    }
