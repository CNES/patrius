...
public class ManeuversSequence {
     ...
     */
    private final Set<ContinuousThrustManeuver> continueManeuvers = new HashSet<ContinuousThrustManeuver>();

    /**
     * List containing all the impulse maneuvers. A HashSet has been used because the order of its
     * elements is not important.
     */
    private final Set<ImpulseManeuver> impulseManeuvers = new HashSet<ImpulseManeuver>();
     ...
     */
    private final Set<AbsoluteDateInterval> maneuverIntervals = new HashSet<AbsoluteDateInterval>();
    ...
    public List<Maneuver> getManeuversList() {
        final List<Maneuver> res = new ArrayList<Maneuver>();
