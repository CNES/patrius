...
public class RediffusedFlux {
     ...
     * @param satProvider
     *        satellite PV coordinates provider
     * @param d
     *        date of computing
     * @param model
     *        emissivity model
     * @throws PatriusException
     *         when orekit error occurred
     * 
     * @since 1.2
     */
     ...
     *        emissivity model
     * @param inIr
     *        computing indicator of the infrared force
     * @param inAlbedo
     *        computing indicator of the albedo force
     * @throws PatriusException
     *         when orekit error occurred
     * 
     * @since 1.2
    ...
    private void computingRediffusedFlux(final int nSurfaces,
        ...
        final double latitudeNadir = geoSat.getLLHCoordinates(LLHCoordinatesSystem.ELLIPSODETIC).getLatitude();
        final double longitudeNadir = geoSat.getLLHCoordinates(LLHCoordinatesSystem.ELLIPSODETIC).getLongitude();
     ...
     *
     * @param numSurface
     *        total number of elementary surfaces
     * @param eA
     *        albedo emissivity
     * @param eIR
     *        infrared emissivity
     * @param latitudeSurface
     *        latitude of elementary surface
     * @param longitudeSurface
     *        longitude of elementary surface
     * @param sunPV
     *        sun position
     * @param satPV
     *        satellite position
     ...
     * @since 1.2
     */
    private ElementaryFlux getElementaryFlux(final double numSurface, final double eA, final double eIR,
                                             final double latitudeSurface, final double longitudeSurface,
