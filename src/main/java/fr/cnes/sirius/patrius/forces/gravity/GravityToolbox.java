...
public final class GravityToolbox {
    ...
    public static Vector3D
        ...
        helm.computeHelmholtzPolynomial(positionInBodyFrame);
        ...
        final double x = positionInBodyFrame.getX();
        final double y = positionInBodyFrame.getY();
        final double z = positionInBodyFrame.getZ();
        final double rsatel = positionInBodyFrame.getNorm();
    ...
    public static Vector3D computeDrozinerAcceleration(final Vector3D positionInBodyFrame,
        ...
        // Get the components of the position in body frame
        final double xBody = positionInBodyFrame.getX();
        final double yBody = positionInBodyFrame.getY();
        final double zBody = positionInBodyFrame.getZ();
    ...
    // Reason: Orekit code kept as such
    public static Vector3D computeCunninghamAcceleration(final Vector3D positionInBodyFrame,
    ...
    // Reason: Orekit code kept as such
    public static double[][] computeDAccDPos(final Vector3D positionInBodyFrame,
                                             final double equatorialRadius,
                                             final double mu, final double[][] c, final double[][] s) {
        // CHECKSTYLE: resume MethodLength check
        // CHECKSTYLE: resume CyclomaticComplexity check
        // Components of the satellite position in the given frame
        final double x = positionInBodyFrame.getX();
        final double y = positionInBodyFrame.getY();
        final double z = positionInBodyFrame.getZ();
        final double x2 = x * x;
