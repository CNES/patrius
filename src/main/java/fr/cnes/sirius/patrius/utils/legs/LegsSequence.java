...
public interface LegsSequence<L extends Leg> extends TimeSequence<L> {
     ...
     *
     * @return A {@code Set} of legs starting at the same date than the given {@code leg}. At least, that {@code Set}
     *         contains the given {@code leg}.
     *
    ...
    /** {@inheritDoc} */
    @Override
    LegsSequence<L> sub(final L fromLeg,
            final L toLeg);
     ...
     *         Elements exactly on the interval boundaries are included only if {@code strict} = false.
     */
     ...
     *
     * @return A new {@code Sequence} object including all elements from the “beginning” to the given one (included only
     ...
     *        true if boundary shall not be included in the extracted sequence, false otherwise.
     *
     * @return A new {@code Sequence} object including all elements from the given one (included only
     ...
     *        Any element of this sequence.
     *
     * @return A new {@code Sequence} object including all elements from the given one (included) to the “end” of the
     *         sequence.
     */
