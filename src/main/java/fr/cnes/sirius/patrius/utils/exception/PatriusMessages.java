...
public enum PatriusMessages implements Localizable {
    ...
    PDB_REDUNDANT_RADIATIVE_PROPERTIES(
            "The part must have only one radiative property (SPHERE or FACET)"),
    /** Error message for aero model: redundant aero properties. */
    PDB_REDUNDANT_AERO_PROPERTIES(
            "The part must have only one aerodynamic property (SPHERE or FACET)"),
    /** Error message for mass model: redundant mass/tank properties. */
    PDB_REDUNDANT_MASS_TANK_PROP(
            "The part can have either a Tank property or a Mass property, not both"),
    ...
    PDB_INVALID_VECTORS_FOR_SECTOR_FIELD(
            "the angle from the pole vector to V1 must be greater than the angle "
    ...
    PDB_UNSUPPORTED_PARAMETER_5(
            "unsupported parameter name {0}: supported names {1}, {2}, {3}, {4}, {5}"),
    /** unsupported parameter. */
    ...
    PDB_NORTHING_OUT_OF_RANGE(
            "northing value out of range : maximum value is {0} but actual value is {1}"),
    /** easting value out of range. */
    PDB_EASTING_OUT_OF_RANGE(
            "easting value out of range : maximum value is {0} but actual value is {1}"),
    ...
    PDB_LATITUDE_OUT_OF_RANGE(
            "The latitude to convert ({0} degrees) is out of range (i.e : > {1} degrees)"),
    /**
     * Error message for the vehicle : no required drag and lift if main shape is not a sphere and
     * has solar panels.
     */
    PDB_NO_AERO_PROP(
            "Inconsistent vehicle for aero properties : main shape is not a sphere and the"
     ...
     * position).
     */
    PDB_AERO_DERIVATIVES_COMPUTATION_ERROR(
            "Partial derivatives wrt position for AeroModel can't be computed"
                    + "since derivatives wrt velocity are deactivated"),
    /** Wrong interpolated drag coefficients file format (wrong number of columns). */
    PDB_WRONG_COLUMNS_NUMBER(
            "Provided interpolated drag coefficients file has wrong number of columns ({0} instead "
                    + "of {1} + {2})"),
    ...
    UNKNOWN_TRANSITION_PARAMETER(
            "unsupported transition points parameter name: supported names {0}, {1}, {2}"),
    /** Not implemented yet. */
    NOT_IMPLEMENTED("Not implemented yet"),
    /** Main wave missing. */
    MAIN_WAVE_MISSING(
            "One of the main waves is has not been found in the file : can't compute admittance"),
    ...
    ATTITUDE_LAW_ALREADY_IN_THE_SEQUENCE(
            "The attitude law with the selected code is already in the sequence"),
    /** Message. */
    ATTITUDE_DYNAMICS_ELEMENTS_NOT_AVAILABLE(
            "Unable to compute spin derivatives for attitude law {0}"),
    /** Message. */
    ATTITUDE_SPIN_DERIVATIVES_NOT_AVAILABLE(
            "Unable to compute spin derivative for attitude law {0}"),
    /** Message. */
    ...
    /** Message. */
    ADD_STATES_MASS_MISMATCH(
            "names in the part names list of mass model are not included in the additional "
                    + "states map"),
    /** Message. */
    ...
    /** Message. */
    WRONG_CORRESPONDENCE_STATES_EQUATIONS(
    ...
    /** Message. */
    CCSDS_ORBIT_DATA_MESSAGE_UNEXPECTED_UNIT(
            "unexpected unit \"{0}\" in CCSDS Orbit Data Message, expected \"{1}\""),
    /** Message. */
    CCSDS_ORBIT_DATA_MESSAGE_UNSUPPORTED_FRAME(
    ...
    /** Message. */
    CCSDS_ORBIT_DATA_MESSAGE_UNSUPPORTED_TIME_SYSTEM(
    ...
    /** Message. */
    CCSDS_ORBIT_DATA_MESSAGE_MISSING_GM(
    ...
    /** Message. */
    ADDITIONAL_EQUATION_NAME_ALREADY_IN_USE(
            "name \"{0}\" is already used for an additional equation"),
    /** Message. */
    ADDITIONAL_STATE_WRONG_TOLERANCES_SIZE(
    ...
    POSITION_PARALLEL_TO_VELOCITY(
            "the position is parallel to the velocity, impossible to compute the normal to the trajectory plane "
                    + "vector."),
    /** Message. */
    OUT_OF_RANGE_DATE_FOR_ATTITUDE_LAW(
            "the date is outside the interval of validity of the attitude law"),
    /** Message. */
    ...
    /** Message. */
    ATTITUDE_LAW_NOT_IN_THE_SEQUENCE(
            "the attitude law in input is not a element of the attitude laws sequence"),
    /** Message. */
    ATTITUDE_LAW_AT_EDGE_SEQUENCE(
            "the attitude law in input is the starting (ending) element of the sequence, "
                    + "therefore there is no previous " + "(next) element"),
    /** Message. */
    UNCOMPUTED_SLEW("the slew has not been computed."),
    /** Message. */
    UNSUPPORTED_SLOPE_SELECTION_TYPE(
            "the event type can only be INCREASING, DECREASING or INCREASING_DECREASING"),
    /** Message. */
    ...
    /** Message. */
    MANEUVER_AMPLITUDE_EXCEEDS_FIXED_MAXIMUM_VALUE(
            "The rotation amplitude exceeds the limit value theta max"),
    /** Message. */
    ...
    /** Message. */
    SINGLE_ATTITUDE_TREATMENT_EXPECTED(
            "The requested action does not correspond with a single attitude treatment"),
    /** Message. */
    ...
    /** Message. */
    DATE_OUTSIDE_LEGS_SEQUENCE_INTERVAL(
            "The requested date : {0} is not in the legs sequence interval : {1}"),
    /** Message. */
    DATE_OUTSIDE_ATTITUDE_SEQUENCE("The requested date : {0} is not in the attitude sequence"),
    /** Message. */
    NOT_ENOUGH_INTERPOLATION_POINTS(
            "There is {0} points while there should be at least {1} entries"),
    /** Message. */
    ...
    /** Message. */
    WRONG_INVERSE_TRIGONOMETRIC_FUNCTION_ARGUMENT(
    ...
    /** Message. */
    UNEXPECTED_ATMOSPHERE_MODEL(
            "Harris Priester atmosphere model does not support speed of sound computation"),
    /** Message. */
    MONO_MULTI_DETECTOR(
    ...
    /** Message. */
    NOT_GRADIENT_MODEL(
            "Provided force model is not a gradient model. Cannot compute partial derivatives using finite "
                    + "differences"),
    /** Message. */
    ...
    CONTRACTION_CRITERIA_SMALLER_THAN_ONE("contraction criteria smaller than one ({0}).  "
            ...
            + "contraction as an internal storage array length "
            + "equal to the number of elements would satisfy the" + "contraction criteria."),
    /** Message. */
    ...
    OUT_OF_ORDER_ABSCISSA_ARRAY(
            "the abscissae array must be sorted in a strictly increasing order, but "
    ...
    INVALID_PARAMETERS_COUNT_NOT_MATCH_ORBITS_NUMBER(
            ...
            + "({0} != {1})"),
    /** Message. */
    NEGATIVE_PARAMETERS_COUNT(
            "Negative additional parameters count: {0} was supplied for orbit number {1}"),
    /** Message. */
    ...
    /** Message. */
    PARAM_DESCRIPTORS_COLLECTION_DUPLICATES(
            "The collection of parameter descriptors contains duplicates"),
    /** Message. */
    ...
    /** Message. */
    UNSUPORTED_COMBINATION_DRAG_LIFT_COEFFICIENTS(
            "Unsupported combination of Drag and Lift coefficients functions."),
    /** Message. */
    ...
    /** Message. */
    SUM_RADIATIVE_COEFFICIENT_NOT_1(
            "Sum of radiative coefficients for visible domain is different from 1"),
    /** Message. */
    SUM_RADIATIVEIR_COEFFICIENT_NOT_1(
            "Sum of radiative coefficients for infrared domain is different from 1"),
    /** Message. */
    ...
    /** Message. */
    METHOD_NOT_AVAILABLE_LIU(
            "This method (propagateMeanOrbit) is not available for Liu propagator."),
    /** Message. */
    ...
    /** Message. */
    METHOD_NOT_AVAILABLE_TABULATED_SLEW(
            "This method (compute) is not available for the class TabulatedSlew"),
    /** Message. */
    METHOD_NOT_AVAILABLE_ANGUAR_VELOCITIES_POLYNOMIAL_SLEW(
            "This method (compute) is not available for the "
    ...
    /** Message. */
    NOT_PERFORMED_DECOMPOSITION(
            "Matrix decomposition has not been performed. Decomposed matrices are null!"),
    /** Message. */
    ...
    /** Message. */
    COWELL_REQUIRES_CARTESIAN_COORDINATES(
            "Cowell integrator requires propagation is cartesian coordinates."),
    /** Message. */
    ...
    /** Message. */
    UNAVAILABLE_FACETCELESTIALBODY_INTERSECTION_POINT_METHOD(
            "Method getIntersectionPoint(altitude) is not available "
                    + "for FacetCelestialBody objects."),
    /** Message. */
    CHEBYCHEV_POLYNOMIALS_NOT_SAME_RANGE(
            ...
            + "range [{2}, {3}]."),
    /** Message. */
    CHEBYCHEV_POLYNOMIAL_OUT_OF_RANGE(
            "The argument {0} is not in the Chebyshev polynomial range [{1}, {2}]."),
    /** Message. */
    ...
    public String getLocalizedString(final Locale locale) {
        ...
        try {
            final ResourceBundle bundle = ResourceBundle.getBundle(
                    "META-INF/localization/PatriusMessages", locale);
