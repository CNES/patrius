...
public final class ToCelestialBodyCenterDirection implements ITargetDirection {
    ...
    public Vector3D getVector(final PVCoordinatesProvider origin, final AbsoluteDate date, final Frame frame)
        ...
        final Frame bodyCenteredFrame = this.body.getInertialFrame(IAUPoleModelType.TRUE);
        final Vector3D bodyCenterInFrame = bodyCenteredFrame.getPVCoordinates(date, frame).getPosition();
    ...
    public PVCoordinates getTargetPVCoordinates(final AbsoluteDate date, final Frame frame) throws PatriusException {
        ...
        return bodyCenteredFrame.getPVCoordinates(date, frame);
    }
    ...
    public Vector3D getVector(final PVCoordinatesProvider origin, final SignalDirection signalDirection,
        ...
        return getVector(origin, getTargetPvProvider(), signalDirection, correction, date, fixedDateType, frame,
                epsilon, this.body.getInertialFrame(IAUPoleModelType.TRUE));
    }
    ...
    public Line getLine(final PVCoordinatesProvider origin, final SignalDirection signalDirection,
        ...
        final Frame frozenFrame = this.body.getInertialFrame(IAUPoleModelType.TRUE).getFrozenFrame(
    ...
    private class TargetPVCoordinatesProvider implements PVCoordinatesProvider {
        ...
        public Frame getNativeFrame(final AbsoluteDate date, final Frame frame) throws PatriusException {
            return ToCelestialBodyCenterDirection.this.body.getNativeFrame(date, frame);
        }
    }
}
