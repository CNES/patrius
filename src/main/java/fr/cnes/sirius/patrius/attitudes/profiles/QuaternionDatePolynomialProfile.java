 ...
 * @since 4.11
 */
public final class QuaternionDatePolynomialProfile extends AbstractAttitudeProfile {
    ...
    public QuaternionDatePolynomialProfile copy(final AbsoluteDateInterval newInterval) {
        ...
        final QuaternionDatePolynomialProfile res =
            new QuaternionDatePolynomialProfile(new Frame(this.referenceFrame, Transform.IDENTITY,
                this.referenceFrame.getName()), newInterval, this.segments, getNature(), getSpinDeltaT());
        // Set the flag for the spin derivatives computation
