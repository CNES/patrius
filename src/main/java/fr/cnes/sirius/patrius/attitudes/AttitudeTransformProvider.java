 ...
 *
 * <p>Spin derivative is computed when required and correspond to spin derivative of underlying attitude law.</p>
 * <p>Frames configuration is unused.</p>
 * 
 * @serial given the attributs {@link AttitudeLaw} and {@link PVCoordinatesProvider} an instance of
...
public class AttitudeTransformProvider implements TransformProvider {
     ...
     *        the parent frame.
     */
    protected AttitudeTransformProvider(final AttitudeLaw law, final PVCoordinatesProvider pv, final Frame frame) {
     ...
     * {@inheritDoc}
     * <p>
     * Spin derivative is computed when required and correspond to spin derivative of underlying attitude law.
     * </p>
     */
    @Override
    ...
    public Transform getTransform(final AbsoluteDate date, final FramesConfiguration config,
                                  final boolean computeSpinDerivatives) throws PatriusException {
        /*
         * the attitude given by the law at a specified date defines a base (reference frame, rotation and angular
         ...
         */
        this.attlaw.setSpinDerivativesComputation(computeSpinDerivatives);
        final Attitude attitude = this.attlaw.getAttitude(this.pvProv, date, this.refFrame);
