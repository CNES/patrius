...
public interface OrientationAngleProvider extends Serializable {
    ...
    /**
     * Build an {@link OrientationAngleProvider} from this.
     *
     * @param function
     *        input function
     * @return an orientation angle provider
     */
    static OrientationAngleProvider build(final UnivariateDateFunction function) {
        return new OrientationAngleProvider(){

            /** Serializable UID. */
            private static final long serialVersionUID = -7738039613071816818L;
