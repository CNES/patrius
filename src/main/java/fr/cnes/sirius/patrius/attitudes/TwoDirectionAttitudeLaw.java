 ...
 * VERSION:4.11:DM:DM-3242:22/05/2023:[PATRIUS] Parametres circulaires adaptes pour orbites hyperboliques
 ...
 * {@link #getAttitude(PVCoordinatesProvider, AbsoluteDate, Frame)} method.
 * </p>
 *
 ...
 * @author Julie Anton
 *
 * @version $Id: TwoDirectionAttitudeLaw.java 17582 2017-05-10 12:58:16Z bignon $
 *
 * @since 1.2
 *
 */
public class TwoDirectionAttitudeLaw extends AbstractAttitudeLaw {
     ...
     * differences (0.2s for spin, 0.001s for spin derivative). <br>
     * If the two directions are collinear at provided date, an exception will be thrown in the
     * {@link #getAttitude(PVCoordinatesProvider, AbsoluteDate, Frame)} method.
     *
     ...
     */
    public TwoDirectionAttitudeLaw(final IDirection firstDirection, final IDirection secondDirection,
    ...
    /**
     * {@inheritDoc} <br>
     * If the two directions of this TwoDirectionAttitudeLaw are collinear at provided date, an exception will be
     * thrown.
     */
    @Override
    ...
    private OrientationFunction getOrientationFunction(final PVCoordinatesProvider pvProv, final Frame frame,
        ...
        return new AbstractOrientationFunction(zeroAbscissa){
            ...
            public Rotation getOrientation(final AbsoluteDate date) throws PatriusException {
                return TwoDirectionAttitudeLaw.this.computeOrientation(pvProv, date, frame);
            }
        };
    }
    ...
    private Vector3DFunction getSpinFunction(final PVCoordinatesProvider pvProv, final Frame frame,
        ...
        return new AbstractVector3DFunction(zeroAbscissa, new FiniteDifferencesDifferentiator(4, this.stepAcc)){
            ...
            public Vector3D getVector3D(final AbsoluteDate date) throws PatriusException {
                final OrientationFunction rot = TwoDirectionAttitudeLaw.this
                    .getOrientationFunction(pvProv, frame, date);
                return rot.estimateRateFunction(TwoDirectionAttitudeLaw.this.stepSpin, AbsoluteDateInterval.INFINITY)
                        .getVector3D(date);
            }
        };
    }
