...
public class AttitudeFrame extends Frame {
     ...
     * @param attitudeLaw
     *        the spacecraft attitude law
     * @param referenceFrame
     *        the parent frame
     * @throws PatriusException
     *         if a problem occurs during frames transformations
     */
    public AttitudeFrame(final PVCoordinatesProvider pvProvider, final AttitudeLaw attitudeLaw,
        final Frame referenceFrame) throws PatriusException {
        super(referenceFrame, new AttitudeTransformProvider(attitudeLaw, pvProvider, referenceFrame), SATELLITE_FRAME);
        this.attlaw = attitudeLaw;
    }

    /**
     * @return the attitude law defining the orientation of the frame.
     */
