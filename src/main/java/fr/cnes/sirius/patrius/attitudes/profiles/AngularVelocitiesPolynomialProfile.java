...
public class AngularVelocitiesPolynomialProfile extends
        StrictAttitudeLegsSequence<AngularVelocitiesPolynomialProfileLeg> implements
        AttitudeProfile {
     ...
     */
    public AngularVelocitiesPolynomialProfile(
    ...
    /**
     * @return the map containing the coefficients of the polynomial function representing x, and
     *         their
    ...
    /**
     * @return the map containing the coefficients of the polynomial function representing y, and
     *         their time
    ...
    /**
     * @return the map containing the coefficients of the polynomial function representing z, and
     *         their time interval
     *         of validity.
     */
    ...
    /** {@inheritDoc} */
    @Override
    public AngularVelocitiesPolynomialProfile copy(final AbsoluteDateInterval newInterval, final boolean strict) {
     // Check that the new interval is included in the old interval
        ...
        // interval
        final List<AngularVelocitiesPolynomialProfileLeg> legs = new ArrayList<>();
        ...
        final AngularVelocitiesPolynomialProfile res = new AngularVelocitiesPolynomialProfile(legs,
                getNature());
    ...
    /** {@inheritDoc} */
    @Override
    public AngularVelocitiesPolynomialProfile sub(final AbsoluteDate fromT, final AbsoluteDate toT,
        ...
        if (isEmpty()) {
            // Empty case
            return new AngularVelocitiesPolynomialProfile("");
        }
        // Standard case
        final SortedSet<TimeStamped> subSet = getSet().subSet(fromT, !strict, toT, !strict);
        final AngularVelocitiesPolynomialProfile subSequence = new AngularVelocitiesPolynomialProfile(
                getNature());
    ...
    /** {@inheritDoc} */
    @Override
    public AngularVelocitiesPolynomialProfile sub(final AbsoluteDateInterval interval,
            final boolean strict) {
    ...
    /** {@inheritDoc} */
    @Override
    public AngularVelocitiesPolynomialProfile head(final AbsoluteDate toT, final boolean strict) {
        if (toT == null) {
            // Null case: exception
            throw PatriusException
                    .createIllegalArgumentException(PatriusMessages.LEG_CANNOT_BE_NULL);
        ...
        final AngularVelocitiesPolynomialProfile headSequence = new AngularVelocitiesPolynomialProfile(
                getNature());
    ...
    /** {@inheritDoc} */
    @Override
    public AngularVelocitiesPolynomialProfile head(final AbsoluteDate toT) {
        return head(toT, false);
    }

    /** {@inheritDoc} */
    @Override
    public AngularVelocitiesPolynomialProfile tail(final AbsoluteDate fromT, final boolean strict) {
        if (fromT == null) {
            // Null case: exception
            throw PatriusException
                    .createIllegalArgumentException(PatriusMessages.LEG_CANNOT_BE_NULL);
        ...
        final AngularVelocitiesPolynomialProfile tailSequence = new AngularVelocitiesPolynomialProfile(
                getNature());
    ...
    /** {@inheritDoc} */
    @Override
    public AngularVelocitiesPolynomialProfile tail(final AbsoluteDate fromT) {
