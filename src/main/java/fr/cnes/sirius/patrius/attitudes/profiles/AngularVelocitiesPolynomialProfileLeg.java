    ...
    private static final class Polynomial3DFunction implements Vector3DFunction, Serializable {
        ...
        public Vector3DFunction nthDerivative(final int order) {
            ...
            for (int i = 1; i <= order; ++i) {
                xNthDer = normalizeFunction(xNthDer.polynomialDerivative(), this.duration);
                yNthDer = normalizeFunction(yNthDer.polynomialDerivative(), this.duration);
                zNthDer = normalizeFunction(zNthDer.polynomialDerivative(), this.duration);
            }
