...
public class LofOffsetPointing extends AbstractGroundPointing {
    ...
    /** {@inheritDoc} */
    @Override
    protected Vector3D getTargetPosition(final PVCoordinatesProvider pvProv,
                                         final AbsoluteDate date, final Frame frame) throws PatriusException {
