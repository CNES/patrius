...
public class Frame implements Serializable {
    ...
    public Transform getTransformTo(final Frame destination, final AbsoluteDate date, final FramesConfiguration config,
        ...
        if (this == referential && destination == destination.referential) {
            ...
            final Transform instanceToInstanceReferential = getTransformTo(referential, date, config,
            ...
            // destination frame
            final Transform instanceReferentialToDestinationReferential = referential.getTransformTo(
...
//        }
    ...
    private static final class LazyRootHolder {
        ...
        /** Unique instance. */
        private static final Frame INSTANCE = new Frame("ICRF", true){
