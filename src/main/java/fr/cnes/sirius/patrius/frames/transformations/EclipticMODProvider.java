...
/**
 * {@link TransformProvider} for {@link fr.cnes.sirius.patrius.frames.FramesFactory#getEclipticMOD(boolean)}.
 * 
 * <p>
 ...
 * 
 * @version $Id: EclipticMODProvider.java 18074 2017-10-02 16:48:51Z bignon $
 * 
 * @since 1.3
 * @serial serializable.
 */
@SuppressWarnings("PMD.NullAssignment")
public final class EclipticMODProvider implements TransformProvider {
     ...
     */
    private static final double OBLI_1 = 23.439_286_401_75 * MathUtils.DEG_TO_RAD;

    /**
     * Constant for the obliquity formula (rad).
     */
    private static final double OBLI_2 = 0.013_012_396_45 * MathUtils.DEG_TO_RAD;
    ...
    public Transform getTransform(final AbsoluteDate date, final FramesConfiguration config,
        ...
        switch (PatriusConfiguration.getPatriusCompatibilityMode()) {
            ...
            case MIXED_MODELS:
                ...
                obliquity = OBLI_1 - OBLI_2 * t;
                break;

            case NEW_MODELS:
                // obliquity (between 0 and 2PI)
                obliquity = config.getEarthObliquity(date);
                break;
            default:
