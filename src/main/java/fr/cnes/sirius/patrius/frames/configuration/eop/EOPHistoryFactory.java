 ...
 * <ul>Data are automatically loaded based on provided {@link EOP2000HistoryLoader} 
 * and {@link EOP1980HistoryLoader}.</ul>
 * <ul>User can provide its own implementation of these loaders and provide them using 
 * {@link #addEOP2000HistoryLoader(EOP2000HistoryLoader)} (and equivalent for 1980 data).</ul>
 ...
 * <ul>List of loaders can be cleared and reordered using {@link #clearEOP2000HistoryLoaders()} and equivalent for
 * 1980 data.</ul>
 * </p>
 * <p>
