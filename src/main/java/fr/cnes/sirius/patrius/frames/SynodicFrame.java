...
public class SynodicFrame extends Frame {
    ...
    private static final class FrameTranslation implements TransformProvider {
        ...
        /**
         * Normalized center position along X-axis: 1 means this frame is equal to provided LOF, 0 means this frame is
         * translated around LOF parent frame.
         */
         ...
         * @param normalizedCenterPosition
         *        normalized center position along X-axis: 1 means this frame is equal to provided LOF, 0 means this
         *        frame
         *        is translated around LOF parent frame
         */
