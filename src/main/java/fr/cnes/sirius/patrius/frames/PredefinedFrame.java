 ...
 * 
 * @serial an instance of PredefinedFrame is serializable,
 *         only the factory Key name is serialized as it allows to define
 *         entierly a PredefinedFrame.
...
public class PredefinedFrame extends CelestialBodyFrame {
    ...
    private final PredefinedFrameType factoryKey;
     ...
     *        key of the frame within the factory
     */
    public PredefinedFrame(final Frame parent, final TransformProvider transformProvider,
        final boolean pseudoInertial, final PredefinedFrameType factoryKeyIn) {
        super(parent, transformProvider, factoryKeyIn.getName(), pseudoInertial, null);
     ...
     */
    public PredefinedFrameType getFactoryKey() {
     ...
     * </p>
     * <p>
     * This conception pattern ensures that at most one instance of each {@link PredefinedFrame} exists even if it
    ...
    private static final class SerializationProxy implements Serializable {
         ...
         *        key of the frame.
         */
        private SerializationProxy(final PredefinedFrameType factoryKey) {
        ...
        private Object readResolve() throws ObjectStreamException {
            try {
                ...
                return FramesFactory.getFrame(PredefinedFrameType.valueOf(this.factoryKeyName));
