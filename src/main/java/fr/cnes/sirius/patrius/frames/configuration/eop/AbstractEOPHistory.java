...
public abstract class AbstractEOPHistory implements Serializable, EOPHistory {
    ...
    private static final int OPTIMAL_CACHE_SIZE = 3;
     ...
     */
    private EOPEntry[] getEOPEntryArray() {
    ...
    private static class DoubleInterpolationFunctionBuilder
        implements TimeStampedInterpolationFunctionBuilder<EOPEntry, Double> {

        /** Serializable UID. */
        private static final long serialVersionUID = 5100897572222997590L;
      
        /** Function linking the EOP entries to {@link Double} values. */
        private final ToDoubleFunction<EOPEntry> func;
         ...
         *        Function linking the EOP entries to {@link Double} values
         */
        public DoubleInterpolationFunctionBuilder(final ToDoubleFunction<EOPEntry> func) {
            this.func = func;
        }

        /** {@inheritDoc} */
        @Override
        public Function<AbsoluteDate, ? extends Double> buildInterpolationFunction(final EOPEntry[] samples,
                                                                                   final int indexInf,
                                                                                   final int indexSup) {
    ...
    private static class LagrangeDoubleInterpolationFunction implements Function<AbsoluteDate, Double> {
         ...
         *        Function linking the EOP entries to {@link Double} values
         */
        public LagrangeDoubleInterpolationFunction(final EOPEntry[] samples, final int indexInf,
                final int indexSup, final ToDoubleFunction<EOPEntry> func) {
