...
public class BentModel implements IonosphericCorrection {
    ...
    /** Serializable UID. */
    private static final long serialVersionUID = 8041374228655106336L;
    /** Q3T5 */
    ...
    /** YMTAB */
    private static final double[] YMTAB0 = { 87.7, 93., 97.8, 102., 102.3, 99.4, 95.1, 91.3, 88., 86.8, 86., 85.2 };
    /** YMTAB */
    private static final double[] YMTAB1 = { 96.2, 98., 103.8, 109.5, 112.5, 112.5, 107.5, 101.2, 96.2, 95.4, 97., 
        98.1 };
    /** YMTAB */
    private static final double[] YMTAB2 = { 107.6, 117.7, 140.1, 150.4, 153.3, 154., 150., 140.2, 127.1, 115.5, 109.2,
        106.5 };
    /** YMTAB */
    private static final double[] YMTAB3 = { 114.4, 125.5, 144.2, 162.7, 175.6, 180.6, 174.8, 157.5, 134.7, 115.,
        110.1, 110. };
    /** YMTAB */
    private static final double[] YMTAB4 = { 113.3, 120.7, 134.9, 158.2, 181.6, 190.5, 177., 152.5, 123., 113.4, 111.5,
        110.3 };
    /** YMTAB */
    private static final double[] YMTAB5 = { 113.5, 125.4, 139., 158.6, 199.5, 188.3, 188.3, 166.8, 136.9, 119.9,
        111.9, 108. };
    /** YMTAB */
    private static final double[] YMTAB6 = { 114., 118.2, 125.6, 157., 211.4, 232.3, 211.2, 188.3, 142.5, 124.8, 116.8,
        112.5 };
    /** YMTAB */
    private static final double[] YMTAB7 = { 122.7, 132., 143.3, 158.3, 187.1, 214.4, 196.8, 185.5, 152.5, 130., 120.7,
        117.8 };
    /** YMTAB */
    private static final double[] YMTAB8 = { 140.8, 147.5, 155., 167.8, 200., 195.6, 187., 168.3, 144.4, 138.7, 137.7,
        137.5 };
    /** YMTAB */
    ...
    /** CT */
    private static final double[] CT0 = { 0., 0., .33333333, .26666667, .25714286, .25396825, .25252525 };
    /** CT */
    private static final double[] CT1 = { 0., 0., 0., .2, .22857142, .23809523, .24242424 };
    /** CT */
    private static final double[] CT2 = { 0., 0., 0., 0., .14285714, .19047619, .21212121 };
    /** CT */
    private static final double[] CT3 = { 0., 0., 0., 0., 0., .11111111, .16161616 };
    /** CT */
    private static final double[] CT4 = { 0., 0., 0., 0., 0., 0., .09090909 };
    /** CT */
    private static final double[] CT5 = { 0., 0., 0., 0., 0., 0., 0. };
    /** CT */
    private static final double[] CT6 = { 0., 0., 0., 0., 0., 0., 0. };
    /** CT */
    private static final double[][] CT = { CT0, CT1, CT2, CT3, CT4, CT5, CT6 };

    // coefficients for the year 1960 (JENSEN & CAIN)
    /** G */
    private static final double[] G0 = { 0., .304112, .024035, -.031518, -.041794, .016256, -.019523 };
    /** G */
    private static final double[] G1 = { 0., .021474, -.051253, .062130, -.045298, -.034407, -.004853 };
    /** G */
    private static final double[] G2 = { 0., 0., -.013381, -.024898, -.021795, -0.019447, .003212 };
    /** G */
    private static final double[] G3 = { 0., 0., 0., -.006496, .007008, -.000608, .021413 };
    /** G */
    private static final double[] G4 = { 0., 0., 0., 0., -.002044, .002775, .001051 };
    /** G */
    private static final double[] G5 = { 0., 0., 0., 0., 0., .000697, .000227 };
    /** G */
    private static final double[] G6 = { 0., 0., 0., 0., 0., 0., .001115 };
    /** G */
    private static final double[][] G = { G0, G1, G2, G3, G4, G5, G6 };
    /** H */
    private static final double[] HR0 = { 0., 0., 0., 0., 0., 0., 0. };
    /** H */
    private static final double[] HR1 = { 0., -.057989, .033124, .014870, -.011825, -.000796, -.005758 };
    /** H */
    private static final double[] HR2 = { 0., 0., -.001579, -.004075, .010006, -.002, -.008735 };
    /** H */
    private static final double[] HR3 = { 0., 0., 0., .00021, .00043, .004597, -.003406 };
    /** H */
    private static final double[] HR4 = { 0., 0., 0., 0., .001385, .002421, -.000118 };
    /** H */
    private static final double[] HR5 = { 0., 0., 0., 0., 0., -.001218, -.001116 };
    /** H */
    private static final double[] HR6 = { 0., 0., 0., 0., 0., 0., -.000325 };
    /** H */
    ...
    /** topocentric frame defining the STATION frame */
    private final TopocentricFrame stationTopoFrame;
    /** station latitude */
     ...
     */
    public BentModel(final R12Provider r12Provider, final SolarActivityDataProvider solarActivity,
                     final USKProvider uskProvider, final EllipsoidBodyShape earth, final Vector3D station,
                     final Frame frameSta)
        throws PatriusException {

        // Station point
        final EllipsoidPoint stationPoint = earth.buildPoint(station, frameSta, null, "stationPoint");
        // Initializations
        this.solarAct = solarActivity;
        this.uskProv = uskProvider;
        this.r12Prov = r12Provider;
        this.stationTopoFrame = new TopocentricFrame(stationPoint, "earth");

        this.flat = stationPoint.getLLHCoordinates(LLHCoordinatesSystem.ELLIPSODETIC).getLatitude();
        // Normalization on [0;2PI] as in the original algorithm
        this.flon = MathUtils.normalizeAngle(stationPoint.getLLHCoordinates(LLHCoordinatesSystem.ELLIPSODETIC)
            .getLongitude(), FastMath.PI);
    }
     ...
     * @param uskProvider
     *        provider for the model data
     * @param stationTopoFrame
     *        topocentric frame defining the STATION frame. Warning this frame should only relate to
     *        {@link EllipsoidBodyShape} and {@link EllipsoidPoint}.
     */
    public BentModel(final R12Provider r12Provider, final SolarActivityDataProvider solarActivity,
                     final USKProvider uskProvider, final TopocentricFrame stationTopoFrame) {

        // Initializations
        this.solarAct = solarActivity;
        this.uskProv = uskProvider;
        this.r12Prov = r12Provider;
        this.stationTopoFrame = stationTopoFrame;

        // Build body point from topocentric frame
        final BodyPoint point = stationTopoFrame.getFrameOrigin();

        // Check point is an EllipsoidPoint
        if (!(point instanceof EllipsoidPoint)) {
            throw new PatriusRuntimeException(PatriusMessages.BENT_MODEL_NOT_ELLIPSOID_POINT, null);
        }

        this.flat = point.getLLHCoordinates(LLHCoordinatesSystem.ELLIPSODETIC).getLatitude();
        // Normalization on [0;2PI] as in the original algorithm
        this.flon = MathUtils.normalizeAngle(point.getLLHCoordinates(LLHCoordinatesSystem.ELLIPSODETIC).getLongitude(),
            FastMath.PI);
    }
    ...
    /** {@inheritDoc} */
    @Override
    public double derivativeValue(final Parameter p, final AbsoluteDate date, final Vector3D satellite,
    ...
    /** {@inheritDoc} */
    @Override
    public double computeSignalDelay(final double freq, final AbsoluteDate date, final Vector3D satellite,
                                     final Frame frameSat)
        throws PatriusException {

        // Electronic content computation:
        final double tec = computeElectronicCont(date, satellite, frameSat);
        return CDELTAT / (Constants.SPEED_OF_LIGHT * freq * freq) * tec;
    }

    // CHECKSTYLE: stop MethodLength check
    // CHECKSTYLE: stop CyclomaticComplexity check
    // Reason: complex code kept as such
     ...
     */
    public double computeElectronicCont(final AbsoluteDate date, final Vector3D satellite, final Frame frameSat)
        throws PatriusException {

        // satellite position in the station's topocentric frame
        final Transform t = frameSat.getTransformTo(this.stationTopoFrame, date);
        final Vector3D satInTopoFrame = t.transformPosition(satellite);
        // dist in km
        final double dist = satInTopoFrame.getNorm() / Q1000;

        // satellite azimut and elevation computation in the station's topocentric frame
        final double elev = this.stationTopoFrame.getElevation(satInTopoFrame, this.stationTopoFrame, date);
        final double azim = this.stationTopoFrame.getAzimuth(satInTopoFrame, this.stationTopoFrame, date);

        // date
        final DateTimeComponents components = date.getComponents(TimeScalesFactory.getTT());
        final int mon = components.getDate().getMonth();
        final int iDay = components.getDate().getDay();
        ...
        final int[] ium = uskData.getIum();
        final int[] iuf = uskData.getIuf();
        final double[][] uf = uskData.getUf();
        final double[][] um = uskData.getUm();
        ...
        final double time = tu * hr;

        // satellite altitude HS computation
        final double rsat = MathLib.sqrt(rat * rat + dist * dist + 2.0 * rat * dist * MathLib.sin(elev));
        final double hs = (rsat - rat) * Q1000;

        // flux
        double flux = this.solarAct.getInstantFluxValue(date);
        if (flux <= 0.) {
            flux = s12;
        }
        flux = MathLib.min(FLUXMAX, flux);

        final double dflux = flux - s12;
        ...
        final double[] sincoselev = MathLib.sinAndCos(elev);
        final double[] sincosazim = MathLib.sinAndCos(azim);
        ...
        pos[2] = Q3T5;
        final double te = time - FastMath.PI;
        ...
        while (!endLoop) {
            ...
            final double sf = MathLib.divide(R * cel, R + pos[2]);
            ...
            olat = MathLib.atan(MathLib.divide(snlat, cnlat));
            final double sdlon = MathLib.divide(saz * sa, cnlat);
            final double cdlon = MathLib.sqrt(MathLib.max(0.0, Q1 - sdlon * sdlon));
            olon = this.flon + MathLib.atan(MathLib.divide(sdlon, cdlon));

            // magnetic latitude computation
            final double sml = snlat * SPLAT + cnlat * CPLAT * MathLib.cos(olon - PLON);
            final double cml = MathLib.sqrt(MathLib.max(0.0, Q1 - sml * sml));
            hlat = MathLib.atan(MathLib.divide(sml, cml));
            ...
            final double h3000 = BentModel.uskf(ium, um, c, te);

            hm = (H1 - H2 * h3000 + H3 * h3000 * h3000) * Q1000;
            if (MathLib.abs(pos[2] - hm) < Q1000) {
                endLoop = true;
            } else {
                pos[2] = hm;
            }
        ...
        // call to the first sub method USKF from the associated subroutine.
        double fof2 = BentModel.uskf(iuf, uf, c, te);
        ...
        if (hlat < DG[lat2]) {
            ...
            if (hlat <= DG[lat2]) {
                lat1 = 1;
                if (MathLib.abs(hlat - DG[lat2]) > Precision.DOUBLE_COMPARISON_EPSILON) {
                    lat2 = 2;
                    if (hlat <= DG[lat2]) {
                        lat1 = 2;
                    }
        ...
        if (lat1 != lat2) {
            cnt = cnt + MathLib.divide((CENT[lat2] - CENT[lat1]) * (DG[lat1] - hlat), DG[lat1] - DG[lat2]);
        }

        fof2 = fof2 * (PER * dflux + cnt);
        ...
        hlat = MathLib.abs(hlat);
        double tloc = time + olon + PI2;
        ...
        t1 = t12 - t1;
        int if1 = (int) (fof2 - QP95);
        int if2 = (int) (fof2 - QP05);
        if1 = BentModel.correctIF(if1);
        if2 = BentModel.correctIF(if2);

        double ym = (YMTAB[if1 - 1][lt1 - 1] + (YMTAB[if1 - 1][lt2 - 1] - YMTAB[if1 - 1][lt1 - 1]) * t1) * Q1000;

        ym = computeYM(ym, if1, if2, t1, lt1, lt2, fof2);
        ...
        final double day = (mon - 1) * Q30 + iDay - Q80;
        double dsza = SO1 * MathLib.sin(SO2 * day);
        dsza = computeDSZA(dsza, olat);

        // seasons' effects on YM
        double s12Bis = 4. - dsza / D8;
        if1 = (int) s12Bis;
        double s1 = if1;
        s1 = s12Bis - s1;
        if2 = if1 + 1;
        // computation of ym
        ym = computeYM(t12, tloc, lt1, lt2, t1, s1, if1, if2, ym, hlat);

        // Computation of the XK(I) constants on the profile's higher part
        final double fqf2 = RN4 * fof2;
        int i1 = 2;
        int i2 = 2;
        final int[] i1i2 = checkI1I2(i1, i2, hlat);
        i1 = i1i2[0];
        i2 = i1i2[1];
        ...
        fillXK(j, i1, i2, xf, xk, hlat, flux);

        // Applies saisons effects of dsza to XK
        t12 = tloc / DEG[2] - EIGHT;
        if (t12 < 0.) {
            t12 = t12 + TWENTYFOUR;
        }
        t12 = t12 / 6. + 1.;
        ...
        s12Bis = Q2P5 - dsza / D16;
        if1 = (int) s12Bis;
        s1 = if1;
        s1 = s12Bis - s1;
        if2 = if1 + 1;
        for (int m = 1; m < 4; m++) {
            final double rat1 = RATK[m - 1][lt1 - 1][if1 - 1]
                    + (RATK[m - 1][lt1 - 1][if2 - 1] - RATK[m - 1][lt1 - 1][if1 - 1]) * s1;
            final double rat2 = RATK[m - 1][lt2 - 1][if1 - 1]
                    + (RATK[m - 1][lt2 - 1][if2 - 1] - RATK[m - 1][lt2 - 1][if1 - 1]) * s1;
            final double ratBis = rat1 + (rat2 - rat1) * (t12 - t1);
            xk[m - 1] = xk[m - 1] * ratBis;
        }
        ...
        double conv = 1.;
        if (fof2 > Q10P5) {
            conv = QP1333 * (fof2 - Q10P5) + 1.;
        }
        final double yt = conv * ym;

        // computation of XNTNM
        // Classical parameter TAU or amounting thickness
        final double xntnm = computeXNTNM(ym, xk, yt, hm, hs, dist);

        // computation of the vertical (TOTN) and oblical (TOTNA) electronic content.
        final double totn = xntnm * 1.24e10 * (fof2 * fof2);
        final double ce = MathLib.cos(elev);
        final double rit = R / (R + hm) * (R / (R + hm));
        final double den2 = 1. - rit * (ce * ce);
        final double den = MathLib.sqrt(MathLib.max(0.0, den2));

        return MathLib.divide(totn, den); // the return is the electronic content
    }
     ...
     * @return om
     */
    private static double uskf(final int[] kd, final double[][] d, final double[] c, final double te) {
        ...
        BentModel.completeAs(as, m, d, nff, gG);
        // Computes the bs array for the usk method
        BentModel.completeBs(bs, m, d, nff, gG);
     ...
     *        g
     */
    private static void completeAs(final double[] initAs, final int m, final double[][] d, final int nff,
                                   final double[] gG) {
     ...
     *        g
     */
    private static void completeBs(final double[] initBs, final int m, final double[][] d, final int nff,
                                   final double[] gG) {
     ...
     */
    private static double computeDSZA(final double dszaIn, final double olat) {

        double dsza = dszaIn;
        if (MathLib.abs(olat) < SO1) {
            final double sang = olat / SO1;
            ...
            dsza = asza - MathLib.abs(olat - dszaIn);
        } else if (olat < 0.) {
            dsza = -dszaIn;
        }
        return dsza;
     ...
     * @return modified YM
     */
    private static double computeYM(final double ymIn, final int if1, final int if2, final double t1, final int lt1,
                                    final int lt2, final double fof2) {
     ...
     *        flux
     */
    private static void fillXK(final int j, final int i1, final int i2, final double xf, final double[] xk,
                               final double hlat, final double flux) {
        ...
        for (int m = 1; m < 4; m++) {
            ...
            if (i1 != i2) {
                final double del = (hlat - DEG[i1 - 1]) / (DEG[i2 - 1] - DEG[i1 - 1]);
    ...
    /**
     * Computes the XNTNM parameter for the PROFL2 method. "Classical parameter TAU or amounting thickness."
     *
     * @param ym
     *        ym
     * @param xk
     ...
     * @return XNTNM
     */
    private static double computeXNTNM(final double ym, final double[] xk, final double yt, final double hm,
                                       final double hs, final double distIn) {
        ...
        if (hs <= hH[0]) {
            if (hs > hm - ym) {
                ...
                if (hs < hm) {
                    xntnm = Q8O15 * ym - dist
                            + 2. * MathLib.pow(dist, 3) / (3. * ym * ym)
                            - MathLib.pow(dist, 5) / (5. * MathLib.pow(dist, 4));
                } else {
                    xntnm = Q8O15 * ym - dist
                            + MathLib.pow(dist, 3) / (3. * yt * yt);
                }
            }
        } else {
     ...
     * @return YM
     */
    private static double computeYM(final double t12in, final double tloc, final int lt1in, final int lt2in,
                                    final double t1in, final double s1, final int if1, final int if2,
                                    final double ymIn, final double hlat) {
        // initialization
        double rat = 0.;
        double t12 = t12in;
        int lt1 = lt1in;
        ...
        if (hlat > D5) {
            ...
            // update rat
            final double rat1 = YRAT[lt1 - 1][if1 - 1] + (YRAT[lt1 - 1][if2 - 1] - YRAT[lt1 - 1][if1 - 1]) * s1;
            final double rat2 = YRAT[lt2 - 1][if1 - 1] + (YRAT[lt2 - 1][if2 - 1] - YRAT[lt2 - 1][if1 - 1]) * s1;
     ...
     */
    private static int correctIF(final int ifIn) {
     ...
     * @return i1 and i2
     */
    private static int[] checkI1I2(final int i1in, final int i2in, final double hlat) {
        ...
        } else if (MathLib.abs(hlat - DEG[1]) > Precision.DOUBLE_COMPARISON_EPSILON) {
            i2 = 1;
            if (hlat >= DEG[0]) {
                i1 = 1;
            }
     ...
     */
    private static double[] magfin(final double[] pos) {
        ...
        // position
        if (MathLib.abs(pos[0]) > Q89P9) {
            pos[0] = MathLib.copySign(Q89P9, pos[0]);
            pos[1] = 0.0;
        }

        // second values
        final double ar = R / (R + pos[2]);
        final double[] sincos0 = MathLib.sinAndCos(pos[0]);
        final double c = sincos0[0];
        final double s = sincos0[1];
        final double[] sincos1 = MathLib.sinAndCos(pos[1]);
        sp[1] = sincos1[0];
        cp[1] = sincos1[1];
        aor[0] = ar * ar;
        aor[1] = aor[0] * ar;
        ...
        for (int n = 2; n < EIGHT; n++) {
            ...
            for (int m = 1; m <= n; m++) {
                ...
                if (m == n) {
                    ...
                    dp[n - 1][m - 1] = c * dp[n - 2][m - 1] - s * p[n - 2][m - 1] - CT[m - 1][n - 1] * dp[n - 3][m - 1];
                }
                final double fm = m - 1;
                final double ts = G[m - 1][n - 1] * cp[m - 1] + H[m - 1][n - 1] * sp[m - 1];
                sumr = sumr + p[n - 1][m - 1] * ts;
                sumt = sumt + dp[n - 1][m - 1] * ts;
                sump = sump + fm * p[n - 1][m - 1] * (-G[m - 1][n - 1] * sp[m - 1] + H[m - 1][n - 1] * cp[m - 1]);
            }
