...
public class VacuumSignalPropagationModel {
    ...
    /**
     * Computes the tropospheric effects corrections to be applied to a given {@link VacuumSignalPropagation} object.
     * 
     * @warning Do not use this method with a date dependent tropospheric model.
     *
     * @param correction
    ...
    public double getSignalTropoCorrection(final TroposphericCorrection correction,
        ...
        final AbsoluteDate emissionDate = signal.getEmissionDate();
        return correction.computeSignalDelay(emissionDate, trueElevation) * Constants.SPEED_OF_LIGHT;
    }
