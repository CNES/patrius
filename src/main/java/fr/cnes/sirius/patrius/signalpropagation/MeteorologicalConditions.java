...
public class MeteorologicalConditions implements Serializable {
     ...
     * @param rh0
     *        reference humidity rate [%]
     * @param h0
     *        reference altitude [m]
     * @param altitude
     *        altitude for which values [T, P, RH] should be returned
     * @return [P, T, RH] values
     * @deprecated as of release 4.11, better use
     *             {@link #computeStandardValues(MeteorologicalConditions, double, double)}.
     */
    // CHECKSTYLE: stop MagicNumber check
    @Deprecated
    public static double[] computeStandardValues(final double p0, final double t0,
                                                 final double rh0, final double h0, final double altitude) {
