...
public final class AzoulayModel implements TroposphericCorrection, AngularCorrection {
    ...
    private MeteorologicalConditionsProvider meteoConditionsProvider;
     ...
     * @deprecated as of release 4.11, better use {@link #AzoulayModel(MeteorologicalConditionsProvider, double)}.
     */
    @Deprecated
     ...
     *             {@link #AzoulayModel(MeteorologicalConditionsProvider, double, boolean)}.
     */
    @Deprecated
    public AzoulayModel(final double pressure, final double temperature, final double moisture,
        ...
        this(new ConstantMeteorologicalConditionsProvider(new MeteorologicalConditions(pressure,
            temperature, moisture)), geodeticAltitude, isGeometricElevation);
    }
     ...
     * @deprecated as of release 4.11, better use {@link #getCorrectionsFromGeometricElevation(AbsoluteDate, double)}. A
    ...
    public double[] getCorrectionsFromGeometricElevation(final double geometricElevation) {
        return getCorrectionsFromGeometricElevation(new AbsoluteDate(), geometricElevation);
    }
     ...
     * @return an array that contains both corrections :
     *         {(geometric elevation - apparent elevation), (geometric distance - apparent distance)}
     * @deprecated as of release 4.11, better use {@link #getCorrectionsFromApparentElevation(AbsoluteDate, double)}. A
     *             date has to be provided for the computations of tropospheric effects.
     */
    @Deprecated
    public double[] getCorrectionsFromApparentElevation(final double apparentElevation) {
        return getCorrectionsFromApparentElevation(new AbsoluteDate(), apparentElevation);
    }
     ...
     * @deprecated as of release 4.11, better use {@link #computeElevationCorrection(AbsoluteDate, double)}. A date has
     ...
     * @deprecated as of release 4.11, better use {@link #computeSignalDelay(AbsoluteDate, double)}. A date has
     *             to be provided for the computations of tropospheric effects.
     */
    @Override
    @Deprecated
