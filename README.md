![patrius_logo](https://github.com/CNES/patrius/blob/main/patrius_logo.png)


# PATRIUS Source Code

This project contains the source code of the PATRIUS library. This code corresponds to **Patrius v4.16**.
